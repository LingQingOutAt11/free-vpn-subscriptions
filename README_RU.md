...
![узлы](https://img.shields.io/badge/узлы-117-brightgreen) ![живые](https://img.shields.io/badge/живые-2651-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-179ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-09_04:20_UTC-informational)
...
- **Выбрано узлов**: 117
- **Живых во всех источниках**: 2651
- **RTT самого быстрого узла**: 43 ms
- **Медиана RTT**: 179 ms
- **Последнее обновление (UTC)**: 2026-07-09 04:20 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 22 · vless × 62 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 9 · `go4sharing-clash` × 1 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 2 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 49
