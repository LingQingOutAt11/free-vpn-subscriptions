...
![узлы](https://img.shields.io/badge/узлы-90-brightgreen) ![живые](https://img.shields.io/badge/живые-2306-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-188ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_21:38_UTC-informational)
...
- **Выбрано узлов**: 90
- **Живых во всех источниках**: 2306
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 188 ms
- **Последнее обновление (UTC)**: 2026-06-19 21:38 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 28 · vless × 9 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 3
