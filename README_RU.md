...
![узлы](https://img.shields.io/badge/узлы-129-brightgreen) ![живые](https://img.shields.io/badge/живые-2472-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-470ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_03:26_UTC-informational)
...
- **Медиана RTT**: 470 ms
- **Последнее обновление (UTC)**: 2026-06-19 03:26 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 38 · trojan × 29 · vless × 50 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 26 · `pawdroid` × 6 · `ruking-clash` × 33 · `snakem982` × 6 · `surfboard-eternity` × 2
