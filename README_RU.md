...
![узлы](https://img.shields.io/badge/узлы-72-brightgreen) ![живые](https://img.shields.io/badge/живые-1887-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-210ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-08_17:12_UTC-informational)
...
- **Медиана RTT**: 210 ms
- **Последнее обновление (UTC)**: 2026-06-08 17:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 31 · trojan × 18 · vless × 12 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 5 · `surfboard-eternity` × 4
