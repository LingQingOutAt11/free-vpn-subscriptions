...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2329-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-82ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-24_06:25_UTC-informational)
...
- **Медиана RTT**: 82 ms
- **Последнее обновление (UTC)**: 2026-05-24 06:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 1 · vless × 89 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 59 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
