...
![узлы](https://img.shields.io/badge/узлы-64-brightgreen) ![живые](https://img.shields.io/badge/живые-3701-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-311ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-28_14:42_UTC-informational)
...
- **Выбрано узлов**: 64
- **Живых во всех источниках**: 3701
- **RTT самого быстрого узла**: 11 ms
- **Медиана RTT**: 311 ms
- **Последнее обновление (UTC)**: 2026-07-28 14:42 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 16 · trojan × 21 · vless × 25 · vmess × 1

**Источники в этом запуске:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `go4sharing-clash` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 8 · `pawdroid` × 5 · `roosterkid-openproxylist` × 2 · `solispirit-v2ray` × 19 · `tg-v2ray-configs-every2h` × 11
