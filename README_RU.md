...
![узлы](https://img.shields.io/badge/узлы-94-brightgreen) ![живые](https://img.shields.io/badge/живые-2107-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-323ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_14:14_UTC-informational)
...
- **Медиана RTT**: 323 ms
- **Последнее обновление (UTC)**: 2026-06-10 14:14 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 14 · vless × 13 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 6
