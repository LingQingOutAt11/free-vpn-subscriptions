...
![узлы](https://img.shields.io/badge/узлы-103-brightgreen) ![живые](https://img.shields.io/badge/живые-2908-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-386ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_15:22_UTC-informational)
...
- **Выбрано узлов**: 103
- **Живых во всех источниках**: 2908
- **RTT самого быстрого узла**: 25 ms
- **Медиана RTT**: 386 ms
- **Последнее обновление (UTC)**: 2026-07-07 15:22 UTC

**Распределение протоколов:** shadowsocks × 3 · trojan × 36 · vless × 52 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 5 · `mahdi0024` × 1 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 4 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 39 · `tg-v2ray-configs-every2h` × 15
