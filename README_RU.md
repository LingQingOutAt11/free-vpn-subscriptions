...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2476-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-94ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_00:12_UTC-informational)
...
- **Медиана RTT**: 94 ms
- **Последнее обновление (UTC)**: 2026-05-10 00:12 UTC

**Распределение протоколов:** shadowsocks × 50 · trojan × 4 · vless × 89 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 62 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 9
