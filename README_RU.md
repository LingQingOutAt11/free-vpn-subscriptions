...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2084-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-197ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-03_19:24_UTC-informational)
...
- **Медиана RTT**: 197 ms
- **Последнее обновление (UTC)**: 2026-05-03 19:24 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 23 · vless × 86 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 58 · `pawdroid` × 2 · `surfboard-eternity` × 5
