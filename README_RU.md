...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2000-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-279ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_15:33_UTC-informational)
...
- **Медиана RTT**: 279 ms
- **Последнее обновление (UTC)**: 2026-05-06 15:33 UTC

**Распределение протоколов:** shadowsocks × 47 · trojan × 19 · vless × 72 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 9 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
