...
![узлы](https://img.shields.io/badge/узлы-83-brightgreen) ![живые](https://img.shields.io/badge/живые-2437-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-147ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-01_08:08_UTC-informational)
...
- **Медиана RTT**: 147 ms
- **Последнее обновление (UTC)**: 2026-06-01 08:08 UTC

**Распределение протоколов:** shadowsocks × 14 · trojan × 29 · vless × 10 · vmess × 30

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 15 · `mahdi0024` × 21 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `surfboard-eternity` × 3
