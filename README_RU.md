...
![узлы](https://img.shields.io/badge/узлы-146-brightgreen) ![живые](https://img.shields.io/badge/живые-2044-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-99ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-21_20:16_UTC-informational)
...
- **Медиана RTT**: 99 ms
- **Последнее обновление (UTC)**: 2026-05-21 20:16 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 31 · vless × 70 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 39 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `pawdroid` × 10 · `snakem982` × 1 · `surfboard-eternity` × 9
