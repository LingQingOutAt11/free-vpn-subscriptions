...
![узлы](https://img.shields.io/badge/узлы-113-brightgreen) ![живые](https://img.shields.io/badge/живые-2309-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-377ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-12_07:10_UTC-informational)
...
- **Выбрано узлов**: 113
- **Живых во всех источниках**: 2309
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 377 ms
- **Последнее обновление (UTC)**: 2026-06-12 07:10 UTC

**Распределение протоколов:** shadowsocks × 48 · trojan × 43 · vless × 16 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 4
