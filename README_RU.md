...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-1936-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-302ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-13_03:35_UTC-informational)
...
- **Медиана RTT**: 302 ms
- **Последнее обновление (UTC)**: 2026-06-13 03:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 25 · vless × 31 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 33 · `pawdroid` × 6 · `ruking-clash` × 13 · `surfboard-eternity` × 7
