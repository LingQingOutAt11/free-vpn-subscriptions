...
![узлы](https://img.shields.io/badge/узлы-92-brightgreen) ![живые](https://img.shields.io/badge/живые-2455-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-113ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-03_13:32_UTC-informational)
...
- **Медиана RTT**: 113 ms
- **Последнее обновление (UTC)**: 2026-06-03 13:32 UTC

**Распределение протоколов:** shadowsocks × 14 · trojan × 36 · vless × 14 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `surfboard-eternity` × 4
