...
![узлы](https://img.shields.io/badge/узлы-112-brightgreen) ![живые](https://img.shields.io/badge/живые-2140-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-331ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-24_23:23_UTC-informational)
...
- **Выбрано узлов**: 112
- **Живых во всех источниках**: 2140
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 331 ms
- **Последнее обновление (UTC)**: 2026-06-24 23:23 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 33 · vless × 36 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 31 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 16 · `surfboard-eternity` × 3
