...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2399-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-133ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_00:24_UTC-informational)
...
- **Медиана RTT**: 133 ms
- **Последнее обновление (UTC)**: 2026-05-09 00:24 UTC

**Распределение протоколов:** shadowsocks × 51 · trojan × 7 · vless × 83 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 74 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 2
