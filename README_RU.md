...
![узлы](https://img.shields.io/badge/узлы-89-brightgreen) ![живые](https://img.shields.io/badge/живые-2052-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-235ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-27_11:27_UTC-informational)
...
- **Медиана RTT**: 235 ms
- **Последнее обновление (UTC)**: 2026-06-27 11:27 UTC

**Распределение протоколов:** shadowsocks × 17 · trojan × 34 · vless × 15 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `ruking-clash` × 14 · `surfboard-eternity` × 3
