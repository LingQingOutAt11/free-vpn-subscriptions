...
![узлы](https://img.shields.io/badge/узлы-136-brightgreen) ![живые](https://img.shields.io/badge/живые-1689-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-359ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_00:11_UTC-informational)
...
- **Выбрано узлов**: 136
- **Живых во всех источниках**: 1689
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 359 ms
- **Последнее обновление (UTC)**: 2026-06-14 00:11 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 56 · trojan × 35 · vless × 37 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 24 · `ninjastrikers` × 37 · `pawdroid` × 5 · `ruking-clash` × 15 · `surfboard-eternity` × 2
