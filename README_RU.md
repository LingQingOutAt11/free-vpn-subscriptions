...
![узлы](https://img.shields.io/badge/узлы-124-brightgreen) ![живые](https://img.shields.io/badge/живые-1977-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-357ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_05:27_UTC-informational)
...
- **Медиана RTT**: 357 ms
- **Последнее обновление (UTC)**: 2026-06-28 05:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 37 · vless × 38 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 30 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 4
