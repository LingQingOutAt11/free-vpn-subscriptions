...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2451-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-268ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_22:30_UTC-informational)
...
- **Медиана RTT**: 268 ms
- **Последнее обновление (UTC)**: 2026-05-10 22:30 UTC

**Распределение протоколов:** shadowsocks × 49 · trojan × 18 · vless × 73 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `ruking-clash` × 6 · `snakem982` × 7 · `surfboard-eternity` × 7
