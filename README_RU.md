...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2422-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-89ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-18_14:16_UTC-informational)
...
- **Медиана RTT**: 89 ms
- **Последнее обновление (UTC)**: 2026-05-18 14:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 44 · trojan × 10 · vless × 88 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 39 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 48 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 7
