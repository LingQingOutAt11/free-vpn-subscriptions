...
![узлы](https://img.shields.io/badge/узлы-88-brightgreen) ![живые](https://img.shields.io/badge/живые-3103-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-113ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-08-01_19:40_UTC-informational)
...
- **Выбрано узлов**: 88
- **Живых во всех источниках**: 3103
- **RTT самого быстрого узла**: 15 ms
- **Медиана RTT**: 113 ms
- **Последнее обновление (UTC)**: 2026-08-01 19:40 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 13 · trojan × 18 · vless × 49 · vmess × 6

**Источники в этом запуске:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 12 · `barry-far-v2ray` × 3 · `epodonios` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 4 · `ninjastrikers` × 5 · `pawdroid` × 4 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 1 · `snakem982` × 1 · `solispirit-v2ray` × 25 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 11
