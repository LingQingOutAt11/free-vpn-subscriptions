...
![узлы](https://img.shields.io/badge/узлы-125-brightgreen) ![живые](https://img.shields.io/badge/живые-1723-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-306ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_02:19_UTC-informational)
...
- **Выбрано узлов**: 125
- **Живых во всех источниках**: 1723
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 306 ms
- **Последнее обновление (UTC)**: 2026-06-15 02:19 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 24 · vless × 38 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 36 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 4
