...
![узлы](https://img.shields.io/badge/узлы-97-brightgreen) ![живые](https://img.shields.io/badge/живые-2292-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-164ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_00:29_UTC-informational)
...
- **Медиана RTT**: 164 ms
- **Последнее обновление (UTC)**: 2026-06-10 00:29 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 12 · vless × 26 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 1 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 1 · `ninjastrikers` × 29 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 1
