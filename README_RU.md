...
![узлы](https://img.shields.io/badge/узлы-126-brightgreen) ![живые](https://img.shields.io/badge/живые-1892-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-361ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_02:29_UTC-informational)
...
- **Медиана RTT**: 361 ms
- **Последнее обновление (UTC)**: 2026-06-17 02:29 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 34 · vless × 29 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 15 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 25 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 5
