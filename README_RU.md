...
![узлы](https://img.shields.io/badge/узлы-143-brightgreen) ![живые](https://img.shields.io/badge/живые-4130-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-144ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-27_04:09_UTC-informational)
...
- **Выбрано узлов**: 143
- **Живых во всех источниках**: 4130
- **RTT самого быстрого узла**: 39 ms
- **Медиана RTT**: 144 ms
- **Последнее обновление (UTC)**: 2026-07-27 04:09 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 21 · trojan × 23 · vless × 91 · vmess × 7

**Источники в этом запуске:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 8 · `barry-far-v2ray` × 3 · `epodonios` × 2 · `go4sharing-clash` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 1 · `snakem982` × 2 · `solispirit-v2ray` × 57 · `surfboard-eternity` × 4 · `tg-v2ray-configs-every2h` × 21
