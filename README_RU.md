...
![узлы](https://img.shields.io/badge/узлы-128-brightgreen) ![живые](https://img.shields.io/badge/живые-2805-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-320ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_10:08_UTC-informational)
...
- **Выбрано узлов**: 128
- **Живых во всех источниках**: 2805
- **RTT самого быстрого узла**: 22 ms
- **Медиана RTT**: 320 ms
- **Последнее обновление (UTC)**: 2026-07-07 10:08 UTC

**Распределение протоколов:** shadowsocks × 14 · trojan × 34 · vless × 69 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 6 · `ninjastrikers` × 11 · `pawdroid` × 5 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 12 · `ruking-clash` × 1 · `solispirit-v2ray` × 44 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 19
