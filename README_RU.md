...
![узлы](https://img.shields.io/badge/узлы-79-brightgreen) ![живые](https://img.shields.io/badge/живые-2404-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-331ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_22:17_UTC-informational)
...
- **Медиана RTT**: 331 ms
- **Последнее обновление (UTC)**: 2026-06-11 22:17 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 20 · vless × 12 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 7 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 4
