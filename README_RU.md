...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2018-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-145ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-08_05:25_UTC-informational)
...
- **Медиана RTT**: 145 ms
- **Последнее обновление (UTC)**: 2026-05-08 05:25 UTC

**Распределение протоколов:** shadowsocks × 46 · trojan × 12 · vless × 82 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 12 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 78 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
