...
![узлы](https://img.shields.io/badge/узлы-118-brightgreen) ![живые](https://img.shields.io/badge/живые-1756-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-427ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_17:37_UTC-informational)
...
- **Выбрано узлов**: 118
- **Живых во всех источниках**: 1756
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 427 ms
- **Последнее обновление (UTC)**: 2026-06-17 17:37 UTC

**Распределение протоколов:** hysteria2 × 4 · shadowsocks × 47 · trojan × 33 · vless × 27 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 3 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 21 · `surfboard-eternity` × 6
