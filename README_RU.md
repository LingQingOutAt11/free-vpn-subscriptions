...
![узлы](https://img.shields.io/badge/узлы-126-brightgreen) ![живые](https://img.shields.io/badge/живые-1915-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-485ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-18_04:13_UTC-informational)
...
- **Медиана RTT**: 485 ms
- **Последнее обновление (UTC)**: 2026-06-18 04:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 44 · trojan × 30 · vless × 44 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `epodonios` × 17 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 25 · `pawdroid` × 2 · `ruking-clash` × 21 · `snakem982` × 6 · `surfboard-eternity` × 2
