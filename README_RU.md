...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2140-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-250ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_10:20_UTC-informational)
...
- **Медиана RTT**: 250 ms
- **Последнее обновление (UTC)**: 2026-05-06 10:20 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 13 · vless × 86 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 65 · `pawdroid` × 2 · `surfboard-eternity` × 10
