...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2577-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-71ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-20_08:35_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2577
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 71 ms
- **Последнее обновление (UTC)**: 2026-05-20 08:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 31 · trojan × 7 · vless × 94 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 71 · `pawdroid` × 7 · `surfboard-eternity` × 8
