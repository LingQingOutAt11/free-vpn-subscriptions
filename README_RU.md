...
![узлы](https://img.shields.io/badge/узлы-93-brightgreen) ![живые](https://img.shields.io/badge/живые-2971-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-210ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-03_04:15_UTC-informational)
...
- **Медиана RTT**: 210 ms
- **Последнее обновление (UTC)**: 2026-07-03 04:15 UTC

**Распределение протоколов:** shadowsocks × 6 · trojan × 32 · vless × 50 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 10 · `pawdroid` × 3 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 34 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 22
