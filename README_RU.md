...
![узлы](https://img.shields.io/badge/узлы-80-brightgreen) ![живые](https://img.shields.io/badge/живые-2130-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-434ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_20:13_UTC-informational)
...
- **Медиана RTT**: 434 ms
- **Последнее обновление (UTC)**: 2026-06-28 20:13 UTC

**Распределение протоколов:** shadowsocks × 16 · trojan × 29 · vless × 18 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 4
