...
![узлы](https://img.shields.io/badge/узлы-107-brightgreen) ![живые](https://img.shields.io/badge/живые-1815-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-374ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-16_10:18_UTC-informational)
...
- **Медиана RTT**: 374 ms
- **Последнее обновление (UTC)**: 2026-06-16 10:18 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 28 · vless × 18 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 1
