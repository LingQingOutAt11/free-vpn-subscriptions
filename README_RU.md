...
![узлы](https://img.shields.io/badge/узлы-104-brightgreen) ![живые](https://img.shields.io/badge/живые-2337-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-353ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-01_05:31_UTC-informational)
...
- **Медиана RTT**: 353 ms
- **Последнее обновление (UTC)**: 2026-07-01 05:31 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 36 · vless × 19 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 5 · `mfuu-clash` × 13 · `ninjastrikers` × 21 · `pawdroid` × 3 · `surfboard-eternity` × 5
