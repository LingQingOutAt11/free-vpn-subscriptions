...
![узлы](https://img.shields.io/badge/узлы-112-brightgreen) ![живые](https://img.shields.io/badge/живые-1833-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-385ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_20:16_UTC-informational)
...
- **Выбрано узлов**: 112
- **Живых во всех источниках**: 1833
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 385 ms
- **Последнее обновление (UTC)**: 2026-06-15 20:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 52 · trojan × 24 · vless × 20 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 4
