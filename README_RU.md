...
![узлы](https://img.shields.io/badge/узлы-58-brightgreen) ![живые](https://img.shields.io/badge/живые-2207-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-111ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-29_20:16_UTC-informational)
...
- **Медиана RTT**: 111 ms
- **Последнее обновление (UTC)**: 2026-05-29 20:16 UTC

**Распределение протоколов:** shadowsocks × 11 · trojan × 21 · vless × 4 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 4 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 2
