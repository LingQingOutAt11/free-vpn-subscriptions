...
![узлы](https://img.shields.io/badge/узлы-76-brightgreen) ![живые](https://img.shields.io/badge/живые-2070-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-208ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-09_16:39_UTC-informational)
...
- **Медиана RTT**: 208 ms
- **Последнее обновление (UTC)**: 2026-06-09 16:39 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 31 · trojan × 14 · vless × 8 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 9 · `pawdroid` × 5 · `ruking-clash` × 4
