...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1968-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-146ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-08_08:23_UTC-informational)
...
- **Медиана RTT**: 146 ms
- **Последнее обновление (UTC)**: 2026-05-08 08:23 UTC

**Распределение протоколов:** shadowsocks × 52 · trojan × 5 · vless × 84 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 68 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 11
