...
![узлы](https://img.shields.io/badge/узлы-89-brightgreen) ![живые](https://img.shields.io/badge/живые-4075-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-113ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-23_03:49_UTC-informational)
...
- **Выбрано узлов**: 89
- **Живых во всех источниках**: 4075
- **RTT самого быстрого узла**: 16 ms
- **Медиана RTT**: 113 ms
- **Последнее обновление (UTC)**: 2026-07-23 03:49 UTC

**Распределение протоколов:** shadowsocks × 8 · trojan × 23 · vless × 56 · vmess × 2

**Источники в этом запуске:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 6 · `epodonios` × 2 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `roosterkid-openproxylist` × 4 · `snakem982` × 1 · `solispirit-v2ray` × 34 · `tg-v2ray-configs-every2h` × 19
