...
![узлы](https://img.shields.io/badge/узлы-145-brightgreen) ![живые](https://img.shields.io/badge/живые-2507-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-175ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_15:31_UTC-informational)
...
- **Выбрано узлов**: 145
- **Живых во всех источниках**: 2507
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 175 ms
- **Последнее обновление (UTC)**: 2026-05-09 15:31 UTC

**Распределение протоколов:** shadowsocks × 47 · trojan × 19 · vless × 70 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 17 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 59 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 3 · `surfboard-eternity` × 6
