...
![узлы](https://img.shields.io/badge/узлы-132-brightgreen) ![живые](https://img.shields.io/badge/живые-1755-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-368ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_03:27_UTC-informational)
...
- **Выбрано узлов**: 132
- **Живых во всех источниках**: 1755
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 368 ms
- **Последнее обновление (UTC)**: 2026-06-15 03:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 51 · trojan × 25 · vless × 42 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 37 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 4
