...
![узлы](https://img.shields.io/badge/узлы-66-brightgreen) ![живые](https://img.shields.io/badge/живые-2240-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-133ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-29_19:21_UTC-informational)
...
- **Медиана RTT**: 133 ms
- **Последнее обновление (UTC)**: 2026-05-29 19:21 UTC

**Распределение протоколов:** shadowsocks × 12 · trojan × 27 · vless × 4 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
