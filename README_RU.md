...
![узлы](https://img.shields.io/badge/узлы-95-brightgreen) ![живые](https://img.shields.io/badge/живые-2271-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-214ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_06:20_UTC-informational)
...
- **Медиана RTT**: 214 ms
- **Последнее обновление (UTC)**: 2026-06-20 06:20 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 29 · vless × 17 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 7 · `ruking-clash` × 17 · `surfboard-eternity` × 7
