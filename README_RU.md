...
![узлы](https://img.shields.io/badge/узлы-140-brightgreen) ![живые](https://img.shields.io/badge/живые-1964-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-400ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-21_20:26_UTC-informational)
...
- **Медиана RTT**: 400 ms
- **Последнее обновление (UTC)**: 2026-06-21 20:26 UTC

**Распределение протоколов:** shadowsocks × 48 · trojan × 32 · vless × 46 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 27 · `snakem982` × 9 · `surfboard-eternity` × 6
