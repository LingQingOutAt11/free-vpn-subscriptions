...
![узлы](https://img.shields.io/badge/узлы-101-brightgreen) ![живые](https://img.shields.io/badge/живые-2034-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-339ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_01:36_UTC-informational)
...
- **Выбрано узлов**: 101
- **Живых во всех источниках**: 2034
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 339 ms
- **Последнее обновление (UTC)**: 2026-06-30 01:36 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 34 · vless × 21 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 14 · `surfboard-eternity` × 3
