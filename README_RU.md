...
![узлы](https://img.shields.io/badge/узлы-126-brightgreen) ![живые](https://img.shields.io/badge/живые-1994-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-423ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-21_14:21_UTC-informational)
...
- **Медиана RTT**: 423 ms
- **Последнее обновление (UTC)**: 2026-06-21 14:21 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 29 · vless × 43 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 27 · `snakem982` × 6 · `surfboard-eternity` × 2
