...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2406-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-114ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-13_22:33_UTC-informational)
...
- **Медиана RTT**: 114 ms
- **Последнее обновление (UTC)**: 2026-05-13 22:33 UTC

**Распределение протоколов:** shadowsocks × 48 · trojan × 18 · vless × 75 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 50 · `pawdroid` × 6 · `ruking-clash` × 9 · `snakem982` × 1 · `surfboard-eternity` × 8
