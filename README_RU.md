...
![узлы](https://img.shields.io/badge/узлы-133-brightgreen) ![живые](https://img.shields.io/badge/живые-1884-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-465ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-18_02:27_UTC-informational)
...
- **Медиана RTT**: 465 ms
- **Последнее обновление (UTC)**: 2026-06-18 02:27 UTC

**Распределение протоколов:** hysteria2 × 4 · shadowsocks × 46 · trojan × 32 · vless × 43 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 25 · `pawdroid` × 3 · `ruking-clash` × 32 · `surfboard-eternity` × 3
