...
![узлы](https://img.shields.io/badge/узлы-87-brightgreen) ![живые](https://img.shields.io/badge/живые-2239-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-370ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-01_13:25_UTC-informational)
...
- **Медиана RTT**: 370 ms
- **Последнее обновление (UTC)**: 2026-07-01 13:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 35 · trojan × 34 · vless × 11 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 10 · `ninjastrikers` × 16 · `pawdroid` × 3 · `surfboard-eternity` × 3
