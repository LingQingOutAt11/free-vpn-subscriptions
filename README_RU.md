...
![узлы](https://img.shields.io/badge/узлы-139-brightgreen) ![живые](https://img.shields.io/badge/живые-1700-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-355ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_00:26_UTC-informational)
...
- **Медиана RTT**: 355 ms
- **Последнее обновление (UTC)**: 2026-06-15 00:26 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 55 · trojan × 26 · vless × 43 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 5 · `mahdi0024` × 14 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 38 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 2
