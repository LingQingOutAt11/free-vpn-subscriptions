...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2397-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-114ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-13_03:17_UTC-informational)
...
- **Медиана RTT**: 114 ms
- **Последнее обновление (UTC)**: 2026-05-13 03:17 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 4 · vless × 96 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 66 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
