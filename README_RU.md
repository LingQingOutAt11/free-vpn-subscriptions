...
![узлы](https://img.shields.io/badge/узлы-97-brightgreen) ![живые](https://img.shields.io/badge/живые-2214-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-228ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_05:38_UTC-informational)
...
- **Медиана RTT**: 228 ms
- **Последнее обновление (UTC)**: 2026-06-11 05:38 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 15 · vless × 21 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 26 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 4
