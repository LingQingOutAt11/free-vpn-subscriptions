...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2550-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-75ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-20_14:36_UTC-informational)
...
- **Медиана RTT**: 75 ms
- **Последнее обновление (UTC)**: 2026-05-20 14:36 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 21 · vless × 69 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 7
