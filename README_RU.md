...
![узлы](https://img.shields.io/badge/узлы-76-brightgreen) ![живые](https://img.shields.io/badge/живые-2337-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-205ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_08:30_UTC-informational)
...
- **Медиана RTT**: 205 ms
- **Последнее обновление (UTC)**: 2026-06-10 08:30 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 12 · vless × 12 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 3
