...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2047-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-71ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_11:28_UTC-informational)
...
- **Медиана RTT**: 71 ms
- **Последнее обновление (UTC)**: 2026-05-22 11:28 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 36 · trojan × 8 · vless × 90 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 64 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 6
