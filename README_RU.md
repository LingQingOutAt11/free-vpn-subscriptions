...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2317-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-82ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-23_12:35_UTC-informational)
...
- **Медиана RTT**: 82 ms
- **Последнее обновление (UTC)**: 2026-05-23 12:35 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 12 · vless × 91 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 8 · `ruking-clash` × 3 · `surfboard-eternity` × 4
