...
![узлы](https://img.shields.io/badge/узлы-64-brightgreen) ![живые](https://img.shields.io/badge/живые-4174-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-97ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-22_14:28_UTC-informational)
...
- **Выбрано узлов**: 64
- **Живых во всех источниках**: 4174
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 97 ms
- **Последнее обновление (UTC)**: 2026-07-22 14:28 UTC

**Распределение протоколов:** shadowsocks × 9 · trojan × 13 · vless × 38 · vmess × 4

**Источники в этом запуске:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 25 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 9
