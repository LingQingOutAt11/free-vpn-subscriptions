...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2061-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-163ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_16:14_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2061
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 163 ms
- **Последнее обновление (UTC)**: 2026-05-07 16:14 UTC

**Распределение протоколов:** shadowsocks × 59 · trojan × 9 · vless × 71 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 56 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 8
