...
![узлы](https://img.shields.io/badge/узлы-128-brightgreen) ![живые](https://img.shields.io/badge/живые-2042-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-424ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-23_11:38_UTC-informational)
...
- **Медиана RTT**: 424 ms
- **Последнее обновление (UTC)**: 2026-06-23 11:38 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 28 · vless × 52 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 45 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 7 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 3
