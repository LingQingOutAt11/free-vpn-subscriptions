...
![узлы](https://img.shields.io/badge/узлы-100-brightgreen) ![живые](https://img.shields.io/badge/живые-2682-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-332ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-10_19:59_UTC-informational)
...
- **Медиана RTT**: 332 ms
- **Последнее обновление (UTC)**: 2026-07-10 19:59 UTC

**Распределение протоколов:** shadowsocks × 11 · trojan × 26 · vless × 59 · vmess × 4

**Источники в этом запуске:** `epodonios` × 3 · `go4sharing-clash` × 1 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 15 · `solispirit-v2ray` × 41 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
