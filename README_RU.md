...
![узлы](https://img.shields.io/badge/узлы-117-brightgreen) ![живые](https://img.shields.io/badge/живые-2009-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-355ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_08:34_UTC-informational)
...
- **Медиана RTT**: 355 ms
- **Последнее обновление (UTC)**: 2026-06-28 08:34 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 33 · trojan × 39 · vless × 29 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 3
