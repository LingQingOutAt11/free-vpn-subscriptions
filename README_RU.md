...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2263-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-159ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-05_10:33_UTC-informational)
...
- **Медиана RTT**: 159 ms
- **Последнее обновление (UTC)**: 2026-05-05 10:33 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 21 · vless × 84 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 69 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
