...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1662-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-440ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_20:21_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1662
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 440 ms
- **Последнее обновление (UTC)**: 2026-06-17 20:21 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 78 · trojan × 31 · vless × 33 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 32 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 3 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 26 · `surfboard-eternity` × 2
