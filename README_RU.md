...
![узлы](https://img.shields.io/badge/узлы-90-brightgreen) ![живые](https://img.shields.io/badge/живые-1955-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-204ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-04_10:40_UTC-informational)
...
- **Медиана RTT**: 204 ms
- **Последнее обновление (UTC)**: 2026-06-04 10:40 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 40 · vless × 17 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 7 · `surfboard-eternity` × 2
