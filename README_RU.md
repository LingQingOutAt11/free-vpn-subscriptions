...
![узлы](https://img.shields.io/badge/узлы-81-brightgreen) ![живые](https://img.shields.io/badge/живые-2327-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-367ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_18:21_UTC-informational)
...
- **Медиана RTT**: 367 ms
- **Последнее обновление (UTC)**: 2026-06-11 18:21 UTC

**Распределение протоколов:** shadowsocks × 47 · trojan × 13 · vless × 16 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 3
