...
![узлы](https://img.shields.io/badge/узлы-88-brightgreen) ![живые](https://img.shields.io/badge/живые-2318-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-250ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_23:18_UTC-informational)
...
- **Медиана RTT**: 250 ms
- **Последнее обновление (UTC)**: 2026-06-19 23:18 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 25 · vless × 9 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 10 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 4
