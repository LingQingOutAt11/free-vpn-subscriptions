...
![узлы](https://img.shields.io/badge/узлы-86-brightgreen) ![живые](https://img.shields.io/badge/живые-2347-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-123ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_17:27_UTC-informational)
...
- **Медиана RTT**: 123 ms
- **Последнее обновление (UTC)**: 2026-06-02 17:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 21 · trojan × 24 · vless × 8 · vmess × 32

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `mahdi0024` × 30 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `surfboard-eternity` × 4
