...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2079-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-90ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-04_01:31_UTC-informational)
...
- **Медиана RTT**: 90 ms
- **Последнее обновление (UTC)**: 2026-05-04 01:31 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 7 · vless × 103 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 72 · `ruking-clash` × 2 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
