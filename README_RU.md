...
![узлы](https://img.shields.io/badge/узлы-124-brightgreen) ![живые](https://img.shields.io/badge/живые-3277-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-201ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-08-04_03:43_UTC-informational)
...
- **Выбрано узлов**: 124
- **Живых во всех источниках**: 3277
- **RTT самого быстрого узла**: 49 ms
- **Медиана RTT**: 201 ms
- **Последнее обновление (UTC)**: 2026-08-04 03:43 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 22 · trojan × 14 · vless × 70 · vmess × 16

**Источники в этом запуске:** `autojiedian-clash` × 11 · `automerge-verified-clash` × 22 · `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 3 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 13 · `ruking-clash` × 2 · `snakem982` × 1 · `solispirit-v2ray` × 28 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 8
