...
![узлы](https://img.shields.io/badge/узлы-140-brightgreen) ![живые](https://img.shields.io/badge/живые-2117-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-316ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-21_05:20_UTC-informational)
...
- **Медиана RTT**: 316 ms
- **Последнее обновление (UTC)**: 2026-06-21 05:20 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 34 · vless × 41 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 4 · `mfuu-clash` × 6 · `ninjastrikers` × 21 · `pawdroid` × 1 · `ruking-clash` × 31 · `snakem982` × 2 · `surfboard-eternity` × 1
