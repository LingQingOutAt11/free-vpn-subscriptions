...
![узлы](https://img.shields.io/badge/узлы-93-brightgreen) ![живые](https://img.shields.io/badge/живые-1873-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-351ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-09_10:25_UTC-informational)
...
- **Выбрано узлов**: 93
- **Живых во всех источниках**: 1873
- **RTT самого быстрого узла**: 22 ms
- **Медиана RTT**: 351 ms
- **Последнее обновление (UTC)**: 2026-06-09 10:25 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 48 · trojan × 18 · vless × 14 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
