...
![узлы](https://img.shields.io/badge/узлы-144-brightgreen) ![живые](https://img.shields.io/badge/живые-1902-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-451ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_09:28_UTC-informational)
...
- **Медиана RTT**: 451 ms
- **Последнее обновление (UTC)**: 2026-06-22 09:28 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 30 · vless × 51 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 29 · `snakem982` × 1 · `surfboard-eternity` × 3
