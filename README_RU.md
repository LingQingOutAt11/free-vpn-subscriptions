...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2397-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-225ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_21:35_UTC-informational)
...
- **Медиана RTT**: 225 ms
- **Последнее обновление (UTC)**: 2026-05-10 21:35 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 58 · trojan × 9 · vless × 73 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 6 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
