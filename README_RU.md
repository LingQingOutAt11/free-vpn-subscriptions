...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2401-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-139ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-12_21:15_UTC-informational)
...
- **Медиана RTT**: 139 ms
- **Последнее обновление (UTC)**: 2026-05-12 21:15 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 17 · vless × 84 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 44 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 47 · `snakem982` × 2 · `surfboard-eternity` × 3
