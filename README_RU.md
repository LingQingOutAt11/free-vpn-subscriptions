...
![узлы](https://img.shields.io/badge/узлы-103-brightgreen) ![живые](https://img.shields.io/badge/живые-1922-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-320ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-13_06:18_UTC-informational)
...
- **Медиана RTT**: 320 ms
- **Последнее обновление (UTC)**: 2026-06-13 06:18 UTC

**Распределение протоколов:** shadowsocks × 53 · trojan × 23 · vless × 20 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 25 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 4
