...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2643-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-84ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_06:23_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2643
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 84 ms
- **Последнее обновление (UTC)**: 2026-05-17 06:23 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 7 · vless × 96 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 60 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 6
