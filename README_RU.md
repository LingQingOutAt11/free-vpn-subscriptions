...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1957-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-305ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_16:22_UTC-informational)
...
- **Медиана RTT**: 305 ms
- **Последнее обновление (UTC)**: 2026-05-06 16:22 UTC

**Распределение протоколов:** shadowsocks × 45 · trojan × 19 · vless × 75 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 61 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
