...
![узлы](https://img.shields.io/badge/узлы-108-brightgreen) ![живые](https://img.shields.io/badge/живые-2354-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-103ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-03_01:11_UTC-informational)
...
- **Медиана RTT**: 103 ms
- **Последнее обновление (UTC)**: 2026-06-03 01:11 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 32 · vless × 26 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `epodonios` × 13 · `mahdi0024` × 25 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 31 · `surfboard-eternity` × 4
