...
![узлы](https://img.shields.io/badge/узлы-90-brightgreen) ![живые](https://img.shields.io/badge/живые-2845-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-315ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_20:23_UTC-informational)
...
- **Выбрано узлов**: 90
- **Живых во всех источниках**: 2845
- **RTT самого быстрого узла**: 49 ms
- **Медиана RTT**: 315 ms
- **Последнее обновление (UTC)**: 2026-07-07 20:23 UTC

**Распределение протоколов:** shadowsocks × 8 · trojan × 29 · vless × 41 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 3 · `ninjastrikers` × 8 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 15 · `solispirit-v2ray` × 32 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 9
