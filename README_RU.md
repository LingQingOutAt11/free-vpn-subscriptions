...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1971-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-621ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-16_19:26_UTC-informational)
...
- **Медиана RTT**: 621 ms
- **Последнее обновление (UTC)**: 2026-06-16 19:26 UTC

**Распределение протоколов:** shadowsocks × 48 · trojan × 20 · vless × 12 · vmess × 70

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 77 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 3
