...
![узлы](https://img.shields.io/badge/узлы-114-brightgreen) ![живые](https://img.shields.io/badge/живые-2389-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-483ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-18_17:29_UTC-informational)
...
- **Выбрано узлов**: 114
- **Живых во всех источниках**: 2389
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 483 ms
- **Последнее обновление (UTC)**: 2026-06-18 17:29 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 30 · vless × 40 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 8 · `pawdroid` × 1 · `ruking-clash` × 25 · `snakem982` × 9 · `surfboard-eternity` × 5
