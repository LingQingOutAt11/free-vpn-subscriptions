...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2414-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-230ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_15:35_UTC-informational)
...
- **Медиана RTT**: 230 ms
- **Последнее обновление (UTC)**: 2026-05-10 15:35 UTC

**Распределение протоколов:** shadowsocks × 47 · trojan × 17 · vless × 76 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 36 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 58 · `pawdroid` × 3 · `ruking-clash` × 7 · `snakem982` × 1 · `surfboard-eternity` × 5
