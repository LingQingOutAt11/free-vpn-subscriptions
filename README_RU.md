...
![узлы](https://img.shields.io/badge/узлы-93-brightgreen) ![живые](https://img.shields.io/badge/живые-2253-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-171ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_06:36_UTC-informational)
...
- **Медиана RTT**: 171 ms
- **Последнее обновление (UTC)**: 2026-06-07 06:36 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 23 · vless × 14 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 17 · `pawdroid` × 2 · `surfboard-eternity` × 5
