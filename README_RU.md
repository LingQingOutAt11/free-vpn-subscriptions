...
![узлы](https://img.shields.io/badge/узлы-95-brightgreen) ![живые](https://img.shields.io/badge/живые-2198-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-279ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_06:31_UTC-informational)
...
- **Медиана RTT**: 279 ms
- **Последнее обновление (UTC)**: 2026-06-11 06:31 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 39 · trojan × 19 · vless × 15 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 4
