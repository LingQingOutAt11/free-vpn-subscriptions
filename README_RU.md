...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1911-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-387ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_06:31_UTC-informational)
...
- **Медиана RTT**: 387 ms
- **Последнее обновление (UTC)**: 2026-06-22 06:31 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 32 · vless × 58 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 30 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 25 · `pawdroid` × 4 · `ruking-clash` × 25 · `snakem982` × 3 · `surfboard-eternity` × 4
