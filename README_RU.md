...
![узлы](https://img.shields.io/badge/узлы-130-brightgreen) ![живые](https://img.shields.io/badge/живые-2081-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-83ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-26_15:31_UTC-informational)
...
- **Медиана RTT**: 83 ms
- **Последнее обновление (UTC)**: 2026-05-26 15:31 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 21 · vless × 65 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 53 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 3
