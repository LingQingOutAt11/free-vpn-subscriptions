...
![узлы](https://img.shields.io/badge/узлы-102-brightgreen) ![живые](https://img.shields.io/badge/живые-2200-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-102ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-30_02:09_UTC-informational)
...
- **Медиана RTT**: 102 ms
- **Последнее обновление (UTC)**: 2026-05-30 02:09 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 16 · trojan × 25 · vless × 33 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `mahdi0024` × 23 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 32 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
