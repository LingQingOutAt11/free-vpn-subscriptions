...
![узлы](https://img.shields.io/badge/узлы-95-brightgreen) ![живые](https://img.shields.io/badge/живые-1925-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-362ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-27_18:35_UTC-informational)
...
- **Медиана RTT**: 362 ms
- **Последнее обновление (UTC)**: 2026-06-27 18:35 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 39 · vless × 18 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 7
