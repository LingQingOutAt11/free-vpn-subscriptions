...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2046-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-141ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_00:17_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2046
- **RTT самого быстрого узла**: 39 ms
- **Медиана RTT**: 141 ms
- **Последнее обновление (UTC)**: 2026-05-07 00:17 UTC

**Распределение протоколов:** shadowsocks × 50 · trojan × 5 · vless × 83 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 25 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 63 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
