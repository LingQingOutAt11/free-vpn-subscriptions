...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1975-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-141ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-12_04:25_UTC-informational)
...
- **Медиана RTT**: 141 ms
- **Последнее обновление (UTC)**: 2026-05-12 04:25 UTC

**Распределение протоколов:** shadowsocks × 56 · trojan × 5 · vless × 80 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 72 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 10
