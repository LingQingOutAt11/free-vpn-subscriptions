...
![узлы](https://img.shields.io/badge/узлы-97-brightgreen) ![живые](https://img.shields.io/badge/живые-2074-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-220ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-27_06:39_UTC-informational)
...
- **Медиана RTT**: 220 ms
- **Последнее обновление (UTC)**: 2026-06-27 06:39 UTC

**Распределение протоколов:** shadowsocks × 18 · trojan × 34 · vless × 25 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 2
