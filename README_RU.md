...
![узлы](https://img.shields.io/badge/узлы-103-brightgreen) ![живые](https://img.shields.io/badge/живые-3552-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-98ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-08-06_03:43_UTC-informational)
...
- **Выбрано узлов**: 103
- **Живых во всех источниках**: 3552
- **RTT самого быстрого узла**: 26 ms
- **Медиана RTT**: 98 ms
- **Последнее обновление (UTC)**: 2026-08-06 03:43 UTC

**Распределение протоколов:** shadowsocks × 7 · trojan × 25 · vless × 61 · vmess × 10

**Источники в этом запуске:** `autojiedian-clash` × 12 · `automerge-verified-clash` × 13 · `epodonios` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 12 · `ruking-clash` × 1 · `snakem982` × 1 · `solispirit-v2ray` × 21 · `tg-v2ray-configs-every2h` × 15
