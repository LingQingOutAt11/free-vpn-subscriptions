...
![узлы](https://img.shields.io/badge/узлы-78-brightgreen) ![живые](https://img.shields.io/badge/живые-1979-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-236ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-28_14:13_UTC-informational)
...
- **Медиана RTT**: 236 ms
- **Последнее обновление (UTC)**: 2026-05-28 14:13 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 21 · vless × 15 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
