...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1873-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-204ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_18:25_UTC-informational)
...
- **Медиана RTT**: 204 ms
- **Последнее обновление (UTC)**: 2026-05-11 18:25 UTC

**Распределение протоколов:** shadowsocks × 63 · trojan × 10 · vless × 66 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 57 · `pawdroid` × 4 · `snakem982` × 1 · `surfboard-eternity` × 7
