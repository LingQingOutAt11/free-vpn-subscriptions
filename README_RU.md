...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2439-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-126ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_00:10_UTC-informational)
...
- **Медиана RTT**: 126 ms
- **Последнее обновление (UTC)**: 2026-05-11 00:10 UTC

**Распределение протоколов:** shadowsocks × 47 · trojan × 2 · vless × 91 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 6 · `surfboard-eternity` × 5
