...
![узлы](https://img.shields.io/badge/узлы-138-brightgreen) ![живые](https://img.shields.io/badge/живые-1959-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-405ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-21_19:26_UTC-informational)
...
- **Медиана RTT**: 405 ms
- **Последнее обновление (UTC)**: 2026-06-21 19:26 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 31 · vless × 50 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `epodonios` × 24 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 30 · `snakem982` × 4 · `surfboard-eternity` × 4
