...
![узлы](https://img.shields.io/badge/узлы-135-brightgreen) ![живые](https://img.shields.io/badge/живые-2063-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-377ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-21_11:11_UTC-informational)
...
- **Выбрано узлов**: 135
- **Живых во всех источниках**: 2063
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 377 ms
- **Последнее обновление (UTC)**: 2026-06-21 11:11 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 30 · vless × 44 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 39 · `snakem982` × 1 · `surfboard-eternity` × 3
