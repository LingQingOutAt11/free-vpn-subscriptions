...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2487-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-85ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_03:12_UTC-informational)
...
- **Медиана RTT**: 85 ms
- **Последнее обновление (UTC)**: 2026-05-17 03:12 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 4 · vless × 98 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 52 · `pawdroid` × 7 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
