...
![узлы](https://img.shields.io/badge/узлы-83-brightgreen) ![живые](https://img.shields.io/badge/живые-3467-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-100ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-08-05_20:01_UTC-informational)
...
- **Выбрано узлов**: 83
- **Живых во всех источниках**: 3467
- **RTT самого быстрого узла**: 22 ms
- **Медиана RTT**: 100 ms
- **Последнее обновление (UTC)**: 2026-08-05 20:01 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 7 · trojan × 19 · vless × 48 · vmess × 8

**Источники в этом запуске:** `autojiedian-clash` × 15 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 3 · `pawdroid` × 1 · `roosterkid-openproxylist` × 14 · `ruking-clash` × 2 · `snakem982` × 2 · `solispirit-v2ray` × 14 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 12
