...
![узлы](https://img.shields.io/badge/узлы-149-brightgreen) ![живые](https://img.shields.io/badge/живые-2441-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-135ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-13_21:24_UTC-informational)
...
- **Выбрано узлов**: 149
- **Живых во всех источниках**: 2441
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 135 ms
- **Последнее обновление (UTC)**: 2026-05-13 21:24 UTC

**Распределение протоколов:** shadowsocks × 44 · trojan × 21 · vless × 76 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 29 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 4
