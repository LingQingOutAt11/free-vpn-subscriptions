...
![узлы](https://img.shields.io/badge/узлы-95-brightgreen) ![живые](https://img.shields.io/badge/живые-2180-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-547ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-29_10:25_UTC-informational)
...
- **Медиана RTT**: 547 ms
- **Последнее обновление (UTC)**: 2026-06-29 10:25 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 36 · vless × 22 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `epodonios` × 19 · `lagzian-mix` × 6 · `mahdi0024` × 13 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 3
