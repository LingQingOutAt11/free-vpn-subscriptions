...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2452-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-121ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_01:09_UTC-informational)
...
- **Медиана RTT**: 121 ms
- **Последнее обновление (UTC)**: 2026-05-11 01:09 UTC

**Распределение протоколов:** shadowsocks × 50 · trojan × 2 · vless × 88 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 66 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 6 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
