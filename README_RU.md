...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2440-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-129ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-13_20:31_UTC-informational)
...
- **Медиана RTT**: 129 ms
- **Последнее обновление (UTC)**: 2026-05-13 20:31 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 22 · vless × 80 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
