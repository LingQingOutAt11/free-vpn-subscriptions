...
![узлы](https://img.shields.io/badge/узлы-80-brightgreen) ![живые](https://img.shields.io/badge/живые-4137-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-160ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-22_19:50_UTC-informational)
...
- **Выбрано узлов**: 80
- **Живых во всех источниках**: 4137
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 160 ms
- **Последнее обновление (UTC)**: 2026-07-22 19:50 UTC

**Распределение протоколов:** shadowsocks × 5 · trojan × 15 · vless × 54 · vmess × 6

**Источники в этом запуске:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 5 · `mahdi0024` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 4 · `ninjastrikers` × 8 · `pawdroid` × 1 · `roosterkid-openproxylist` × 13 · `solispirit-v2ray` × 30 · `tg-v2ray-configs-every2h` × 13
