...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2536-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-102ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-15_23:29_UTC-informational)
...
- **Медиана RTT**: 102 ms
- **Последнее обновление (UTC)**: 2026-05-15 23:29 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 27 · vless × 83 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 50 · `pawdroid` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
