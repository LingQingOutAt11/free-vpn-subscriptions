...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2574-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-76ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-16_13:22_UTC-informational)
...
- **Медиана RTT**: 76 ms
- **Последнее обновление (UTC)**: 2026-05-16 13:22 UTC

**Распределение протоколов:** shadowsocks × 33 · trojan × 16 · vless × 93 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 55 · `pawdroid` × 11 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 2
