...
![узлы](https://img.shields.io/badge/узлы-135-brightgreen) ![живые](https://img.shields.io/badge/живые-1607-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-475ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_21:19_UTC-informational)
...
- **Выбрано узлов**: 135
- **Живых во всех источниках**: 1607
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 475 ms
- **Последнее обновление (UTC)**: 2026-06-14 21:19 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 65 · trojan × 32 · vless × 26 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 5 · `ruking-clash` × 19 · `surfboard-eternity` × 5
