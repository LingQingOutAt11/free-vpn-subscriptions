...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2480-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-71ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-21_12:37_UTC-informational)
...
- **Медиана RTT**: 71 ms
- **Последнее обновление (UTC)**: 2026-05-21 12:37 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 14 · vless × 80 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 58 · `pawdroid` × 12 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
