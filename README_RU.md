...
![узлы](https://img.shields.io/badge/узлы-142-brightgreen) ![живые](https://img.shields.io/badge/живые-2241-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-310ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-05_16:39_UTC-informational)
...
- **Медиана RTT**: 310 ms
- **Последнее обновление (UTC)**: 2026-05-05 16:39 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 27 · vless × 71 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `snakem982` × 1 · `surfboard-eternity` × 5
