...
![узлы](https://img.shields.io/badge/узлы-146-brightgreen) ![живые](https://img.shields.io/badge/живые-2285-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-432ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-08_19:36_UTC-informational)
...
- **Медиана RTT**: 432 ms
- **Последнее обновление (UTC)**: 2026-05-08 19:36 UTC

**Распределение протоколов:** shadowsocks × 51 · trojan × 21 · vless × 65 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 4 · `ninjastrikers` × 58 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
