...
![узлы](https://img.shields.io/badge/узлы-87-brightgreen) ![живые](https://img.shields.io/badge/живые-2191-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-281ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-29_05:13_UTC-informational)
...
- **Медиана RTT**: 281 ms
- **Последнее обновление (UTC)**: 2026-06-29 05:13 UTC

**Распределение протоколов:** shadowsocks × 17 · trojan × 29 · vless × 28 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `mfuu-clash` × 11 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 3
