...
![узлы](https://img.shields.io/badge/узлы-95-brightgreen) ![живые](https://img.shields.io/badge/живые-2398-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-91ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-03_05:16_UTC-informational)
...
- **Медиана RTT**: 91 ms
- **Последнее обновление (UTC)**: 2026-06-03 05:16 UTC

**Распределение протоколов:** shadowsocks × 20 · trojan × 33 · vless × 13 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 17 · `pawdroid` × 1 · `surfboard-eternity` × 4
