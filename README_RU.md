...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2461-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-79ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-14_12:26_UTC-informational)
...
- **Медиана RTT**: 79 ms
- **Последнее обновление (UTC)**: 2026-05-14 12:26 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 15 · vless × 83 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 30 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 51 · `pawdroid` × 3 · `ruking-clash` × 7 · `snakem982` × 1 · `surfboard-eternity` × 5
