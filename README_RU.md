...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2336-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-83ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-24_01:37_UTC-informational)
...
- **Медиана RTT**: 83 ms
- **Последнее обновление (UTC)**: 2026-05-24 01:37 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 1 · vless × 88 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 21 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 64 · `pawdroid` × 2 · `surfboard-eternity` × 7
