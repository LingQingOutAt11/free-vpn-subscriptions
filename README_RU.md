...
![узлы](https://img.shields.io/badge/узлы-122-brightgreen) ![живые](https://img.shields.io/badge/живые-1614-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-407ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_19:12_UTC-informational)
...
- **Выбрано узлов**: 122
- **Живых во всех источниках**: 1614
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 407 ms
- **Последнее обновление (UTC)**: 2026-06-14 19:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 61 · trojan × 29 · vless × 19 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 13 · `ruking-clash` × 20 · `surfboard-eternity` × 8
