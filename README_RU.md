...
![узлы](https://img.shields.io/badge/узлы-98-brightgreen) ![живые](https://img.shields.io/badge/живые-1878-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-356ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_15:17_UTC-informational)
...
- **Медиана RTT**: 356 ms
- **Последнее обновление (UTC)**: 2026-06-07 15:17 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 51 · trojan × 24 · vless × 14 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 3 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 26 · `mfuu-clash` × 3 · `ninjastrikers` × 17 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 3
