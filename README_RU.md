...
![узлы](https://img.shields.io/badge/узлы-146-brightgreen) ![живые](https://img.shields.io/badge/живые-2380-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-301ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_11:31_UTC-informational)
...
- **Медиана RTT**: 301 ms
- **Последнее обновление (UTC)**: 2026-05-09 11:31 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 18 · vless × 77 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
