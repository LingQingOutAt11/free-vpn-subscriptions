...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2349-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-83ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-24_00:28_UTC-informational)
...
- **Медиана RTT**: 83 ms
- **Последнее обновление (UTC)**: 2026-05-24 00:28 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 3 · vless × 82 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 37 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 60 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
