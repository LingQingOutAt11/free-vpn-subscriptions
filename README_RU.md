...
![узлы](https://img.shields.io/badge/узлы-108-brightgreen) ![живые](https://img.shields.io/badge/живые-1885-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-290ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-09_02:38_UTC-informational)
...
- **Медиана RTT**: 290 ms
- **Последнее обновление (UTC)**: 2026-06-09 02:38 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 45 · trojan × 20 · vless × 32 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 12 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 2 · `ninjastrikers` × 30 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 2
