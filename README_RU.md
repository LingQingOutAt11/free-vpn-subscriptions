...
![узлы](https://img.shields.io/badge/узлы-105-brightgreen) ![живые](https://img.shields.io/badge/живые-1925-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-494ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_06:24_UTC-informational)
...
- **Медиана RTT**: 494 ms
- **Последнее обновление (UTC)**: 2026-06-26 06:24 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 41 · vless × 24 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `epodonios` × 21 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 3
