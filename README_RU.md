...
![узлы](https://img.shields.io/badge/узлы-96-brightgreen) ![живые](https://img.shields.io/badge/живые-1931-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-480ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_09:11_UTC-informational)
...
- **Медиана RTT**: 480 ms
- **Последнее обновление (UTC)**: 2026-06-26 09:11 UTC

**Распределение протоколов:** shadowsocks × 30 · trojan × 37 · vless × 19 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 20 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 7
