...
![узлы](https://img.shields.io/badge/узлы-102-brightgreen) ![живые](https://img.shields.io/badge/живые-3096-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-515ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-05_14:16_UTC-informational)
...
- **Выбрано узлов**: 102
- **Живых во всех источниках**: 3096
- **RTT самого быстрого узла**: 23 ms
- **Медиана RTT**: 515 ms
- **Последнее обновление (UTC)**: 2026-07-05 14:16 UTC

**Распределение протоколов:** trojan × 39 · vless × 50 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 2 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 47 · `tg-v2ray-configs-every2h` × 18
