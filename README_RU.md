...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-1763-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-470ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_23:23_UTC-informational)
...
- **Медиана RTT**: 470 ms
- **Последнее обновление (UTC)**: 2026-06-17 23:23 UTC

**Распределение протоколов:** hysteria2 × 3 · shadowsocks × 47 · trojan × 31 · vless × 23 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 20 · `surfboard-eternity` × 5
