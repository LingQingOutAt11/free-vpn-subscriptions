...
![узлы](https://img.shields.io/badge/узлы-108-brightgreen) ![живые](https://img.shields.io/badge/живые-2963-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-394ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-07_04:23_UTC-informational)
...
- **Выбрано узлов**: 108
- **Живых во всех источниках**: 2963
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 394 ms
- **Последнее обновление (UTC)**: 2026-07-07 04:23 UTC

**Распределение протоколов:** shadowsocks × 3 · trojan × 35 · vless × 62 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 5 · `ninjastrikers` × 16 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 7 · `solispirit-v2ray` × 41 · `tg-v2ray-configs-every2h` × 20
