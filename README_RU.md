...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2429-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-138ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_04:27_UTC-informational)
...
- **Медиана RTT**: 138 ms
- **Последнее обновление (UTC)**: 2026-05-09 04:27 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 11 · vless × 89 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 74 · `pawdroid` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
