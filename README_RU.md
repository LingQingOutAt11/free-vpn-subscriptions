...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2489-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-214ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_23:22_UTC-informational)
...
- **Медиана RTT**: 214 ms
- **Последнее обновление (UTC)**: 2026-05-09 23:22 UTC

**Распределение протоколов:** shadowsocks × 52 · trojan × 18 · vless × 72 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 41 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
