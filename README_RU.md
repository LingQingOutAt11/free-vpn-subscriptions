...
![узлы](https://img.shields.io/badge/узлы-117-brightgreen) ![живые](https://img.shields.io/badge/живые-3119-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-105ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-08-01_14:00_UTC-informational)
...
- **Выбрано узлов**: 117
- **Живых во всех источниках**: 3119
- **RTT самого быстрого узла**: 17 ms
- **Медиана RTT**: 105 ms
- **Последнее обновление (UTC)**: 2026-08-01 14:00 UTC

**Распределение протоколов:** hysteria2 × 4 · shadowsocks × 23 · trojan × 20 · vless × 60 · vmess × 10

**Источники в этом запуске:** `autojiedian-clash` × 11 · `automerge-verified-clash` × 25 · `barry-far-v2ray` × 9 · `epodonios` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 1 · `pawdroid` × 4 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 4 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 13
