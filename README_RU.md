...
![узлы](https://img.shields.io/badge/узлы-146-brightgreen) ![живые](https://img.shields.io/badge/живые-2251-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-293ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-04_20:19_UTC-informational)
...
- **Медиана RTT**: 293 ms
- **Последнее обновление (UTC)**: 2026-05-04 20:19 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 26 · vless × 73 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 60 · `ruking-clash` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
