...
![узлы](https://img.shields.io/badge/узлы-109-brightgreen) ![живые](https://img.shields.io/badge/живые-3630-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-132ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-19_08:39_UTC-informational)
...
- **Выбрано узлов**: 109
- **Живых во всех источниках**: 3630
- **RTT самого быстрого узла**: 21 ms
- **Медиана RTT**: 132 ms
- **Последнее обновление (UTC)**: 2026-07-19 08:39 UTC

**Распределение протоколов:** shadowsocks × 4 · trojan × 18 · vless × 79 · vmess × 8

**Источники в этом запуске:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 4 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 4 · `roosterkid-openproxylist` × 7 · `solispirit-v2ray` × 48 · `tg-v2ray-configs-every2h` × 20
