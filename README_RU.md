...
![узлы](https://img.shields.io/badge/узлы-75-brightgreen) ![живые](https://img.shields.io/badge/живые-2357-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-92ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_18:18_UTC-informational)
...
- **Выбрано узлов**: 75
- **Живых во всех источниках**: 2357
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 92 ms
- **Последнее обновление (UTC)**: 2026-06-02 18:18 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 15 · vless × 8 · vmess × 31

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 3 · `pawdroid` × 2 · `surfboard-eternity` × 2
