...
![узлы](https://img.shields.io/badge/узлы-142-brightgreen) ![живые](https://img.shields.io/badge/живые-1972-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-471ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-21_15:14_UTC-informational)
...
- **Медиана RTT**: 471 ms
- **Последнее обновление (UTC)**: 2026-06-21 15:14 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 45 · trojan × 28 · vless × 58 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 33 · `snakem982` × 5 · `surfboard-eternity` × 2
