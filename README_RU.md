...
![узлы](https://img.shields.io/badge/узлы-126-brightgreen) ![живые](https://img.shields.io/badge/живые-2130-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-430ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_16:28_UTC-informational)
...
- **Выбрано узлов**: 126
- **Живых во всех источниках**: 2130
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 430 ms
- **Последнее обновление (UTC)**: 2026-06-20 16:28 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 30 · vless × 29 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 28 · `snakem982` × 1 · `surfboard-eternity` × 2
