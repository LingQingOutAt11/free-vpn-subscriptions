...
![узлы](https://img.shields.io/badge/узлы-128-brightgreen) ![живые](https://img.shields.io/badge/живые-2397-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-451ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-19_01:17_UTC-informational)
...
- **Выбрано узлов**: 128
- **Живых во всех источниках**: 2397
- **RTT самого быстрого узла**: 36 ms
- **Медиана RTT**: 451 ms
- **Последнее обновление (UTC)**: 2026-06-19 01:17 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 28 · vless × 50 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 26 · `pawdroid` × 7 · `ruking-clash` × 26 · `snakem982` × 8 · `surfboard-eternity` × 2
