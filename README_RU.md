...
![узлы](https://img.shields.io/badge/узлы-62-brightgreen) ![живые](https://img.shields.io/badge/живые-2198-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-261ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-29_15:39_UTC-informational)
...
- **Медиана RTT**: 261 ms
- **Последнее обновление (UTC)**: 2026-05-29 15:39 UTC

**Распределение протоколов:** shadowsocks × 13 · trojan × 20 · vless × 5 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
