...
![узлы](https://img.shields.io/badge/узлы-83-brightgreen) ![живые](https://img.shields.io/badge/живые-2121-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-274ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_11:36_UTC-informational)
...
- **Выбрано узлов**: 83
- **Живых во всех источниках**: 2121
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 274 ms
- **Последнее обновление (UTC)**: 2026-06-06 11:36 UTC

**Распределение протоколов:** shadowsocks × 28 · trojan × 24 · vless × 16 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
