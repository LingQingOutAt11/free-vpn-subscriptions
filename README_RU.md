...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2609-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-81ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-17_20:13_UTC-informational)
...
- **Медиана RTT**: 81 ms
- **Последнее обновление (UTC)**: 2026-05-17 20:13 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 46 · trojan × 11 · vless × 86 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 8 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 45 · `pawdroid` × 5 · `ruking-clash` × 9 · `surfboard-eternity` × 5
