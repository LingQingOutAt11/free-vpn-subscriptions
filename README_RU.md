...
![узлы](https://img.shields.io/badge/узлы-63-brightgreen) ![живые](https://img.shields.io/badge/живые-1891-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-147ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-27_06:27_UTC-informational)
...
- **Медиана RTT**: 147 ms
- **Последнее обновление (UTC)**: 2026-05-27 06:27 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 14 · vless × 12 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 1 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 4
