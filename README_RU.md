...
![узлы](https://img.shields.io/badge/узлы-101-brightgreen) ![живые](https://img.shields.io/badge/живые-2987-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-86ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_08:35_UTC-informational)
...
- **Выбрано узлов**: 101
- **Живых во всех источниках**: 2987
- **RTT самого быстрого узла**: 23 ms
- **Медиана RTT**: 86 ms
- **Последнее обновление (UTC)**: 2026-07-14 08:35 UTC

**Распределение протоколов:** shadowsocks × 5 · trojan × 20 · vless × 69 · vmess × 7

**Источники в этом запуске:** `mahdi0024` × 2 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 9 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 13 · `solispirit-v2ray` × 36 · `tg-v2ray-configs-every2h` × 17
