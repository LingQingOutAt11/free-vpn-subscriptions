...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2364-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-84ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-13_08:13_UTC-informational)
...
- **Медиана RTT**: 84 ms
- **Последнее обновление (UTC)**: 2026-05-13 08:13 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 3 · vless × 99 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 40 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 62 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
