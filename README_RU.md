...
![узлы](https://img.shields.io/badge/узлы-107-brightgreen) ![живые](https://img.shields.io/badge/живые-2539-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-161ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_03:51_UTC-informational)
...
- **Выбрано узлов**: 107
- **Живых во всех источниках**: 2539
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 161 ms
- **Последнее обновление (UTC)**: 2026-07-08 03:51 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 23 · vless × 43 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 4 · `radikal-clash` × 8 · `roosterkid-openproxylist` × 16 · `ruking-clash` × 2 · `surfboard-eternity` × 5 · `tg-v2ray-configs-every2h` × 15
