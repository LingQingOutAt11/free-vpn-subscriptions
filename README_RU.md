...
![узлы](https://img.shields.io/badge/узлы-112-brightgreen) ![живые](https://img.shields.io/badge/живые-1832-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-421ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-16_15:20_UTC-informational)
...
- **Медиана RTT**: 421 ms
- **Последнее обновление (UTC)**: 2026-06-16 15:20 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 49 · trojan × 26 · vless × 19 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 4
