...
![узлы](https://img.shields.io/badge/узлы-125-brightgreen) ![живые](https://img.shields.io/badge/живые-1959-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-278ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-25_01:24_UTC-informational)
...
- **Медиана RTT**: 278 ms
- **Последнее обновление (UTC)**: 2026-06-25 01:24 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 27 · trojan × 34 · vless × 49 · vmess × 14

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 39 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 23 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 4
