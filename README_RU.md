...
![узлы](https://img.shields.io/badge/узлы-145-brightgreen) ![живые](https://img.shields.io/badge/живые-2558-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-111ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-14_18:10_UTC-informational)
...
- **Выбрано узлов**: 145
- **Живых во всех источниках**: 2558
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 111 ms
- **Последнее обновление (UTC)**: 2026-05-14 18:10 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 16 · vless × 85 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `mfuu-clash` × 6 · `ninjastrikers` × 50 · `pawdroid` × 2 · `surfboard-eternity` × 5
