...
![узлы](https://img.shields.io/badge/узлы-132-brightgreen) ![живые](https://img.shields.io/badge/живые-2525-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-235ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_16:13_UTC-informational)
...
- **Медиана RTT**: 235 ms
- **Последнее обновление (UTC)**: 2026-05-09 16:13 UTC

**Распределение протоколов:** shadowsocks × 50 · trojan × 18 · vless × 57 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 3 · `surfboard-eternity` × 7
