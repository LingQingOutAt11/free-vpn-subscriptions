...
![узлы](https://img.shields.io/badge/узлы-107-brightgreen) ![живые](https://img.shields.io/badge/живые-2186-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-135ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-30_03:19_UTC-informational)
...
- **Медиана RTT**: 135 ms
- **Последнее обновление (UTC)**: 2026-05-30 03:19 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 26 · vless × 29 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 32 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
