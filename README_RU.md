...
![узлы](https://img.shields.io/badge/узлы-127-brightgreen) ![живые](https://img.shields.io/badge/живые-1687-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-384ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_05:30_UTC-informational)
...
- **Выбрано узлов**: 127
- **Живых во всех источниках**: 1687
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 384 ms
- **Последнее обновление (UTC)**: 2026-06-14 05:30 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 36 · vless × 33 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 5 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 32 · `pawdroid` × 4 · `ruking-clash` × 23 · `surfboard-eternity` × 1
