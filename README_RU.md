...
![узлы](https://img.shields.io/badge/узлы-102-brightgreen) ![живые](https://img.shields.io/badge/живые-1863-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-345ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_03:17_UTC-informational)
...
- **Выбрано узлов**: 102
- **Живых во всех источниках**: 1863
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 345 ms
- **Последнее обновление (UTC)**: 2026-06-30 03:17 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 39 · trojan × 33 · vless × 22 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 6 · `ruking-clash` × 12 · `surfboard-eternity` × 3
