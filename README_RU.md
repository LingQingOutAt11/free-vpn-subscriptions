...
![узлы](https://img.shields.io/badge/узлы-69-brightgreen) ![живые](https://img.shields.io/badge/живые-3197-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-69ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-08-04_09:01_UTC-informational)
...
- **Выбрано узлов**: 69
- **Живых во всех источниках**: 3197
- **RTT самого быстрого узла**: 12 ms
- **Медиана RTT**: 69 ms
- **Последнее обновление (UTC)**: 2026-08-04 09:01 UTC

**Распределение протоколов:** shadowsocks × 2 · trojan × 11 · vless × 48 · vmess × 8

**Источники в этом запуске:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 3 · `barry-far-v2ray` × 2 · `epodonios` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 5 · `pawdroid` × 7 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 23 · `tg-v2ray-configs-every2h` × 7
