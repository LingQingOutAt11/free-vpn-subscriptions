...
![узлы](https://img.shields.io/badge/узлы-79-brightgreen) ![живые](https://img.shields.io/badge/живые-2284-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-190ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_06:13_UTC-informational)
...
- **Медиана RTT**: 190 ms
- **Последнее обновление (UTC)**: 2026-06-10 06:13 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 13 · vless × 15 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 8
