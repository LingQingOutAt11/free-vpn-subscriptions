...
![узлы](https://img.shields.io/badge/узлы-141-brightgreen) ![живые](https://img.shields.io/badge/живые-1693-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-469ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_10:11_UTC-informational)
...
- **Медиана RTT**: 469 ms
- **Последнее обновление (UTC)**: 2026-06-14 10:11 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 87 · trojan × 25 · vless × 20 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 3 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 7 · `ruking-clash` × 17 · `surfboard-eternity` × 7
