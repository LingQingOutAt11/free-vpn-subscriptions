...
![узлы](https://img.shields.io/badge/узлы-82-brightgreen) ![живые](https://img.shields.io/badge/живые-1774-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-350ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-08_09:21_UTC-informational)
...
- **Медиана RTT**: 350 ms
- **Последнее обновление (UTC)**: 2026-06-08 09:21 UTC

**Распределение протоколов:** shadowsocks × 47 · trojan × 16 · vless × 14 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 7
