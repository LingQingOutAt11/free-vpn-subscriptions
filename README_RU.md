...
![узлы](https://img.shields.io/badge/узлы-143-brightgreen) ![живые](https://img.shields.io/badge/живые-2396-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-148ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_12:24_UTC-informational)
...
- **Выбрано узлов**: 143
- **Живых во всех источниках**: 2396
- **RTT самого быстрого узла**: 27 ms
- **Медиана RTT**: 148 ms
- **Последнее обновление (UTC)**: 2026-05-09 12:24 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 18 · vless × 75 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 61 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
