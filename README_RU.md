...
![узлы](https://img.shields.io/badge/узлы-99-brightgreen) ![живые](https://img.shields.io/badge/живые-2266-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-130ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-31_05:25_UTC-informational)
...
- **Медиана RTT**: 130 ms
- **Последнее обновление (UTC)**: 2026-05-31 05:25 UTC

**Распределение протоколов:** shadowsocks × 16 · trojan × 30 · vless × 24 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 23 · `pawdroid` × 2
