...
![узлы](https://img.shields.io/badge/узлы-116-brightgreen) ![живые](https://img.shields.io/badge/живые-1776-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-416ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_21:29_UTC-informational)
...
- **Медиана RTT**: 416 ms
- **Последнее обновление (UTC)**: 2026-06-17 21:29 UTC

**Распределение протоколов:** hysteria2 × 6 · shadowsocks × 47 · trojan × 30 · vless × 25 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 5 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 24 · `surfboard-eternity` × 6
