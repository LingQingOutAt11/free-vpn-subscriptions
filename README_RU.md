...
![узлы](https://img.shields.io/badge/узлы-94-brightgreen) ![живые](https://img.shields.io/badge/живые-4195-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-65ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-18_08:14_UTC-informational)
...
- **Выбрано узлов**: 94
- **Живых во всех источниках**: 4195
- **RTT самого быстрого узла**: 21 ms
- **Медиана RTT**: 65 ms
- **Последнее обновление (UTC)**: 2026-07-18 08:14 UTC

**Распределение протоколов:** shadowsocks × 9 · trojan × 17 · vless × 63 · vmess × 5

**Источники в этом запуске:** `automerge-verified-clash` × 5 · `epodonios` × 3 · `mahdi0024` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 4 · `ninjastrikers` × 8 · `pawdroid` × 4 · `roosterkid-openproxylist` × 5 · `snakem982` × 1 · `solispirit-v2ray` × 36 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 22
