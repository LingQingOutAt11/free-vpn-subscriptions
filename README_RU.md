...
![узлы](https://img.shields.io/badge/узлы-79-brightgreen) ![живые](https://img.shields.io/badge/живые-1896-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-379ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-05_11:31_UTC-informational)
...
- **Медиана RTT**: 379 ms
- **Последнее обновление (UTC)**: 2026-06-05 11:31 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 27 · vless × 13 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 23 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
