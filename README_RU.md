...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-1972-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-86ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-26_19:35_UTC-informational)
...
- **Медиана RTT**: 86 ms
- **Последнее обновление (UTC)**: 2026-05-26 19:35 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 15 · vless × 60 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 2 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 41 · `pawdroid` × 1 · `ruking-clash` × 13 · `surfboard-eternity` × 4
