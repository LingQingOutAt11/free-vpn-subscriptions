...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2358-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-93ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-23_17:22_UTC-informational)
...
- **Медиана RTT**: 93 ms
- **Последнее обновление (UTC)**: 2026-05-23 17:22 UTC

**Распределение протоколов:** shadowsocks × 38 · trojan × 22 · vless × 67 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 6
