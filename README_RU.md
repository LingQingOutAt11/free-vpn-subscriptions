...
![узлы](https://img.shields.io/badge/узлы-134-brightgreen) ![живые](https://img.shields.io/badge/живые-2084-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-465ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_21:20_UTC-informational)
...
- **Медиана RTT**: 465 ms
- **Последнее обновление (UTC)**: 2026-06-20 21:20 UTC

**Распределение протоколов:** shadowsocks × 39 · trojan × 35 · vless × 36 · vmess × 24

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 5 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 35 · `snakem982` × 1 · `surfboard-eternity` × 1
