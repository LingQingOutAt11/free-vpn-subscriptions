...
![узлы](https://img.shields.io/badge/узлы-108-brightgreen) ![живые](https://img.shields.io/badge/живые-1765-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-416ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_18:19_UTC-informational)
...
- **Медиана RTT**: 416 ms
- **Последнее обновление (UTC)**: 2026-06-17 18:19 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 51 · trojan × 23 · vless × 25 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 15 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 22 · `surfboard-eternity` × 2
