...
![узлы](https://img.shields.io/badge/узлы-93-brightgreen) ![живые](https://img.shields.io/badge/живые-1856-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-381ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_10:12_UTC-informational)
...
- **Выбрано узлов**: 93
- **Живых во всех источниках**: 1856
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 381 ms
- **Последнее обновление (UTC)**: 2026-06-30 10:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 34 · vless × 12 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 3
