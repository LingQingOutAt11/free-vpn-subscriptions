...
![узлы](https://img.shields.io/badge/узлы-122-brightgreen) ![живые](https://img.shields.io/badge/живые-1909-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-413ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_00:33_UTC-informational)
...
- **Медиана RTT**: 413 ms
- **Последнее обновление (UTC)**: 2026-06-26 00:33 UTC

**Распределение протоколов:** shadowsocks × 32 · trojan × 40 · vless × 37 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `epodonios` × 27 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `ruking-clash` × 18 · `surfboard-eternity` × 1
