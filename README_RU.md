...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2494-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-108ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-16_22:37_UTC-informational)
...
- **Медиана RTT**: 108 ms
- **Последнее обновление (UTC)**: 2026-05-16 22:37 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 21 · vless × 79 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 43 · `pawdroid` × 6 · `ruking-clash` × 5 · `surfboard-eternity` × 6
