...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1937-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-484ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_12:31_UTC-informational)
...
- **Медиана RTT**: 484 ms
- **Последнее обновление (UTC)**: 2026-06-22 12:31 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 31 · vless × 63 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 30 · `snakem982` × 2 · `surfboard-eternity` × 4
