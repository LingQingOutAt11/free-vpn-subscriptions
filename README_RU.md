...
![узлы](https://img.shields.io/badge/узлы-119-brightgreen) ![живые](https://img.shields.io/badge/живые-1814-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-354ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-27_05:19_UTC-informational)
...
- **Медиана RTT**: 354 ms
- **Последнее обновление (UTC)**: 2026-06-27 05:19 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 34 · vless × 22 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 1 · `ruking-clash` × 20 · `surfboard-eternity` × 5
