...
![узлы](https://img.shields.io/badge/узлы-88-brightgreen) ![живые](https://img.shields.io/badge/живые-2014-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-253ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-26_17:14_UTC-informational)
...
- **Медиана RTT**: 253 ms
- **Последнее обновление (UTC)**: 2026-06-26 17:14 UTC

**Распределение протоколов:** shadowsocks × 22 · trojan × 27 · vless × 16 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 3 · `ruking-clash` × 18 · `surfboard-eternity` × 3
