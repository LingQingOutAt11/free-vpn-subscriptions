...
![узлы](https://img.shields.io/badge/узлы-128-brightgreen) ![живые](https://img.shields.io/badge/живые-2102-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-392ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_22:32_UTC-informational)
...
- **Медиана RTT**: 392 ms
- **Последнее обновление (UTC)**: 2026-06-20 22:32 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 33 · vless × 31 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `epodonios` × 11 · `mahdi0024` × 23 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 30 · `snakem982` × 1 · `surfboard-eternity` × 4
