...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1942-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-135ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-12_07:13_UTC-informational)
...
- **Медиана RTT**: 135 ms
- **Последнее обновление (UTC)**: 2026-05-12 07:13 UTC

**Распределение протоколов:** shadowsocks × 57 · trojan × 3 · vless × 80 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 7 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
