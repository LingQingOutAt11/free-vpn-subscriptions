...
![узлы](https://img.shields.io/badge/узлы-92-brightgreen) ![живые](https://img.shields.io/badge/живые-2868-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-71ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-14_14:20_UTC-informational)
...
- **Выбрано узлов**: 92
- **Живых во всех источниках**: 2868
- **RTT самого быстрого узла**: 22 ms
- **Медиана RTT**: 71 ms
- **Последнее обновление (UTC)**: 2026-07-14 14:20 UTC

**Распределение протоколов:** shadowsocks × 4 · trojan × 17 · vless × 60 · vmess × 11

**Источники в этом запуске:** `epodonios` × 1 · `go4sharing-clash` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 3 · `ninjastrikers` × 6 · `pawdroid` × 5 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `solispirit-v2ray` × 35 · `tg-v2ray-configs-every2h` × 22
