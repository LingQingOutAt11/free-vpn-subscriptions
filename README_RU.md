...
![узлы](https://img.shields.io/badge/узлы-121-brightgreen) ![живые](https://img.shields.io/badge/живые-1783-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-371ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-18_00:34_UTC-informational)
...
- **Выбрано узлов**: 121
- **Живых во всех источниках**: 1783
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 371 ms
- **Последнее обновление (UTC)**: 2026-06-18 00:34 UTC

**Распределение протоколов:** hysteria2 × 3 · shadowsocks × 44 · trojan × 32 · vless × 33 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 4
