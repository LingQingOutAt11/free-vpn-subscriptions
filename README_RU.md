...
![узлы](https://img.shields.io/badge/узлы-105-brightgreen) ![живые](https://img.shields.io/badge/живые-1846-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-372ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_15:26_UTC-informational)
...
- **Выбрано узлов**: 105
- **Живых во всех источниках**: 1846
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 372 ms
- **Последнее обновление (UTC)**: 2026-06-15 15:26 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 50 · trojan × 22 · vless × 17 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 6
