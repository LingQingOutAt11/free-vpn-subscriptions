...
![узлы](https://img.shields.io/badge/узлы-59-brightgreen) ![живые](https://img.shields.io/badge/живые-1988-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-125ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-27_20:36_UTC-informational)
...
- **Выбрано узлов**: 59
- **Живых во всех источниках**: 1988
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 125 ms
- **Последнее обновление (UTC)**: 2026-05-27 20:36 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 4 · vless × 21 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 3 · `surfboard-eternity` × 3
