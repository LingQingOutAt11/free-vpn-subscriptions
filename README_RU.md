...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2372-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-257ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_12:30_UTC-informational)
...
- **Медиана RTT**: 257 ms
- **Последнее обновление (UTC)**: 2026-05-11 12:30 UTC

**Распределение протоколов:** shadowsocks × 44 · trojan × 18 · vless × 81 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
