...
![узлы](https://img.shields.io/badge/узлы-100-brightgreen) ![живые](https://img.shields.io/badge/живые-2072-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-335ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_15:11_UTC-informational)
...
- **Медиана RTT**: 335 ms
- **Последнее обновление (UTC)**: 2026-06-10 15:11 UTC

**Распределение протоколов:** shadowsocks × 43 · trojan × 20 · vless × 11 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 1
