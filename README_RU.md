...
![узлы](https://img.shields.io/badge/узлы-96-brightgreen) ![живые](https://img.shields.io/badge/живые-1955-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-463ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-18_07:22_UTC-informational)
...
- **Медиана RTT**: 463 ms
- **Последнее обновление (UTC)**: 2026-06-18 07:22 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 29 · vless × 23 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 17 · `snakem982` × 6 · `surfboard-eternity` × 3
