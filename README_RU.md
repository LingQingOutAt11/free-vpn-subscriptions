...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-1969-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-250ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-25_02:22_UTC-informational)
...
- **Медиана RTT**: 250 ms
- **Последнее обновление (UTC)**: 2026-06-25 02:22 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 32 · vless × 50 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 37 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 14 · `surfboard-eternity` × 6
