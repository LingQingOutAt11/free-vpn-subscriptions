...
![узлы](https://img.shields.io/badge/узлы-98-brightgreen) ![живые](https://img.shields.io/badge/живые-1977-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-179ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-04_09:18_UTC-informational)
...
- **Медиана RTT**: 179 ms
- **Последнее обновление (UTC)**: 2026-06-04 09:18 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 45 · vless × 20 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 33 · `mahdi0024` × 13 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 11 · `pawdroid` × 2 · `surfboard-eternity` × 4
