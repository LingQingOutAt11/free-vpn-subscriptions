...
![узлы](https://img.shields.io/badge/узлы-117-brightgreen) ![живые](https://img.shields.io/badge/живые-2769-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-273ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-08_08:53_UTC-informational)
...
- **Выбрано узлов**: 117
- **Живых во всех источниках**: 2769
- **RTT самого быстрого узла**: 19 ms
- **Медиана RTT**: 273 ms
- **Последнее обновление (UTC)**: 2026-07-08 08:53 UTC

**Распределение протоколов:** shadowsocks × 19 · trojan × 30 · vless × 60 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 5 · `radikal-clash` × 6 · `roosterkid-openproxylist` × 12 · `solispirit-v2ray` × 48 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 6
