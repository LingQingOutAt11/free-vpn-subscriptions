...
![узлы](https://img.shields.io/badge/узлы-100-brightgreen) ![живые](https://img.shields.io/badge/живые-1952-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-213ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-28_01:25_UTC-informational)
...
- **Медиана RTT**: 213 ms
- **Последнее обновление (UTC)**: 2026-06-28 01:25 UTC

**Распределение протоколов:** shadowsocks × 21 · trojan × 39 · vless × 31 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `epodonios` × 20 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 4
