...
![узлы](https://img.shields.io/badge/узлы-62-brightgreen) ![живые](https://img.shields.io/badge/живые-3463-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-103ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-08-09_13:23_UTC-informational)
...
- **Выбрано узлов**: 62
- **Живых во всех источниках**: 3463
- **RTT самого быстрого узла**: 21 ms
- **Медиана RTT**: 103 ms
- **Последнее обновление (UTC)**: 2026-08-09 13:23 UTC

**Распределение протоколов:** shadowsocks × 12 · trojan × 10 · vless × 27 · vmess × 13

**Источники в этом запуске:** `autojiedian-clash` × 5 · `automerge-verified-clash` × 13 · `barry-far-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 8 · `tg-v2ray-configs-every2h` × 3
