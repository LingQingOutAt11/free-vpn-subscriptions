...
![узлы](https://img.shields.io/badge/узлы-101-brightgreen) ![живые](https://img.shields.io/badge/живые-2113-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-211ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_21:30_UTC-informational)
...
- **Медиана RTT**: 211 ms
- **Последнее обновление (UTC)**: 2026-06-06 21:30 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 21 · vless × 10 · vmess × 28

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 45 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
