...
![узлы](https://img.shields.io/badge/узлы-79-brightgreen) ![живые](https://img.shields.io/badge/живые-3387-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-127ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-07-31_19:59_UTC-informational)
...
- **Выбрано узлов**: 79
- **Живых во всех источниках**: 3387
- **RTT самого быстрого узла**: 43 ms
- **Медиана RTT**: 127 ms
- **Последнее обновление (UTC)**: 2026-07-31 19:59 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 16 · trojan × 14 · vless × 39 · vmess × 8

**Источники в этом запуске:** `autojiedian-clash` × 9 · `automerge-verified-clash` × 14 · `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 11 · `ruking-clash` × 1 · `solispirit-v2ray` × 15 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 11
