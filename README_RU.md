...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2161-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-180ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_12:37_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2161
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 180 ms
- **Последнее обновление (UTC)**: 2026-05-06 12:37 UTC

**Распределение протоколов:** shadowsocks × 47 · trojan × 11 · vless × 79 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 60 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
