...
![узлы](https://img.shields.io/badge/узлы-62-brightgreen) ![живые](https://img.shields.io/badge/живые-2134-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-157ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-05_18:33_UTC-informational)
...
- **Медиана RTT**: 157 ms
- **Последнее обновление (UTC)**: 2026-06-05 18:33 UTC

**Распределение протоколов:** shadowsocks × 19 · trojan × 21 · vless × 6 · vmess × 16

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 6 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
