...
![узлы](https://img.shields.io/badge/узлы-124-brightgreen) ![живые](https://img.shields.io/badge/живые-2019-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-391ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-23_19:25_UTC-informational)
...
- **Выбрано узлов**: 124
- **Живых во всех источниках**: 2019
- **RTT самого быстрого узла**: 37 ms
- **Медиана RTT**: 391 ms
- **Последнее обновление (UTC)**: 2026-06-23 19:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 37 · trojan × 26 · vless × 43 · vmess × 17

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 45 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
