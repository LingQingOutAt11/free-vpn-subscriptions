...
![узлы](https://img.shields.io/badge/узлы-145-brightgreen) ![живые](https://img.shields.io/badge/живые-2211-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-77ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-26_10:32_UTC-informational)
...
- **Медиана RTT**: 77 ms
- **Последнее обновление (UTC)**: 2026-05-26 10:32 UTC

**Распределение протоколов:** shadowsocks × 31 · trojan × 26 · vless × 73 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 5
