...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2450-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-81ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-25_10:39_UTC-informational)
...
- **Медиана RTT**: 81 ms
- **Последнее обновление (UTC)**: 2026-05-25 10:39 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 14 · vless × 67 · vmess × 27

**Источники в этом запуске:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 44 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 5 · `surfboard-eternity` × 5
