...
![узлы](https://img.shields.io/badge/узлы-73-brightgreen) ![живые](https://img.shields.io/badge/живые-2365-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-78ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-02_19:27_UTC-informational)
...
- **Выбрано узлов**: 73
- **Живых во всех источниках**: 2365
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 78 ms
- **Последнее обновление (UTC)**: 2026-06-02 19:27 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 18 · trojan × 23 · vless × 6 · vmess × 25

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 5 · `pawdroid` × 1 · `surfboard-eternity` × 1
