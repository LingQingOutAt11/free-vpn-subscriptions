...
![узлы](https://img.shields.io/badge/узлы-86-brightgreen) ![живые](https://img.shields.io/badge/живые-2279-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-198ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-20_13:30_UTC-informational)
...
- **Медиана RTT**: 198 ms
- **Последнее обновление (UTC)**: 2026-06-20 13:30 UTC

**Распределение протоколов:** shadowsocks × 23 · trojan × 23 · vless × 11 · vmess × 29

**Источники в этом запуске:** `barry-far-v2ray` × 6 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 2
