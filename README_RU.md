...
![узлы](https://img.shields.io/badge/узлы-105-brightgreen) ![живые](https://img.shields.io/badge/живые-1863-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-373ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-15_10:31_UTC-informational)
...
- **Медиана RTT**: 373 ms
- **Последнее обновление (UTC)**: 2026-06-15 10:31 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 48 · trojan × 23 · vless × 21 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 4
