...
![узлы](https://img.shields.io/badge/узлы-88-brightgreen) ![живые](https://img.shields.io/badge/живые-2091-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-240ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-27_10:19_UTC-informational)
...
- **Медиана RTT**: 240 ms
- **Последнее обновление (UTC)**: 2026-06-27 10:19 UTC

**Распределение протоколов:** shadowsocks × 17 · trojan × 33 · vless × 17 · vmess × 21

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `epodonios` × 14 · `mahdi0024` × 12 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 2
