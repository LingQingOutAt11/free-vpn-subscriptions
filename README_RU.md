...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2222-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-140ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-06_00:30_UTC-informational)
...
- **Медиана RTT**: 140 ms
- **Последнее обновление (UTC)**: 2026-05-06 00:30 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 9 · vless × 94 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 74 · `pawdroid` × 1 · `surfboard-eternity` × 9
