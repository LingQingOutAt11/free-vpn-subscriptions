...
![узлы](https://img.shields.io/badge/узлы-122-brightgreen) ![живые](https://img.shields.io/badge/живые-1694-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-397ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_06:33_UTC-informational)
...
- **Выбрано узлов**: 122
- **Живых во всех источниках**: 1694
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 397 ms
- **Последнее обновление (UTC)**: 2026-06-14 06:33 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 53 · trojan × 35 · vless × 27 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 25 · `pawdroid` × 4 · `ruking-clash` × 21 · `surfboard-eternity` × 5
