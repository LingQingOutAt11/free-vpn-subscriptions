...
![узлы](https://img.shields.io/badge/узлы-98-brightgreen) ![живые](https://img.shields.io/badge/живые-3071-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-99ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-08-02_08:45_UTC-informational)
...
- **Выбрано узлов**: 98
- **Живых во всех источниках**: 3071
- **RTT самого быстрого узла**: 26 ms
- **Медиана RTT**: 99 ms
- **Последнее обновление (UTC)**: 2026-08-02 08:45 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 10 · trojan × 12 · vless × 61 · vmess × 14

**Источники в этом запуске:** `autojiedian-clash` × 11 · `automerge-verified-clash` × 16 · `epodonios` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 4 · `ninjastrikers` × 5 · `pawdroid` × 3 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 10 · `snakem982` × 1 · `solispirit-v2ray` × 21 · `tg-v2ray-configs-every2h` × 11
