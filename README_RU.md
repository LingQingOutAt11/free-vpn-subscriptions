...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1922-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-285ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-07_21:32_UTC-informational)
...
- **Медиана RTT**: 285 ms
- **Последнее обновление (UTC)**: 2026-05-07 21:32 UTC

**Распределение протоколов:** shadowsocks × 54 · trojan × 14 · vless × 74 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
