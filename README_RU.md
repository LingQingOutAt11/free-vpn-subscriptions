...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2361-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-118ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-12_18:17_UTC-informational)
...
- **Медиана RTT**: 118 ms
- **Последнее обновление (UTC)**: 2026-05-12 18:17 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 18 · vless × 82 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 36 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
