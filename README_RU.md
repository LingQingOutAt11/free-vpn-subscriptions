...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2331-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-82ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-23_13:16_UTC-informational)
...
- **Медиана RTT**: 82 ms
- **Последнее обновление (UTC)**: 2026-05-23 13:16 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 21 · vless × 85 · vmess × 9

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 20 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
