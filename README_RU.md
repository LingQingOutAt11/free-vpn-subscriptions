...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2429-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-151ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-11_07:19_UTC-informational)
...
- **Медиана RTT**: 151 ms
- **Последнее обновление (UTC)**: 2026-05-11 07:19 UTC

**Распределение протоколов:** shadowsocks × 42 · trojan × 7 · vless × 94 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 70 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 7
