...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2285-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-135ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-05_02:13_UTC-informational)
...
- **Медиана RTT**: 135 ms
- **Последнее обновление (UTC)**: 2026-05-05 02:13 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 13 · vless × 93 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 3 · `ninjastrikers` × 72 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 6
