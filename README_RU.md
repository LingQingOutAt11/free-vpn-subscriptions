...
![узлы](https://img.shields.io/badge/узлы-90-brightgreen) ![живые](https://img.shields.io/badge/живые-2185-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-217ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_14:13_UTC-informational)
...
- **Выбрано узлов**: 90
- **Живых во всех источниках**: 2185
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 217 ms
- **Последнее обновление (UTC)**: 2026-06-06 14:13 UTC

**Распределение протоколов:** shadowsocks × 29 · trojan × 33 · vless × 5 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `surfboard-eternity` × 3
