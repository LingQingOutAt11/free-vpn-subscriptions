...
![узлы](https://img.shields.io/badge/узлы-102-brightgreen) ![живые](https://img.shields.io/badge/живые-1672-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-376ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-07_19:15_UTC-informational)
...
- **Выбрано узлов**: 102
- **Живых во всех источниках**: 1672
- **RTT самого быстрого узла**: 29 ms
- **Медиана RTT**: 376 ms
- **Последнее обновление (UTC)**: 2026-06-07 19:15 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 56 · trojan × 23 · vless × 16 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 25 · `mfuu-clash` × 6 · `ninjastrikers` × 13 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
