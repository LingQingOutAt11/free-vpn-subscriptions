...
![узлы](https://img.shields.io/badge/узлы-119-brightgreen) ![живые](https://img.shields.io/badge/живые-1742-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-459ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_07:29_UTC-informational)
...
- **Выбрано узлов**: 119
- **Живых во всех источниках**: 1742
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 459 ms
- **Последнее обновление (UTC)**: 2026-06-14 07:29 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 52 · trojan × 36 · vless × 24 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 24 · `pawdroid` × 7 · `ruking-clash` × 21 · `surfboard-eternity` × 5
