...
![узлы](https://img.shields.io/badge/узлы-120-brightgreen) ![живые](https://img.shields.io/badge/живые-1684-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-388ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-14_23:16_UTC-informational)
...
- **Выбрано узлов**: 120
- **Живых во всех источниках**: 1684
- **RTT самого быстрого узла**: 35 ms
- **Медиана RTT**: 388 ms
- **Последнее обновление (UTC)**: 2026-06-14 23:16 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 53 · trojan × 26 · vless × 25 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 5
