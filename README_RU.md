...
![узлы](https://img.shields.io/badge/узлы-139-brightgreen) ![живые](https://img.shields.io/badge/живые-2231-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-407ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-05_22:20_UTC-informational)
...
- **Выбрано узлов**: 139
- **Живых во всех источниках**: 2231
- **RTT самого быстрого узла**: 33 ms
- **Медиана RTT**: 407 ms
- **Последнее обновление (UTC)**: 2026-05-05 22:20 UTC

**Распределение протоколов:** shadowsocks × 34 · trojan × 28 · vless × 65 · vmess × 12

**Источники в этом запуске:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `surfboard-eternity` × 6
