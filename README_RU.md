...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2444-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-110ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-09_07:28_UTC-informational)
...
- **Медиана RTT**: 110 ms
- **Последнее обновление (UTC)**: 2026-05-09 07:28 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 17 · vless × 89 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 77 · `pawdroid` × 1 · `surfboard-eternity` × 5
