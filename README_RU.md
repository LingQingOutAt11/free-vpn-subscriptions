...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2401-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-111ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-13_00:30_UTC-informational)
...
- **Медиана RTT**: 111 ms
- **Последнее обновление (UTC)**: 2026-05-13 00:30 UTC

**Распределение протоколов:** shadowsocks × 36 · trojan × 3 · vless × 98 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 37 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
