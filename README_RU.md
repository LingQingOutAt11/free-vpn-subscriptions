...
![узлы](https://img.shields.io/badge/узлы-116-brightgreen) ![живые](https://img.shields.io/badge/живые-2204-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-493ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-11_16:36_UTC-informational)
...
- **Выбрано узлов**: 116
- **Живых во всех источниках**: 2204
- **RTT самого быстрого узла**: 30 ms
- **Медиана RTT**: 493 ms
- **Последнее обновление (UTC)**: 2026-06-11 16:36 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 47 · trojan × 26 · vless × 37 · vmess × 5

**Источники в этом запуске:** `barry-far-v2ray` × 16 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 6 · `surfboard-eternity` × 3
