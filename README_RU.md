...
![узлы](https://img.shields.io/badge/узлы-97-brightgreen) ![живые](https://img.shields.io/badge/живые-2050-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-333ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_17:23_UTC-informational)
...
- **Медиана RTT**: 333 ms
- **Последнее обновление (UTC)**: 2026-06-10 17:23 UTC

**Распределение протоколов:** shadowsocks × 41 · trojan × 19 · vless × 14 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 7 · `ruking-clash` × 6 · `surfboard-eternity` × 2
