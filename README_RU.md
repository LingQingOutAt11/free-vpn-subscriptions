...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2507-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-97ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-15_14:34_UTC-informational)
...
- **Медиана RTT**: 97 ms
- **Последнее обновление (UTC)**: 2026-05-15 14:34 UTC

**Распределение протоколов:** shadowsocks × 40 · trojan × 19 · vless × 83 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 64 · `pawdroid` × 8 · `ruking-clash` × 4 · `surfboard-eternity` × 1
