...
![узлы](https://img.shields.io/badge/узлы-113-brightgreen) ![живые](https://img.shields.io/badge/живые-1956-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-492ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-18_13:33_UTC-informational)
...
- **Медиана RTT**: 492 ms
- **Последнее обновление (UTC)**: 2026-06-18 13:33 UTC

**Распределение протоколов:** hysteria2 × 3 · shadowsocks × 33 · trojan × 34 · vless × 36 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 3 · `surfboard-eternity` × 3
