...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1961-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-466ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-22_18:12_UTC-informational)
...
- **Медиана RTT**: 466 ms
- **Последнее обновление (UTC)**: 2026-06-22 18:12 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 22 · vless × 76 · vmess × 10

**Источники в этом запуске:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 53 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 23 · `snakem982` × 3 · `surfboard-eternity` × 3
