...
![узлы](https://img.shields.io/badge/узлы-88-brightgreen) ![живые](https://img.shields.io/badge/живые-1994-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-284ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-10_20:30_UTC-informational)
...
- **Выбрано узлов**: 88
- **Живых во всех источниках**: 1994
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 284 ms
- **Последнее обновление (UTC)**: 2026-06-10 20:30 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 41 · trojan × 14 · vless × 9 · vmess × 23

**Источники в этом запуске:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 8 · `surfboard-eternity` × 5
