...
![узлы](https://img.shields.io/badge/узлы-136-brightgreen) ![живые](https://img.shields.io/badge/живые-2229-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-69ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-19_12:28_UTC-informational)
...
- **Медиана RTT**: 69 ms
- **Последнее обновление (UTC)**: 2026-05-19 12:28 UTC

**Распределение протоколов:** shadowsocks × 16 · trojan × 20 · vless × 80 · vmess × 20

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 10 · `surfboard-eternity` × 3
