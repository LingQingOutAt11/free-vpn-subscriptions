...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2446-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-113ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-14_03:38_UTC-informational)
...
- **Медиана RTT**: 113 ms
- **Последнее обновление (UTC)**: 2026-05-14 03:38 UTC

**Распределение протоколов:** shadowsocks × 46 · trojan × 2 · vless × 94 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 27 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 62 · `pawdroid` × 2 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 8
