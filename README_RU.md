...
![узлы](https://img.shields.io/badge/узлы-110-brightgreen) ![живые](https://img.shields.io/badge/живые-1907-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-410ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-25_21:18_UTC-informational)
...
- **Медиана RTT**: 410 ms
- **Последнее обновление (UTC)**: 2026-06-25 21:18 UTC

**Распределение протоколов:** shadowsocks × 37 · trojan × 33 · vless × 25 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 12 · `epodonios` × 27 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 19 · `surfboard-eternity` × 3
