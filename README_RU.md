...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2242-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-72ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-19_06:32_UTC-informational)
...
- **Медиана RTT**: 72 ms
- **Последнее обновление (UTC)**: 2026-05-19 06:32 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 26 · trojan × 10 · vless × 87 · vmess × 26

**Источники в этом запуске:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 65 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 5
