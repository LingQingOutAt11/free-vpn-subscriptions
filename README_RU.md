...
![узлы](https://img.shields.io/badge/узлы-116-brightgreen) ![живые](https://img.shields.io/badge/живые-1820-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-447ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_15:26_UTC-informational)
...
- **Выбрано узлов**: 116
- **Живых во всех источниках**: 1820
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 447 ms
- **Последнее обновление (UTC)**: 2026-06-30 15:26 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 42 · trojan × 48 · vless × 18 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 8 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 13 · `surfboard-eternity` × 5
