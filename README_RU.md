...
![узлы](https://img.shields.io/badge/узлы-108-brightgreen) ![живые](https://img.shields.io/badge/живые-1933-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-406ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-12_19:16_UTC-informational)
...
- **Медиана RTT**: 406 ms
- **Последнее обновление (UTC)**: 2026-06-12 19:16 UTC

**Распределение протоколов:** hysteria2 × 2 · shadowsocks × 50 · trojan × 35 · vless × 13 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 31 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 6
