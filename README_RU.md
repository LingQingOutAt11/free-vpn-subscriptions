...
![узлы](https://img.shields.io/badge/узлы-85-brightgreen) ![живые](https://img.shields.io/badge/живые-2271-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-169ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-30_15:34_UTC-informational)
...
- **Выбрано узлов**: 85
- **Живых во всех источниках**: 2271
- **RTT самого быстрого узла**: 32 ms
- **Медиана RTT**: 169 ms
- **Последнее обновление (UTC)**: 2026-05-30 15:34 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 22 · vless × 7 · vmess × 30

**Источники в этом запуске:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
