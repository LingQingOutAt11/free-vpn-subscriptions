...
![узлы](https://img.shields.io/badge/узлы-111-brightgreen) ![живые](https://img.shields.io/badge/живые-2112-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-276ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-25_06:34_UTC-informational)
...
- **Медиана RTT**: 276 ms
- **Последнее обновление (UTC)**: 2026-06-25 06:34 UTC

**Распределение протоколов:** shadowsocks × 26 · trojan × 33 · vless × 37 · vmess × 15

**Источники в этом запуске:** `barry-far-v2ray` × 4 · `epodonios` × 34 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 1 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
