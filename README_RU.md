...
![узлы](https://img.shields.io/badge/узлы-139-brightgreen) ![живые](https://img.shields.io/badge/живые-1934-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-403ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-21_18:10_UTC-informational)
...
- **Выбрано узлов**: 139
- **Живых во всех источниках**: 1934
- **RTT самого быстрого узла**: 28 ms
- **Медиана RTT**: 403 ms
- **Последнее обновление (UTC)**: 2026-06-21 18:10 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 27 · vless × 55 · vmess × 13

**Источники в этом запуске:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 5 · `ruking-clash` × 32 · `snakem982` × 4 · `surfboard-eternity` × 6
