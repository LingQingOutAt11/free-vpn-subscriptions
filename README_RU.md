...
![узлы](https://img.shields.io/badge/узлы-98-brightgreen) ![живые](https://img.shields.io/badge/живые-2153-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-173ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-06_05:24_UTC-informational)
...
- **Выбрано узлов**: 98
- **Живых во всех источниках**: 2153
- **RTT самого быстрого узла**: 26 ms
- **Медиана RTT**: 173 ms
- **Последнее обновление (UTC)**: 2026-06-06 05:24 UTC

**Распределение протоколов:** shadowsocks × 24 · trojan × 29 · vless × 26 · vmess × 19

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 23 · `pawdroid` × 2 · `surfboard-eternity` × 3
