...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-1943-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-508ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-17_01:11_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 1943
- **RTT самого быстрого узла**: 31 ms
- **Медиана RTT**: 508 ms
- **Последнее обновление (UTC)**: 2026-06-17 01:11 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 43 · trojan × 30 · vless × 20 · vmess × 56

**Источники в этом запуске:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 61 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 24 · `ruking-clash` × 16 · `surfboard-eternity` × 4
