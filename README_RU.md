...
![узлы](https://img.shields.io/badge/узлы-147-brightgreen) ![живые](https://img.shields.io/badge/живые-2369-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-88ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-22_22:25_UTC-informational)
...
- **Выбрано узлов**: 147
- **Живых во всех источниках**: 2369
- **RTT самого быстрого узла**: 22 ms
- **Медиана RTT**: 88 ms
- **Последнее обновление (UTC)**: 2026-05-22 22:25 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 35 · trojan × 26 · vless × 74 · vmess × 11

**Источники в этом запуске:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 20 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 5
