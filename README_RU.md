...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2443-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-109ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-13_19:34_UTC-informational)
...
- **Выбрано узлов**: 150
- **Живых во всех источниках**: 2443
- **RTT самого быстрого узла**: 34 ms
- **Медиана RTT**: 109 ms
- **Последнее обновление (UTC)**: 2026-05-13 19:34 UTC

**Распределение протоколов:** shadowsocks × 44 · trojan × 20 · vless × 78 · vmess × 8

**Источники в этом запуске:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 4 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 5 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 5
