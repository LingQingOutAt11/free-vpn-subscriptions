...
![узлы](https://img.shields.io/badge/узлы-121-brightgreen) ![живые](https://img.shields.io/badge/живые-3460-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-135ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-08-01_03:56_UTC-informational)
...
- **Выбрано узлов**: 121
- **Живых во всех источниках**: 3460
- **RTT самого быстрого узла**: 14 ms
- **Медиана RTT**: 135 ms
- **Последнее обновление (UTC)**: 2026-08-01 03:56 UTC

**Распределение протоколов:** hysteria2 × 3 · shadowsocks × 20 · trojan × 18 · vless × 73 · vmess × 7

**Источники в этом запуске:** `autojiedian-clash` × 16 · `automerge-verified-clash` × 23 · `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 10 · `pawdroid` × 3 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 8 · `ruking-clash` × 3 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
