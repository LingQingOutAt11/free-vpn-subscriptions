...
![узлы](https://img.shields.io/badge/узлы-150-brightgreen) ![живые](https://img.shields.io/badge/живые-2502-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-98ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-05-10_03:19_UTC-informational)
...
- **Медиана RTT**: 98 ms
- **Последнее обновление (UTC)**: 2026-05-10 03:19 UTC

**Распределение протоколов:** shadowsocks × 46 · trojan × 3 · vless × 94 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 72 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 4
