...
![узлы](https://img.shields.io/badge/узлы-73-brightgreen) ![живые](https://img.shields.io/badge/живые-2031-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-229ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-09_18:09_UTC-informational)
...
- **Медиана RTT**: 229 ms
- **Последнее обновление (UTC)**: 2026-06-09 18:09 UTC

**Распределение протоколов:** shadowsocks × 35 · trojan × 12 · vless × 4 · vmess × 22

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 2
