...
![узлы](https://img.shields.io/badge/узлы-105-brightgreen) ![живые](https://img.shields.io/badge/живые-1936-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-231ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-04_13:25_UTC-informational)
...
- **Медиана RTT**: 231 ms
- **Последнее обновление (UTC)**: 2026-06-04 13:25 UTC

**Распределение протоколов:** shadowsocks × 25 · trojan × 55 · vless × 18 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 39 · `epodonios` × 25 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
