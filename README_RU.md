...
![узлы](https://img.shields.io/badge/узлы-102-brightgreen) ![живые](https://img.shields.io/badge/живые-1811-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-501ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_13:20_UTC-informational)
...
- **Медиана RTT**: 501 ms
- **Последнее обновление (UTC)**: 2026-06-30 13:20 UTC

**Распределение протоколов:** hysteria2 × 1 · shadowsocks × 40 · trojan × 41 · vless × 13 · vmess × 7

**Источники в этом запуске:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 9 · `ruking-clash` × 12 · `surfboard-eternity` × 6
