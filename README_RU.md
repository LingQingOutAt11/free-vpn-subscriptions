...
![узлы](https://img.shields.io/badge/узлы-68-brightgreen) ![живые](https://img.shields.io/badge/живые-1981-blue) ![медиана--rtt](https://img.shields.io/badge/медиана--rtt-324ms-orange) ![обновлено](https://img.shields.io/badge/обновлено-2026-06-30_23:15_UTC-informational)
...
- **Медиана RTT**: 324 ms
- **Последнее обновление (UTC)**: 2026-06-30 23:15 UTC

**Распределение протоколов:** shadowsocks × 27 · trojan × 28 · vless × 7 · vmess × 6

**Источники в этом запуске:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 13 · `ruking-clash` × 4 · `surfboard-eternity` × 5
