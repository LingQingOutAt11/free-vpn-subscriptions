...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1970-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-465ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-22_20:14_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 465 ms
- **최종 업데이트 (UTC)**: 2026-06-22 20:14 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 41 · trojan × 20 · vless × 76 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 51 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 33 · `snakem982` × 1 · `surfboard-eternity` × 2
