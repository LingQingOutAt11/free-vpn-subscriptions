...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1942-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-135ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-12_07:13_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 135 ms
- **최종 업데이트 (UTC)**: 2026-05-12 07:13 UTC

**프로토콜 분포:** shadowsocks × 57 · trojan × 3 · vless × 80 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 7 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
