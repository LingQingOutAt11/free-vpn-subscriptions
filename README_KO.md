...
![노드](https://img.shields.io/badge/노드-64-brightgreen) ![생존](https://img.shields.io/badge/생존-4174-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-97ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-22_14:28_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 97 ms
- **최종 업데이트 (UTC)**: 2026-07-22 14:28 UTC

**프로토콜 분포:** shadowsocks × 9 · trojan × 13 · vless × 38 · vmess × 4

**이번 실행에 사용된 소스:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 25 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 9
