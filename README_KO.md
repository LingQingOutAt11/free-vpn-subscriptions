...
![노드](https://img.shields.io/badge/노드-90-brightgreen) ![생존](https://img.shields.io/badge/생존-1955-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-204ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-04_10:40_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 204 ms
- **최종 업데이트 (UTC)**: 2026-06-04 10:40 UTC

**프로토콜 분포:** shadowsocks × 23 · trojan × 40 · vless × 17 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 30 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 7 · `surfboard-eternity` × 2
