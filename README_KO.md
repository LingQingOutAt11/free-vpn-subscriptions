...
![노드](https://img.shields.io/badge/노드-82-brightgreen) ![생존](https://img.shields.io/badge/생존-3993-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-222ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-22_08:50_UTC-informational)
...
- **최고 속도 RTT**: 39 ms
- **중앙값 RTT**: 222 ms
- **최종 업데이트 (UTC)**: 2026-07-22 08:50 UTC

**프로토콜 분포:** shadowsocks × 4 · trojan × 22 · vless × 54 · vmess × 2

**이번 실행에 사용된 소스:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 5 · `barry-far-v2ray` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 34 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 13
