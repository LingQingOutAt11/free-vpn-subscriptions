...
![노드](https://img.shields.io/badge/노드-76-brightgreen) ![생존](https://img.shields.io/badge/생존-2222-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-246ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-28_23:32_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 246 ms
- **최종 업데이트 (UTC)**: 2026-06-28 23:32 UTC

**프로토콜 분포:** shadowsocks × 17 · trojan × 26 · vless × 18 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 11 · `ninjastrikers` × 12 · `ruking-clash` × 1 · `surfboard-eternity` × 4
