...
![노드](https://img.shields.io/badge/노드-111-brightgreen) ![생존](https://img.shields.io/badge/생존-1925-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-401ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-26_03:17_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 401 ms
- **최종 업데이트 (UTC)**: 2026-06-26 03:17 UTC

**프로토콜 분포:** shadowsocks × 32 · trojan × 40 · vless × 27 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 10 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `ruking-clash` × 17 · `surfboard-eternity` × 3
