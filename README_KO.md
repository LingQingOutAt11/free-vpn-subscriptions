...
![노드](https://img.shields.io/badge/노드-147-brightgreen) ![생존](https://img.shields.io/badge/생존-2093-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-411ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_06:14_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 411 ms
- **최종 업데이트 (UTC)**: 2026-06-21 06:14 UTC

**프로토콜 분포:** shadowsocks × 38 · trojan × 34 · vless × 50 · vmess × 25

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 39 · `snakem982` × 4 · `surfboard-eternity` × 3
