...
![노드](https://img.shields.io/badge/노드-78-brightgreen) ![생존](https://img.shields.io/badge/생존-3842-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-387ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-20_09:40_UTC-informational)
...
- **최고 속도 RTT**: 18 ms
- **중앙값 RTT**: 387 ms
- **최종 업데이트 (UTC)**: 2026-07-20 09:40 UTC

**프로토콜 분포:** shadowsocks × 1 · trojan × 16 · vless × 55 · vmess × 6

**이번 실행에 사용된 소스:** `automerge-verified-clash` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 5 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 39 · `tg-v2ray-configs-every2h` × 10
