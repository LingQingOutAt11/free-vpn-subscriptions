...
![노드](https://img.shields.io/badge/노드-130-brightgreen) ![생존](https://img.shields.io/badge/생존-2542-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-484ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_14:21_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 484 ms
- **최종 업데이트 (UTC)**: 2026-06-19 14:21 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 30 · trojan × 29 · vless × 50 · vmess × 20

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 16 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 42 · `snakem982` × 6 · `surfboard-eternity` × 3
