...
![노드](https://img.shields.io/badge/노드-140-brightgreen) ![생존](https://img.shields.io/badge/생존-2117-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-316ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_05:20_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 316 ms
- **최종 업데이트 (UTC)**: 2026-06-21 05:20 UTC

**프로토콜 분포:** shadowsocks × 42 · trojan × 34 · vless × 41 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 9 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 4 · `mfuu-clash` × 6 · `ninjastrikers` × 21 · `pawdroid` × 1 · `ruking-clash` × 31 · `snakem982` × 2 · `surfboard-eternity` × 1
