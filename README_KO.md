...
![노드](https://img.shields.io/badge/노드-139-brightgreen) ![생존](https://img.shields.io/badge/생존-1934-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-403ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_18:10_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 403 ms
- **최종 업데이트 (UTC)**: 2026-06-21 18:10 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 43 · trojan × 27 · vless × 55 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 5 · `ruking-clash` × 32 · `snakem982` × 4 · `surfboard-eternity` × 6
