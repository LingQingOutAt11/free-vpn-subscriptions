...
![노드](https://img.shields.io/badge/노드-134-brightgreen) ![생존](https://img.shields.io/badge/생존-2084-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-465ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-20_21:20_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 465 ms
- **최종 업데이트 (UTC)**: 2026-06-20 21:20 UTC

**프로토콜 분포:** shadowsocks × 39 · trojan × 35 · vless × 36 · vmess × 24

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 13 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 5 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 35 · `snakem982` × 1 · `surfboard-eternity` × 1
