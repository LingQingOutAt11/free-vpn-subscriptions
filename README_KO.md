...
![노드](https://img.shields.io/badge/노드-97-brightgreen) ![생존](https://img.shields.io/badge/생존-3006-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-153ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-13_15:18_UTC-informational)
...
- **최고 속도 RTT**: 51 ms
- **중앙값 RTT**: 153 ms
- **최종 업데이트 (UTC)**: 2026-07-13 15:18 UTC

**프로토콜 분포:** shadowsocks × 11 · trojan × 24 · vless × 54 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 2 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 8 · `pawdroid` × 4 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 6 · `snakem982` × 1 · `solispirit-v2ray` × 46 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
