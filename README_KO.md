...
![노드](https://img.shields.io/badge/노드-82-brightgreen) ![생존](https://img.shields.io/badge/생존-3052-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-321ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-12_08:38_UTC-informational)
...
- **최고 속도 RTT**: 42 ms
- **중앙값 RTT**: 321 ms
- **최종 업데이트 (UTC)**: 2026-07-12 08:38 UTC

**프로토콜 분포:** shadowsocks × 4 · trojan × 23 · vless × 50 · vmess × 5

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 1 · `epodonios` × 3 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 4 · `ninjastrikers` × 13 · `pawdroid` × 3 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `solispirit-v2ray` × 25 · `tg-v2ray-configs-every2h` × 16
