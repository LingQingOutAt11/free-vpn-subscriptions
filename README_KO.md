...
![노드](https://img.shields.io/badge/노드-89-brightgreen) ![생존](https://img.shields.io/badge/생존-2052-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-235ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-27_11:27_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 235 ms
- **최종 업데이트 (UTC)**: 2026-06-27 11:27 UTC

**프로토콜 분포:** shadowsocks × 17 · trojan × 34 · vless × 15 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `ruking-clash` × 14 · `surfboard-eternity` × 3
