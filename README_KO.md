...
![노드](https://img.shields.io/badge/노드-88-brightgreen) ![생존](https://img.shields.io/badge/생존-3027-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-347ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-11_19:39_UTC-informational)
...
- **최고 속도 RTT**: 17 ms
- **중앙값 RTT**: 347 ms
- **최종 업데이트 (UTC)**: 2026-07-11 19:39 UTC

**프로토콜 분포:** shadowsocks × 3 · trojan × 22 · vless × 57 · vmess × 6

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 3 · `ninjastrikers` × 6 · `pawdroid` × 4 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `solispirit-v2ray` × 40 · `tg-v2ray-configs-every2h` × 19
