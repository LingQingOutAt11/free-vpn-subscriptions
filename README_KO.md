...
![노드](https://img.shields.io/badge/노드-80-brightgreen) ![생존](https://img.shields.io/badge/생존-4107-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-207ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-21_14:28_UTC-informational)
...
- **최고 속도 RTT**: 49 ms
- **중앙값 RTT**: 207 ms
- **최종 업데이트 (UTC)**: 2026-07-21 14:28 UTC

**프로토콜 분포:** shadowsocks × 5 · trojan × 19 · vless × 52 · vmess × 4

**이번 실행에 사용된 소스:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 2 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 7 · `roosterkid-openproxylist` × 7 · `snakem982` × 1 · `solispirit-v2ray` × 32 · `tg-v2ray-configs-every2h` × 15
