...
![노드](https://img.shields.io/badge/노드-113-brightgreen) ![생존](https://img.shields.io/badge/생존-1956-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-492ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_13:33_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 492 ms
- **최종 업데이트 (UTC)**: 2026-06-18 13:33 UTC

**프로토콜 분포:** hysteria2 × 3 · shadowsocks × 33 · trojan × 34 · vless × 36 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 3 · `surfboard-eternity` × 3
