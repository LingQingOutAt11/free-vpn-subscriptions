...
![노드](https://img.shields.io/badge/노드-137-brightgreen) ![생존](https://img.shields.io/badge/생존-2097-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-414ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_08:30_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 414 ms
- **최종 업데이트 (UTC)**: 2026-06-21 08:30 UTC

**프로토콜 분포:** shadowsocks × 37 · trojan × 32 · vless × 44 · vmess × 24

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 38 · `snakem982` × 3 · `surfboard-eternity` × 4
