...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2440-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-129ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-13_20:31_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 129 ms
- **최종 업데이트 (UTC)**: 2026-05-13 20:31 UTC

**프로토콜 분포:** shadowsocks × 40 · trojan × 22 · vless × 80 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
