...
![노드](https://img.shields.io/badge/노드-83-brightgreen) ![생존](https://img.shields.io/badge/생존-3467-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-100ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-08-05_20:01_UTC-informational)
...
- **최고 속도 RTT**: 22 ms
- **중앙값 RTT**: 100 ms
- **최종 업데이트 (UTC)**: 2026-08-05 20:01 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 7 · trojan × 19 · vless × 48 · vmess × 8

**이번 실행에 사용된 소스:** `autojiedian-clash` × 15 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 3 · `pawdroid` × 1 · `roosterkid-openproxylist` × 14 · `ruking-clash` × 2 · `snakem982` × 2 · `solispirit-v2ray` × 14 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 12
