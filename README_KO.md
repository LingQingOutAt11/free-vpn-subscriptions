...
![노드](https://img.shields.io/badge/노드-106-brightgreen) ![생존](https://img.shields.io/badge/생존-3795-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-147ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-08-12_02:50_UTC-informational)
...
- **최고 속도 RTT**: 50 ms
- **중앙값 RTT**: 147 ms
- **최종 업데이트 (UTC)**: 2026-08-12 02:50 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 19 · trojan × 20 · vless × 51 · vmess × 15

**이번 실행에 사용된 소스:** `autojiedian-clash` × 15 · `automerge-verified-clash` × 23 · `barry-far-v2ray` × 1 · `epodonios` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 16 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 12
