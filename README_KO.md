...
![노드](https://img.shields.io/badge/노드-113-brightgreen) ![생존](https://img.shields.io/badge/생존-1932-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-290ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-13_02:18_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 290 ms
- **최종 업데이트 (UTC)**: 2026-06-13 02:18 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 51 · trojan × 24 · vless × 29 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 35 · `pawdroid` × 5 · `ruking-clash` × 9 · `surfboard-eternity` × 4
