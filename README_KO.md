...
![노드](https://img.shields.io/badge/노드-96-brightgreen) ![생존](https://img.shields.io/badge/생존-1955-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-463ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_07:22_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 463 ms
- **최종 업데이트 (UTC)**: 2026-06-18 07:22 UTC

**프로토콜 분포:** shadowsocks × 35 · trojan × 29 · vless × 23 · vmess × 9

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 13 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 17 · `snakem982` × 6 · `surfboard-eternity` × 3
