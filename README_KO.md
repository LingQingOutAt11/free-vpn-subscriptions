...
![노드](https://img.shields.io/badge/노드-143-brightgreen) ![생존](https://img.shields.io/badge/생존-4130-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-144ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-27_04:09_UTC-informational)
...
- **최고 속도 RTT**: 39 ms
- **중앙값 RTT**: 144 ms
- **최종 업데이트 (UTC)**: 2026-07-27 04:09 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 21 · trojan × 23 · vless × 91 · vmess × 7

**이번 실행에 사용된 소스:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 8 · `barry-far-v2ray` × 3 · `epodonios` × 2 · `go4sharing-clash` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 1 · `snakem982` × 2 · `solispirit-v2ray` × 57 · `surfboard-eternity` × 4 · `tg-v2ray-configs-every2h` × 21
