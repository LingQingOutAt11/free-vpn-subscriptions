...
![노드](https://img.shields.io/badge/노드-125-brightgreen) ![생존](https://img.shields.io/badge/생존-1676-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-402ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-14_22:28_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 402 ms
- **최종 업데이트 (UTC)**: 2026-06-14 22:28 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 67 · trojan × 26 · vless × 20 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 22 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 4
