...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2082-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-93ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-04_00:18_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 93 ms
- **최종 업데이트 (UTC)**: 2026-05-04 00:18 UTC

**프로토콜 분포:** shadowsocks × 30 · trojan × 3 · vless × 107 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 28 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 69 · `ruking-clash` × 2 · `surfboard-eternity` × 6
