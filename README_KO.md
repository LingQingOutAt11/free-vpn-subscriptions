...
![노드](https://img.shields.io/badge/노드-114-brightgreen) ![생존](https://img.shields.io/badge/생존-1936-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-302ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-13_03:35_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 302 ms
- **최종 업데이트 (UTC)**: 2026-06-13 03:35 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 50 · trojan × 25 · vless × 31 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 33 · `pawdroid` × 6 · `ruking-clash` × 13 · `surfboard-eternity` × 7
