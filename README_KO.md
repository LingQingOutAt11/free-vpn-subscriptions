...
![노드](https://img.shields.io/badge/노드-87-brightgreen) ![생존](https://img.shields.io/badge/생존-2385-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-91ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-03_07:28_UTC-informational)
...
- **최고 속도 RTT**: 34 ms
- **중앙값 RTT**: 91 ms
- **최종 업데이트 (UTC)**: 2026-06-03 07:28 UTC

**프로토콜 분포:** shadowsocks × 16 · trojan × 33 · vless × 7 · vmess × 31

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 19 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 11 · `surfboard-eternity` × 4
