...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1973-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-140ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-12_00:13_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 140 ms
- **최종 업데이트 (UTC)**: 2026-05-12 00:13 UTC

**프로토콜 분포:** shadowsocks × 53 · trojan × 3 · vless × 83 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 71 · `snakem982` × 2 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
