...
![노드](https://img.shields.io/badge/노드-128-brightgreen) ![생존](https://img.shields.io/badge/생존-2102-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-392ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-20_22:32_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 392 ms
- **최종 업데이트 (UTC)**: 2026-06-20 22:32 UTC

**프로토콜 분포:** shadowsocks × 41 · trojan × 33 · vless × 31 · vmess × 23

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 15 · `epodonios` × 11 · `mahdi0024` × 23 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 30 · `snakem982` × 1 · `surfboard-eternity` × 4
