...
![노드](https://img.shields.io/badge/노드-146-brightgreen) ![생존](https://img.shields.io/badge/생존-2251-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-293ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-04_20:19_UTC-informational)
...
- **최고 속도 RTT**: 37 ms
- **중앙값 RTT**: 293 ms
- **최종 업데이트 (UTC)**: 2026-05-04 20:19 UTC

**프로토콜 분포:** shadowsocks × 34 · trojan × 26 · vless × 73 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 60 · `ruking-clash` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
