...
![노드](https://img.shields.io/badge/노드-93-brightgreen) ![생존](https://img.shields.io/badge/생존-4049-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-214ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-21_19:58_UTC-informational)
...
- **최고 속도 RTT**: 41 ms
- **중앙값 RTT**: 214 ms
- **최종 업데이트 (UTC)**: 2026-07-21 19:58 UTC

**프로토콜 분포:** shadowsocks × 11 · trojan × 23 · vless × 54 · vmess × 5

**이번 실행에 사용된 소스:** `autojiedian-clash` × 6 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `roosterkid-openproxylist` × 15 · `solispirit-v2ray` × 34 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 12
