...
![노드](https://img.shields.io/badge/노드-91-brightgreen) ![생존](https://img.shields.io/badge/생존-3204-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-129ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-14_19:52_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 129 ms
- **최종 업데이트 (UTC)**: 2026-07-14 19:52 UTC

**프로토콜 분포:** shadowsocks × 7 · trojan × 22 · vless × 51 · vmess × 11

**이번 실행에 사용된 소스:** `autojiedian-clash` × 5 · `barry-far-v2ray` × 2 · `go4sharing-clash` × 3 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 6 · `pawdroid` × 1 · `roosterkid-openproxylist` × 10 · `solispirit-v2ray` × 38 · `tg-v2ray-configs-every2h` × 21
