...
![노드](https://img.shields.io/badge/노드-53-brightgreen) ![생존](https://img.shields.io/badge/생존-3616-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-52ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-08-08_07:21_UTC-informational)
...
- **최고 속도 RTT**: 12 ms
- **중앙값 RTT**: 52 ms
- **최종 업데이트 (UTC)**: 2026-08-08 07:21 UTC

**프로토콜 분포:** shadowsocks × 1 · trojan × 11 · vless × 29 · vmess × 12

**이번 실행에 사용된 소스:** `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `mahdi0024` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 4 · `pawdroid` × 1 · `roosterkid-openproxylist` × 7 · `snakem982` × 1 · `solispirit-v2ray` × 19 · `tg-v2ray-configs-every2h` × 8
