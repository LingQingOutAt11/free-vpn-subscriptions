...
![노드](https://img.shields.io/badge/노드-140-brightgreen) ![생존](https://img.shields.io/badge/생존-2074-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-170ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-03_23:37_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 170 ms
- **최종 업데이트 (UTC)**: 2026-05-03 23:37 UTC

**프로토콜 분포:** shadowsocks × 26 · trojan × 20 · vless × 82 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 56 · `ruking-clash` × 2 · `surfboard-eternity` × 11 · `vxiaov-clash` × 1
