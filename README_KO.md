...
![노드](https://img.shields.io/badge/노드-86-brightgreen) ![생존](https://img.shields.io/badge/생존-3987-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-350ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-20_14:40_UTC-informational)
...
- **최고 속도 RTT**: 18 ms
- **중앙값 RTT**: 350 ms
- **최종 업데이트 (UTC)**: 2026-07-20 14:40 UTC

**프로토콜 분포:** shadowsocks × 1 · trojan × 23 · vless × 57 · vmess × 5

**이번 실행에 사용된 소스:** `autojiedian-clash` × 2 · `barry-far-v2ray` × 1 · `mahdi0024` × 5 · `matin-v2ray` × 10 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 39 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
