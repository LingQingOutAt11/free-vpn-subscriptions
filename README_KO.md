...
![노드](https://img.shields.io/badge/노드-48-brightgreen) ![생존](https://img.shields.io/badge/생존-3895-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-431ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-28_19:58_UTC-informational)
...
- **최고 속도 RTT**: 18 ms
- **중앙값 RTT**: 431 ms
- **최종 업데이트 (UTC)**: 2026-07-28 19:58 UTC

**프로토콜 분포:** shadowsocks × 6 · trojan × 21 · vless × 20 · vmess × 1

**이번 실행에 사용된 소스:** `autojiedian-clash` × 7 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `go4sharing-clash` × 1 · `mahdibland-aggregator` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 15 · `tg-v2ray-configs-every2h` × 6
