...
![노드](https://img.shields.io/badge/노드-68-brightgreen) ![생존](https://img.shields.io/badge/생존-1981-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-324ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-30_23:15_UTC-informational)
...
- **최고 속도 RTT**: 48 ms
- **중앙값 RTT**: 324 ms
- **최종 업데이트 (UTC)**: 2026-06-30 23:15 UTC

**프로토콜 분포:** shadowsocks × 27 · trojan × 28 · vless × 7 · vmess × 6

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 13 · `ruking-clash` × 4 · `surfboard-eternity` × 5
