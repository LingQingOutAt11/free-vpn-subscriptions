...
![노드](https://img.shields.io/badge/노드-85-brightgreen) ![생존](https://img.shields.io/badge/생존-4014-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-368ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-21_03:50_UTC-informational)
...
- **최고 속도 RTT**: 41 ms
- **중앙값 RTT**: 368 ms
- **최종 업데이트 (UTC)**: 2026-07-21 03:50 UTC

**프로토콜 분포:** shadowsocks × 5 · trojan × 20 · vless × 55 · vmess × 5

**이번 실행에 사용된 소스:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 3 · `roosterkid-openproxylist` × 2 · `solispirit-v2ray` × 39 · `tg-v2ray-configs-every2h` × 12
