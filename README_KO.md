...
![노드](https://img.shields.io/badge/노드-138-brightgreen) ![생존](https://img.shields.io/badge/생존-3088-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-223ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-05_04:27_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 223 ms
- **최종 업데이트 (UTC)**: 2026-07-05 04:27 UTC

**프로토콜 분포:** shadowsocks × 18 · trojan × 31 · vless × 78 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 1 · `radikal-clash` × 6 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 56 · `tg-v2ray-configs-every2h` × 24
