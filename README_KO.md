...
![노드](https://img.shields.io/badge/노드-90-brightgreen) ![생존](https://img.shields.io/badge/생존-3681-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-143ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-08-12_13:52_UTC-informational)
...
- **최고 속도 RTT**: 25 ms
- **중앙값 RTT**: 143 ms
- **최종 업데이트 (UTC)**: 2026-08-12 13:52 UTC

**프로토콜 분포:** hysteria2 × 3 · shadowsocks × 24 · trojan × 15 · vless × 31 · vmess × 17

**이번 실행에 사용된 소스:** `autojiedian-clash` × 10 · `automerge-verified-clash` × 11 · `barry-far-v2ray` × 3 · `epodonios` × 7 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 3 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 2 · `snakem982` × 3 · `solispirit-v2ray` × 11 · `surfboard-eternity` × 4 · `tg-v2ray-configs-every2h` × 10
