...
![노드](https://img.shields.io/badge/노드-138-brightgreen) ![생존](https://img.shields.io/badge/생존-1978-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-427ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_17:22_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 427 ms
- **최종 업데이트 (UTC)**: 2026-06-21 17:22 UTC

**프로토콜 분포:** shadowsocks × 45 · trojan × 33 · vless × 48 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 17 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 28 · `snakem982` × 6 · `surfboard-eternity` × 4
