...
![노드](https://img.shields.io/badge/노드-80-brightgreen) ![생존](https://img.shields.io/badge/생존-3556-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-136ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-08-11_19:27_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 136 ms
- **최종 업데이트 (UTC)**: 2026-08-11 19:27 UTC

**프로토콜 분포:** hysteria2 × 3 · shadowsocks × 22 · trojan × 7 · vless × 36 · vmess × 12

**이번 실행에 사용된 소스:** `autojiedian-clash` × 15 · `automerge-verified-clash` × 14 · `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 2 · `solispirit-v2ray` × 2 · `tg-v2ray-configs-every2h` × 12
