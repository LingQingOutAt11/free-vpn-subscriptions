...
![노드](https://img.shields.io/badge/노드-69-brightgreen) ![생존](https://img.shields.io/badge/생존-3197-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-69ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-08-04_09:01_UTC-informational)
...
- **최고 속도 RTT**: 12 ms
- **중앙값 RTT**: 69 ms
- **최종 업데이트 (UTC)**: 2026-08-04 09:01 UTC

**프로토콜 분포:** shadowsocks × 2 · trojan × 11 · vless × 48 · vmess × 8

**이번 실행에 사용된 소스:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 3 · `barry-far-v2ray` × 2 · `epodonios` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 5 · `pawdroid` × 7 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 23 · `tg-v2ray-configs-every2h` × 7
