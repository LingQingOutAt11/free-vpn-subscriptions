...
![노드](https://img.shields.io/badge/노드-54-brightgreen) ![생존](https://img.shields.io/badge/생존-3637-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-89ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-08-11_13:49_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 89 ms
- **최종 업데이트 (UTC)**: 2026-08-11 13:49 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 9 · trojan × 2 · vless × 33 · vmess × 9

**이번 실행에 사용된 소스:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 1 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 1 · `solispirit-v2ray` × 7 · `tg-v2ray-configs-every2h` × 4
