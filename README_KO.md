...
![노드](https://img.shields.io/badge/노드-112-brightgreen) ![생존](https://img.shields.io/badge/생존-2112-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-334ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-24_18:12_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 334 ms
- **최종 업데이트 (UTC)**: 2026-06-24 18:12 UTC

**프로토콜 분포:** shadowsocks × 31 · trojan × 31 · vless × 35 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 2 · `epodonios` × 39 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 3
