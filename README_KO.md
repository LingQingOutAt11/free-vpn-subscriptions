...
![노드](https://img.shields.io/badge/노드-138-brightgreen) ![생존](https://img.shields.io/badge/생존-1959-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-405ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_19:26_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 405 ms
- **최종 업데이트 (UTC)**: 2026-06-21 19:26 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 43 · trojan × 31 · vless × 50 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 17 · `epodonios` × 24 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 30 · `snakem982` × 4 · `surfboard-eternity` × 4
