...
![노드](https://img.shields.io/badge/노드-62-brightgreen) ![생존](https://img.shields.io/badge/생존-3493-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-110ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-08-07_13:46_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 110 ms
- **최종 업데이트 (UTC)**: 2026-08-07 13:46 UTC

**프로토콜 분포:** shadowsocks × 4 · trojan × 14 · vless × 35 · vmess × 9

**이번 실행에 사용된 소스:** `automerge-verified-clash` × 12 · `barry-far-v2ray` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 2 · `pawdroid` × 1 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 11 · `tg-v2ray-configs-every2h` × 11
