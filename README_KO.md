...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1979-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-465ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-22_22:36_UTC-informational)
...
- **최고 속도 RTT**: 31 ms
- **중앙값 RTT**: 465 ms
- **최종 업데이트 (UTC)**: 2026-06-22 22:36 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 42 · trojan × 24 · vless × 70 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `epodonios` × 52 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 21 · `snakem982` × 3 · `surfboard-eternity` × 3
