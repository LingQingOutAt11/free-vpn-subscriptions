...
![노드](https://img.shields.io/badge/노드-126-brightgreen) ![생존](https://img.shields.io/badge/생존-1915-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-485ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_04:13_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 485 ms
- **최종 업데이트 (UTC)**: 2026-06-18 04:13 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 44 · trojan × 30 · vless × 44 · vmess × 7

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 21 · `epodonios` × 17 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 25 · `pawdroid` × 2 · `ruking-clash` × 21 · `snakem982` × 6 · `surfboard-eternity` × 2
