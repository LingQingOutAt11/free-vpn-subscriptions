...
![노드](https://img.shields.io/badge/노드-142-brightgreen) ![생존](https://img.shields.io/badge/생존-2241-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-310ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-05_16:39_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 310 ms
- **최종 업데이트 (UTC)**: 2026-05-05 16:39 UTC

**프로토콜 분포:** shadowsocks × 34 · trojan × 27 · vless × 71 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `snakem982` × 1 · `surfboard-eternity` × 5
