...
![노드](https://img.shields.io/badge/노드-82-brightgreen) ![생존](https://img.shields.io/badge/생존-3092-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-404ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-01_20:22_UTC-informational)
...
- **최고 속도 RTT**: 12 ms
- **중앙값 RTT**: 404 ms
- **최종 업데이트 (UTC)**: 2026-07-01 20:22 UTC

**프로토콜 분포:** shadowsocks × 11 · trojan × 28 · vless × 38 · vmess × 5

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 5 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 10 · `solispirit-v2ray` × 26 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 14
