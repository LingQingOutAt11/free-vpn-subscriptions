...
![노드](https://img.shields.io/badge/노드-140-brightgreen) ![생존](https://img.shields.io/badge/생존-1964-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-400ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_20:26_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 400 ms
- **최종 업데이트 (UTC)**: 2026-06-21 20:26 UTC

**프로토콜 분포:** shadowsocks × 48 · trojan × 32 · vless × 46 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 19 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 27 · `snakem982` × 9 · `surfboard-eternity` × 6
