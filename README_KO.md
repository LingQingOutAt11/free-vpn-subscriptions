...
![노드](https://img.shields.io/badge/노드-62-brightgreen) ![생존](https://img.shields.io/badge/생존-3463-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-103ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-08-09_13:23_UTC-informational)
...
- **최고 속도 RTT**: 21 ms
- **중앙값 RTT**: 103 ms
- **최종 업데이트 (UTC)**: 2026-08-09 13:23 UTC

**프로토콜 분포:** shadowsocks × 12 · trojan × 10 · vless × 27 · vmess × 13

**이번 실행에 사용된 소스:** `autojiedian-clash` × 5 · `automerge-verified-clash` × 13 · `barry-far-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 8 · `tg-v2ray-configs-every2h` × 3
