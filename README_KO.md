...
![노드](https://img.shields.io/badge/노드-124-brightgreen) ![생존](https://img.shields.io/badge/생존-1928-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-493ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_05:17_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 493 ms
- **최종 업데이트 (UTC)**: 2026-06-18 05:17 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 41 · trojan × 30 · vless × 46 · vmess × 6

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 14 · `epodonios` × 17 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 26 · `pawdroid` × 4 · `ruking-clash` × 19 · `snakem982` × 7 · `surfboard-eternity` × 3
