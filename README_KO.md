...
![노드](https://img.shields.io/badge/노드-78-brightgreen) ![생존](https://img.shields.io/badge/생존-2218-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-349ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-29_08:12_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 349 ms
- **최종 업데이트 (UTC)**: 2026-06-29 08:12 UTC

**프로토콜 분포:** shadowsocks × 16 · trojan × 28 · vless × 19 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 8 · `epodonios` × 20 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 7 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 4
