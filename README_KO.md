...
![노드](https://img.shields.io/badge/노드-97-brightgreen) ![생존](https://img.shields.io/badge/생존-3447-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-388ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-30_08:56_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 388 ms
- **최종 업데이트 (UTC)**: 2026-07-30 08:56 UTC

**프로토콜 분포:** shadowsocks × 7 · trojan × 21 · vless × 61 · vmess × 8

**이번 실행에 사용된 소스:** `autojiedian-clash` × 23 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 1 · `go4sharing-clash` × 1 · `mahdi0024` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 7 · `pawdroid` × 7 · `roosterkid-openproxylist` × 9 · `solispirit-v2ray` × 23 · `tg-v2ray-configs-every2h` × 10
