...
![노드](https://img.shields.io/badge/노드-64-brightgreen) ![생존](https://img.shields.io/badge/생존-2195-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-162ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-05_20:26_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 162 ms
- **최종 업데이트 (UTC)**: 2026-06-05 20:26 UTC

**프로토콜 분포:** shadowsocks × 19 · trojan × 23 · vless × 6 · vmess × 16

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 4 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
