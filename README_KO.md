...
![노드](https://img.shields.io/badge/노드-69-brightgreen) ![생존](https://img.shields.io/badge/생존-3008-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-107ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-13_19:56_UTC-informational)
...
- **최고 속도 RTT**: 26 ms
- **중앙값 RTT**: 107 ms
- **최종 업데이트 (UTC)**: 2026-07-13 19:56 UTC

**프로토콜 분포:** trojan × 10 · vless × 48 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 1 · `matin-v2ray` × 4 · `ninjastrikers` × 5 · `pawdroid` × 1 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 23 · `tg-v2ray-configs-every2h` × 15
