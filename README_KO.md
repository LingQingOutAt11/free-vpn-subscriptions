...
![노드](https://img.shields.io/badge/노드-100-brightgreen) ![생존](https://img.shields.io/badge/생존-2072-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-335ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-10_15:11_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 335 ms
- **최종 업데이트 (UTC)**: 2026-06-10 15:11 UTC

**프로토콜 분포:** shadowsocks × 43 · trojan × 20 · vless × 11 · vmess × 26

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 8 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 1
