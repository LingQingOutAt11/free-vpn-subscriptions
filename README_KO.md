...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2125-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-172ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_02:24_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 172 ms
- **최종 업데이트 (UTC)**: 2026-06-21 02:24 UTC

**프로토콜 분포:** shadowsocks × 38 · trojan × 27 · vless × 63 · vmess × 22

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `epodonios` × 39 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 21 · `pawdroid` × 4 · `ruking-clash` × 22 · `surfboard-eternity` × 3
