...
![노드](https://img.shields.io/badge/노드-126-brightgreen) ![생존](https://img.shields.io/badge/생존-3058-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-160ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-15_03:40_UTC-informational)
...
- **최고 속도 RTT**: 46 ms
- **중앙값 RTT**: 160 ms
- **최종 업데이트 (UTC)**: 2026-07-15 03:40 UTC

**프로토콜 분포:** shadowsocks × 18 · trojan × 25 · vless × 70 · vmess × 13

**이번 실행에 사용된 소스:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 2 · `epodonios` × 5 · `go4sharing-clash` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 4 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 11 · `snakem982` × 1 · `solispirit-v2ray` × 44 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 21
