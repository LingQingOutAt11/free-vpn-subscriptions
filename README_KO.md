...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2285-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-135ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-05_02:13_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 135 ms
- **최종 업데이트 (UTC)**: 2026-05-05 02:13 UTC

**프로토콜 분포:** shadowsocks × 34 · trojan × 13 · vless × 93 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 28 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 3 · `ninjastrikers` × 72 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 6
