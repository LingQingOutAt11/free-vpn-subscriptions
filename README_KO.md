...
![노드](https://img.shields.io/badge/노드-132-brightgreen) ![생존](https://img.shields.io/badge/생존-2195-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-490ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_08:27_UTC-informational)
...
- **최고 속도 RTT**: 37 ms
- **중앙값 RTT**: 490 ms
- **최종 업데이트 (UTC)**: 2026-06-19 08:27 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 54 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 37 · `snakem982` × 7 · `surfboard-eternity` × 1
