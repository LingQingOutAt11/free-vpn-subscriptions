...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-1937-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-484ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-22_12:31_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 484 ms
- **최종 업데이트 (UTC)**: 2026-06-22 12:31 UTC

**프로토콜 분포:** shadowsocks × 41 · trojan × 31 · vless × 63 · vmess × 15

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 9 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 30 · `snakem982` × 2 · `surfboard-eternity` × 4
