...
![노드](https://img.shields.io/badge/노드-118-brightgreen) ![생존](https://img.shields.io/badge/생존-2114-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-343ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-24_16:29_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 343 ms
- **최종 업데이트 (UTC)**: 2026-06-24 16:29 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 31 · trojan × 33 · vless × 39 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 7 · `epodonios` × 38 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 7 · `ruking-clash` × 15 · `surfboard-eternity` × 2
