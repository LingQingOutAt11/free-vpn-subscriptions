...
![노드](https://img.shields.io/badge/노드-109-brightgreen) ![생존](https://img.shields.io/badge/생존-3630-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-132ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-07-19_08:39_UTC-informational)
...
- **최고 속도 RTT**: 21 ms
- **중앙값 RTT**: 132 ms
- **최종 업데이트 (UTC)**: 2026-07-19 08:39 UTC

**프로토콜 분포:** shadowsocks × 4 · trojan × 18 · vless × 79 · vmess × 8

**이번 실행에 사용된 소스:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 4 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 4 · `roosterkid-openproxylist` × 7 · `solispirit-v2ray` × 48 · `tg-v2ray-configs-every2h` × 20
