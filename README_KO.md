...
![노드](https://img.shields.io/badge/노드-92-brightgreen) ![생존](https://img.shields.io/badge/생존-1972-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-424ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_11:17_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 424 ms
- **최종 업데이트 (UTC)**: 2026-06-18 11:17 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 32 · trojan × 34 · vless × 17 · vmess × 8

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 1
