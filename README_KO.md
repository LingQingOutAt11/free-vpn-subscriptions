...
![노드](https://img.shields.io/badge/노드-111-brightgreen) ![생존](https://img.shields.io/badge/생존-2420-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-489ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_22:11_UTC-informational)
...
- **최고 속도 RTT**: 38 ms
- **중앙값 RTT**: 489 ms
- **최종 업데이트 (UTC)**: 2026-06-18 22:11 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 38 · trojan × 27 · vless × 33 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 1 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 29 · `snakem982` × 9 · `surfboard-eternity` × 1
