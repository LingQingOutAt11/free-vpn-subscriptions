...
![노드](https://img.shields.io/badge/노드-80-brightgreen) ![생존](https://img.shields.io/badge/생존-2224-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-540ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-29_15:13_UTC-informational)
...
- **최고 속도 RTT**: 35 ms
- **중앙값 RTT**: 540 ms
- **최종 업데이트 (UTC)**: 2026-06-29 15:13 UTC

**프로토콜 분포:** shadowsocks × 17 · trojan × 31 · vless × 18 · vmess × 14

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 3
