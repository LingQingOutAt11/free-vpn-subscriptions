...
![노드](https://img.shields.io/badge/노드-95-brightgreen) ![생존](https://img.shields.io/badge/생존-1925-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-362ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-27_18:35_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 362 ms
- **최종 업데이트 (UTC)**: 2026-06-27 18:35 UTC

**프로토콜 분포:** shadowsocks × 25 · trojan × 39 · vless × 18 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 7
