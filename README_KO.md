...
![노드](https://img.shields.io/badge/노드-119-brightgreen) ![생존](https://img.shields.io/badge/생존-2393-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-487ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_21:34_UTC-informational)
...
- **최고 속도 RTT**: 39 ms
- **중앙값 RTT**: 487 ms
- **최종 업데이트 (UTC)**: 2026-06-18 21:34 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 40 · trojan × 28 · vless × 40 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `pawdroid` × 6 · `ruking-clash` × 34 · `snakem982` × 6 · `surfboard-eternity` × 4
