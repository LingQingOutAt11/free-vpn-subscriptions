...
![노드](https://img.shields.io/badge/노드-150-brightgreen) ![생존](https://img.shields.io/badge/생존-2046-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-141ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-07_00:17_UTC-informational)
...
- **최고 속도 RTT**: 39 ms
- **중앙값 RTT**: 141 ms
- **최종 업데이트 (UTC)**: 2026-05-07 00:17 UTC

**프로토콜 분포:** shadowsocks × 50 · trojan × 5 · vless × 83 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 25 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 63 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
