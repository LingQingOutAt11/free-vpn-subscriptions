...
![노드](https://img.shields.io/badge/노드-142-brightgreen) ![생존](https://img.shields.io/badge/생존-1972-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-471ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-21_15:14_UTC-informational)
...
- **최고 속도 RTT**: 29 ms
- **중앙값 RTT**: 471 ms
- **최종 업데이트 (UTC)**: 2026-06-21 15:14 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 45 · trojan × 28 · vless × 58 · vmess × 10

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 33 · `snakem982` × 5 · `surfboard-eternity` × 2
