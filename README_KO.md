...
![노드](https://img.shields.io/badge/노드-134-brightgreen) ![생존](https://img.shields.io/badge/생존-2385-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-498ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-18_16:31_UTC-informational)
...
- **최고 속도 RTT**: 33 ms
- **중앙값 RTT**: 498 ms
- **최종 업데이트 (UTC)**: 2026-06-18 16:31 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 34 · trojan × 34 · vless × 54 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 29 · `snakem982` × 8 · `surfboard-eternity` × 4
