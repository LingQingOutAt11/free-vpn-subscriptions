...
![노드](https://img.shields.io/badge/노드-93-brightgreen) ![생존](https://img.shields.io/badge/생존-3146-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-65ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-08-03_20:05_UTC-informational)
...
- **최고 속도 RTT**: 12 ms
- **중앙값 RTT**: 65 ms
- **최종 업데이트 (UTC)**: 2026-08-03 20:05 UTC

**프로토콜 분포:** shadowsocks × 6 · trojan × 11 · vless × 67 · vmess × 9

**이번 실행에 사용된 소스:** `autojiedian-clash` × 18 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 2 · `epodonios` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 3 · `pawdroid` × 3 · `roosterkid-openproxylist` × 16 · `snakem982` × 1 · `solispirit-v2ray` × 27 · `tg-v2ray-configs-every2h` × 8
