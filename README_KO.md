...
![노드](https://img.shields.io/badge/노드-128-brightgreen) ![생존](https://img.shields.io/badge/생존-2495-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-472ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-19_04:34_UTC-informational)
...
- **최고 속도 RTT**: 28 ms
- **중앙값 RTT**: 472 ms
- **최종 업데이트 (UTC)**: 2026-06-19 04:34 UTC

**프로토콜 분포:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 54 · vmess × 11

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 17 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 27 · `pawdroid` × 4 · `ruking-clash` × 35 · `snakem982` × 3 · `surfboard-eternity` × 1
