...
![노드](https://img.shields.io/badge/노드-122-brightgreen) ![생존](https://img.shields.io/badge/생존-1909-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-413ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-26_00:33_UTC-informational)
...
- **최고 속도 RTT**: 32 ms
- **중앙값 RTT**: 413 ms
- **최종 업데이트 (UTC)**: 2026-06-26 00:33 UTC

**프로토콜 분포:** shadowsocks × 32 · trojan × 40 · vless × 37 · vmess × 13

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 14 · `epodonios` × 27 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `ruking-clash` × 18 · `surfboard-eternity` × 1
