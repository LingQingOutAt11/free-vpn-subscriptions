...
![노드](https://img.shields.io/badge/노드-142-brightgreen) ![생존](https://img.shields.io/badge/생존-2241-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-215ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-05-04_16:19_UTC-informational)
...
- **최고 속도 RTT**: 30 ms
- **중앙값 RTT**: 215 ms
- **최종 업데이트 (UTC)**: 2026-05-04 16:19 UTC

**프로토콜 분포:** shadowsocks × 37 · trojan × 24 · vless × 69 · vmess × 12

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 58 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 7
