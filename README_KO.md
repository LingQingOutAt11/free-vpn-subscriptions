...
![노드](https://img.shields.io/badge/노드-58-brightgreen) ![생존](https://img.shields.io/badge/생존-2147-blue) ![중앙값--rtt](https://img.shields.io/badge/중앙값--rtt-152ms-orange) ![업데이트](https://img.shields.io/badge/업데이트-2026-06-05_19:11_UTC-informational)
...
- **최고 속도 RTT**: 27 ms
- **중앙값 RTT**: 152 ms
- **최종 업데이트 (UTC)**: 2026-06-05 19:11 UTC

**프로토콜 분포:** shadowsocks × 20 · trojan × 17 · vless × 5 · vmess × 16

**이번 실행에 사용된 소스:** `barry-far-v2ray` × 3 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 6 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
