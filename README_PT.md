...
![nós](https://img.shields.io/badge/nós-71-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3443-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-62ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-04_20:04_UTC-informational)
...
- **Nós selecionados**: 71
- **Ativos em todas as fontes**: 3443
- **RTT do nó mais rápido**: 18 ms
- **RTT mediano**: 62 ms
- **Última atualização (UTC)**: 2026-08-04 20:04 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 5 · trojan × 8 · vless × 47 · vmess × 10

**Fontes usadas nesta execução:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 4 · `pawdroid` × 4 · `roosterkid-openproxylist` × 15 · `ruking-clash` × 1 · `snakem982` × 3 · `solispirit-v2ray` × 11 · `tg-v2ray-configs-every2h` × 8
