...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4128-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-334ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_03:42_UTC-informational)
...
- **Nós selecionados**: 79
- **Ativos em todas as fontes**: 4128
- **RTT do nó mais rápido**: 25 ms
- **RTT mediano**: 334 ms
- **Última atualização (UTC)**: 2026-07-17 03:42 UTC

**Mix de protocolos:** trojan × 21 · vless × 55 · vmess × 3

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `barry-far-v2ray` × 1 · `mahdi0024` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 7 · `radikal-clash` × 1 · `solispirit-v2ray` × 37 · `tg-v2ray-configs-every2h` × 15
