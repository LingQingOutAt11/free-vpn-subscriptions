...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1861-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-356ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_21:35_UTC-informational)
...
- **Nós selecionados**: 98
- **Ativos em todas as fontes**: 1861
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 356 ms
- **Última atualização (UTC)**: 2026-06-07 21:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 28 · vless × 11 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 3 · `mfuu-clash` × 6 · `ninjastrikers` × 16 · `ruking-clash` × 2 · `surfboard-eternity` × 4
