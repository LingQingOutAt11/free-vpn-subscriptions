...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1948-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-388ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_23:35_UTC-informational)
...
- **Ativos em todas as fontes**: 1948
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 388 ms
- **Última atualização (UTC)**: 2026-06-16 23:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 47 · trojan × 18 · vless × 13 · vmess × 71

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 78 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 18 · `ruking-clash` × 3 · `surfboard-eternity` × 4
