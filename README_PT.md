...
![nós](https://img.shields.io/badge/nós-116-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1820-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-447ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_15:26_UTC-informational)
...
- **Ativos em todas as fontes**: 1820
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 447 ms
- **Última atualização (UTC)**: 2026-06-30 15:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 48 · vless × 18 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 13 · `surfboard-eternity` × 5
