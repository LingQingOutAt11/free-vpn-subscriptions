...
![nós](https://img.shields.io/badge/nós-52-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2203-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-104ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_16:27_UTC-informational)
...
- **Nós selecionados**: 52
- **Ativos em todas as fontes**: 2203
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 104 ms
- **Última atualização (UTC)**: 2026-05-29 16:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 12 · trojan × 10 · vless × 4 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 4
