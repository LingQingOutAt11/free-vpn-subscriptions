...
![nós](https://img.shields.io/badge/nós-120-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1684-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-388ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_23:16_UTC-informational)
...
- **Nós selecionados**: 120
- **Ativos em todas as fontes**: 1684
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 388 ms
- **Última atualização (UTC)**: 2026-06-14 23:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 26 · vless × 25 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 5
