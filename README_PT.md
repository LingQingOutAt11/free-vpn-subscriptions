...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2294-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-147ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_03:18_UTC-informational)
...
- **RTT mediano**: 147 ms
- **Última atualização (UTC)**: 2026-05-05 03:18 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 14 · vless × 89 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 3 · `ninjastrikers` × 75 · `pawdroid` × 3 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
