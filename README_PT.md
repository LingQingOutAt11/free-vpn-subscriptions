...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2191-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-281ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_05:13_UTC-informational)
...
- **Nós selecionados**: 87
- **Ativos em todas as fontes**: 2191
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 281 ms
- **Última atualização (UTC)**: 2026-06-29 05:13 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 29 · vless × 28 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `mfuu-clash` × 11 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 3
