...
![nós](https://img.shields.io/badge/nós-119-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3530-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-138ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-30_03:34_UTC-informational)
...
- **Nós selecionados**: 119
- **Ativos em todas as fontes**: 3530
- **RTT do nó mais rápido**: 43 ms
- **RTT mediano**: 138 ms
- **Última atualização (UTC)**: 2026-07-30 03:34 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 33 · trojan × 25 · vless × 52 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 15 · `automerge-verified-clash` × 20 · `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 6 · `roosterkid-openproxylist` × 10 · `snakem982` × 2 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 6
