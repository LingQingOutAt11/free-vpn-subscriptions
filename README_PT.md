...
![nós](https://img.shields.io/badge/nós-142-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2241-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-310ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_16:39_UTC-informational)
...
- **RTT mediano**: 310 ms
- **Última atualização (UTC)**: 2026-05-05 16:39 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 27 · vless × 71 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `snakem982` × 1 · `surfboard-eternity` × 5
