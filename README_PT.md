...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2047-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-71ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_11:28_UTC-informational)
...
- **RTT mediano**: 71 ms
- **Última atualização (UTC)**: 2026-05-22 11:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 8 · vless × 90 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 64 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 6
