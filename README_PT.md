...
![nós](https://img.shields.io/badge/nós-70-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2463-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-106ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_11:39_UTC-informational)
...
- **Nós selecionados**: 70
- **Ativos em todas as fontes**: 2463
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 106 ms
- **Última atualização (UTC)**: 2026-06-02 11:39 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 16 · vless × 8 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 1 · `ninjastrikers` × 5 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
