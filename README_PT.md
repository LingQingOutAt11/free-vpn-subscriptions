...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2058-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-346ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_13:05_UTC-informational)
...
- **Ativos em todas as fontes**: 2058
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 346 ms
- **Última atualização (UTC)**: 2026-06-24 13:05 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 27 · vless × 32 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 40 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 6
