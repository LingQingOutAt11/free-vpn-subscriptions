...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2102-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-392ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_22:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2102
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 392 ms
- **Última atualização (UTC)**: 2026-06-20 22:32 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 33 · vless × 31 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 11 · `mahdi0024` × 23 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 30 · `snakem982` × 1 · `surfboard-eternity` × 4
