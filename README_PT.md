...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2005-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-101ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_09:33_UTC-informational)
...
- **Ativos em todas as fontes**: 2005
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 101 ms
- **Última atualização (UTC)**: 2026-05-04 09:33 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 7 · vless × 100 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 3 · `surfboard-eternity` × 5
