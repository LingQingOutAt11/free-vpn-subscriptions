...
![nós](https://img.shields.io/badge/nós-52-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3736-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-103ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-11_07:43_UTC-informational)
...
- **Nós selecionados**: 52
- **Ativos em todas as fontes**: 3736
- **RTT do nó mais rápido**: 25 ms
- **RTT mediano**: 103 ms
- **Última atualização (UTC)**: 2026-08-11 07:43 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 6 · trojan × 9 · vless × 28 · vmess × 8

**Fontes usadas nesta execução:** `automerge-verified-clash` × 9 · `barry-far-v2ray` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 4 · `pawdroid` × 4 · `roosterkid-openproxylist` × 5 · `ruking-clash` × 1 · `solispirit-v2ray` × 13 · `tg-v2ray-configs-every2h` × 2
