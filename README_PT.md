...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2413-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-140ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_07:12_UTC-informational)
...
- **Nós selecionados**: 94
- **Ativos em todas as fontes**: 2413
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 140 ms
- **Última atualização (UTC)**: 2026-06-01 07:12 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 26 · vless × 15 · vmess × 34

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 19 · `pawdroid` × 1 · `surfboard-eternity` × 1
