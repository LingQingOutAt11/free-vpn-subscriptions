...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2265-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-212ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_10:17_UTC-informational)
...
- **RTT mediano**: 212 ms
- **Última atualização (UTC)**: 2026-06-20 10:17 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 24 · vless × 10 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 3
