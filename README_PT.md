...
![nós](https://img.shields.io/badge/nós-77-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4227-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-177ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_19:38_UTC-informational)
...
- **Nós selecionados**: 77
- **Ativos em todas as fontes**: 4227
- **RTT do nó mais rápido**: 52 ms
- **RTT mediano**: 177 ms
- **Última atualização (UTC)**: 2026-07-17 19:38 UTC

**Mix de protocolos:** trojan × 17 · vless × 55 · vmess × 5

**Fontes usadas nesta execução:** `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 7 · `pawdroid` × 6 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 33 · `tg-v2ray-configs-every2h` × 24
