...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2916-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-525ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_08:22_UTC-informational)
...
- **Ativos em todas as fontes**: 2916
- **RTT do nó mais rápido**: 14 ms
- **RTT mediano**: 525 ms
- **Última atualização (UTC)**: 2026-07-11 08:22 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 28 · vless × 73 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 5 · `ninjastrikers` × 13 · `pawdroid` × 4 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 22 · `solispirit-v2ray` × 33 · `tg-v2ray-configs-every2h` × 25
