...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2140-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-250ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_10:20_UTC-informational)
...
- **RTT mediano**: 250 ms
- **Última atualização (UTC)**: 2026-05-06 10:20 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 13 · vless × 86 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 65 · `pawdroid` × 2 · `surfboard-eternity` × 10
