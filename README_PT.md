...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3312-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-153ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_19:42_UTC-informational)
...
- **Nós selecionados**: 115
- **Ativos em todas as fontes**: 3312
- **RTT do nó mais rápido**: 44 ms
- **RTT mediano**: 153 ms
- **Última atualização (UTC)**: 2026-07-16 19:42 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 16 · vless × 63 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 10 · `pawdroid` × 2 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `solispirit-v2ray` × 38 · `tg-v2ray-configs-every2h` × 23
