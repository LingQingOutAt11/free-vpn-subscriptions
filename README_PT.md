...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1968-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-146ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-08_08:23_UTC-informational)
...
- **Ativos em todas as fontes**: 1968
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 146 ms
- **Última atualização (UTC)**: 2026-05-08 08:23 UTC

**Mix de protocolos:** shadowsocks × 52 · trojan × 5 · vless × 84 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 68 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 11
