...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2074-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-170ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-03_23:37_UTC-informational)
...
- **Ativos em todas as fontes**: 2074
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 170 ms
- **Última atualização (UTC)**: 2026-05-03 23:37 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 20 · vless × 82 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 56 · `ruking-clash` × 2 · `surfboard-eternity` × 11 · `vxiaov-clash` × 1
