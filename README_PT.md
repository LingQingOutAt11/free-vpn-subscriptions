...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1767-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-276ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_12:20_UTC-informational)
...
- **Nós selecionados**: 76
- **Ativos em todas as fontes**: 1767
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 276 ms
- **Última atualização (UTC)**: 2026-06-08 12:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 15 · vless × 11 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 5
