...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3058-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-160ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_03:40_UTC-informational)
...
- **Ativos em todas as fontes**: 3058
- **RTT do nó mais rápido**: 46 ms
- **RTT mediano**: 160 ms
- **Última atualização (UTC)**: 2026-07-15 03:40 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 25 · vless × 70 · vmess × 13

**Fontes usadas nesta execução:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 2 · `epodonios` × 5 · `go4sharing-clash` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 4 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 11 · `snakem982` × 1 · `solispirit-v2ray` × 44 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 21
