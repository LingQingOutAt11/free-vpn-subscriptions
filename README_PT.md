...
![nós](https://img.shields.io/badge/nós-84-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2031-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-160ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_04:14_UTC-informational)
...
- **Nós selecionados**: 84
- **Ativos em todas as fontes**: 2031
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 160 ms
- **Última atualização (UTC)**: 2026-05-28 04:14 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 27 · vless × 24 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 6 · `surfboard-eternity` × 5
