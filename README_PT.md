...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4150-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-138ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-25_03:42_UTC-informational)
...
- **Nós selecionados**: 95
- **Ativos em todas as fontes**: 4150
- **RTT do nó mais rápido**: 22 ms
- **RTT mediano**: 138 ms
- **Última atualização (UTC)**: 2026-07-25 03:42 UTC

**Mix de protocolos:** shadowsocks × 8 · trojan × 20 · vless × 65 · vmess × 2

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 4 · `epodonios` × 2 · `go4sharing-clash` × 2 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 1 · `roosterkid-openproxylist` × 3 · `snakem982` × 1 · `solispirit-v2ray` × 44 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 18
