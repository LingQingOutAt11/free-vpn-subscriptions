...
![nós](https://img.shields.io/badge/nós-144-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1902-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-451ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_09:28_UTC-informational)
...
- **RTT mediano**: 451 ms
- **Última atualização (UTC)**: 2026-06-22 09:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 30 · vless × 51 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 29 · `snakem982` × 1 · `surfboard-eternity` × 3
