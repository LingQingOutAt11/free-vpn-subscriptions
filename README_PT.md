...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2091-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-240ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_10:19_UTC-informational)
...
- **RTT mediano**: 240 ms
- **Última atualização (UTC)**: 2026-06-27 10:19 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 33 · vless × 17 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 14 · `mahdi0024` × 12 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 2
