...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3807-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-96ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-24_03:48_UTC-informational)
...
- **Nós selecionados**: 91
- **Ativos em todas as fontes**: 3807
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 96 ms
- **Última atualização (UTC)**: 2026-07-24 03:48 UTC

**Mix de protocolos:** shadowsocks × 5 · trojan × 15 · vless × 66 · vmess × 5

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 2 · `epodonios` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 3 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 42 · `tg-v2ray-configs-every2h` × 14
