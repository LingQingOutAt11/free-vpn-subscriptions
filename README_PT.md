...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2651-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-179ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-09_04:20_UTC-informational)
...
- **Ativos em todas as fontes**: 2651
- **RTT do nó mais rápido**: 43 ms
- **RTT mediano**: 179 ms
- **Última atualização (UTC)**: 2026-07-09 04:20 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 22 · vless × 62 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 9 · `go4sharing-clash` × 1 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 2 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 49
