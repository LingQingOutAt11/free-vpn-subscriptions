...
![nós](https://img.shields.io/badge/nós-83-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3359-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-105ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-31_14:41_UTC-informational)
...
- **Nós selecionados**: 83
- **Ativos em todas as fontes**: 3359
- **RTT do nó mais rápido**: 17 ms
- **RTT mediano**: 105 ms
- **Última atualização (UTC)**: 2026-07-31 14:41 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 16 · trojan × 8 · vless × 49 · vmess × 7

**Fontes usadas nesta execução:** `autojiedian-clash` × 9 · `automerge-verified-clash` × 8 · `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 3 · `pawdroid` × 7 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 11 · `ruking-clash` × 2 · `snakem982` × 1 · `solispirit-v2ray` × 12 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 7
