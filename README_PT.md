...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2472-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-75ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_07:20_UTC-informational)
...
- **RTT mediano**: 75 ms
- **Última atualização (UTC)**: 2026-05-25 07:20 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 2 · vless × 84 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 62 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 5
