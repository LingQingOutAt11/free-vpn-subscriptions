...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2222-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-246ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_23:32_UTC-informational)
...
- **RTT mediano**: 246 ms
- **Última atualização (UTC)**: 2026-06-28 23:32 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 26 · vless × 18 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 11 · `ninjastrikers` × 12 · `ruking-clash` × 1 · `surfboard-eternity` × 4
