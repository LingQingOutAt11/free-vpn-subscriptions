...
![nós](https://img.shields.io/badge/nós-77-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2284-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-158ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_16:30_UTC-informational)
...
- **Nós selecionados**: 77
- **Ativos em todas as fontes**: 2284
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 158 ms
- **Última atualização (UTC)**: 2026-05-30 16:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 23 · trojan × 20 · vless × 5 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 30 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 7 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
