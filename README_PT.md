...
![nós](https://img.shields.io/badge/nós-61-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2245-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-127ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_18:34_UTC-informational)
...
- **Nós selecionados**: 61
- **Ativos em todas as fontes**: 2245
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 127 ms
- **Última atualização (UTC)**: 2026-05-29 18:34 UTC

**Mix de protocolos:** shadowsocks × 11 · trojan × 23 · vless × 3 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
