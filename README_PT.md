...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3458-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-02_19:41_UTC-informational)
...
- **Nós selecionados**: 86
- **Ativos em todas as fontes**: 3458
- **RTT do nó mais rápido**: 23 ms
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-08-02 19:41 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 4 · trojan × 9 · vless × 62 · vmess × 10

**Fontes usadas nesta execução:** `autojiedian-clash` × 8 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 2 · `epodonios` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 5 · `pawdroid` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 28 · `tg-v2ray-configs-every2h` × 8
