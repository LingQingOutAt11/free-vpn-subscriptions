...
![nós](https://img.shields.io/badge/nós-129-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1995-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-395ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_16:23_UTC-informational)
...
- **Nós selecionados**: 129
- **Ativos em todas as fontes**: 1995
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 395 ms
- **Última atualização (UTC)**: 2026-06-23 16:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 27 · vless × 43 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 44 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 2
