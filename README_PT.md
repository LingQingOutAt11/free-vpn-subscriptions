...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1833-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-385ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_20:16_UTC-informational)
...
- **Ativos em todas as fontes**: 1833
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 385 ms
- **Última atualização (UTC)**: 2026-06-15 20:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 52 · trojan × 24 · vless × 20 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 4
