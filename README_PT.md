...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2696-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-82ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-17_23:39_UTC-informational)
...
- **Ativos em todas as fontes**: 2696
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 82 ms
- **Última atualização (UTC)**: 2026-05-17 23:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 14 · vless × 85 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 5 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 43 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 42 · `pawdroid` × 5 · `ruking-clash` × 7 · `surfboard-eternity` × 4
