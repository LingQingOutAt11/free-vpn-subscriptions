...
![nós](https://img.shields.io/badge/nós-147-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2369-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_22:25_UTC-informational)
...
- **Ativos em todas as fontes**: 2369
- **RTT do nó mais rápido**: 22 ms
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-05-22 22:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 26 · vless × 74 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 20 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 5
