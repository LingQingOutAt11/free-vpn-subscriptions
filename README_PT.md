...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2397-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-225ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_21:35_UTC-informational)
...
- **RTT mediano**: 225 ms
- **Última atualização (UTC)**: 2026-05-10 21:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 58 · trojan × 9 · vless × 73 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 6 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
