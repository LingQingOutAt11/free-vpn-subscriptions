...
![nós](https://img.shields.io/badge/nós-135-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2543-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-482ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_07:25_UTC-informational)
...
- **Ativos em todas as fontes**: 2543
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 482 ms
- **Última atualização (UTC)**: 2026-06-19 07:25 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 26 · vless × 58 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 19 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 25 · `pawdroid` × 7 · `ruking-clash` × 31 · `snakem982` × 8 · `surfboard-eternity` × 4
