...
![nós](https://img.shields.io/badge/nós-133-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1884-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-465ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_02:27_UTC-informational)
...
- **Ativos em todas as fontes**: 1884
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 465 ms
- **Última atualização (UTC)**: 2026-06-18 02:27 UTC

**Mix de protocolos:** hysteria2 × 4 · shadowsocks × 46 · trojan × 32 · vless × 43 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 25 · `pawdroid` × 3 · `ruking-clash` × 32 · `surfboard-eternity` × 3
