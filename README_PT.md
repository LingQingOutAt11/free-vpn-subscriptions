...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1844-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-370ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_23:36_UTC-informational)
...
- **Nós selecionados**: 97
- **Ativos em todas as fontes**: 1844
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 370 ms
- **Última atualização (UTC)**: 2026-06-08 23:36 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 47 · trojan × 21 · vless × 16 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 2
