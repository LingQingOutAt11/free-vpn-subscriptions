...
![nós](https://img.shields.io/badge/nós-69-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3008-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-107ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_19:56_UTC-informational)
...
- **Nós selecionados**: 69
- **Ativos em todas as fontes**: 3008
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 107 ms
- **Última atualização (UTC)**: 2026-07-13 19:56 UTC

**Mix de protocolos:** trojan × 10 · vless × 48 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 1 · `matin-v2ray` × 4 · `ninjastrikers` × 5 · `pawdroid` × 1 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 23 · `tg-v2ray-configs-every2h` × 15
