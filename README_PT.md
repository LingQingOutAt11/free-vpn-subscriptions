...
![nós](https://img.shields.io/badge/nós-46-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3508-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-152ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-08_19:06_UTC-informational)
...
- **Nós selecionados**: 46
- **Ativos em todas as fontes**: 3508
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 152 ms
- **Última atualização (UTC)**: 2026-08-08 19:06 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 11 · trojan × 4 · vless × 22 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 1 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 8 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 7
