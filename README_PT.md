...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2029-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-285ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_09:38_UTC-informational)
...
- **Ativos em todas as fontes**: 2029
- **RTT do nó mais rápido**: 38 ms
- **RTT mediano**: 285 ms
- **Última atualização (UTC)**: 2026-06-25 09:38 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 30 · vless × 36 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 32 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 3 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 4
