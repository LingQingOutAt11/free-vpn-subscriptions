...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2159-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-375ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_15:15_UTC-informational)
...
- **RTT mediano**: 375 ms
- **Última atualização (UTC)**: 2026-06-11 15:15 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 21 · vless × 14 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 6 · `surfboard-eternity` × 8
