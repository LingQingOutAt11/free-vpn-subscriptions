...
![nós](https://img.shields.io/badge/nós-110-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2273-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-103ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_02:26_UTC-informational)
...
- **RTT mediano**: 103 ms
- **Última atualização (UTC)**: 2026-05-31 02:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 20 · trojan × 30 · vless × 31 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 34 · `pawdroid` × 1 · `surfboard-eternity` × 3
