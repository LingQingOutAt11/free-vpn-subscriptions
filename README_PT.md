...
![nós](https://img.shields.io/badge/nós-70-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3764-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-517ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-19_19:37_UTC-informational)
...
- **Nós selecionados**: 70
- **Ativos em todas as fontes**: 3764
- **RTT do nó mais rápido**: 21 ms
- **RTT mediano**: 517 ms
- **Última atualização (UTC)**: 2026-07-19 19:37 UTC

**Mix de protocolos:** trojan × 14 · vless × 50 · vmess × 6

**Fontes usadas nesta execução:** `autojiedian-clash` × 4 · `barry-far-v2ray` × 1 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 7 · `ninjastrikers` × 3 · `pawdroid` × 2 · `roosterkid-openproxylist` × 1 · `solispirit-v2ray` × 36 · `tg-v2ray-configs-every2h` × 12
