...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1994-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-284ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_20:30_UTC-informational)
...
- **RTT mediano**: 284 ms
- **Última atualização (UTC)**: 2026-06-10 20:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 14 · vless × 9 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 8 · `surfboard-eternity` × 5
