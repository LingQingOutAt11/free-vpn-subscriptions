...
![nós](https://img.shields.io/badge/nós-84-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2277-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-224ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_11:16_UTC-informational)
...
- **RTT mediano**: 224 ms
- **Última atualização (UTC)**: 2026-06-20 11:16 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 22 · vless × 11 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 1
