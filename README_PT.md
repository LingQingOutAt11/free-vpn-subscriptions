...
![nós](https://img.shields.io/badge/nós-78-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1979-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-236ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_14:13_UTC-informational)
...
- **RTT mediano**: 236 ms
- **Última atualização (UTC)**: 2026-05-28 14:13 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 21 · vless × 15 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
