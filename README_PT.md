...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2284-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-190ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_06:13_UTC-informational)
...
- **RTT mediano**: 190 ms
- **Última atualização (UTC)**: 2026-06-10 06:13 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 13 · vless × 15 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 8
