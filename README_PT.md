...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2253-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-171ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_06:36_UTC-informational)
...
- **RTT mediano**: 171 ms
- **Última atualização (UTC)**: 2026-06-07 06:36 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 23 · vless × 14 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 17 · `pawdroid` × 2 · `surfboard-eternity` × 5
