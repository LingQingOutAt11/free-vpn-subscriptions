...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1853-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-359ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_17:23_UTC-informational)
...
- **Nós selecionados**: 95
- **Ativos em todas as fontes**: 1853
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 359 ms
- **Última atualização (UTC)**: 2026-06-07 17:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 52 · trojan × 23 · vless × 11 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 3 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 26 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
