...
![nós](https://img.shields.io/badge/nós-89-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2052-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-235ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_11:27_UTC-informational)
...
- **RTT mediano**: 235 ms
- **Última atualização (UTC)**: 2026-06-27 11:27 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 34 · vless × 15 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `ruking-clash` × 14 · `surfboard-eternity` × 3
