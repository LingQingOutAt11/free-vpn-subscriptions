...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2520-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-79ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_14:17_UTC-informational)
...
- **Ativos em todas as fontes**: 2520
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 79 ms
- **Última atualização (UTC)**: 2026-05-16 14:17 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 13 · vless × 93 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 33 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 56 · `pawdroid` × 7 · `ruking-clash` × 4 · `surfboard-eternity` × 6
