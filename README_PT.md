...
![nós](https://img.shields.io/badge/nós-132-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2195-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-490ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_08:27_UTC-informational)
...
- **RTT mediano**: 490 ms
- **Última atualização (UTC)**: 2026-06-19 08:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 54 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 37 · `snakem982` × 7 · `surfboard-eternity` × 1
