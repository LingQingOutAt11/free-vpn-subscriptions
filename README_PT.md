...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1906-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-372ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_11:31_UTC-informational)
...
- **RTT mediano**: 372 ms
- **Última atualização (UTC)**: 2026-06-15 11:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 21 · vless × 16 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 9 · `surfboard-eternity` × 3
