...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2543-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-72ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-20_07:24_UTC-informational)
...
- **RTT mediano**: 72 ms
- **Última atualização (UTC)**: 2026-05-20 07:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 6 · vless × 91 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 70 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
