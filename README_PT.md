...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2283-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-183ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_18:19_UTC-informational)
...
- **RTT mediano**: 183 ms
- **Última atualização (UTC)**: 2026-06-19 18:19 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 24 · vless × 10 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 2
