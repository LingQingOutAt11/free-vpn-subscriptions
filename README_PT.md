...
![nós](https://img.shields.io/badge/nós-132-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3004-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-234ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_04:01_UTC-informational)
...
- **Ativos em todas as fontes**: 3004
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 234 ms
- **Última atualização (UTC)**: 2026-07-12 04:01 UTC

**Mix de protocolos:** shadowsocks × 9 · trojan × 33 · vless × 77 · vmess × 13

**Fontes usadas nesta execução:** `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 9 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 57 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 15
