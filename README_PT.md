...
![nós](https://img.shields.io/badge/nós-75-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2459-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-120ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_15:16_UTC-informational)
...
- **RTT mediano**: 120 ms
- **Última atualização (UTC)**: 2026-06-02 15:16 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 24 · vless × 7 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `mahdi0024` × 32 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 7 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
