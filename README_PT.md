...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1922-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-241ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_07:18_UTC-informational)
...
- **RTT mediano**: 241 ms
- **Última atualização (UTC)**: 2026-06-17 07:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 22 · vless × 14 · vmess × 73

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `mahdi0024` × 74 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 2
