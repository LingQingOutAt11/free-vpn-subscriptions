...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1977-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-179ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_09:18_UTC-informational)
...
- **RTT mediano**: 179 ms
- **Última atualização (UTC)**: 2026-06-04 09:18 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 45 · vless × 20 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 33 · `mahdi0024` × 13 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 11 · `pawdroid` × 2 · `surfboard-eternity` × 4
