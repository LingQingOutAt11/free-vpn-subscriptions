...
![nós](https://img.shields.io/badge/nós-142-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2294-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-309ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_23:36_UTC-informational)
...
- **RTT mediano**: 309 ms
- **Última atualização (UTC)**: 2026-05-04 23:36 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 26 · vless × 68 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 9
