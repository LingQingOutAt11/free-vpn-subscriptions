...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2398-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-91ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_05:16_UTC-informational)
...
- **Nós selecionados**: 95
- **Ativos em todas as fontes**: 2398
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 91 ms
- **Última atualização (UTC)**: 2026-06-03 05:16 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 33 · vless × 13 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 17 · `pawdroid` × 1 · `surfboard-eternity` × 4
