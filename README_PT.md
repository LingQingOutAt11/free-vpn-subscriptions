...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4240-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-50ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-26_08:45_UTC-informational)
...
- **Nós selecionados**: 97
- **Ativos em todas as fontes**: 4240
- **RTT do nó mais rápido**: 10 ms
- **RTT mediano**: 50 ms
- **Última atualização (UTC)**: 2026-07-26 08:45 UTC

**Mix de protocolos:** shadowsocks × 9 · trojan × 23 · vless × 63 · vmess × 2

**Fontes usadas nesta execução:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 2 · `epodonios` × 2 · `go4sharing-clash` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `roosterkid-openproxylist` × 3 · `solispirit-v2ray` × 44 · `tg-v2ray-configs-every2h` × 19
