...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3027-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-347ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_19:39_UTC-informational)
...
- **Nós selecionados**: 88
- **Ativos em todas as fontes**: 3027
- **RTT do nó mais rápido**: 17 ms
- **RTT mediano**: 347 ms
- **Última atualização (UTC)**: 2026-07-11 19:39 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 22 · vless × 57 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 3 · `ninjastrikers` × 6 · `pawdroid` × 4 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `solispirit-v2ray` × 40 · `tg-v2ray-configs-every2h` × 19
