...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1925-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-494ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_06:24_UTC-informational)
...
- **RTT mediano**: 494 ms
- **Última atualização (UTC)**: 2026-06-26 06:24 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 41 · vless × 24 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 21 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 3
