...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2233-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-262ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_11:34_UTC-informational)
...
- **Nós selecionados**: 79
- **Ativos em todas as fontes**: 2233
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 262 ms
- **Última atualização (UTC)**: 2026-06-10 11:34 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 17 · vless × 7 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 11 · `ruking-clash` × 3 · `surfboard-eternity` × 4
