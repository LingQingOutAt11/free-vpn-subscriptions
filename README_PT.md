...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2283-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-82ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-19_02:14_UTC-informational)
...
- **RTT mediano**: 82 ms
- **Última atualização (UTC)**: 2026-05-19 02:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 18 · trojan × 29 · vless × 82 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 63 · `pawdroid` × 9 · `ruking-clash` × 10 · `surfboard-eternity` × 4
