...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1979-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-465ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_22:36_UTC-informational)
...
- **Ativos em todas as fontes**: 1979
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 465 ms
- **Última atualização (UTC)**: 2026-06-22 22:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 24 · vless × 70 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 52 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 21 · `snakem982` × 3 · `surfboard-eternity` × 3
