...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1933-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-406ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_19:16_UTC-informational)
...
- **Ativos em todas as fontes**: 1933
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 406 ms
- **Última atualização (UTC)**: 2026-06-12 19:16 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 50 · trojan × 35 · vless × 13 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 31 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 6
