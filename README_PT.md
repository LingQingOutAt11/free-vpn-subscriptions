...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1936-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-231ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_13:25_UTC-informational)
...
- **RTT mediano**: 231 ms
- **Última atualização (UTC)**: 2026-06-04 13:25 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 55 · vless × 18 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 39 · `epodonios` × 25 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
