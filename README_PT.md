...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1925-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-114ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-05_07:12_UTC-informational)
...
- **Nós selecionados**: 99
- **Ativos em todas as fontes**: 1925
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 114 ms
- **Última atualização (UTC)**: 2026-06-05 07:12 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 37 · vless × 22 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 1
