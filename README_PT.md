...
![nós](https://img.shields.io/badge/nós-110-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2339-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-350ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_06:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2339
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 350 ms
- **Última atualização (UTC)**: 2026-07-01 06:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 36 · vless × 23 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 11 · `mahdi0024` × 6 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `mfuu-clash` × 12 · `ninjastrikers` × 26 · `pawdroid` × 6 · `surfboard-eternity` × 3
