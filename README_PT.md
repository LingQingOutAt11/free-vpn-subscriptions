...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2014-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-253ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_17:14_UTC-informational)
...
- **RTT mediano**: 253 ms
- **Última atualização (UTC)**: 2026-06-26 17:14 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 27 · vless × 16 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 3 · `ruking-clash` × 18 · `surfboard-eternity` × 3
