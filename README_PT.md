...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1956-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-492ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_13:33_UTC-informational)
...
- **Ativos em todas as fontes**: 1956
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 492 ms
- **Última atualização (UTC)**: 2026-06-18 13:33 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 33 · trojan × 34 · vless × 36 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 3 · `surfboard-eternity` × 3
