...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2248-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-409ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_10:37_UTC-informational)
...
- **RTT mediano**: 409 ms
- **Última atualização (UTC)**: 2026-07-01 10:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 45 · vless × 12 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 19 · `mfuu-clash` × 10 · `ninjastrikers` × 19 · `pawdroid` × 3 · `surfboard-eternity` × 3
