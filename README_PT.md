...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3993-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-222ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-22_08:50_UTC-informational)
...
- **Nós selecionados**: 82
- **Ativos em todas as fontes**: 3993
- **RTT do nó mais rápido**: 39 ms
- **RTT mediano**: 222 ms
- **Última atualização (UTC)**: 2026-07-22 08:50 UTC

**Mix de protocolos:** shadowsocks × 4 · trojan × 22 · vless × 54 · vmess × 2

**Fontes usadas nesta execução:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 5 · `barry-far-v2ray` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 34 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 13
