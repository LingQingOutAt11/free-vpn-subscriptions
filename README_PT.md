...
![nós](https://img.shields.io/badge/nós-147-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2093-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-411ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_06:14_UTC-informational)
...
- **Ativos em todas as fontes**: 2093
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 411 ms
- **Última atualização (UTC)**: 2026-06-21 06:14 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 34 · vless × 50 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 39 · `snakem982` × 4 · `surfboard-eternity` × 3
