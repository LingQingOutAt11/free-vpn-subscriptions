...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2333-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-167ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_20:19_UTC-informational)
...
- **Nós selecionados**: 81
- **Ativos em todas as fontes**: 2333
- **RTT do nó mais rápido**: 22 ms
- **RTT mediano**: 167 ms
- **Última atualização (UTC)**: 2026-05-31 20:19 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 18 · vless × 6 · vmess × 34

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 8 · `mahdi0024` × 28 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 8 · `pawdroid` × 1 · `surfboard-eternity` × 2
