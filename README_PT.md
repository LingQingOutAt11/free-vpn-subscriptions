...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2279-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-198ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_13:30_UTC-informational)
...
- **RTT mediano**: 198 ms
- **Última atualização (UTC)**: 2026-06-20 13:30 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 23 · vless × 11 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 2
