...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2155-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-231ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_06:23_UTC-informational)
...
- **Nós selecionados**: 96
- **Ativos em todas as fontes**: 2155
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 231 ms
- **Última atualização (UTC)**: 2026-06-06 06:23 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 32 · vless × 22 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 31 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
