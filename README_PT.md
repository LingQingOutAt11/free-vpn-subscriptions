...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1926-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-120ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_08:35_UTC-informational)
...
- **Ativos em todas as fontes**: 1926
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 120 ms
- **Última atualização (UTC)**: 2026-05-12 08:35 UTC

**Mix de protocolos:** shadowsocks × 59 · trojan × 2 · vless × 79 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
