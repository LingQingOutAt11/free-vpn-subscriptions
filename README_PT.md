...
![nós](https://img.shields.io/badge/nós-57-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3559-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-537ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_14:14_UTC-informational)
...
- **Nós selecionados**: 57
- **Ativos em todas as fontes**: 3559
- **RTT do nó mais rápido**: 22 ms
- **RTT mediano**: 537 ms
- **Última atualização (UTC)**: 2026-07-15 14:14 UTC

**Mix de protocolos:** shadowsocks × 1 · trojan × 14 · vless × 36 · vmess × 6

**Fontes usadas nesta execução:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 1 · `mahdibland-aggregator` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 1 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 28 · `tg-v2ray-configs-every2h` × 10
