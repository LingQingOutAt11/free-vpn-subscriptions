...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4137-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-160ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-22_19:50_UTC-informational)
...
- **Nós selecionados**: 80
- **Ativos em todas as fontes**: 4137
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 160 ms
- **Última atualização (UTC)**: 2026-07-22 19:50 UTC

**Mix de protocolos:** shadowsocks × 5 · trojan × 15 · vless × 54 · vmess × 6

**Fontes usadas nesta execução:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 5 · `mahdi0024` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 4 · `ninjastrikers` × 8 · `pawdroid` × 1 · `roosterkid-openproxylist` × 13 · `solispirit-v2ray` × 30 · `tg-v2ray-configs-every2h` × 13
