...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3204-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-129ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-14_19:52_UTC-informational)
...
- **Nós selecionados**: 91
- **Ativos em todas as fontes**: 3204
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 129 ms
- **Última atualização (UTC)**: 2026-07-14 19:52 UTC

**Mix de protocolos:** shadowsocks × 7 · trojan × 22 · vless × 51 · vmess × 11

**Fontes usadas nesta execução:** `autojiedian-clash` × 5 · `barry-far-v2ray` × 2 · `go4sharing-clash` × 3 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 6 · `pawdroid` × 1 · `roosterkid-openproxylist` × 10 · `solispirit-v2ray` × 38 · `tg-v2ray-configs-every2h` × 21
