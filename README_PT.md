...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2214-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-228ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_05:38_UTC-informational)
...
- **RTT mediano**: 228 ms
- **Última atualização (UTC)**: 2026-06-11 05:38 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 15 · vless × 21 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 26 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 4
