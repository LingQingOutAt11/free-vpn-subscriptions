...
![nós](https://img.shields.io/badge/nós-119-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1742-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-459ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_07:29_UTC-informational)
...
- **Ativos em todas as fontes**: 1742
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 459 ms
- **Última atualização (UTC)**: 2026-06-14 07:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 52 · trojan × 36 · vless × 24 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 24 · `pawdroid` × 7 · `ruking-clash` × 21 · `surfboard-eternity` × 5
