...
![nós](https://img.shields.io/badge/nós-89-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4075-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-113ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-23_03:49_UTC-informational)
...
- **Nós selecionados**: 89
- **Ativos em todas as fontes**: 4075
- **RTT do nó mais rápido**: 16 ms
- **RTT mediano**: 113 ms
- **Última atualização (UTC)**: 2026-07-23 03:49 UTC

**Mix de protocolos:** shadowsocks × 8 · trojan × 23 · vless × 56 · vmess × 2

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 6 · `epodonios` × 2 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `roosterkid-openproxylist` × 4 · `snakem982` × 1 · `solispirit-v2ray` × 34 · `tg-v2ray-configs-every2h` × 19
