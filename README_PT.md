...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4041-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-111ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-23_19:52_UTC-informational)
...
- **Ativos em todas as fontes**: 4041
- **RTT do nó mais rápido**: 12 ms
- **RTT mediano**: 111 ms
- **Última atualização (UTC)**: 2026-07-23 19:52 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 15 · vless × 76 · vmess × 4

**Fontes usadas nesta execução:** `autojiedian-clash` × 7 · `automerge-verified-clash` × 12 · `barry-far-v2ray` × 1 · `epodonios` × 3 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 4 · `ninjastrikers` × 7 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 7 · `snakem982` × 1 · `solispirit-v2ray` × 42 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 16
