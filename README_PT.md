...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2452-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-121ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_01:09_UTC-informational)
...
- **Ativos em todas as fontes**: 2452
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 121 ms
- **Última atualização (UTC)**: 2026-05-11 01:09 UTC

**Mix de protocolos:** shadowsocks × 50 · trojan × 2 · vless × 88 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 66 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 6 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
