...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2203-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-151ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_02:29_UTC-informational)
...
- **RTT mediano**: 151 ms
- **Última atualização (UTC)**: 2026-05-06 02:29 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 10 · vless × 92 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 80 · `pawdroid` × 2 · `surfboard-eternity` × 6
