...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2432-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-96ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-14_07:39_UTC-informational)
...
- **Ativos em todas as fontes**: 2432
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 96 ms
- **Última atualização (UTC)**: 2026-05-14 07:39 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 6 · vless × 91 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 29 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 4 · `ruking-clash` × 6 · `snakem982` × 2 · `surfboard-eternity` × 3
