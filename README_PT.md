...
![nós](https://img.shields.io/badge/nós-144-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2302-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-97ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-24_16:19_UTC-informational)
...
- **RTT mediano**: 97 ms
- **Última atualização (UTC)**: 2026-05-24 16:19 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 16 · vless × 60 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 43 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 4
