...
![nós](https://img.shields.io/badge/nós-69-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3197-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-69ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-04_09:01_UTC-informational)
...
- **Nós selecionados**: 69
- **Ativos em todas as fontes**: 3197
- **RTT do nó mais rápido**: 12 ms
- **RTT mediano**: 69 ms
- **Última atualização (UTC)**: 2026-08-04 09:01 UTC

**Mix de protocolos:** shadowsocks × 2 · trojan × 11 · vless × 48 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 3 · `barry-far-v2ray` × 2 · `epodonios` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 5 · `pawdroid` × 7 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 23 · `tg-v2ray-configs-every2h` × 7
