...
![nós](https://img.shields.io/badge/nós-103-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2908-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-386ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_15:22_UTC-informational)
...
- **Ativos em todas as fontes**: 2908
- **RTT do nó mais rápido**: 25 ms
- **RTT mediano**: 386 ms
- **Última atualização (UTC)**: 2026-07-07 15:22 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 36 · vless × 52 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 5 · `mahdi0024` × 1 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 4 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 39 · `tg-v2ray-configs-every2h` × 15
