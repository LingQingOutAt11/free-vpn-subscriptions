...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4014-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-368ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-21_03:50_UTC-informational)
...
- **Nós selecionados**: 85
- **Ativos em todas as fontes**: 4014
- **RTT do nó mais rápido**: 41 ms
- **RTT mediano**: 368 ms
- **Última atualização (UTC)**: 2026-07-21 03:50 UTC

**Mix de protocolos:** shadowsocks × 5 · trojan × 20 · vless × 55 · vmess × 5

**Fontes usadas nesta execução:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 3 · `roosterkid-openproxylist` × 2 · `solispirit-v2ray` × 39 · `tg-v2ray-configs-every2h` × 12
