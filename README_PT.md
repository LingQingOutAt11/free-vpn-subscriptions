...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2084-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-385ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_07:22_UTC-informational)
...
- **RTT mediano**: 385 ms
- **Última atualização (UTC)**: 2026-06-24 07:22 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 29 · vless × 45 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 39 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 8 · `ruking-clash` × 12 · `surfboard-eternity` × 4
