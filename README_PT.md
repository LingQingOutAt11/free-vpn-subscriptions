...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2117-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-316ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_05:20_UTC-informational)
...
- **Ativos em todas as fontes**: 2117
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 316 ms
- **Última atualização (UTC)**: 2026-06-21 05:20 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 34 · vless × 41 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 4 · `mfuu-clash` × 6 · `ninjastrikers` × 21 · `pawdroid` × 1 · `ruking-clash` × 31 · `snakem982` × 2 · `surfboard-eternity` × 1
