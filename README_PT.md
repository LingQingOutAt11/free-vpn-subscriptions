...
![nós](https://img.shields.io/badge/nós-134-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2084-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-465ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_21:20_UTC-informational)
...
- **RTT mediano**: 465 ms
- **Última atualização (UTC)**: 2026-06-20 21:20 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 35 · vless × 36 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 5 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 35 · `snakem982` × 1 · `surfboard-eternity` × 1
