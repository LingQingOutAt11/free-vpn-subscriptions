...
![nós](https://img.shields.io/badge/nós-137-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2097-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-414ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_08:30_UTC-informational)
...
- **RTT mediano**: 414 ms
- **Última atualização (UTC)**: 2026-06-21 08:30 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 32 · vless × 44 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 38 · `snakem982` × 3 · `surfboard-eternity` × 4
