...
![nós](https://img.shields.io/badge/nós-141-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2226-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-318ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_21:15_UTC-informational)
...
- **Ativos em todas as fontes**: 2226
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 318 ms
- **Última atualização (UTC)**: 2026-05-05 21:15 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 28 · vless × 66 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 56 · `pawdroid` × 1 · `surfboard-eternity` × 7
