...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2468-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-80ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_15:12_UTC-informational)
...
- **Ativos em todas as fontes**: 2468
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 80 ms
- **Última atualização (UTC)**: 2026-05-21 15:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 12 · vless × 82 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 54 · `pawdroid` × 10 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
