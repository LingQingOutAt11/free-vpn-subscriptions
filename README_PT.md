...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2321-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-346ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_04:31_UTC-informational)
...
- **RTT mediano**: 346 ms
- **Última atualização (UTC)**: 2026-07-01 04:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 35 · vless × 23 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 6 · `mfuu-clash` × 12 · `ninjastrikers` × 25 · `pawdroid` × 3 · `surfboard-eternity` × 3
