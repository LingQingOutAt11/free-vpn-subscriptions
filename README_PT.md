...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1985-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-140ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-07_03:10_UTC-informational)
...
- **Ativos em todas as fontes**: 1985
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 140 ms
- **Última atualização (UTC)**: 2026-05-07 03:10 UTC

**Mix de protocolos:** shadowsocks × 54 · trojan × 4 · vless × 82 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `ninjastrikers` × 70 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
