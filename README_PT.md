...
![nós](https://img.shields.io/badge/nós-125-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2528-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-175ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_04:38_UTC-informational)
...
- **Nós selecionados**: 125
- **Ativos em todas as fontes**: 2528
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 175 ms
- **Última atualização (UTC)**: 2026-06-02 04:38 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 38 · trojan × 33 · vless × 22 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 41 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 22 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 7
