...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2489-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-214ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-09_23:22_UTC-informational)
...
- **Ativos em todas as fontes**: 2489
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 214 ms
- **Última atualização (UTC)**: 2026-05-09 23:22 UTC

**Mix de protocolos:** shadowsocks × 52 · trojan × 18 · vless × 72 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 41 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
