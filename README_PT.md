...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2406-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-114ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-13_22:33_UTC-informational)
...
- **Ativos em todas as fontes**: 2406
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 114 ms
- **Última atualização (UTC)**: 2026-05-13 22:33 UTC

**Mix de protocolos:** shadowsocks × 48 · trojan × 18 · vless × 75 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 50 · `pawdroid` × 6 · `ruking-clash` × 9 · `snakem982` × 1 · `surfboard-eternity` × 8
