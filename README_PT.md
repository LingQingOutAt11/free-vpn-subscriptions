...
![nós](https://img.shields.io/badge/nós-146-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2251-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-293ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_20:19_UTC-informational)
...
- **Ativos em todas as fontes**: 2251
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 293 ms
- **Última atualização (UTC)**: 2026-05-04 20:19 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 26 · vless × 73 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 60 · `ruking-clash` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
