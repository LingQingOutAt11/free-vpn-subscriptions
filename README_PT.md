...
![nós](https://img.shields.io/badge/nós-84-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2203-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-174ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_08:25_UTC-informational)
...
- **RTT mediano**: 174 ms
- **Última atualização (UTC)**: 2026-06-07 08:25 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 23 · vless × 10 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `surfboard-eternity` × 4
