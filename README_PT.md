...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1885-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-290ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_02:38_UTC-informational)
...
- **RTT mediano**: 290 ms
- **Última atualização (UTC)**: 2026-06-09 02:38 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 45 · trojan × 20 · vless × 32 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 12 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 2 · `ninjastrikers` × 30 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 2
