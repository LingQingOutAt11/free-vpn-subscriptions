...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3387-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-127ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-31_19:59_UTC-informational)
...
- **Nós selecionados**: 79
- **Ativos em todas as fontes**: 3387
- **RTT do nó mais rápido**: 43 ms
- **RTT mediano**: 127 ms
- **Última atualização (UTC)**: 2026-07-31 19:59 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 16 · trojan × 14 · vless × 39 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 9 · `automerge-verified-clash` × 14 · `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 11 · `ruking-clash` × 1 · `solispirit-v2ray` × 15 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 11
