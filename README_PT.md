...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1873-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-351ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_10:25_UTC-informational)
...
- **Nós selecionados**: 93
- **Ativos em todas as fontes**: 1873
- **RTT do nó mais rápido**: 22 ms
- **RTT mediano**: 351 ms
- **Última atualização (UTC)**: 2026-06-09 10:25 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 48 · trojan × 18 · vless × 14 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 7 · `surfboard-eternity` × 5
