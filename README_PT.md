...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2182-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-154ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_05:20_UTC-informational)
...
- **Nós selecionados**: 88
- **Ativos em todas as fontes**: 2182
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 154 ms
- **Última atualização (UTC)**: 2026-05-30 05:20 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 23 · vless × 14 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
