...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2318-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-250ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_23:18_UTC-informational)
...
- **RTT mediano**: 250 ms
- **Última atualização (UTC)**: 2026-06-19 23:18 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 25 · vless × 9 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 10 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 4
