...
![nós](https://img.shields.io/badge/nós-78-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1825-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-161ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_18:14_UTC-informational)
...
- **Nós selecionados**: 78
- **Ativos em todas as fontes**: 1825
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 161 ms
- **Última atualização (UTC)**: 2026-06-28 18:14 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 16 · vless × 21 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `surfboard-eternity` × 2
