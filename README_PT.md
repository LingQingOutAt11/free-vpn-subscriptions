...
![nós](https://img.shields.io/badge/nós-74-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3200-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-345ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_08:42_UTC-informational)
...
- **Nós selecionados**: 74
- **Ativos em todas as fontes**: 3200
- **RTT do nó mais rápido**: 20 ms
- **RTT mediano**: 345 ms
- **Última atualização (UTC)**: 2026-07-15 08:42 UTC

**Mix de protocolos:** shadowsocks × 1 · trojan × 22 · vless × 45 · vmess × 6

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 2 · `epodonios` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 4 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 46
