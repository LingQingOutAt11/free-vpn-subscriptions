...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3781-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-91ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-12_07:58_UTC-informational)
...
- **Nós selecionados**: 81
- **Ativos em todas as fontes**: 3781
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 91 ms
- **Última atualização (UTC)**: 2026-08-12 07:58 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 15 · trojan × 15 · vless × 39 · vmess × 9

**Fontes usadas nesta execução:** `autojiedian-clash` × 5 · `automerge-verified-clash` × 17 · `barry-far-v2ray` × 1 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 3 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 10 · `ruking-clash` × 2 · `snakem982` × 1 · `solispirit-v2ray` × 11 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 9
