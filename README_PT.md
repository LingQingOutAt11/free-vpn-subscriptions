...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2979-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-323ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_09:43_UTC-informational)
...
- **Nós selecionados**: 98
- **Ativos em todas as fontes**: 2979
- **RTT do nó mais rápido**: 23 ms
- **RTT mediano**: 323 ms
- **Última atualização (UTC)**: 2026-07-03 09:43 UTC

**Mix de protocolos:** shadowsocks × 6 · trojan × 34 · vless × 53 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `mahdi0024` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 5 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 16 · `solispirit-v2ray` × 28 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 16
