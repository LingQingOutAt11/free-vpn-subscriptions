...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2316-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_23:29_UTC-informational)
...
- **Nós selecionados**: 92
- **Ativos em todas as fontes**: 2316
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-05-30 23:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 21 · trojan × 34 · vless × 7 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 10 · `pawdroid` × 1 · `surfboard-eternity` × 2
