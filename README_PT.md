...
![nós](https://img.shields.io/badge/nós-75-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2357-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-92ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_18:18_UTC-informational)
...
- **Nós selecionados**: 75
- **Ativos em todas as fontes**: 2357
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 92 ms
- **Última atualização (UTC)**: 2026-06-02 18:18 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 15 · vless × 8 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 3 · `pawdroid` × 2 · `surfboard-eternity` × 2
