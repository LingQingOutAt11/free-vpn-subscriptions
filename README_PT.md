...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2064-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-374ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_09:13_UTC-informational)
...
- **RTT mediano**: 374 ms
- **Última atualização (UTC)**: 2026-06-24 09:13 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 29 · vless × 37 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 40 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 15 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 4
