...
![nós](https://img.shields.io/badge/nós-63-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4055-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-394ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_08:34_UTC-informational)
...
- **Nós selecionados**: 63
- **Ativos em todas as fontes**: 4055
- **RTT do nó mais rápido**: 48 ms
- **RTT mediano**: 394 ms
- **Última atualização (UTC)**: 2026-07-17 08:34 UTC

**Mix de protocolos:** trojan × 19 · vless × 42 · vmess × 2

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 28 · `tg-v2ray-configs-every2h` × 9
