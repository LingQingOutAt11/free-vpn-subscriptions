...
![nós](https://img.shields.io/badge/nós-90-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1955-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-204ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_10:40_UTC-informational)
...
- **RTT mediano**: 204 ms
- **Última atualização (UTC)**: 2026-06-04 10:40 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 40 · vless × 17 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 7 · `surfboard-eternity` × 2
