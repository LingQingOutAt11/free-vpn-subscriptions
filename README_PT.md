...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1948-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-120ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-08_01:24_UTC-informational)
...
- **RTT mediano**: 120 ms
- **Última atualização (UTC)**: 2026-05-08 01:24 UTC

**Mix de protocolos:** shadowsocks × 53 · trojan × 5 · vless × 85 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 69 · `snakem982` × 1 · `surfboard-eternity` × 9
