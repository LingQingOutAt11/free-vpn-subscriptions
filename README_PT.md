...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2397-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-451ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_01:17_UTC-informational)
...
- **Ativos em todas as fontes**: 2397
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 451 ms
- **Última atualização (UTC)**: 2026-06-19 01:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 28 · vless × 50 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 26 · `pawdroid` × 7 · `ruking-clash` × 26 · `snakem982` × 8 · `surfboard-eternity` × 2
