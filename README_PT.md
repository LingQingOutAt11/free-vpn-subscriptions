...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2609-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-70ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-20_11:37_UTC-informational)
...
- **Ativos em todas as fontes**: 2609
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 70 ms
- **Última atualização (UTC)**: 2026-05-20 11:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 11 · vless × 83 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 9 · `surfboard-eternity` × 9
