...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1594-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-400ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_14:25_UTC-informational)
...
- **Ativos em todas as fontes**: 1594
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 400 ms
- **Última atualização (UTC)**: 2026-06-14 14:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 57 · trojan × 26 · vless × 21 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 5
