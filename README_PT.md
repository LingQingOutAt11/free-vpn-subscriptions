...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2300-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-162ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_22:16_UTC-informational)
...
- **Nós selecionados**: 96
- **Ativos em todas as fontes**: 2300
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 162 ms
- **Última atualização (UTC)**: 2026-05-30 22:16 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 36 · vless × 9 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 10 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
