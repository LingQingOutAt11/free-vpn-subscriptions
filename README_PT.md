...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2285-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-371ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_10:38_UTC-informational)
...
- **RTT mediano**: 371 ms
- **Última atualização (UTC)**: 2026-06-12 10:38 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 39 · trojan × 40 · vless × 11 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 7
