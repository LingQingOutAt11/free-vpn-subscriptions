...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1922-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-285ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-07_21:32_UTC-informational)
...
- **RTT mediano**: 285 ms
- **Última atualização (UTC)**: 2026-05-07 21:32 UTC

**Mix de protocolos:** shadowsocks × 54 · trojan × 14 · vless × 74 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
