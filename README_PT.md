...
![nós](https://img.shields.io/badge/nós-145-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2789-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-238ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_03:48_UTC-informational)
...
- **Nós selecionados**: 145
- **Ativos em todas as fontes**: 2789
- **RTT do nó mais rápido**: 23 ms
- **RTT mediano**: 238 ms
- **Última atualização (UTC)**: 2026-07-11 03:48 UTC

**Mix de protocolos:** shadowsocks × 7 · trojan × 30 · vless × 94 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 5 · `radikal-clash` × 9 · `roosterkid-openproxylist` × 23 · `ruking-clash` × 1 · `solispirit-v2ray` × 49 · `tg-v2ray-configs-every2h` × 22
