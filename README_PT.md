...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3775-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-271ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_08:40_UTC-informational)
...
- **Nós selecionados**: 79
- **Ativos em todas as fontes**: 3775
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 271 ms
- **Última atualização (UTC)**: 2026-07-16 08:40 UTC

**Mix de protocolos:** trojan × 19 · vless × 59 · vmess × 1

**Fontes usadas nesta execução:** `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 7 · `snakem982` × 1 · `solispirit-v2ray` × 26 · `tg-v2ray-configs-every2h` × 26
