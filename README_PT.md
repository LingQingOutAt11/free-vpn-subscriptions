...
![nós](https://img.shields.io/badge/nós-139-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2231-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-407ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_22:20_UTC-informational)
...
- **Ativos em todas as fontes**: 2231
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 407 ms
- **Última atualização (UTC)**: 2026-05-05 22:20 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 28 · vless × 65 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `surfboard-eternity` × 6
