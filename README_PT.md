...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2075-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-243ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_09:26_UTC-informational)
...
- **RTT mediano**: 243 ms
- **Última atualização (UTC)**: 2026-06-27 09:26 UTC

**Mix de protocolos:** shadowsocks × 16 · trojan × 32 · vless × 17 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 1
