...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3535-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-219ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-08_13:20_UTC-informational)
...
- **Ativos em todas as fontes**: 3535
- **RTT do nó mais rápido**: 24 ms
- **RTT mediano**: 219 ms
- **Última atualização (UTC)**: 2026-08-08 13:20 UTC

**Mix de protocolos:** hysteria2 × 5 · shadowsocks × 33 · trojan × 31 · vless × 58 · vmess × 23

**Fontes usadas nesta execução:** `autojiedian-clash` × 5 · `automerge-verified-clash` × 29 · `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 47 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 10 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 10 · `ruking-clash` × 2 · `snakem982` × 3 · `solispirit-v2ray` × 7 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 5
