...
![nós](https://img.shields.io/badge/nós-124-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3277-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-201ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-04_03:43_UTC-informational)
...
- **Nós selecionados**: 124
- **Ativos em todas as fontes**: 3277
- **RTT do nó mais rápido**: 49 ms
- **RTT mediano**: 201 ms
- **Última atualização (UTC)**: 2026-08-04 03:43 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 22 · trojan × 14 · vless × 70 · vmess × 16

**Fontes usadas nesta execução:** `autojiedian-clash` × 11 · `automerge-verified-clash` × 22 · `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 3 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 13 · `ruking-clash` × 2 · `snakem982` × 1 · `solispirit-v2ray` × 28 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 8
