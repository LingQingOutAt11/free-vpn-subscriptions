...
![nós](https://img.shields.io/badge/nós-64-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4174-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-97ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-22_14:28_UTC-informational)
...
- **Nós selecionados**: 64
- **Ativos em todas as fontes**: 4174
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 97 ms
- **Última atualização (UTC)**: 2026-07-22 14:28 UTC

**Mix de protocolos:** shadowsocks × 9 · trojan × 13 · vless × 38 · vmess × 4

**Fontes usadas nesta execução:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 25 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 9
