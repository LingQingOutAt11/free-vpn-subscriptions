...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1842-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-378ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_11:10_UTC-informational)
...
- **RTT mediano**: 378 ms
- **Última atualização (UTC)**: 2026-06-30 11:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 37 · vless × 12 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 4 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 3
