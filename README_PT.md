...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1774-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-350ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_09:21_UTC-informational)
...
- **Nós selecionados**: 82
- **Ativos em todas as fontes**: 1774
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 350 ms
- **Última atualização (UTC)**: 2026-06-08 09:21 UTC

**Mix de protocolos:** shadowsocks × 47 · trojan × 16 · vless × 14 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 7
