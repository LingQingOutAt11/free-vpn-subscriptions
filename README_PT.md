...
![nós](https://img.shields.io/badge/nós-67-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3460-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-108ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-05_14:39_UTC-informational)
...
- **RTT mediano**: 108 ms
- **Última atualização (UTC)**: 2026-08-05 14:39 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 20 · vless × 38 · vmess × 6

**Fontes usadas nesta execução:** `autojiedian-clash` × 6 · `automerge-verified-clash` × 10 · `mahdi0024` × 6 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 5 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 12 · `solispirit-v2ray` × 15 · `tg-v2ray-configs-every2h` × 9
