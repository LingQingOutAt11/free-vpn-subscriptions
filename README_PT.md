...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1856-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-381ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_10:12_UTC-informational)
...
- **RTT mediano**: 381 ms
- **Última atualização (UTC)**: 2026-06-30 10:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 34 · vless × 12 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 3
