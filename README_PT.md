...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3063-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-432ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_19:57_UTC-informational)
...
- **Nós selecionados**: 96
- **Ativos em todas as fontes**: 3063
- **RTT do nó mais rápido**: 45 ms
- **RTT mediano**: 432 ms
- **Última atualização (UTC)**: 2026-07-03 19:57 UTC

**Mix de protocolos:** shadowsocks × 12 · trojan × 41 · vless × 37 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `mahdi0024` × 2 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `ninjastrikers` × 8 · `pawdroid` × 4 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 26 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 19
