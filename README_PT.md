...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3728-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-227ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_03:41_UTC-informational)
...
- **Nós selecionados**: 82
- **Ativos em todas as fontes**: 3728
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 227 ms
- **Última atualização (UTC)**: 2026-07-16 03:41 UTC

**Mix de protocolos:** shadowsocks × 1 · trojan × 22 · vless × 55 · vmess × 4

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `epodonios` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 39 · `tg-v2ray-configs-every2h` × 16
