...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2018-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-145ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-08_05:25_UTC-informational)
...
- **Ativos em todas as fontes**: 2018
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 145 ms
- **Última atualização (UTC)**: 2026-05-08 05:25 UTC

**Mix de protocolos:** shadowsocks × 46 · trojan × 12 · vless × 82 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 12 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 78 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
