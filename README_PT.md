...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3623-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-81ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-19_03:59_UTC-informational)
...
- **Ativos em todas as fontes**: 3623
- **RTT do nó mais rápido**: 18 ms
- **RTT mediano**: 81 ms
- **Última atualização (UTC)**: 2026-07-19 03:59 UTC

**Mix de protocolos:** shadowsocks × 9 · trojan × 18 · vless × 75 · vmess × 4

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 10 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 5 · `ninjastrikers` × 15 · `pawdroid` × 2 · `roosterkid-openproxylist` × 1 · `solispirit-v2ray` × 41 · `tg-v2ray-configs-every2h` × 26
