...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2228-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-153ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_03:39_UTC-informational)
...
- **RTT mediano**: 153 ms
- **Última atualização (UTC)**: 2026-05-06 03:39 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 12 · vless × 92 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 77 · `pawdroid` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
