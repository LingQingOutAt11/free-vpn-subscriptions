...
![nós](https://img.shields.io/badge/nós-89-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3136-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-314ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_09:40_UTC-informational)
...
- **Nós selecionados**: 89
- **Ativos em todas as fontes**: 3136
- **RTT do nó mais rápido**: 11 ms
- **RTT mediano**: 314 ms
- **Última atualização (UTC)**: 2026-07-02 09:40 UTC

**Mix de protocolos:** shadowsocks × 6 · trojan × 31 · vless × 49 · vmess × 3

**Fontes usadas nesta execução:** `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `ninjastrikers` × 8 · `pawdroid` × 5 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 15 · `solispirit-v2ray` × 28 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 15
