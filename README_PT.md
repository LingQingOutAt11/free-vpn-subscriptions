...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1973-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-140ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_00:13_UTC-informational)
...
- **RTT mediano**: 140 ms
- **Última atualização (UTC)**: 2026-05-12 00:13 UTC

**Mix de protocolos:** shadowsocks × 53 · trojan × 3 · vless × 83 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 71 · `snakem982` × 2 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
