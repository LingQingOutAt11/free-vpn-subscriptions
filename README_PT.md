...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2455-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-113ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_13:32_UTC-informational)
...
- **Nós selecionados**: 92
- **Ativos em todas as fontes**: 2455
- **RTT do nó mais rápido**: 23 ms
- **RTT mediano**: 113 ms
- **Última atualização (UTC)**: 2026-06-03 13:32 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 36 · vless × 14 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `surfboard-eternity` × 4
