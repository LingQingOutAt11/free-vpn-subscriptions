...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4423-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-169ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-18_13:54_UTC-informational)
...
- **Ativos em todas as fontes**: 4423
- **RTT do nó mais rápido**: 42 ms
- **RTT mediano**: 169 ms
- **Última atualização (UTC)**: 2026-07-18 13:54 UTC

**Mix de protocolos:** shadowsocks × 15 · trojan × 26 · vless × 65 · vmess × 12

**Fontes usadas nesta execução:** `autojiedian-clash` × 9 · `automerge-verified-clash` × 11 · `barry-far-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 12 · `roosterkid-openproxylist` × 3 · `solispirit-v2ray` × 40 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 17
