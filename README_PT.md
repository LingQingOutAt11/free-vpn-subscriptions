...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2242-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_22:13_UTC-informational)
...
- **Nós selecionados**: 87
- **Ativos em todas as fontes**: 2242
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-05-29 22:13 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 36 · vless × 6 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 3
