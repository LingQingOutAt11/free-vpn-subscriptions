...
![nós](https://img.shields.io/badge/nós-73-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1927-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-276ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_18:17_UTC-informational)
...
- **Nós selecionados**: 73
- **Ativos em todas as fontes**: 1927
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 276 ms
- **Última atualização (UTC)**: 2026-06-08 18:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 30 · trojan × 19 · vless × 13 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 11 · `pawdroid` × 4 · `ruking-clash` × 6 · `surfboard-eternity` × 3
