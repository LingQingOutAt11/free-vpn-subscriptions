...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2072-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-335ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_15:11_UTC-informational)
...
- **RTT mediano**: 335 ms
- **Última atualização (UTC)**: 2026-06-10 15:11 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 20 · vless × 11 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 1
