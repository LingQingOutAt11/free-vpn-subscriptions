...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1937-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-484ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_12:31_UTC-informational)
...
- **Ativos em todas as fontes**: 1937
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 484 ms
- **Última atualização (UTC)**: 2026-06-22 12:31 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 31 · vless × 63 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 30 · `snakem982` × 2 · `surfboard-eternity` × 4
