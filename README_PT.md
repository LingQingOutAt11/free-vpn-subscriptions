...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1983-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-389ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_01:18_UTC-informational)
...
- **Ativos em todas as fontes**: 1983
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 389 ms
- **Última atualização (UTC)**: 2026-06-24 01:18 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 39 · trojan × 31 · vless × 63 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 49 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 3 · `ninjastrikers` × 27 · `pawdroid` × 6 · `ruking-clash` × 16 · `surfboard-eternity` × 3
