...
![nós](https://img.shields.io/badge/nós-116-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1776-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-416ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_21:29_UTC-informational)
...
- **Nós selecionados**: 116
- **Ativos em todas as fontes**: 1776
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 416 ms
- **Última atualização (UTC)**: 2026-06-17 21:29 UTC

**Mix de protocolos:** hysteria2 × 6 · shadowsocks × 47 · trojan × 30 · vless × 25 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 5 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 24 · `surfboard-eternity` × 6
