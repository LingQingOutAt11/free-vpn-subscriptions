...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1763-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-470ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_23:23_UTC-informational)
...
- **Ativos em todas as fontes**: 1763
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 470 ms
- **Última atualização (UTC)**: 2026-06-17 23:23 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 47 · trojan × 31 · vless × 23 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 20 · `surfboard-eternity` × 5
