...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1967-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-400ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_22:28_UTC-informational)
...
- **Ativos em todas as fontes**: 1967
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 400 ms
- **Última atualização (UTC)**: 2026-06-12 22:28 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 51 · trojan × 42 · vless × 13 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 31 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 5
