...
![nós](https://img.shields.io/badge/nós-69-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4061-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-182ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-16_14:27_UTC-informational)
...
- **Nós selecionados**: 69
- **Ativos em todas as fontes**: 4061
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 182 ms
- **Última atualização (UTC)**: 2026-07-16 14:27 UTC

**Mix de protocolos:** trojan × 19 · vless × 46 · vmess × 4

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `ninjastrikers` × 9 · `pawdroid` × 1 · `radikal-clash` × 2 · `solispirit-v2ray` × 29 · `tg-v2ray-configs-every2h` × 20
