...
![nós](https://img.shields.io/badge/nós-77-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3571-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-122ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-10_13:50_UTC-informational)
...
- **Nós selecionados**: 77
- **Ativos em todas as fontes**: 3571
- **RTT do nó mais rápido**: 15 ms
- **RTT mediano**: 122 ms
- **Última atualização (UTC)**: 2026-08-10 13:50 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 21 · vless × 31 · vmess × 11

**Fontes usadas nesta execução:** `autojiedian-clash` × 13 · `automerge-verified-clash` × 15 · `barry-far-v2ray` × 3 · `epodonios` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `pawdroid` × 1 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 1 · `snakem982` × 1 · `solispirit-v2ray` × 11 · `tg-v2ray-configs-every2h` × 1
