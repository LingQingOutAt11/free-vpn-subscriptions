...
![nós](https://img.shields.io/badge/nós-130-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2542-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-484ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_14:21_UTC-informational)
...
- **Ativos em todas as fontes**: 2542
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 484 ms
- **Última atualização (UTC)**: 2026-06-19 14:21 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 30 · trojan × 29 · vless × 50 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 42 · `snakem982` × 6 · `surfboard-eternity` × 3
