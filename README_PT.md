...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1993-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-234ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_04:12_UTC-informational)
...
- **Ativos em todas as fontes**: 1993
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 234 ms
- **Última atualização (UTC)**: 2026-06-25 04:12 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 32 · vless × 45 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 36 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 5
