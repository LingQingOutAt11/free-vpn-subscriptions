...
![nós](https://img.shields.io/badge/nós-46-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2073-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-166ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_11:17_UTC-informational)
...
- **Nós selecionados**: 46
- **Ativos em todas as fontes**: 2073
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 166 ms
- **Última atualização (UTC)**: 2026-05-29 11:17 UTC

**Mix de protocolos:** shadowsocks × 20 · trojan × 11 · vless × 6 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 7 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 3 · `surfboard-eternity` × 3
