...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2429-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-138ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-09_04:27_UTC-informational)
...
- **RTT mediano**: 138 ms
- **Última atualização (UTC)**: 2026-05-09 04:27 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 11 · vless × 89 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 74 · `pawdroid` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
