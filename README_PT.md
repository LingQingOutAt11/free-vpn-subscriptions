...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2226-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-427ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_14:33_UTC-informational)
...
- **RTT mediano**: 427 ms
- **Última atualização (UTC)**: 2026-06-29 14:33 UTC

**Mix de protocolos:** shadowsocks × 15 · trojan × 32 · vless × 18 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 19 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 4
