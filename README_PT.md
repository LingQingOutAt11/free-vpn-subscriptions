...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1990-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-380ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_22:17_UTC-informational)
...
- **Nós selecionados**: 98
- **Ativos em todas as fontes**: 1990
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 380 ms
- **Última atualização (UTC)**: 2026-06-29 22:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 37 · vless × 8 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 16 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 5
