...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2386-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_00:36_UTC-informational)
...
- **Ativos em todas as fontes**: 2386
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-05-21 00:36 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 14 · vless × 82 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 15 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 71 · `pawdroid` × 7 · `surfboard-eternity` × 6
