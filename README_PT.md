...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3917-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-140ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-25_19:41_UTC-informational)
...
- **Nós selecionados**: 91
- **Ativos em todas as fontes**: 3917
- **RTT do nó mais rápido**: 39 ms
- **RTT mediano**: 140 ms
- **Última atualização (UTC)**: 2026-07-25 19:41 UTC

**Mix de protocolos:** shadowsocks × 12 · trojan × 16 · vless × 57 · vmess × 6

**Fontes usadas nesta execução:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 2 · `epodonios` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 14 · `solispirit-v2ray` × 28 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 18
