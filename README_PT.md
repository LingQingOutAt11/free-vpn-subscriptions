...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2285-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-135ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_02:13_UTC-informational)
...
- **RTT mediano**: 135 ms
- **Última atualização (UTC)**: 2026-05-05 02:13 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 13 · vless × 93 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 3 · `ninjastrikers` × 72 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 6
