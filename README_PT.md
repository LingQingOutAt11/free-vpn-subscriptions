...
![nós](https://img.shields.io/badge/nós-89-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3440-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-467ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-05_08:59_UTC-informational)
...
- **Nós selecionados**: 89
- **Ativos em todas as fontes**: 3440
- **RTT do nó mais rápido**: 17 ms
- **RTT mediano**: 467 ms
- **Última atualização (UTC)**: 2026-08-05 08:59 UTC

**Mix de protocolos:** shadowsocks × 7 · trojan × 13 · vless × 61 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 19 · `automerge-verified-clash` × 5 · `epodonios` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 4 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 17 · `ruking-clash` × 1 · `solispirit-v2ray` × 17 · `tg-v2ray-configs-every2h` × 8
