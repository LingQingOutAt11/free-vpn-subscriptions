...
![nós](https://img.shields.io/badge/nós-139-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1700-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-355ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_00:26_UTC-informational)
...
- **Ativos em todas as fontes**: 1700
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 355 ms
- **Última atualização (UTC)**: 2026-06-15 00:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 55 · trojan × 26 · vless × 43 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 5 · `mahdi0024` × 14 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 38 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 2
