...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2375-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-100ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_19:18_UTC-informational)
...
- **RTT mediano**: 100 ms
- **Última atualização (UTC)**: 2026-05-23 19:18 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 18 · vless × 66 · vmess × 25

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 42 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 6 · `surfboard-eternity` × 4
