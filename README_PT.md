...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3630-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-132ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-19_08:39_UTC-informational)
...
- **Ativos em todas as fontes**: 3630
- **RTT do nó mais rápido**: 21 ms
- **RTT mediano**: 132 ms
- **Última atualização (UTC)**: 2026-07-19 08:39 UTC

**Mix de protocolos:** shadowsocks × 4 · trojan × 18 · vless × 79 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 4 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 4 · `roosterkid-openproxylist` × 7 · `solispirit-v2ray` × 48 · `tg-v2ray-configs-every2h` × 20
