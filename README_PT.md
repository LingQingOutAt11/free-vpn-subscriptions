...
![nós](https://img.shields.io/badge/nós-91-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2177-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-174ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-07_11:38_UTC-informational)
...
- **Nós selecionados**: 91
- **Ativos em todas as fontes**: 2177
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 174 ms
- **Última atualização (UTC)**: 2026-06-07 11:38 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 24 · vless × 8 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 42 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
