...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1893-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-398ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_11:37_UTC-informational)
...
- **Nós selecionados**: 92
- **Ativos em todas as fontes**: 1893
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 398 ms
- **Última atualização (UTC)**: 2026-06-26 11:37 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 34 · vless × 17 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 4
