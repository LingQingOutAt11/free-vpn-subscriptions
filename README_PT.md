...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3067-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-496ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_19:44_UTC-informational)
...
- **Nós selecionados**: 87
- **Ativos em todas as fontes**: 3067
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 496 ms
- **Última atualização (UTC)**: 2026-07-04 19:44 UTC

**Mix de protocolos:** shadowsocks × 2 · trojan × 27 · vless × 48 · vmess × 10

**Fontes usadas nesta execução:** `epodonios` × 1 · `mahdi0024` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 38 · `tg-v2ray-configs-every2h` × 19
