...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2892-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-369ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_20:04_UTC-informational)
...
- **Nós selecionados**: 92
- **Ativos em todas as fontes**: 2892
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 369 ms
- **Última atualização (UTC)**: 2026-07-08 20:04 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 27 · vless × 52 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 6 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 16 · `solispirit-v2ray` × 46 · `tg-v2ray-configs-every2h` × 9
