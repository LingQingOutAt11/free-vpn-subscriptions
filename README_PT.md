...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3103-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-113ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-01_19:40_UTC-informational)
...
- **Nós selecionados**: 88
- **Ativos em todas as fontes**: 3103
- **RTT do nó mais rápido**: 15 ms
- **RTT mediano**: 113 ms
- **Última atualização (UTC)**: 2026-08-01 19:40 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 13 · trojan × 18 · vless × 49 · vmess × 6

**Fontes usadas nesta execução:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 12 · `barry-far-v2ray` × 3 · `epodonios` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 4 · `ninjastrikers` × 5 · `pawdroid` × 4 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 1 · `snakem982` × 1 · `solispirit-v2ray` × 25 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 11
