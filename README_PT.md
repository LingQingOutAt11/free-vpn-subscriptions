...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3119-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-105ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-01_14:00_UTC-informational)
...
- **Nós selecionados**: 117
- **Ativos em todas as fontes**: 3119
- **RTT do nó mais rápido**: 17 ms
- **RTT mediano**: 105 ms
- **Última atualização (UTC)**: 2026-08-01 14:00 UTC

**Mix de protocolos:** hysteria2 × 4 · shadowsocks × 23 · trojan × 20 · vless × 60 · vmess × 10

**Fontes usadas nesta execução:** `autojiedian-clash` × 11 · `automerge-verified-clash` × 25 · `barry-far-v2ray` × 9 · `epodonios` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 1 · `pawdroid` × 4 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 4 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 13
