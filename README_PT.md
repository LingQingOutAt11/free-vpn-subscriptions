...
![nós](https://img.shields.io/badge/nós-127-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4241-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-169ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-27_20:03_UTC-informational)
...
- **Nós selecionados**: 127
- **Ativos em todas as fontes**: 4241
- **RTT do nó mais rápido**: 23 ms
- **RTT mediano**: 169 ms
- **Última atualização (UTC)**: 2026-07-27 20:03 UTC

**Mix de protocolos:** shadowsocks × 12 · trojan × 47 · vless × 60 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 8 · `barry-far-v2ray` × 2 · `epodonios` × 1 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 3 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 10 · `ruking-clash` × 28 · `solispirit-v2ray` × 35 · `tg-v2ray-configs-every2h` × 14
