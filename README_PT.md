...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3146-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-65ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-03_20:05_UTC-informational)
...
- **Nós selecionados**: 93
- **Ativos em todas as fontes**: 3146
- **RTT do nó mais rápido**: 12 ms
- **RTT mediano**: 65 ms
- **Última atualização (UTC)**: 2026-08-03 20:05 UTC

**Mix de protocolos:** shadowsocks × 6 · trojan × 11 · vless × 67 · vmess × 9

**Fontes usadas nesta execução:** `autojiedian-clash` × 18 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 2 · `epodonios` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 3 · `pawdroid` × 3 · `roosterkid-openproxylist` × 16 · `snakem982` × 1 · `solispirit-v2ray` × 27 · `tg-v2ray-configs-every2h` × 8
