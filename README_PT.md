...
![nós](https://img.shields.io/badge/nós-130-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2132-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-98ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_21:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2132
- **RTT do nó mais rápido**: 44 ms
- **RTT mediano**: 98 ms
- **Última atualização (UTC)**: 2026-05-25 21:11 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 26 · vless × 55 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 7 · `ruking-clash` × 9 · `surfboard-eternity` × 6
