...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2971-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-210ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_04:15_UTC-informational)
...
- **RTT mediano**: 210 ms
- **Última atualização (UTC)**: 2026-07-03 04:15 UTC

**Mix de protocolos:** shadowsocks × 6 · trojan × 32 · vless × 50 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 10 · `pawdroid` × 3 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 34 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 22
