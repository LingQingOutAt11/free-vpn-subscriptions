...
![nós](https://img.shields.io/badge/nós-83-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2094-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-246ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_12:12_UTC-informational)
...
- **RTT mediano**: 246 ms
- **Última atualização (UTC)**: 2026-06-10 12:12 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 13 · vless × 8 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 12 · `ruking-clash` × 5 · `surfboard-eternity` × 3
