...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1946-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-174ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-08_12:27_UTC-informational)
...
- **Ativos em todas as fontes**: 1946
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 174 ms
- **Última atualização (UTC)**: 2026-05-08 12:27 UTC

**Mix de protocolos:** shadowsocks × 60 · trojan × 5 · vless × 76 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 2 · `ninjastrikers` × 69 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
