...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1849-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-346ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_06:30_UTC-informational)
...
- **Ativos em todas as fontes**: 1849
- **RTT do nó mais rápido**: 40 ms
- **RTT mediano**: 346 ms
- **Última atualização (UTC)**: 2026-06-08 06:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 21 · vless × 26 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `pawdroid` × 6 · `ruking-clash` × 5 · `surfboard-eternity` × 6
