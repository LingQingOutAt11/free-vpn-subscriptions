...
![nós](https://img.shields.io/badge/nós-56-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4069-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-59ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-17_14:08_UTC-informational)
...
- **Nós selecionados**: 56
- **Ativos em todas as fontes**: 4069
- **RTT do nó mais rápido**: 24 ms
- **RTT mediano**: 59 ms
- **Última atualização (UTC)**: 2026-07-17 14:08 UTC

**Mix de protocolos:** shadowsocks × 1 · trojan × 10 · vless × 42 · vmess × 3

**Fontes usadas nesta execução:** `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `mahdibland-aggregator` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 3 · `pawdroid` × 6 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 2 · `solispirit-v2ray` × 29 · `tg-v2ray-configs-every2h` × 8
