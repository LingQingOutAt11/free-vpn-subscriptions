...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1909-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-413ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_00:33_UTC-informational)
...
- **RTT mediano**: 413 ms
- **Última atualização (UTC)**: 2026-06-26 00:33 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 40 · vless × 37 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 27 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `ruking-clash` × 18 · `surfboard-eternity` × 1
