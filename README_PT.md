...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3502-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-15_19:43_UTC-informational)
...
- **Nós selecionados**: 80
- **Ativos em todas as fontes**: 3502
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-07-15 19:43 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 6 · trojan × 17 · vless × 46 · vmess × 10

**Fontes usadas nesta execução:** `autojiedian-clash` × 6 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 6 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `solispirit-v2ray` × 28 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 16
