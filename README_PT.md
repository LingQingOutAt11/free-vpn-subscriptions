...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2133-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-167ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_07:36_UTC-informational)
...
- **Nós selecionados**: 92
- **Ativos em todas as fontes**: 2133
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 167 ms
- **Última atualização (UTC)**: 2026-05-30 07:36 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 25 · vless × 13 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 15 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
