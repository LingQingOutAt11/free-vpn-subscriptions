...
![nós](https://img.shields.io/badge/nós-124-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1635-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-413ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_15:36_UTC-informational)
...
- **Ativos em todas as fontes**: 1635
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 413 ms
- **Última atualização (UTC)**: 2026-06-14 15:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 54 · trojan × 28 · vless × 25 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 3 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 2 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 4
