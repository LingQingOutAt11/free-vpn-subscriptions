...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2126-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-186ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_04:29_UTC-informational)
...
- **RTT mediano**: 186 ms
- **Última atualização (UTC)**: 2026-06-21 04:29 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 33 · vless × 58 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 35 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 28 · `surfboard-eternity` × 2
