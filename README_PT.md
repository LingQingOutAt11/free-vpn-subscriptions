...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3469-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-530ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-29_09:15_UTC-informational)
...
- **Nós selecionados**: 87
- **Ativos em todas as fontes**: 3469
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 530 ms
- **Última atualização (UTC)**: 2026-07-29 09:15 UTC

**Mix de protocolos:** shadowsocks × 10 · trojan × 35 · vless × 33 · vmess × 9

**Fontes usadas nesta execução:** `autojiedian-clash` × 8 · `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 13 · `pawdroid` × 4 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 5 · `ruking-clash` × 2 · `snakem982` × 5 · `solispirit-v2ray` × 21 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 10
