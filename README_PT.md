...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2156-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-121ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-25_22:28_UTC-informational)
...
- **RTT mediano**: 121 ms
- **Última atualização (UTC)**: 2026-05-25 22:28 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 27 · vless × 53 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 10 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 3 · `ninjastrikers` × 50 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 5
