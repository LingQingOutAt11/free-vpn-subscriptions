...
![nós](https://img.shields.io/badge/nós-135-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2063-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-377ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_11:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2063
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 377 ms
- **Última atualização (UTC)**: 2026-06-21 11:11 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 30 · vless × 44 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 39 · `snakem982` × 1 · `surfboard-eternity` × 3
