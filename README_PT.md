...
![nós](https://img.shields.io/badge/nós-124-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1932-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-314ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-13_01:11_UTC-informational)
...
- **RTT mediano**: 314 ms
- **Última atualização (UTC)**: 2026-06-13 01:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 25 · vless × 37 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 1 · `ninjastrikers` × 36 · `pawdroid` × 8 · `ruking-clash` × 11 · `surfboard-eternity` × 2
