...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1926-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-138ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_17:26_UTC-informational)
...
- **RTT mediano**: 138 ms
- **Última atualização (UTC)**: 2026-06-03 17:26 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 33 · vless × 15 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 8 · `pawdroid` × 1 · `surfboard-eternity` × 3
