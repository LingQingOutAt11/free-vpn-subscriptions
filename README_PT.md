...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1966-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-277ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-05_14:30_UTC-informational)
...
- **Nós selecionados**: 76
- **Ativos em todas as fontes**: 1966
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 277 ms
- **Última atualização (UTC)**: 2026-06-05 14:30 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 31 · vless × 6 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 1
