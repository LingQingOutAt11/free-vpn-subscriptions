...
![nós](https://img.shields.io/badge/nós-142-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1972-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-471ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_15:14_UTC-informational)
...
- **Ativos em todas as fontes**: 1972
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 471 ms
- **Última atualização (UTC)**: 2026-06-21 15:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 28 · vless × 58 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 33 · `snakem982` × 5 · `surfboard-eternity` × 2
