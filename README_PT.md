...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1864-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-276ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_04:19_UTC-informational)
...
- **Ativos em todas as fontes**: 1864
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 276 ms
- **Última atualização (UTC)**: 2026-06-08 04:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 21 · vless × 28 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 1 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 33 · `ruking-clash` × 3 · `surfboard-eternity` × 5
