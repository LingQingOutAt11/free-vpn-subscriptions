...
![nós](https://img.shields.io/badge/nós-125-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1959-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-278ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_01:24_UTC-informational)
...
- **RTT mediano**: 278 ms
- **Última atualização (UTC)**: 2026-06-25 01:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 27 · trojan × 34 · vless × 49 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 39 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 23 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 4
