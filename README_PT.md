...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2576-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-80ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_05:38_UTC-informational)
...
- **Ativos em todas as fontes**: 2576
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 80 ms
- **Última atualização (UTC)**: 2026-05-16 05:38 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 14 · vless × 96 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 57 · `pawdroid` × 10 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 5
