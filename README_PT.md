...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2224-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-540ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_15:13_UTC-informational)
...
- **Nós selecionados**: 80
- **Ativos em todas as fontes**: 2224
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 540 ms
- **Última atualização (UTC)**: 2026-06-29 15:13 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 31 · vless × 18 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 3
