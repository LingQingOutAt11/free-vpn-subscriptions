...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1952-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-358ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_17:27_UTC-informational)
...
- **Nós selecionados**: 95
- **Ativos em todas as fontes**: 1952
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 358 ms
- **Última atualização (UTC)**: 2026-06-27 17:27 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 36 · vless × 20 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 24 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 2
