...
![nós](https://img.shields.io/badge/nós-83-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1894-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-309ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-05_13:17_UTC-informational)
...
- **Nós selecionados**: 83
- **Ativos em todas as fontes**: 1894
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 309 ms
- **Última atualização (UTC)**: 2026-06-05 13:17 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 26 · vless × 14 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 24 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
