...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1852-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-375ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_16:11_UTC-informational)
...
- **Ativos em todas as fontes**: 1852
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 375 ms
- **Última atualização (UTC)**: 2026-06-15 16:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 22 · vless × 19 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 4
