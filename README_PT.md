...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1955-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-100ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_01:18_UTC-informational)
...
- **Ativos em todas as fontes**: 1955
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 100 ms
- **Última atualização (UTC)**: 2026-05-22 01:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 10 · vless × 79 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 7
