...
![nós](https://img.shields.io/badge/nós-90-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3681-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-143ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-12_13:52_UTC-informational)
...
- **Nós selecionados**: 90
- **Ativos em todas as fontes**: 3681
- **RTT do nó mais rápido**: 25 ms
- **RTT mediano**: 143 ms
- **Última atualização (UTC)**: 2026-08-12 13:52 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 24 · trojan × 15 · vless × 31 · vmess × 17

**Fontes usadas nesta execução:** `autojiedian-clash` × 10 · `automerge-verified-clash` × 11 · `barry-far-v2ray` × 3 · `epodonios` × 7 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 3 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 2 · `snakem982` × 3 · `solispirit-v2ray` × 11 · `surfboard-eternity` × 4 · `tg-v2ray-configs-every2h` × 10
