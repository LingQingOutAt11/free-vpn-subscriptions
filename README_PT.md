...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2384-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-84ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_02:27_UTC-informational)
...
- **Ativos em todas as fontes**: 2384
- **RTT do nó mais rápido**: 21 ms
- **RTT mediano**: 84 ms
- **Última atualização (UTC)**: 2026-05-23 02:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 33 · trojan × 10 · vless × 95 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 68 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 5
