...
![nós](https://img.shields.io/badge/nós-110-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1853-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-266ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_00:31_UTC-informational)
...
- **RTT mediano**: 266 ms
- **Última atualização (UTC)**: 2026-06-09 00:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 20 · vless × 34 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 35 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 1
