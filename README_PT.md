...
![nós](https://img.shields.io/badge/nós-101-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3130-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-252ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-02_04:29_UTC-informational)
...
- **Ativos em todas as fontes**: 3130
- **RTT do nó mais rápido**: 20 ms
- **RTT mediano**: 252 ms
- **Última atualização (UTC)**: 2026-07-02 04:29 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 38 · vless × 56 · vmess × 4

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 5 · `ninjastrikers` × 14 · `pawdroid` × 4 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 10 · `solispirit-v2ray` × 37 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 16
