...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2401-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-139ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_21:15_UTC-informational)
...
- **RTT mediano**: 139 ms
- **Última atualização (UTC)**: 2026-05-12 21:15 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 17 · vless × 84 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 44 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 47 · `snakem982` × 2 · `surfboard-eternity` × 3
