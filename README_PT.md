...
![nós](https://img.shields.io/badge/nós-70-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4159-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-426ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-25_14:08_UTC-informational)
...
- **Nós selecionados**: 70
- **Ativos em todas as fontes**: 4159
- **RTT do nó mais rápido**: 22 ms
- **RTT mediano**: 426 ms
- **Última atualização (UTC)**: 2026-07-25 14:08 UTC

**Mix de protocolos:** trojan × 12 · vless × 57 · vmess × 1

**Fontes usadas nesta execução:** `autojiedian-clash` × 3 · `barry-far-v2ray` × 1 · `mahdibland-aggregator` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 1 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 29 · `tg-v2ray-configs-every2h` × 21
