...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3953-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-299ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-20_20:04_UTC-informational)
...
- **Nós selecionados**: 93
- **Ativos em todas as fontes**: 3953
- **RTT do nó mais rápido**: 19 ms
- **RTT mediano**: 299 ms
- **Última atualização (UTC)**: 2026-07-20 20:04 UTC

**Mix de protocolos:** shadowsocks × 2 · trojan × 23 · vless × 61 · vmess × 7

**Fontes usadas nesta execução:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 4 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 42 · `tg-v2ray-configs-every2h` × 22
