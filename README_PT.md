...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2990-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-118ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_09:55_UTC-informational)
...
- **Ativos em todas as fontes**: 2990
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 118 ms
- **Última atualização (UTC)**: 2026-07-13 09:55 UTC

**Mix de protocolos:** shadowsocks × 5 · trojan × 19 · vless × 83 · vmess × 11

**Fontes usadas nesta execução:** `epodonios` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 4 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 16 · `solispirit-v2ray` × 49 · `tg-v2ray-configs-every2h` × 22
