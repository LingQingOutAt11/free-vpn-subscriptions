...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2130-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-430ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_16:28_UTC-informational)
...
- **Ativos em todas as fontes**: 2130
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 430 ms
- **Última atualização (UTC)**: 2026-06-20 16:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 30 · vless × 29 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 28 · `snakem982` × 1 · `surfboard-eternity` × 2
