...
![nós](https://img.shields.io/badge/nós-90-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3803-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-77ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-24_08:48_UTC-informational)
...
- **Nós selecionados**: 90
- **Ativos em todas as fontes**: 3803
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 77 ms
- **Última atualização (UTC)**: 2026-07-24 08:48 UTC

**Mix de protocolos:** shadowsocks × 5 · trojan × 17 · vless × 63 · vmess × 5

**Fontes usadas nesta execução:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 2 · `epodonios` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `roosterkid-openproxylist` × 10 · `solispirit-v2ray` × 32 · `tg-v2ray-configs-every2h` × 20
