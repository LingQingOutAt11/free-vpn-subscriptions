...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2074-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-220ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_06:39_UTC-informational)
...
- **RTT mediano**: 220 ms
- **Última atualização (UTC)**: 2026-06-27 06:39 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 34 · vless × 25 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 2
