...
![nós](https://img.shields.io/badge/nós-75-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3521-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-116ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-04_14:46_UTC-informational)
...
- **Nós selecionados**: 75
- **Ativos em todas as fontes**: 3521
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 116 ms
- **Última atualização (UTC)**: 2026-08-04 14:46 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 11 · vless × 53 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 8 · `automerge-verified-clash` × 9 · `epodonios` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 3 · `pawdroid` × 3 · `roosterkid-openproxylist` × 12 · `ruking-clash` × 2 · `snakem982` × 1 · `solispirit-v2ray` × 9 · `tg-v2ray-configs-every2h` × 4
