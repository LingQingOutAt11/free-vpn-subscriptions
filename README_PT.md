...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1756-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-427ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_17:37_UTC-informational)
...
- **Ativos em todas as fontes**: 1756
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 427 ms
- **Última atualização (UTC)**: 2026-06-17 17:37 UTC

**Mix de protocolos:** hysteria2 × 4 · shadowsocks × 47 · trojan × 33 · vless × 27 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 3 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 21 · `surfboard-eternity` × 6
