...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2509-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-79ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_06:39_UTC-informational)
...
- **Ativos em todas as fontes**: 2509
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 79 ms
- **Última atualização (UTC)**: 2026-05-21 06:39 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 11 · vless × 83 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 59 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 8
