...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2050-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-333ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_17:23_UTC-informational)
...
- **Nós selecionados**: 97
- **Ativos em todas as fontes**: 2050
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 333 ms
- **Última atualização (UTC)**: 2026-06-10 17:23 UTC

**Mix de protocolos:** shadowsocks × 41 · trojan × 19 · vless × 14 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 7 · `ruking-clash` × 6 · `surfboard-eternity` × 2
