...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2309-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-377ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_07:10_UTC-informational)
...
- **Ativos em todas as fontes**: 2309
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 377 ms
- **Última atualização (UTC)**: 2026-06-12 07:10 UTC

**Mix de protocolos:** shadowsocks × 48 · trojan × 43 · vless × 16 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 4
