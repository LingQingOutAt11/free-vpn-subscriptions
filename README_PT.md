...
![nós](https://img.shields.io/badge/nós-103-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1922-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-320ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-13_06:18_UTC-informational)
...
- **Ativos em todas as fontes**: 1922
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 320 ms
- **Última atualização (UTC)**: 2026-06-13 06:18 UTC

**Mix de protocolos:** shadowsocks × 53 · trojan × 23 · vless × 20 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 25 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 4
