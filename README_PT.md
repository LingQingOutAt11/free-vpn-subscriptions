...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2372-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-257ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_12:30_UTC-informational)
...
- **RTT mediano**: 257 ms
- **Última atualização (UTC)**: 2026-05-11 12:30 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 18 · vless × 81 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
