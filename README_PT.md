...
![nós](https://img.shields.io/badge/nós-70-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2414-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-124ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_16:10_UTC-informational)
...
- **RTT mediano**: 124 ms
- **Última atualização (UTC)**: 2026-06-01 16:10 UTC

**Mix de protocolos:** shadowsocks × 13 · trojan × 21 · vless × 6 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 23 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 5 · `pawdroid` × 3 · `surfboard-eternity` × 4
