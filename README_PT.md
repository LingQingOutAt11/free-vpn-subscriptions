...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1901-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-430ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_15:37_UTC-informational)
...
- **Ativos em todas as fontes**: 1901
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 430 ms
- **Última atualização (UTC)**: 2026-06-25 15:37 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 42 · vless × 23 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 18 · `surfboard-eternity` × 2
