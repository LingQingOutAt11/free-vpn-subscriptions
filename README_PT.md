...
![nós](https://img.shields.io/badge/nós-102-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1933-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-111ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-05_05:22_UTC-informational)
...
- **RTT mediano**: 111 ms
- **Última atualização (UTC)**: 2026-06-05 05:22 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 35 · vless × 28 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `ruking-clash` × 3 · `surfboard-eternity` × 2
