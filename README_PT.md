...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3460-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-135ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-01_03:56_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 46 | [clash-US.yaml](https://github.com/LingQingOutAt11/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/LingQingOutAt11/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/LingQingOutAt11/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
| 🇩🇪 Germany (`DE`) | 10 | [clash-DE.yaml](https://github.com/LingQingOutAt11/free-vpn-subscriptions/raw/main/output/by-country/clash-DE.yaml) | [singbox-DE.json](https://github.com/LingQingOutAt11/free-vpn-subscriptions/raw/main/output/by-country/singbox-DE.json) | [v2ray-base64-DE.txt](https://github.com/LingQingOutAt11/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-DE.txt) |
...
- **Nós selecionados**: 121
- **Ativos em todas as fontes**: 3460
- **RTT do nó mais rápido**: 14 ms
- **RTT mediano**: 135 ms
- **Última atualização (UTC)**: 2026-08-01 03:56 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 20 · trojan × 18 · vless × 73 · vmess × 7

**Fontes usadas nesta execução:** `autojiedian-clash` × 16 · `automerge-verified-clash` × 23 · `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 10 · `pawdroid` × 3 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 8 · `ruking-clash` × 3 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
