...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3163-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-335ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_14:02_UTC-informational)
...
- **Nós selecionados**: 99
- **Ativos em todas as fontes**: 3163
- **RTT do nó mais rápido**: 25 ms
- **RTT mediano**: 335 ms
- **Última atualização (UTC)**: 2026-07-12 14:02 UTC

**Mix de protocolos:** shadowsocks × 8 · trojan × 28 · vless × 57 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 1 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 7 · `pawdroid` × 3 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 10 · `snakem982` × 1 · `solispirit-v2ray` × 50 · `tg-v2ray-configs-every2h` × 12
