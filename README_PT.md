...
![nós](https://img.shields.io/badge/nós-83-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2305-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-161ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_21:16_UTC-informational)
...
- **Nós selecionados**: 83
- **Ativos em todas as fontes**: 2305
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 161 ms
- **Última atualização (UTC)**: 2026-05-30 21:16 UTC

**Mix de protocolos:** shadowsocks × 22 · trojan × 26 · vless × 8 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
