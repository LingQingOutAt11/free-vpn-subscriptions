...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1952-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-213ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-28_01:25_UTC-informational)
...
- **RTT mediano**: 213 ms
- **Última atualização (UTC)**: 2026-06-28 01:25 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 39 · vless × 31 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 20 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 23 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 4
