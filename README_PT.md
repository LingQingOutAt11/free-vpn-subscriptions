...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2310-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-275ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_15:29_UTC-informational)
...
- **Nós selecionados**: 85
- **Ativos em todas as fontes**: 2310
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 275 ms
- **Última atualização (UTC)**: 2026-06-19 15:29 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 29 · vless × 8 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 10 · `mahdi0024` × 20 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 2
