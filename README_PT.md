...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2083-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-367ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_15:37_UTC-informational)
...
- **Ativos em todas as fontes**: 2083
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 367 ms
- **Última atualização (UTC)**: 2026-06-24 15:37 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 34 · vless × 28 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 36 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 5
