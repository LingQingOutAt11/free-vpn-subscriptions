...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1903-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-476ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_12:18_UTC-informational)
...
- **Nós selecionados**: 97
- **Ativos em todas as fontes**: 1903
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 476 ms
- **Última atualização (UTC)**: 2026-06-26 12:18 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 36 · vless × 18 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 20 · `surfboard-eternity` × 2
