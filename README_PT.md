...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2128-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-180ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_16:19_UTC-informational)
...
- **RTT mediano**: 180 ms
- **Última atualização (UTC)**: 2026-06-06 16:19 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 26 · vless × 8 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 13 · `mahdi0024` × 35 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 4
