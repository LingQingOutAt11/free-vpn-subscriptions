...
![nós](https://img.shields.io/badge/nós-119-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2393-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-487ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_21:34_UTC-informational)
...
- **Ativos em todas as fontes**: 2393
- **RTT do nó mais rápido**: 39 ms
- **RTT mediano**: 487 ms
- **Última atualização (UTC)**: 2026-06-18 21:34 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 28 · vless × 40 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `pawdroid` × 6 · `ruking-clash` × 34 · `snakem982` × 6 · `surfboard-eternity` × 4
