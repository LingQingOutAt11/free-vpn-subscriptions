...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2451-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-268ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_22:30_UTC-informational)
...
- **Ativos em todas as fontes**: 2451
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 268 ms
- **Última atualização (UTC)**: 2026-05-10 22:30 UTC

**Mix de protocolos:** shadowsocks × 49 · trojan × 18 · vless × 73 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `ruking-clash` × 6 · `snakem982` × 7 · `surfboard-eternity` × 7
