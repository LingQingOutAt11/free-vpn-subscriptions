...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1949-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-160ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_04:31_UTC-informational)
...
- **Ativos em todas as fontes**: 1949
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 160 ms
- **Última atualização (UTC)**: 2026-06-04 04:31 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 47 · vless × 29 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 32 · `epodonios` × 32 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 23 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
