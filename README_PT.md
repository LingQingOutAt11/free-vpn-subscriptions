...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2439-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-126ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_00:10_UTC-informational)
...
- **RTT mediano**: 126 ms
- **Última atualização (UTC)**: 2026-05-11 00:10 UTC

**Mix de protocolos:** shadowsocks × 47 · trojan × 2 · vless × 91 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 6 · `surfboard-eternity` × 5
