...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2062-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-429ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_10:22_UTC-informational)
...
- **Ativos em todas as fontes**: 2062
- **RTT do nó mais rápido**: 25 ms
- **RTT mediano**: 429 ms
- **Última atualização (UTC)**: 2026-06-23 10:22 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 27 · vless × 43 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
