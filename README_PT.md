...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2469-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-93ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-15_02:40_UTC-informational)
...
- **Ativos em todas as fontes**: 2469
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 93 ms
- **Última atualização (UTC)**: 2026-05-15 02:40 UTC

**Mix de protocolos:** shadowsocks × 49 · trojan × 1 · vless × 91 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 34 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 55 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
