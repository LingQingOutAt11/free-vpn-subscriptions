...
![nós](https://img.shields.io/badge/nós-74-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2433-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-335ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_21:13_UTC-informational)
...
- **Nós selecionados**: 74
- **Ativos em todas as fontes**: 2433
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 335 ms
- **Última atualização (UTC)**: 2026-06-11 21:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 19 · vless × 9 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 3
