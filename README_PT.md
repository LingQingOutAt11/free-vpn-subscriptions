...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1915-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-485ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_04:13_UTC-informational)
...
- **Ativos em todas as fontes**: 1915
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 485 ms
- **Última atualização (UTC)**: 2026-06-18 04:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 30 · vless × 44 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `epodonios` × 17 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 25 · `pawdroid` × 2 · `ruking-clash` × 21 · `snakem982` × 6 · `surfboard-eternity` × 2
