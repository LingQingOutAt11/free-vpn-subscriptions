...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2300-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-178ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_04:29_UTC-informational)
...
- **RTT mediano**: 178 ms
- **Última atualização (UTC)**: 2026-06-20 04:29 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 28 · vless × 18 · vmess × 31

**Fontes usadas nesta execução:** `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
