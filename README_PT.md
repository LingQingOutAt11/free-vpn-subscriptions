...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4054-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-153ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-23_14:36_UTC-informational)
...
- **Nós selecionados**: 86
- **Ativos em todas as fontes**: 4054
- **RTT do nó mais rápido**: 18 ms
- **RTT mediano**: 153 ms
- **Última atualização (UTC)**: 2026-07-23 14:36 UTC

**Mix de protocolos:** shadowsocks × 7 · trojan × 28 · vless × 49 · vmess × 2

**Fontes usadas nesta execução:** `automerge-verified-clash` × 3 · `barry-far-v2ray` × 4 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 1 · `roosterkid-openproxylist` × 1 · `snakem982` × 1 · `solispirit-v2ray` × 41 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 21
