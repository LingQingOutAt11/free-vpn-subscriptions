...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4206-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-342ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-25_08:30_UTC-informational)
...
- **Nós selecionados**: 80
- **Ativos em todas as fontes**: 4206
- **RTT do nó mais rápido**: 47 ms
- **RTT mediano**: 342 ms
- **Última atualização (UTC)**: 2026-07-25 08:30 UTC

**Mix de protocolos:** shadowsocks × 4 · trojan × 21 · vless × 54 · vmess × 1

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 2 · `mahdibland-aggregator` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `pawdroid` × 2 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 35 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 17
