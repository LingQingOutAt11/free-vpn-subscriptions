...
![nós](https://img.shields.io/badge/nós-77-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2010-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-420ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-27_23:11_UTC-informational)
...
- **Nós selecionados**: 77
- **Ativos em todas as fontes**: 2010
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 420 ms
- **Última atualização (UTC)**: 2026-05-27 23:11 UTC

**Mix de protocolos:** shadowsocks × 25 · trojan × 36 · vless × 7 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 3 · `snakem982` × 4 · `surfboard-eternity` × 2
