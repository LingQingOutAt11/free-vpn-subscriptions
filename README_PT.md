...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1875-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-445ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_23:32_UTC-informational)
...
- **RTT mediano**: 445 ms
- **Última atualização (UTC)**: 2026-06-25 23:32 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 41 · vless × 27 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 29 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 3
