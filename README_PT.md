...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1834-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-406ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_16:34_UTC-informational)
...
- **Nós selecionados**: 99
- **Ativos em todas as fontes**: 1834
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 406 ms
- **Última atualização (UTC)**: 2026-06-30 16:34 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 38 · vless × 15 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 14 · `surfboard-eternity` × 6
