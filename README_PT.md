...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4331-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-106ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-26_04:00_UTC-informational)
...
- **Ativos em todas as fontes**: 4331
- **RTT do nó mais rápido**: 19 ms
- **RTT mediano**: 106 ms
- **Última atualização (UTC)**: 2026-07-26 04:00 UTC

**Mix de protocolos:** shadowsocks × 13 · trojan × 23 · vless × 75 · vmess × 2

**Fontes usadas nesta execução:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 1 · `epodonios` × 4 · `go4sharing-clash` × 2 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 2 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 42 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 21
