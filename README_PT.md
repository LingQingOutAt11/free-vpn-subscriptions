...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2170-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-90ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-26_02:32_UTC-informational)
...
- **Ativos em todas as fontes**: 2170
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 90 ms
- **Última atualização (UTC)**: 2026-05-26 02:32 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 16 · vless × 89 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 5 · `ruking-clash` × 14 · `snakem982` × 1 · `surfboard-eternity` × 2 · `vxiaov-clash` × 1
