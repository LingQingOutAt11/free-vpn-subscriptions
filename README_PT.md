...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3526-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-107ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-02_14:00_UTC-informational)
...
- **Nós selecionados**: 93
- **Ativos em todas as fontes**: 3526
- **RTT do nó mais rápido**: 13 ms
- **RTT mediano**: 107 ms
- **Última atualização (UTC)**: 2026-08-02 14:00 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 13 · trojan × 5 · vless × 66 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 11 · `automerge-verified-clash` × 5 · `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `matin-v2ray` × 1 · `pawdroid` × 3 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 10 · `snakem982` × 1 · `solispirit-v2ray` × 27 · `tg-v2ray-configs-every2h` × 11
