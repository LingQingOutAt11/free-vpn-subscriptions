...
![nós](https://img.shields.io/badge/nós-126-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1994-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-423ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_14:21_UTC-informational)
...
- **Ativos em todas as fontes**: 1994
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 423 ms
- **Última atualização (UTC)**: 2026-06-21 14:21 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 29 · vless × 43 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 27 · `snakem982` × 6 · `surfboard-eternity` × 2
