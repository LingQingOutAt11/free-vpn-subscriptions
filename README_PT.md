...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1783-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-371ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_00:34_UTC-informational)
...
- **Ativos em todas as fontes**: 1783
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 371 ms
- **Última atualização (UTC)**: 2026-06-18 00:34 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 44 · trojan × 32 · vless × 33 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 4
