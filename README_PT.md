...
![nós](https://img.shields.io/badge/nós-90-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3327-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-218ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-19_13:59_UTC-informational)
...
- **Nós selecionados**: 90
- **Ativos em todas as fontes**: 3327
- **RTT do nó mais rápido**: 48 ms
- **RTT mediano**: 218 ms
- **Última atualização (UTC)**: 2026-07-19 13:59 UTC

**Mix de protocolos:** shadowsocks × 6 · trojan × 20 · vless × 54 · vmess × 10

**Fontes usadas nesta execução:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 3 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `roosterkid-openproxylist` × 3 · `solispirit-v2ray` × 40 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 20
