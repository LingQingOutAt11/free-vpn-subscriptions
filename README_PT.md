...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1949-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-105ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-05_04:19_UTC-informational)
...
- **RTT mediano**: 105 ms
- **Última atualização (UTC)**: 2026-06-05 04:19 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 35 · vless × 31 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 28 · `mahdi0024` × 10 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 23 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 2
