...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2337-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-353ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_05:31_UTC-informational)
...
- **Ativos em todas as fontes**: 2337
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 353 ms
- **Última atualização (UTC)**: 2026-07-01 05:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 36 · vless × 19 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 5 · `mfuu-clash` × 13 · `ninjastrikers` × 21 · `pawdroid` × 3 · `surfboard-eternity` × 5
