...
![nós](https://img.shields.io/badge/nós-107-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3961-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-309ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-20_04:09_UTC-informational)
...
- **Ativos em todas as fontes**: 3961
- **RTT do nó mais rápido**: 48 ms
- **RTT mediano**: 309 ms
- **Última atualização (UTC)**: 2026-07-20 04:09 UTC

**Mix de protocolos:** shadowsocks × 4 · trojan × 28 · vless × 72 · vmess × 3

**Fontes usadas nesta execução:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 1 · `epodonios` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 4 · `matin-v2ray` × 8 · `ninjastrikers` × 13 · `pawdroid` × 5 · `roosterkid-openproxylist` × 2 · `solispirit-v2ray` × 49 · `tg-v2ray-configs-every2h` × 16
