...
![nós](https://img.shields.io/badge/nós-73-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3479-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-314ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-29_03:44_UTC-informational)
...
- **Nós selecionados**: 73
- **Ativos em todas as fontes**: 3479
- **RTT do nó mais rápido**: 8 ms
- **RTT mediano**: 314 ms
- **Última atualização (UTC)**: 2026-07-29 03:44 UTC

**Mix de protocolos:** shadowsocks × 15 · trojan × 26 · vless × 31 · vmess × 1

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `roosterkid-openproxylist` × 5 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 11
