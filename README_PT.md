...
![nós](https://img.shields.io/badge/nós-58-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2207-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-111ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_20:16_UTC-informational)
...
- **Nós selecionados**: 58
- **Ativos em todas as fontes**: 2207
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 111 ms
- **Última atualização (UTC)**: 2026-05-29 20:16 UTC

**Mix de protocolos:** shadowsocks × 11 · trojan × 21 · vless × 4 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 4 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 2
