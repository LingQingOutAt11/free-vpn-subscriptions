...
![nós](https://img.shields.io/badge/nós-103-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1923-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-484ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_10:21_UTC-informational)
...
- **RTT mediano**: 484 ms
- **Última atualização (UTC)**: 2026-06-26 10:21 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 39 · vless × 19 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 21 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
