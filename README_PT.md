...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3156-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-511ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_04:20_UTC-informational)
...
- **Nós selecionados**: 95
- **Ativos em todas as fontes**: 3156
- **RTT do nó mais rápido**: 24 ms
- **RTT mediano**: 511 ms
- **Última atualização (UTC)**: 2026-07-10 04:20 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 25 · vless × 54 · vmess × 13

**Fontes usadas nesta execução:** `mahdi0024` × 7 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 31 · `tg-v2ray-configs-every2h` × 20
