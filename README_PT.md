...
![nós](https://img.shields.io/badge/nós-63-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1891-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-147ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-27_06:27_UTC-informational)
...
- **Nós selecionados**: 63
- **Ativos em todas as fontes**: 1891
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 147 ms
- **Última atualização (UTC)**: 2026-05-27 06:27 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 14 · vless × 12 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 1 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 4
