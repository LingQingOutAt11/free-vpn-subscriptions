...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3092-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-404ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_20:22_UTC-informational)
...
- **Nós selecionados**: 82
- **Ativos em todas as fontes**: 3092
- **RTT do nó mais rápido**: 12 ms
- **RTT mediano**: 404 ms
- **Última atualização (UTC)**: 2026-07-01 20:22 UTC

**Mix de protocolos:** shadowsocks × 11 · trojan × 28 · vless × 38 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 10 · `solispirit-v2ray` × 26 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 14
