...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1957-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-305ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_16:22_UTC-informational)
...
- **Ativos em todas as fontes**: 1957
- **RTT do nó mais rápido**: 41 ms
- **RTT mediano**: 305 ms
- **Última atualização (UTC)**: 2026-05-06 16:22 UTC

**Mix de protocolos:** shadowsocks × 45 · trojan × 19 · vless × 75 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 61 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
