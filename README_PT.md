...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2228-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-88ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_17:38_UTC-informational)
...
- **Ativos em todas as fontes**: 2228
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 88 ms
- **Última atualização (UTC)**: 2026-05-21 17:38 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 26 · vless × 77 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 41 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 9 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
