...
![nós](https://img.shields.io/badge/nós-142-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2302-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-89ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-24_20:36_UTC-informational)
...
- **Nós selecionados**: 142
- **Ativos em todas as fontes**: 2302
- **RTT do nó mais rápido**: 19 ms
- **RTT mediano**: 89 ms
- **Última atualização (UTC)**: 2026-05-24 20:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 19 · vless × 53 · vmess × 26

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 46 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 50 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
