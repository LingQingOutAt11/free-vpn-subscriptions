...
![nós](https://img.shields.io/badge/nós-143-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2200-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-306ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_23:24_UTC-informational)
...
- **Ativos em todas as fontes**: 2200
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 306 ms
- **Última atualização (UTC)**: 2026-05-05 23:24 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 27 · vless × 68 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 4 · `surfboard-eternity` × 6
