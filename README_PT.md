...
![nós](https://img.shields.io/badge/nós-102-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1811-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-501ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_13:20_UTC-informational)
...
- **Ativos em todas as fontes**: 1811
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 501 ms
- **Última atualização (UTC)**: 2026-06-30 13:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 41 · vless × 13 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `pawdroid` × 9 · `ruking-clash` × 12 · `surfboard-eternity` × 6
