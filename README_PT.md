...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2965-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-322ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_14:06_UTC-informational)
...
- **Nós selecionados**: 99
- **Ativos em todas as fontes**: 2965
- **RTT do nó mais rápido**: 23 ms
- **RTT mediano**: 322 ms
- **Última atualização (UTC)**: 2026-07-04 14:06 UTC

**Mix de protocolos:** shadowsocks × 15 · trojan × 28 · vless × 46 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 2 · `go4sharing-clash` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 4 · `ninjastrikers` × 7 · `pawdroid` × 3 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 40 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 11
