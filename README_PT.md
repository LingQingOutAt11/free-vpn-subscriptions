...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4210-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-53ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-26_14:02_UTC-informational)
...
- **Nós selecionados**: 96
- **Ativos em todas as fontes**: 4210
- **RTT do nó mais rápido**: 17 ms
- **RTT mediano**: 53 ms
- **Última atualização (UTC)**: 2026-07-26 14:02 UTC

**Mix de protocolos:** shadowsocks × 6 · trojan × 17 · vless × 68 · vmess × 5

**Fontes usadas nesta execução:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `pawdroid` × 2 · `roosterkid-openproxylist` × 9 · `solispirit-v2ray` × 40 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 21
