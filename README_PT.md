...
![nós](https://img.shields.io/badge/nós-88-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2166-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_08:10_UTC-informational)
...
- **Nós selecionados**: 88
- **Ativos em todas as fontes**: 2166
- **RTT do nó mais rápido**: 21 ms
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-05-30 08:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 25 · trojan × 24 · vless × 9 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
