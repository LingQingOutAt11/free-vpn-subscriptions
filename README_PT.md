...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1955-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-463ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_07:22_UTC-informational)
...
- **RTT mediano**: 463 ms
- **Última atualização (UTC)**: 2026-06-18 07:22 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 29 · vless × 23 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 17 · `snakem982` × 6 · `surfboard-eternity` × 3
