...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2467-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-102ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_05:38_UTC-informational)
...
- **Ativos em todas as fontes**: 2467
- **RTT do nó mais rápido**: 24 ms
- **RTT mediano**: 102 ms
- **Última atualização (UTC)**: 2026-05-10 05:38 UTC

**Mix de protocolos:** shadowsocks × 46 · trojan × 3 · vless × 93 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 68 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
