...
![nós](https://img.shields.io/badge/nós-103-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1868-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-239ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_02:33_UTC-informational)
...
- **RTT mediano**: 239 ms
- **Última atualização (UTC)**: 2026-06-08 02:33 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 21 · vless × 29 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 1 · `ninjastrikers` × 32 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
