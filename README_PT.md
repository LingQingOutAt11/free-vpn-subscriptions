...
![nós](https://img.shields.io/badge/nós-125-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1875-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-365ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_05:31_UTC-informational)
...
- **Ativos em todas as fontes**: 1875
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 365 ms
- **Última atualização (UTC)**: 2026-06-16 05:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 53 · trojan × 26 · vless × 32 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 17 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 31 · `pawdroid` × 3 · `ruking-clash` × 9 · `surfboard-eternity` × 6
