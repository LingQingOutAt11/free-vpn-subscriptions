...
![nós](https://img.shields.io/badge/nós-67-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3073-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-325ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-04_08:58_UTC-informational)
...
- **Nós selecionados**: 67
- **Ativos em todas as fontes**: 3073
- **RTT do nó mais rápido**: 49 ms
- **RTT mediano**: 325 ms
- **Última atualização (UTC)**: 2026-07-04 08:58 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 21 · vless × 34 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 8 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 18 · `tg-v2ray-configs-every2h` × 11
