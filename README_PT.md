...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2337-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-205ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_08:30_UTC-informational)
...
- **RTT mediano**: 205 ms
- **Última atualização (UTC)**: 2026-06-10 08:30 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 12 · vless × 12 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 3
