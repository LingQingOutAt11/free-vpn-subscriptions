...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3447-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-388ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-30_08:56_UTC-informational)
...
- **Nós selecionados**: 97
- **Ativos em todas as fontes**: 3447
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 388 ms
- **Última atualização (UTC)**: 2026-07-30 08:56 UTC

**Mix de protocolos:** shadowsocks × 7 · trojan × 21 · vless × 61 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 23 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 1 · `go4sharing-clash` × 1 · `mahdi0024` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 7 · `pawdroid` × 7 · `roosterkid-openproxylist` × 9 · `solispirit-v2ray` × 23 · `tg-v2ray-configs-every2h` × 10
