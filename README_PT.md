...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2266-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-130ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_05:25_UTC-informational)
...
- **Nós selecionados**: 99
- **Ativos em todas as fontes**: 2266
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 130 ms
- **Última atualização (UTC)**: 2026-05-31 05:25 UTC

**Mix de protocolos:** shadowsocks × 16 · trojan × 30 · vless × 24 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 23 · `pawdroid` × 2
