...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2029-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-223ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-28_05:18_UTC-informational)
...
- **RTT mediano**: 223 ms
- **Última atualização (UTC)**: 2026-05-28 05:18 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 30 · vless × 25 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
