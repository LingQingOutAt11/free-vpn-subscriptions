...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3170-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-84ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-03_15:22_UTC-informational)
...
- **Nós selecionados**: 100
- **Ativos em todas as fontes**: 3170
- **RTT do nó mais rápido**: 12 ms
- **RTT mediano**: 84 ms
- **Última atualização (UTC)**: 2026-08-03 15:22 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 16 · trojan × 12 · vless × 62 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 9 · `automerge-verified-clash` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 3 · `ninjastrikers` × 5 · `pawdroid` × 5 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 11 · `ruking-clash` × 3 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 6
