...
![nós](https://img.shields.io/badge/nós-68-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1981-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-324ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_23:15_UTC-informational)
...
- **Nós selecionados**: 68
- **Ativos em todas as fontes**: 1981
- **RTT do nó mais rápido**: 48 ms
- **RTT mediano**: 324 ms
- **Última atualização (UTC)**: 2026-06-30 23:15 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 28 · vless × 7 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 13 · `ruking-clash` × 4 · `surfboard-eternity` × 5
