...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2628-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-71ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-17_11:10_UTC-informational)
...
- **Ativos em todas as fontes**: 2628
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 71 ms
- **Última atualização (UTC)**: 2026-05-17 11:10 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 10 · vless × 95 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 8 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 4 · `ninjastrikers` × 52 · `pawdroid` × 11 · `ruking-clash` × 4 · `surfboard-eternity` × 5
