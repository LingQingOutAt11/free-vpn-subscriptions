...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2404-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-331ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_22:17_UTC-informational)
...
- **Nós selecionados**: 79
- **Ativos em todas as fontes**: 2404
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 331 ms
- **Última atualização (UTC)**: 2026-06-11 22:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 40 · trojan × 20 · vless × 12 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 7 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 4
