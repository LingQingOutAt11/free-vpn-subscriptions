...
![nós](https://img.shields.io/badge/nós-125-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1676-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-402ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_22:28_UTC-informational)
...
- **Ativos em todas as fontes**: 1676
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 402 ms
- **Última atualização (UTC)**: 2026-06-14 22:28 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 67 · trojan × 26 · vless × 20 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 22 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 4
