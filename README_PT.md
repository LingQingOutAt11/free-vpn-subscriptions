...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1970-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-465ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_20:14_UTC-informational)
...
- **Ativos em todas as fontes**: 1970
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 465 ms
- **Última atualização (UTC)**: 2026-06-22 20:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 20 · vless × 76 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 51 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 33 · `snakem982` × 1 · `surfboard-eternity` × 2
