...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2188-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-137ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_07:15_UTC-informational)
...
- **Ativos em todas as fontes**: 2188
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 137 ms
- **Última atualização (UTC)**: 2026-05-06 07:15 UTC

**Mix de protocolos:** shadowsocks × 39 · trojan × 11 · vless × 89 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
