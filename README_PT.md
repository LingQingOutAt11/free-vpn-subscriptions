...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1882-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-354ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_21:27_UTC-informational)
...
- **Nós selecionados**: 86
- **Ativos em todas as fontes**: 1882
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 354 ms
- **Última atualização (UTC)**: 2026-06-08 21:27 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 22 · vless × 9 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `ruking-clash` × 5 · `surfboard-eternity` × 4
