...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3579-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-634ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-29_19:48_UTC-informational)
...
- **Nós selecionados**: 85
- **Ativos em todas as fontes**: 3579
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 634 ms
- **Última atualização (UTC)**: 2026-07-29 19:48 UTC

**Mix de protocolos:** shadowsocks × 6 · trojan × 34 · vless × 35 · vmess × 10

**Fontes usadas nesta execução:** `autojiedian-clash` × 8 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 22 · `tg-v2ray-configs-every2h` × 12
