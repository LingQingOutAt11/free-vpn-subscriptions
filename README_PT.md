...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2284-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-243ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_07:19_UTC-informational)
...
- **RTT mediano**: 243 ms
- **Última atualização (UTC)**: 2026-06-20 07:19 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 27 · vless × 16 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 3
