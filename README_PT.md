...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3017-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-341ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-11_13:59_UTC-informational)
...
- **Ativos em todas as fontes**: 3017
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 341 ms
- **Última atualização (UTC)**: 2026-07-11 13:59 UTC

**Mix de protocolos:** shadowsocks × 10 · trojan × 30 · vless × 62 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `go4sharing-clash` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 8 · `pawdroid` × 3 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 12 · `solispirit-v2ray` × 40 · `tg-v2ray-configs-every2h` × 22
