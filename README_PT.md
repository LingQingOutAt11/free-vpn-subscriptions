...
![nós](https://img.shields.io/badge/nós-83-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2121-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-274ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_11:36_UTC-informational)
...
- **RTT mediano**: 274 ms
- **Última atualização (UTC)**: 2026-06-06 11:36 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 24 · vless × 16 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
