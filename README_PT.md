...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1662-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-440ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_20:21_UTC-informational)
...
- **Ativos em todas as fontes**: 1662
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 440 ms
- **Última atualização (UTC)**: 2026-06-17 20:21 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 78 · trojan × 31 · vless × 33 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 32 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 3 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 26 · `surfboard-eternity` × 2
