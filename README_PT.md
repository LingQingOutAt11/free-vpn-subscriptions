...
![nós](https://img.shields.io/badge/nós-82-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3052-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-321ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-12_08:38_UTC-informational)
...
- **Nós selecionados**: 82
- **Ativos em todas as fontes**: 3052
- **RTT do nó mais rápido**: 42 ms
- **RTT mediano**: 321 ms
- **Última atualização (UTC)**: 2026-07-12 08:38 UTC

**Mix de protocolos:** shadowsocks × 4 · trojan × 23 · vless × 50 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 3 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 4 · `ninjastrikers` × 13 · `pawdroid` × 3 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `solispirit-v2ray` × 25 · `tg-v2ray-configs-every2h` × 16
