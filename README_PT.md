...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2359-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-77ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_05:19_UTC-informational)
...
- **RTT mediano**: 77 ms
- **Última atualização (UTC)**: 2026-05-23 05:19 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 7 · vless × 98 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 72 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
