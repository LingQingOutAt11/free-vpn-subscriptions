...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1919-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-365ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_04:17_UTC-informational)
...
- **Ativos em todas as fontes**: 1919
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 365 ms
- **Última atualização (UTC)**: 2026-06-26 04:17 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 40 · vless × 31 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 25 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 5
