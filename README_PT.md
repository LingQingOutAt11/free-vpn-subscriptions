...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1614-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-407ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_19:12_UTC-informational)
...
- **Ativos em todas as fontes**: 1614
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 407 ms
- **Última atualização (UTC)**: 2026-06-14 19:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 61 · trojan × 29 · vless × 19 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 13 · `ruking-clash` × 20 · `surfboard-eternity` × 8
