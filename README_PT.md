...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2271-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-214ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_06:20_UTC-informational)
...
- **RTT mediano**: 214 ms
- **Última atualização (UTC)**: 2026-06-20 06:20 UTC

**Mix de protocolos:** shadowsocks × 21 · trojan × 29 · vless × 17 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 7 · `ruking-clash` × 17 · `surfboard-eternity` × 7
