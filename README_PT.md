...
![nós](https://img.shields.io/badge/nós-106-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1876-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-426ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_17:17_UTC-informational)
...
- **RTT mediano**: 426 ms
- **Última atualização (UTC)**: 2026-06-29 17:17 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 31 · vless × 27 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 24 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 1
