...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1975-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-141ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_04:25_UTC-informational)
...
- **Ativos em todas as fontes**: 1975
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 141 ms
- **Última atualização (UTC)**: 2026-05-12 04:25 UTC

**Mix de protocolos:** shadowsocks × 56 · trojan × 5 · vless × 80 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 72 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 10
