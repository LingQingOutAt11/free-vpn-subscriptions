...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2452-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-109ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_02:32_UTC-informational)
...
- **RTT mediano**: 109 ms
- **Última atualização (UTC)**: 2026-05-11 02:32 UTC

**Mix de protocolos:** shadowsocks × 46 · trojan × 2 · vless × 93 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 1 · `ninjastrikers` × 68 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 4 · `surfboard-eternity` × 6
