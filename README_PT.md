...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1971-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-621ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_19:26_UTC-informational)
...
- **RTT mediano**: 621 ms
- **Última atualização (UTC)**: 2026-06-16 19:26 UTC

**Mix de protocolos:** shadowsocks × 48 · trojan × 20 · vless × 12 · vmess × 70

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 77 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 3
