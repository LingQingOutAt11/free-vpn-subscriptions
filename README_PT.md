...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2963-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-394ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_04:23_UTC-informational)
...
- **Nós selecionados**: 108
- **Ativos em todas as fontes**: 2963
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 394 ms
- **Última atualização (UTC)**: 2026-07-07 04:23 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 35 · vless × 62 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 5 · `ninjastrikers` × 16 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 7 · `solispirit-v2ray` × 41 · `tg-v2ray-configs-every2h` × 20
