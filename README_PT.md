...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1972-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-424ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_11:17_UTC-informational)
...
- **RTT mediano**: 424 ms
- **Última atualização (UTC)**: 2026-06-18 11:17 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 32 · trojan × 34 · vless × 17 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 1
