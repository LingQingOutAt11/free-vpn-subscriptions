...
![nós](https://img.shields.io/badge/nós-143-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4130-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-144ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-27_04:09_UTC-informational)
...
- **Nós selecionados**: 143
- **Ativos em todas as fontes**: 4130
- **RTT do nó mais rápido**: 39 ms
- **RTT mediano**: 144 ms
- **Última atualização (UTC)**: 2026-07-27 04:09 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 21 · trojan × 23 · vless × 91 · vmess × 7

**Fontes usadas nesta execução:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 8 · `barry-far-v2ray` × 3 · `epodonios` × 2 · `go4sharing-clash` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 1 · `snakem982` × 2 · `solispirit-v2ray` × 57 · `surfboard-eternity` × 4 · `tg-v2ray-configs-every2h` × 21
