...
![nós](https://img.shields.io/badge/nós-79-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2108-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-277ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_17:13_UTC-informational)
...
- **Nós selecionados**: 79
- **Ativos em todas as fontes**: 2108
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 277 ms
- **Última atualização (UTC)**: 2026-06-09 17:13 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 15 · vless × 7 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 11 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 7
