...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4154-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-45ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-24_19:53_UTC-informational)
...
- **Nós selecionados**: 76
- **Ativos em todas as fontes**: 4154
- **RTT do nó mais rápido**: 14 ms
- **RTT mediano**: 45 ms
- **Última atualização (UTC)**: 2026-07-24 19:53 UTC

**Mix de protocolos:** shadowsocks × 7 · trojan × 11 · vless × 56 · vmess × 2

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 6 · `epodonios` × 1 · `go4sharing-clash` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 6 · `roosterkid-openproxylist` × 4 · `snakem982` × 1 · `solispirit-v2ray` × 30 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 22
