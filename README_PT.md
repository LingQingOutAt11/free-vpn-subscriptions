...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1887-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-359ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_22:11_UTC-informational)
...
- **Nós selecionados**: 87
- **Ativos em todas as fontes**: 1887
- **RTT do nó mais rápido**: 38 ms
- **RTT mediano**: 359 ms
- **Última atualização (UTC)**: 2026-06-08 22:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 23 · vless × 11 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 8 · `surfboard-eternity` × 7
