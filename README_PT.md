...
![nós](https://img.shields.io/badge/nós-117-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2769-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-273ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_08:53_UTC-informational)
...
- **Ativos em todas as fontes**: 2769
- **RTT do nó mais rápido**: 19 ms
- **RTT mediano**: 273 ms
- **Última atualização (UTC)**: 2026-07-08 08:53 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 30 · vless × 60 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 4 · `ninjastrikers` × 10 · `pawdroid` × 5 · `radikal-clash` × 6 · `roosterkid-openproxylist` × 12 · `solispirit-v2ray` × 48 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 6
