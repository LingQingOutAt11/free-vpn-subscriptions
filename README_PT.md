...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1854-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-379ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_07:16_UTC-informational)
...
- **Ativos em todas as fontes**: 1854
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 379 ms
- **Última atualização (UTC)**: 2026-06-30 07:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 37 · vless × 18 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 12 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 6 · `ruking-clash` × 11 · `surfboard-eternity` × 1
