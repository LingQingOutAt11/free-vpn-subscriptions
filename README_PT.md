...
![nós](https://img.shields.io/badge/nós-85-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2271-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-169ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_15:34_UTC-informational)
...
- **Nós selecionados**: 85
- **Ativos em todas as fontes**: 2271
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 169 ms
- **Última atualização (UTC)**: 2026-05-30 15:34 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 22 · vless × 7 · vmess × 30

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
