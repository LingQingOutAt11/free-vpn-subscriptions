...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2535-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-101ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-15_17:28_UTC-informational)
...
- **Ativos em todas as fontes**: 2535
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 101 ms
- **Última atualização (UTC)**: 2026-05-15 17:28 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 21 · vless × 83 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 4 · `ruking-clash` × 5 · `surfboard-eternity` × 5
