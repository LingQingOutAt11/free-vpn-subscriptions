...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2301-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-122ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-20_03:25_UTC-informational)
...
- **Ativos em todas as fontes**: 2301
- **RTT do nó mais rápido**: 38 ms
- **RTT mediano**: 122 ms
- **Última atualização (UTC)**: 2026-05-20 03:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 8 · vless × 81 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 59 · `pawdroid` × 6 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
