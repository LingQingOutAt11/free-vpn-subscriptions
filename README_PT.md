...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1873-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-204ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-11_18:25_UTC-informational)
...
- **RTT mediano**: 204 ms
- **Última atualização (UTC)**: 2026-05-11 18:25 UTC

**Mix de protocolos:** shadowsocks × 63 · trojan × 10 · vless × 66 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 57 · `pawdroid` × 4 · `snakem982` × 1 · `surfboard-eternity` × 7
