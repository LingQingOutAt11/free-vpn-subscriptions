...
![nós](https://img.shields.io/badge/nós-99-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3179-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-363ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-10_10:00_UTC-informational)
...
- **Nós selecionados**: 99
- **Ativos em todas as fontes**: 3179
- **RTT do nó mais rápido**: 19 ms
- **RTT mediano**: 363 ms
- **Última atualização (UTC)**: 2026-07-10 10:00 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 35 · vless × 55 · vmess × 6

**Fontes usadas nesta execução:** `epodonios` × 1 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 47 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 15
