...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1917-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-413ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-26_13:36_UTC-informational)
...
- **Nós selecionados**: 95
- **Ativos em todas as fontes**: 1917
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 413 ms
- **Última atualização (UTC)**: 2026-06-26 13:36 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 29 · trojan × 35 · vless × 18 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 23 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 2
