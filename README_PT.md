...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1757-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-463ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_08:37_UTC-informational)
...
- **Ativos em todas as fontes**: 1757
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 463 ms
- **Última atualização (UTC)**: 2026-06-14 08:37 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 71 · trojan × 30 · vless × 29 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 8 · `ruking-clash` × 24 · `surfboard-eternity` × 7
