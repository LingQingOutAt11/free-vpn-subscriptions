...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1989-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-251ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_21:16_UTC-informational)
...
- **Ativos em todas as fontes**: 1989
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 251 ms
- **Última atualização (UTC)**: 2026-06-16 21:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 46 · trojan × 19 · vless × 13 · vmess × 71

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 75 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `ruking-clash` × 13 · `surfboard-eternity` × 2
