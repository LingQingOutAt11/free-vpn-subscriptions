...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2430-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-114ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-09_06:15_UTC-informational)
...
- **Ativos em todas as fontes**: 2430
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 114 ms
- **Última atualização (UTC)**: 2026-05-09 06:15 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 20 · vless × 86 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 75 · `pawdroid` × 2 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
