...
![nós](https://img.shields.io/badge/nós-129-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2472-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-470ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_03:26_UTC-informational)
...
- **Ativos em todas as fontes**: 2472
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 470 ms
- **Última atualização (UTC)**: 2026-06-19 03:26 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 29 · vless × 50 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 26 · `pawdroid` × 6 · `ruking-clash` × 33 · `snakem982` × 6 · `surfboard-eternity` × 2
