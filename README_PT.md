...
![nós](https://img.shields.io/badge/nós-108-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1765-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-416ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_18:19_UTC-informational)
...
- **Ativos em todas as fontes**: 1765
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 416 ms
- **Última atualização (UTC)**: 2026-06-17 18:19 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 23 · vless × 25 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `epodonios` × 15 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 22 · `surfboard-eternity` × 2
