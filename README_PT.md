...
![nós](https://img.shields.io/badge/nós-69-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1878-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-255ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-08_19:38_UTC-informational)
...
- **Nós selecionados**: 69
- **Ativos em todas as fontes**: 1878
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 255 ms
- **Última atualização (UTC)**: 2026-06-08 19:38 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 12 · vless × 9 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 7
