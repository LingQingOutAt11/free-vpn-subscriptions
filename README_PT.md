...
![nós](https://img.shields.io/badge/nós-116-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1829-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-465ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_15:14_UTC-informational)
...
- **Ativos em todas as fontes**: 1829
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 465 ms
- **Última atualização (UTC)**: 2026-06-17 15:14 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 33 · vless × 27 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 22
