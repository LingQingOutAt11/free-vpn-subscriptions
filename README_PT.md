...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4120-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-386ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-21_08:50_UTC-informational)
...
- **Nós selecionados**: 76
- **Ativos em todas as fontes**: 4120
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 386 ms
- **Última atualização (UTC)**: 2026-07-21 08:50 UTC

**Mix de protocolos:** shadowsocks × 1 · trojan × 19 · vless × 54 · vmess × 2

**Fontes usadas nesta execução:** `automerge-verified-clash` × 1 · `barry-far-v2ray` × 1 · `mahdi0024` × 1 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 1 · `roosterkid-openproxylist` × 7 · `snakem982` × 2 · `solispirit-v2ray` × 38 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 10
