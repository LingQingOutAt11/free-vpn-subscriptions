...
![nós](https://img.shields.io/badge/nós-114-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1936-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-302ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-13_03:35_UTC-informational)
...
- **Ativos em todas as fontes**: 1936
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 302 ms
- **Última atualização (UTC)**: 2026-06-13 03:35 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 25 · vless × 31 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 33 · `pawdroid` × 6 · `ruking-clash` × 13 · `surfboard-eternity` × 7
