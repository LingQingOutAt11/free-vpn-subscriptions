...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2128-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-372ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-20_17:39_UTC-informational)
...
- **Ativos em todas as fontes**: 2128
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 372 ms
- **Última atualização (UTC)**: 2026-06-20 17:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 29 · vless × 31 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `mahdi0024` × 27 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 24 · `snakem982` × 3 · `surfboard-eternity` × 3
