...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2348-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-131ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-13_14:10_UTC-informational)
...
- **RTT mediano**: 131 ms
- **Última atualização (UTC)**: 2026-05-13 14:10 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 20 · vless × 81 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 44 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
