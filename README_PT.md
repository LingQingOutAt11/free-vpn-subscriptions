...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1973-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-141ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_01:21_UTC-informational)
...
- **Ativos em todas as fontes**: 1973
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 141 ms
- **Última atualização (UTC)**: 2026-05-12 01:21 UTC

**Mix de protocolos:** shadowsocks × 59 · trojan × 3 · vless × 78 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 7 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 58 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 12 · `vxiaov-clash` × 1
