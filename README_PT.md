...
![nós](https://img.shields.io/badge/nós-98-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2153-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-173ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-06_05:24_UTC-informational)
...
- **Nós selecionados**: 98
- **Ativos em todas as fontes**: 2153
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 173 ms
- **Última atualização (UTC)**: 2026-06-06 05:24 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 29 · vless × 26 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 23 · `pawdroid` × 2 · `surfboard-eternity` × 3
