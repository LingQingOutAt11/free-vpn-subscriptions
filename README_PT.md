...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2016-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-119ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_11:22_UTC-informational)
...
- **Ativos em todas as fontes**: 2016
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 119 ms
- **Última atualização (UTC)**: 2026-05-04 11:22 UTC

**Mix de protocolos:** shadowsocks × 33 · trojan × 12 · vless × 95 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `mahdi0024` × 25 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 3 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
