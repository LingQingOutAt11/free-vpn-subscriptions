...
![nós](https://img.shields.io/badge/nós-138-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1978-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-427ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_17:22_UTC-informational)
...
- **Ativos em todas as fontes**: 1978
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 427 ms
- **Última atualização (UTC)**: 2026-06-21 17:22 UTC

**Mix de protocolos:** shadowsocks × 45 · trojan × 33 · vless × 48 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 28 · `snakem982` × 6 · `surfboard-eternity` × 4
