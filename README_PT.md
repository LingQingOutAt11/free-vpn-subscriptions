...
![nós](https://img.shields.io/badge/nós-139-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1934-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-403ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_18:10_UTC-informational)
...
- **Nós selecionados**: 139
- **Ativos em todas as fontes**: 1934
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 403 ms
- **Última atualização (UTC)**: 2026-06-21 18:10 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 27 · vless × 55 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 5 · `ruking-clash` × 32 · `snakem982` × 4 · `surfboard-eternity` × 6
