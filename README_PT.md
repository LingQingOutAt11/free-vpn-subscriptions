...
![nós](https://img.shields.io/badge/nós-136-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1595-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-432ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-14_17:23_UTC-informational)
...
- **Nós selecionados**: 136
- **Ativos em todas as fontes**: 1595
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 432 ms
- **Última atualização (UTC)**: 2026-06-14 17:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 74 · trojan × 25 · vless × 22 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 7 · `mahdi0024` × 11 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 6
