...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1961-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-466ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_18:12_UTC-informational)
...
- **RTT mediano**: 466 ms
- **Última atualização (UTC)**: 2026-06-22 18:12 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 22 · vless × 76 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 53 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 23 · `snakem982` × 3 · `surfboard-eternity` × 3
