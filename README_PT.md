...
![nós](https://img.shields.io/badge/nós-112-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1832-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-421ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_15:20_UTC-informational)
...
- **Ativos em todas as fontes**: 1832
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 421 ms
- **Última atualização (UTC)**: 2026-06-16 15:20 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 26 · vless × 19 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 4
