...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3006-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-153ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-13_15:18_UTC-informational)
...
- **Nós selecionados**: 97
- **Ativos em todas as fontes**: 3006
- **RTT do nó mais rápido**: 51 ms
- **RTT mediano**: 153 ms
- **Última atualização (UTC)**: 2026-07-13 15:18 UTC

**Mix de protocolos:** shadowsocks × 11 · trojan × 24 · vless × 54 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 2 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 8 · `pawdroid` × 4 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 6 · `snakem982` × 1 · `solispirit-v2ray` × 46 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
