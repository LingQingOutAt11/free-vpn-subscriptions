...
![nós](https://img.shields.io/badge/nós-63-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2066-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-230ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_14:39_UTC-informational)
...
- **Nós selecionados**: 63
- **Ativos em todas as fontes**: 2066
- **RTT do nó mais rápido**: 21 ms
- **RTT mediano**: 230 ms
- **Última atualização (UTC)**: 2026-05-29 14:39 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 20 · vless × 9 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 2
