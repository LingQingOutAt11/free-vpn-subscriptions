...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1943-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-337ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_15:12_UTC-informational)
...
- **Ativos em todas as fontes**: 1943
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 337 ms
- **Última atualização (UTC)**: 2026-06-27 15:12 UTC

**Mix de protocolos:** shadowsocks × 30 · trojan × 35 · vless × 21 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 7
