...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3958-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-107ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-24_14:18_UTC-informational)
...
- **Nós selecionados**: 80
- **Ativos em todas as fontes**: 3958
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 107 ms
- **Última atualização (UTC)**: 2026-07-24 14:18 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 16 · vless × 57 · vmess × 4

**Fontes usadas nesta execução:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `roosterkid-openproxylist` × 1 · `snakem982` × 2 · `solispirit-v2ray` × 31 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 25
