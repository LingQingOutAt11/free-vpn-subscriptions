...
![nós](https://img.shields.io/badge/nós-102-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1959-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-323ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-27_16:11_UTC-informational)
...
- **Ativos em todas as fontes**: 1959
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 323 ms
- **Última atualização (UTC)**: 2026-06-27 16:11 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 40 · vless × 23 · vmess × 15

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 25 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 15 · `surfboard-eternity` × 4
