...
![nós](https://img.shields.io/badge/nós-64-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2263-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-145ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-30_19:17_UTC-informational)
...
- **RTT mediano**: 145 ms
- **Última atualização (UTC)**: 2026-05-30 19:17 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 6 · vless × 8 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 3 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
