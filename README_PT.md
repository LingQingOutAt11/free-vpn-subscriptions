...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2239-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-370ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-01_13:25_UTC-informational)
...
- **Nós selecionados**: 87
- **Ativos em todas as fontes**: 2239
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 370 ms
- **Última atualização (UTC)**: 2026-07-01 13:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 34 · vless × 11 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 10 · `ninjastrikers` × 16 · `pawdroid` × 3 · `surfboard-eternity` × 3
