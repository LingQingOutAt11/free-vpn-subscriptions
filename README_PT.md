...
![nós](https://img.shields.io/badge/nós-78-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3842-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-387ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-20_09:40_UTC-informational)
...
- **Nós selecionados**: 78
- **Ativos em todas as fontes**: 3842
- **RTT do nó mais rápido**: 18 ms
- **RTT mediano**: 387 ms
- **Última atualização (UTC)**: 2026-07-20 09:40 UTC

**Mix de protocolos:** shadowsocks × 1 · trojan × 16 · vless × 55 · vmess × 6

**Fontes usadas nesta execução:** `automerge-verified-clash` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 5 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 39 · `tg-v2ray-configs-every2h` × 10
