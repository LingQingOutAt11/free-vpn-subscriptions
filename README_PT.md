...
![nós](https://img.shields.io/badge/nós-116-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2119-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-278ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-25_05:16_UTC-informational)
...
- **Ativos em todas as fontes**: 2119
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 278 ms
- **Última atualização (UTC)**: 2026-06-25 05:16 UTC

**Mix de protocolos:** shadowsocks × 27 · trojan × 31 · vless × 42 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 36 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 7
