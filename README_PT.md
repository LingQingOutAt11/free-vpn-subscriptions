...
![nós](https://img.shields.io/badge/nós-121-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3450-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-165ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-31_03:56_UTC-informational)
...
- **Ativos em todas as fontes**: 3450
- **RTT do nó mais rápido**: 40 ms
- **RTT mediano**: 165 ms
- **Última atualização (UTC)**: 2026-07-31 03:56 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 17 · trojan × 27 · vless × 67 · vmess × 8

**Fontes usadas nesta execução:** `autojiedian-clash` × 19 · `automerge-verified-clash` × 10 · `barry-far-v2ray` × 1 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 14 · `pawdroid` × 7 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 7 · `snakem982` × 1 · `solispirit-v2ray` × 33 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 12
