...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2805-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-320ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_10:08_UTC-informational)
...
- **Nós selecionados**: 128
- **Ativos em todas as fontes**: 2805
- **RTT do nó mais rápido**: 22 ms
- **RTT mediano**: 320 ms
- **Última atualização (UTC)**: 2026-07-07 10:08 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 34 · vless × 69 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 6 · `ninjastrikers` × 11 · `pawdroid` × 5 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 12 · `ruking-clash` × 1 · `solispirit-v2ray` × 44 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 19
