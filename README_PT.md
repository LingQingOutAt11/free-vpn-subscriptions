...
![nós](https://img.shields.io/badge/nós-67-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3719-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-110ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-07_07:48_UTC-informational)
...
- **Nós selecionados**: 67
- **Ativos em todas as fontes**: 3719
- **RTT do nó mais rápido**: 16 ms
- **RTT mediano**: 110 ms
- **Última atualização (UTC)**: 2026-08-07 07:48 UTC

**Mix de protocolos:** shadowsocks × 6 · trojan × 16 · vless × 34 · vmess × 11

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 1 · `roosterkid-openproxylist` × 12 · `ruking-clash` × 1 · `solispirit-v2ray` × 19 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 8
