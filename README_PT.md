...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2156-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-148ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-06_09:14_UTC-informational)
...
- **Ativos em todas as fontes**: 2156
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 148 ms
- **Última atualização (UTC)**: 2026-05-06 09:14 UTC

**Mix de protocolos:** shadowsocks × 43 · trojan × 11 · vless × 85 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 65 · `pawdroid` × 4 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
