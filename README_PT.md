...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2420-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-489ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_22:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2420
- **RTT do nó mais rápido**: 38 ms
- **RTT mediano**: 489 ms
- **Última atualização (UTC)**: 2026-06-18 22:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 27 · vless × 33 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 1 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 29 · `snakem982` × 9 · `surfboard-eternity` × 1
