...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1909-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-363ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_04:30_UTC-informational)
...
- **Ativos em todas as fontes**: 1909
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 363 ms
- **Última atualização (UTC)**: 2026-06-22 04:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 25 · vless × 65 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 26 · `pawdroid` × 4 · `ruking-clash` × 23 · `snakem982` × 3 · `surfboard-eternity` × 2
