...
![nós](https://img.shields.io/badge/nós-69-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3511-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-130ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-06_09:00_UTC-informational)
...
- **RTT mediano**: 130 ms
- **Última atualização (UTC)**: 2026-08-06 09:00 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 14 · trojan × 12 · vless × 38 · vmess × 3

**Fontes usadas nesta execução:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 8 · `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 2 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 13 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 13
