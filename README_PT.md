...
![nós](https://img.shields.io/badge/nós-62-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3493-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-110ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-07_13:46_UTC-informational)
...
- **Nós selecionados**: 62
- **Ativos em todas as fontes**: 3493
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 110 ms
- **Última atualização (UTC)**: 2026-08-07 13:46 UTC

**Mix de protocolos:** shadowsocks × 4 · trojan × 14 · vless × 35 · vmess × 9

**Fontes usadas nesta execução:** `automerge-verified-clash` × 12 · `barry-far-v2ray` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 2 · `pawdroid` × 1 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 11 · `tg-v2ray-configs-every2h` × 11
