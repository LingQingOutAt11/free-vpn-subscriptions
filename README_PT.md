...
![nós](https://img.shields.io/badge/nós-100-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1848-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-376ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_11:21_UTC-informational)
...
- **Ativos em todas as fontes**: 1848
- **RTT do nó mais rápido**: 23 ms
- **RTT mediano**: 376 ms
- **Última atualização (UTC)**: 2026-06-09 11:21 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 20 · vless × 19 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 11 · `surfboard-eternity` × 4
