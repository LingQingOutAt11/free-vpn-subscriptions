...
![nós](https://img.shields.io/badge/nós-111-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3511-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-128ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-10_02:40_UTC-informational)
...
|---|---|---|---|---|
| 🇺🇸 United States (`US`) | 74 | [clash-US.yaml](https://github.com/LingQingOutAt11/free-vpn-subscriptions/raw/main/output/by-country/clash-US.yaml) | [singbox-US.json](https://github.com/LingQingOutAt11/free-vpn-subscriptions/raw/main/output/by-country/singbox-US.json) | [v2ray-base64-US.txt](https://github.com/LingQingOutAt11/free-vpn-subscriptions/raw/main/output/by-country/v2ray-base64-US.txt) |
...
- **Ativos em todas as fontes**: 3511
- **RTT do nó mais rápido**: 18 ms
- **RTT mediano**: 128 ms
- **Última atualização (UTC)**: 2026-08-10 02:40 UTC

**Mix de protocolos:** shadowsocks × 18 · trojan × 25 · vless × 52 · vmess × 16

**Fontes usadas nesta execução:** `autojiedian-clash` × 17 · `automerge-verified-clash` × 20 · `barry-far-v2ray` × 5 · `epodonios` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 4 · `ruking-clash` × 3 · `solispirit-v2ray` × 17 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 5
