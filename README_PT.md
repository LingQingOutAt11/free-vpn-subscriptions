...
![nós](https://img.shields.io/badge/nós-105-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1863-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-373ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-15_10:31_UTC-informational)
...
- **RTT mediano**: 373 ms
- **Última atualização (UTC)**: 2026-06-15 10:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 23 · vless × 21 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 15 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 4
