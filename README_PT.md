...
![nós](https://img.shields.io/badge/nós-80-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4107-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-207ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-21_14:28_UTC-informational)
...
- **Nós selecionados**: 80
- **Ativos em todas as fontes**: 4107
- **RTT do nó mais rápido**: 49 ms
- **RTT mediano**: 207 ms
- **Última atualização (UTC)**: 2026-07-21 14:28 UTC

**Mix de protocolos:** shadowsocks × 5 · trojan × 19 · vless × 52 · vmess × 4

**Fontes usadas nesta execução:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 2 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 7 · `roosterkid-openproxylist` × 7 · `snakem982` × 1 · `solispirit-v2ray` × 32 · `tg-v2ray-configs-every2h` × 15
