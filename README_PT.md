...
![nós](https://img.shields.io/badge/nós-102-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3096-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-515ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_14:16_UTC-informational)
...
- **Ativos em todas as fontes**: 3096
- **RTT do nó mais rápido**: 23 ms
- **RTT mediano**: 515 ms
- **Última atualização (UTC)**: 2026-07-05 14:16 UTC

**Mix de protocolos:** trojan × 39 · vless × 50 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 5 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 2 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 47 · `tg-v2ray-configs-every2h` × 18
