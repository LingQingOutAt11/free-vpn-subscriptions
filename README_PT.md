...
![nós](https://img.shields.io/badge/nós-140-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2382-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-165ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-09_13:17_UTC-informational)
...
- **Ativos em todas as fontes**: 2382
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 165 ms
- **Última atualização (UTC)**: 2026-05-09 13:17 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 17 · vless × 74 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 28 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 6 · `ninjastrikers` × 60 · `snakem982` × 1 · `surfboard-eternity` × 8
