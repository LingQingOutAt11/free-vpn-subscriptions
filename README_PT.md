...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2404-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-251ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-10_16:30_UTC-informational)
...
- **RTT mediano**: 251 ms
- **Última atualização (UTC)**: 2026-05-10 16:30 UTC

**Mix de protocolos:** shadowsocks × 44 · trojan × 15 · vless × 79 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 35 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 56 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 9
