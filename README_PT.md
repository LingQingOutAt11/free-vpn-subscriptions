...
![nós](https://img.shields.io/badge/nós-101-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2551-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-111ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-02_02:10_UTC-informational)
...
- **Ativos em todas as fontes**: 2551
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 111 ms
- **Última atualização (UTC)**: 2026-06-02 02:10 UTC

**Mix de protocolos:** shadowsocks × 26 · trojan × 32 · vless × 20 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 28 · `pawdroid` × 1 · `surfboard-eternity` × 4
