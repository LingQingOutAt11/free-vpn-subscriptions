...
![nós](https://img.shields.io/badge/nós-107-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2286-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-118ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_03:23_UTC-informational)
...
- **Ativos em todas as fontes**: 2286
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 118 ms
- **Última atualização (UTC)**: 2026-05-31 03:23 UTC

**Mix de protocolos:** shadowsocks × 19 · trojan × 29 · vless × 31 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 33 · `surfboard-eternity` × 5
