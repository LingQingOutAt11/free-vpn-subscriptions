...
![nós](https://img.shields.io/badge/nós-142-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2241-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-215ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_16:19_UTC-informational)
...
- **Ativos em todas as fontes**: 2241
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 215 ms
- **Última atualização (UTC)**: 2026-05-04 16:19 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 24 · vless × 69 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 58 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 7
