...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2131-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-179ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_00:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2131
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 179 ms
- **Última atualização (UTC)**: 2026-06-21 00:11 UTC

**Mix de protocolos:** shadowsocks × 42 · trojan × 23 · vless × 64 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 40 · `mahdi0024` × 29 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 6 · `ninjastrikers` × 24 · `pawdroid` × 2 · `ruking-clash` × 15 · `snakem982` × 2 · `surfboard-eternity` × 2
