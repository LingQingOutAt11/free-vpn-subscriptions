...
![nós](https://img.shields.io/badge/nós-115-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2374-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-483ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_18:38_UTC-informational)
...
- **Ativos em todas as fontes**: 2374
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 483 ms
- **Última atualização (UTC)**: 2026-06-18 18:38 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 31 · vless × 35 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 32 · `snakem982` × 10 · `surfboard-eternity` × 5
