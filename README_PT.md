...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1943-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-508ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_01:11_UTC-informational)
...
- **RTT mediano**: 508 ms
- **Última atualização (UTC)**: 2026-06-17 01:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 30 · vless × 20 · vmess × 56

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 61 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 24 · `ruking-clash` × 16 · `surfboard-eternity` × 4
