...
![nós](https://img.shields.io/badge/nós-66-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2240-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-133ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_19:21_UTC-informational)
...
- **Nós selecionados**: 66
- **Ativos em todas as fontes**: 2240
- **RTT do nó mais rápido**: 34 ms
- **RTT mediano**: 133 ms
- **Última atualização (UTC)**: 2026-05-29 19:21 UTC

**Mix de protocolos:** shadowsocks × 12 · trojan × 27 · vless × 4 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
