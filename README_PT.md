...
![nós](https://img.shields.io/badge/nós-116-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1852-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-360ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_22:24_UTC-informational)
...
- **RTT mediano**: 360 ms
- **Última atualização (UTC)**: 2026-06-10 22:24 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 50 · trojan × 25 · vless × 13 · vmess × 27

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 6 · `surfboard-eternity` × 4
