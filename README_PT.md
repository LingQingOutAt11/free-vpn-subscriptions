...
![nós](https://img.shields.io/badge/nós-66-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2305-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-102ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-31_14:30_UTC-informational)
...
- **RTT mediano**: 102 ms
- **Última atualização (UTC)**: 2026-05-31 14:30 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 16 · vless × 4 · vmess × 32

**Fontes usadas nesta execução:** `barry-far-v2ray` × 10 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 6 · `pawdroid` × 1 · `surfboard-eternity` × 2
