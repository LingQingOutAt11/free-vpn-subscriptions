...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3034-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-318ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-05_09:30_UTC-informational)
...
- **Nós selecionados**: 113
- **Ativos em todas as fontes**: 3034
- **RTT do nó mais rápido**: 22 ms
- **RTT mediano**: 318 ms
- **Última atualização (UTC)**: 2026-07-05 09:30 UTC

**Mix de protocolos:** shadowsocks × 11 · trojan × 37 · vless × 55 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 1 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 5 · `snakem982` × 1 · `solispirit-v2ray` × 47 · `tg-v2ray-configs-every2h` × 18
