...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1911-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-387ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-22_06:31_UTC-informational)
...
- **Ativos em todas as fontes**: 1911
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 387 ms
- **Última atualização (UTC)**: 2026-06-22 06:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 32 · vless × 58 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 30 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 25 · `pawdroid` × 4 · `ruking-clash` × 25 · `snakem982` × 3 · `surfboard-eternity` × 4
