...
![nós](https://img.shields.io/badge/nós-104-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1858-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-393ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_16:31_UTC-informational)
...
- **Nós selecionados**: 104
- **Ativos em todas as fontes**: 1858
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 393 ms
- **Última atualização (UTC)**: 2026-06-16 16:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 23 · vless × 20 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 9 · `surfboard-eternity` × 3
