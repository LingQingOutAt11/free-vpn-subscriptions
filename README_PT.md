...
![nós](https://img.shields.io/badge/nós-135-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2047-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-413ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-21_13:38_UTC-informational)
...
- **Nós selecionados**: 135
- **Ativos em todas as fontes**: 2047
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 413 ms
- **Última atualização (UTC)**: 2026-06-21 13:38 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 29 · vless × 40 · vmess × 20

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 30 · `snakem982` × 2 · `surfboard-eternity` × 7
