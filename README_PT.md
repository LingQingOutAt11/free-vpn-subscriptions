...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2440-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-129ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-13_20:31_UTC-informational)
...
- **Ativos em todas as fontes**: 2440
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 129 ms
- **Última atualização (UTC)**: 2026-05-13 20:31 UTC

**Mix de protocolos:** shadowsocks × 40 · trojan × 22 · vless × 80 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
