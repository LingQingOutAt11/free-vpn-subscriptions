...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2317-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-82ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_12:35_UTC-informational)
...
- **Ativos em todas as fontes**: 2317
- **RTT do nó mais rápido**: 35 ms
- **RTT mediano**: 82 ms
- **Última atualização (UTC)**: 2026-05-23 12:35 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 12 · vless × 91 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 8 · `ruking-clash` × 3 · `surfboard-eternity` × 4
