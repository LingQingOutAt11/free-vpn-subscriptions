...
![nós](https://img.shields.io/badge/nós-53-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3616-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-52ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-08_07:21_UTC-informational)
...
- **Nós selecionados**: 53
- **Ativos em todas as fontes**: 3616
- **RTT do nó mais rápido**: 12 ms
- **RTT mediano**: 52 ms
- **Última atualização (UTC)**: 2026-08-08 07:21 UTC

**Mix de protocolos:** shadowsocks × 1 · trojan × 11 · vless × 29 · vmess × 12

**Fontes usadas nesta execução:** `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `mahdi0024` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 4 · `pawdroid` × 1 · `roosterkid-openproxylist` × 7 · `snakem982` × 1 · `solispirit-v2ray` × 19 · `tg-v2ray-configs-every2h` × 8
