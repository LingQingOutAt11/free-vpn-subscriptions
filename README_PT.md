...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2292-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-164ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-10_00:29_UTC-informational)
...
- **RTT mediano**: 164 ms
- **Última atualização (UTC)**: 2026-06-10 00:29 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 12 · vless × 26 · vmess × 23

**Fontes usadas nesta execução:** `barry-far-v2ray` × 1 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 14 · `mfuu-clash` × 1 · `ninjastrikers` × 29 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 1
