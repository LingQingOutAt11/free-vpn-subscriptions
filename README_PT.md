...
![nós](https://img.shields.io/badge/nós-87-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2385-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-91ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-03_07:28_UTC-informational)
...
- **RTT mediano**: 91 ms
- **Última atualização (UTC)**: 2026-06-03 07:28 UTC

**Mix de protocolos:** shadowsocks × 16 · trojan × 33 · vless × 7 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 19 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 11 · `surfboard-eternity` × 4
