...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2372-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-80ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-22_15:13_UTC-informational)
...
- **Ativos em todas as fontes**: 2372
- **RTT do nó mais rápido**: 38 ms
- **RTT mediano**: 80 ms
- **Última atualização (UTC)**: 2026-05-22 15:13 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 32 · trojan × 19 · vless × 89 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 5
