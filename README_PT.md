...
![nós](https://img.shields.io/badge/nós-122-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2273-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-356ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-12_05:10_UTC-informational)
...
- **RTT mediano**: 356 ms
- **Última atualização (UTC)**: 2026-06-12 05:10 UTC

**Mix de protocolos:** shadowsocks × 46 · trojan × 43 · vless × 27 · vmess × 6

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 3 · `mahdi0024` × 1 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 30 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 4
