...
![nós](https://img.shields.io/badge/nós-113-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1932-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-290ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-13_02:18_UTC-informational)
...
- **Ativos em todas as fontes**: 1932
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 290 ms
- **Última atualização (UTC)**: 2026-06-13 02:18 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 24 · vless × 29 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 35 · `pawdroid` × 5 · `ruking-clash` × 9 · `surfboard-eternity` × 4
