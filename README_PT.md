...
![nós](https://img.shields.io/badge/nós-62-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2198-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-261ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-29_15:39_UTC-informational)
...
- **RTT mediano**: 261 ms
- **Última atualização (UTC)**: 2026-05-29 15:39 UTC

**Mix de protocolos:** shadowsocks × 13 · trojan × 20 · vless × 5 · vmess × 24

**Fontes usadas nesta execução:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
