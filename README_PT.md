...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2508-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-73ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_07:37_UTC-informational)
...
- **Ativos em todas as fontes**: 2508
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 73 ms
- **Última atualização (UTC)**: 2026-05-21 07:37 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 14 · vless × 85 · vmess × 16

**Fontes usadas nesta execução:** `barry-far-v2ray` × 25 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 2 · `ninjastrikers` × 60 · `pawdroid` × 14 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
