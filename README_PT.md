...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2443-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-84ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-15_10:30_UTC-informational)
...
- **RTT mediano**: 84 ms
- **Última atualização (UTC)**: 2026-05-15 10:30 UTC

**Mix de protocolos:** shadowsocks × 45 · trojan × 4 · vless × 92 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 58 · `pawdroid` × 7 · `ruking-clash` × 5 · `surfboard-eternity` × 6
