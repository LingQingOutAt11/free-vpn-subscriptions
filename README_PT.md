...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1997-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-147ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-08_04:14_UTC-informational)
...
- **RTT mediano**: 147 ms
- **Última atualização (UTC)**: 2026-05-08 04:14 UTC

**Mix de protocolos:** shadowsocks × 54 · trojan × 6 · vless × 81 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 2 · `ninjastrikers` × 73 · `pawdroid` × 2 · `surfboard-eternity` × 6
