...
![nós](https://img.shields.io/badge/nós-96-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3488-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-421ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-31_09:23_UTC-informational)
...
- **Nós selecionados**: 96
- **Ativos em todas as fontes**: 3488
- **RTT do nó mais rápido**: 13 ms
- **RTT mediano**: 421 ms
- **Última atualização (UTC)**: 2026-07-31 09:23 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 10 · trojan × 22 · vless × 57 · vmess × 6

**Fontes usadas nesta execução:** `autojiedian-clash` × 22 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 13 · `ruking-clash` × 1 · `solispirit-v2ray` × 24 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 6
