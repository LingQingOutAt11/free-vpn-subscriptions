...
![nós](https://img.shields.io/badge/nós-124-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2019-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-391ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_19:25_UTC-informational)
...
- **Ativos em todas as fontes**: 2019
- **RTT do nó mais rápido**: 37 ms
- **RTT mediano**: 391 ms
- **Última atualização (UTC)**: 2026-06-23 19:25 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 26 · vless × 43 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 45 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
