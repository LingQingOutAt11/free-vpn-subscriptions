...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3987-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-350ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-20_14:40_UTC-informational)
...
- **Nós selecionados**: 86
- **Ativos em todas as fontes**: 3987
- **RTT do nó mais rápido**: 18 ms
- **RTT mediano**: 350 ms
- **Última atualização (UTC)**: 2026-07-20 14:40 UTC

**Mix de protocolos:** shadowsocks × 1 · trojan × 23 · vless × 57 · vmess × 5

**Fontes usadas nesta execução:** `autojiedian-clash` × 2 · `barry-far-v2ray` × 1 · `mahdi0024` × 5 · `matin-v2ray` × 10 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 39 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
