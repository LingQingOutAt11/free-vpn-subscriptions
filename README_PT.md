...
![nós](https://img.shields.io/badge/nós-107-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1857-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-376ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-16_13:11_UTC-informational)
...
- **Ativos em todas as fontes**: 1857
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 376 ms
- **Última atualização (UTC)**: 2026-06-16 13:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 48 · trojan × 26 · vless × 14 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 3
