...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1999-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-146ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-08_06:34_UTC-informational)
...
- **Ativos em todas as fontes**: 1999
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 146 ms
- **Última atualização (UTC)**: 2026-05-08 06:34 UTC

**Mix de protocolos:** shadowsocks × 50 · trojan × 9 · vless × 82 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 3 · `ninjastrikers` × 79 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
