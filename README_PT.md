...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2471-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-75ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_11:35_UTC-informational)
...
- **Ativos em todas as fontes**: 2471
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 75 ms
- **Última atualização (UTC)**: 2026-05-21 11:35 UTC

**Mix de protocolos:** shadowsocks × 36 · trojan × 15 · vless × 81 · vmess × 18

**Fontes usadas nesta execução:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 63 · `pawdroid` × 8 · `snakem982` × 1 · `surfboard-eternity` × 9
