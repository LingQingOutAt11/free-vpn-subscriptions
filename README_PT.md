...
![nós](https://img.shields.io/badge/nós-134-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2385-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-498ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-18_16:31_UTC-informational)
...
- **Nós selecionados**: 134
- **Ativos em todas as fontes**: 2385
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 498 ms
- **Última atualização (UTC)**: 2026-06-18 16:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 34 · trojan × 34 · vless × 54 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 29 · `snakem982` × 8 · `surfboard-eternity` × 4
