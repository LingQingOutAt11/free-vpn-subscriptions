...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2480-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-71ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-21_12:37_UTC-informational)
...
- **RTT mediano**: 71 ms
- **Última atualização (UTC)**: 2026-05-21 12:37 UTC

**Mix de protocolos:** shadowsocks × 37 · trojan × 14 · vless × 80 · vmess × 19

**Fontes usadas nesta execução:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 58 · `pawdroid` × 12 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
