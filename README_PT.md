...
![nós](https://img.shields.io/badge/nós-94-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1843-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-356ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-30_17:30_UTC-informational)
...
- **Nós selecionados**: 94
- **Ativos em todas as fontes**: 1843
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 356 ms
- **Última atualização (UTC)**: 2026-06-30 17:30 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 38 · trojan × 34 · vless × 14 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 12 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 10 · `ruking-clash` × 12 · `surfboard-eternity` × 2
