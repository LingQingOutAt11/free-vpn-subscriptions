...
![nós](https://img.shields.io/badge/nós-95-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2198-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-279ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_06:31_UTC-informational)
...
- **Nós selecionados**: 95
- **Ativos em todas as fontes**: 2198
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 279 ms
- **Última atualização (UTC)**: 2026-06-11 06:31 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 39 · trojan × 19 · vless × 15 · vmess × 21

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 4
