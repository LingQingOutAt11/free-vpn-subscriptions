...
![nós](https://img.shields.io/badge/nós-90-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2845-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-315ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-07_20:23_UTC-informational)
...
- **Nós selecionados**: 90
- **Ativos em todas as fontes**: 2845
- **RTT do nó mais rápido**: 49 ms
- **RTT mediano**: 315 ms
- **Última atualização (UTC)**: 2026-07-07 20:23 UTC

**Mix de protocolos:** shadowsocks × 8 · trojan × 29 · vless × 41 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 3 · `ninjastrikers` × 8 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 15 · `solispirit-v2ray` × 32 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 9
