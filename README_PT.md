...
![nós](https://img.shields.io/badge/nós-54-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3637-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-89ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-11_13:49_UTC-informational)
...
- **Nós selecionados**: 54
- **Ativos em todas as fontes**: 3637
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 89 ms
- **Última atualização (UTC)**: 2026-08-11 13:49 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 9 · trojan × 2 · vless × 33 · vmess × 9

**Fontes usadas nesta execução:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 1 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 1 · `solispirit-v2ray` × 7 · `tg-v2ray-configs-every2h` × 4
