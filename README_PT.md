...
![nós](https://img.shields.io/badge/nós-89-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2306-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-235ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_22:26_UTC-informational)
...
- **RTT mediano**: 235 ms
- **Última atualização (UTC)**: 2026-06-19 22:26 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 26 · vless × 8 · vmess × 31

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 2
