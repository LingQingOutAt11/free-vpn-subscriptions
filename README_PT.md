...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2042-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-424ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_11:38_UTC-informational)
...
- **RTT mediano**: 424 ms
- **Última atualização (UTC)**: 2026-06-23 11:38 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 28 · vless × 52 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `epodonios` × 45 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 7 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 3
