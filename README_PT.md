...
![nós](https://img.shields.io/badge/nós-92-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2993-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-107ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-03_14:38_UTC-informational)
...
- **Nós selecionados**: 92
- **Ativos em todas as fontes**: 2993
- **RTT do nó mais rápido**: 26 ms
- **RTT mediano**: 107 ms
- **Última atualização (UTC)**: 2026-07-03 14:38 UTC

**Mix de protocolos:** trojan × 41 · vless × 42 · vmess × 9

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 5 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 3 · `solispirit-v2ray` × 40 · `tg-v2ray-configs-every2h` × 14
