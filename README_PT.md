...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2342-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-85ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_01:11_UTC-informational)
...
- **Ativos em todas as fontes**: 2342
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 85 ms
- **Última atualização (UTC)**: 2026-05-23 01:11 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 7 · vless × 96 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
