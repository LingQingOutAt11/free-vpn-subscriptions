...
![nós](https://img.shields.io/badge/nós-128-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2495-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-472ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_04:34_UTC-informational)
...
- **Ativos em todas as fontes**: 2495
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 472 ms
- **Última atualização (UTC)**: 2026-06-19 04:34 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 54 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 17 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 27 · `pawdroid` × 4 · `ruking-clash` × 35 · `snakem982` × 3 · `surfboard-eternity` × 1
