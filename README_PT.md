...
![nós](https://img.shields.io/badge/nós-97-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3741-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-111ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-11_02:34_UTC-informational)
...
- **Nós selecionados**: 97
- **Ativos em todas as fontes**: 3741
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 111 ms
- **Última atualização (UTC)**: 2026-08-11 02:34 UTC

**Mix de protocolos:** shadowsocks × 13 · trojan × 21 · vless × 50 · vmess × 13

**Fontes usadas nesta execução:** `autojiedian-clash` × 11 · `automerge-verified-clash` × 15 · `barry-far-v2ray` × 3 · `epodonios` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 2 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 5 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 5
