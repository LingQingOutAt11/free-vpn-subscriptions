...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2370-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-128ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-13_12:29_UTC-informational)
...
- **Ativos em todas as fontes**: 2370
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 128 ms
- **Última atualização (UTC)**: 2026-05-13 12:29 UTC

**Mix de protocolos:** shadowsocks × 38 · trojan × 13 · vless × 88 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 5 · `snakem982` × 1 · `surfboard-eternity` × 5
