...
![nós](https://img.shields.io/badge/nós-69-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3510-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-89ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-07_19:23_UTC-informational)
...
- **Nós selecionados**: 69
- **Ativos em todas as fontes**: 3510
- **RTT do nó mais rápido**: 11 ms
- **RTT mediano**: 89 ms
- **Última atualização (UTC)**: 2026-08-07 19:23 UTC

**Mix de protocolos:** hysteria2 × 3 · shadowsocks × 15 · trojan × 9 · vless × 33 · vmess × 9

**Fontes usadas nesta execução:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 10 · `barry-far-v2ray` × 5 · `epodonios` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 4 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 8 · `ruking-clash` × 1 · `snakem982` × 1 · `solispirit-v2ray` × 11 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 10
