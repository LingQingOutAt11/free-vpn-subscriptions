...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2367-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-80ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-23_07:36_UTC-informational)
...
- **RTT mediano**: 80 ms
- **Última atualização (UTC)**: 2026-05-23 07:36 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 4 · vless × 100 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 23 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 66 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
