...
![nós](https://img.shields.io/badge/nós-107-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2539-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-161ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-08_03:51_UTC-informational)
...
- **Nós selecionados**: 107
- **Ativos em todas as fontes**: 2539
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 161 ms
- **Última atualização (UTC)**: 2026-07-08 03:51 UTC

**Mix de protocolos:** shadowsocks × 24 · trojan × 23 · vless × 43 · vmess × 17

**Fontes usadas nesta execução:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 5 · `ninjastrikers` × 19 · `pawdroid` × 4 · `radikal-clash` × 8 · `roosterkid-openproxylist` × 16 · `ruking-clash` × 2 · `surfboard-eternity` × 5 · `tg-v2ray-configs-every2h` × 15
