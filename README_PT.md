...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3540-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-211ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-29_14:38_UTC-informational)
...
- **Nós selecionados**: 76
- **Ativos em todas as fontes**: 3540
- **RTT do nó mais rápido**: 7 ms
- **RTT mediano**: 211 ms
- **Última atualização (UTC)**: 2026-07-29 14:38 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 18 · trojan × 19 · vless × 36 · vmess × 2

**Fontes usadas nesta execução:** `autojiedian-clash` × 9 · `automerge-verified-clash` × 8 · `epodonios` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 8 · `pawdroid` × 2 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 6 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 7
