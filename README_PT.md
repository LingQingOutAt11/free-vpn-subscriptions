...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2114-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-343ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-24_16:29_UTC-informational)
...
- **Ativos em todas as fontes**: 2114
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 343 ms
- **Última atualização (UTC)**: 2026-06-24 16:29 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 31 · trojan × 33 · vless × 39 · vmess × 14

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 38 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 7 · `ruking-clash` × 15 · `surfboard-eternity` × 2
