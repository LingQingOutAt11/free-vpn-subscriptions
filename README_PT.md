...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2276-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-157ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-05_09:27_UTC-informational)
...
- **Ativos em todas as fontes**: 2276
- **RTT do nó mais rápido**: 27 ms
- **RTT mediano**: 157 ms
- **Última atualização (UTC)**: 2026-05-05 09:27 UTC

**Mix de protocolos:** shadowsocks × 35 · trojan × 19 · vless × 86 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 73 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6
