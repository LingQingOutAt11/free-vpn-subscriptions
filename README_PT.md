...
![nós](https://img.shields.io/badge/nós-109-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1751-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-472ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-17_19:23_UTC-informational)
...
- **Ativos em todas as fontes**: 1751
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 472 ms
- **Última atualização (UTC)**: 2026-06-17 19:23 UTC

**Mix de protocolos:** hysteria2 × 4 · shadowsocks × 44 · trojan × 27 · vless × 26 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 4 · `epodonios` × 17 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 23 · `surfboard-eternity` × 2
