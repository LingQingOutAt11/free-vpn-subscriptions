...
![nós](https://img.shields.io/badge/nós-62-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3463-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-103ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-09_13:23_UTC-informational)
...
- **Nós selecionados**: 62
- **Ativos em todas as fontes**: 3463
- **RTT do nó mais rápido**: 21 ms
- **RTT mediano**: 103 ms
- **Última atualização (UTC)**: 2026-08-09 13:23 UTC

**Mix de protocolos:** shadowsocks × 12 · trojan × 10 · vless × 27 · vmess × 13

**Fontes usadas nesta execução:** `autojiedian-clash` × 5 · `automerge-verified-clash` × 13 · `barry-far-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 8 · `tg-v2ray-configs-every2h` × 3
