...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2109-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-108ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-04_03:36_UTC-informational)
...
- **Ativos em todas as fontes**: 2109
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 108 ms
- **Última atualização (UTC)**: 2026-05-04 03:36 UTC

**Mix de protocolos:** shadowsocks × 29 · trojan × 6 · vless × 105 · vmess × 10

**Fontes usadas nesta execução:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 3 · `ninjastrikers` × 72 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
