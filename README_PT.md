...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2602-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-96ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-16_03:18_UTC-informational)
...
- **Ativos em todas as fontes**: 2602
- **RTT do nó mais rápido**: 36 ms
- **RTT mediano**: 96 ms
- **Última atualização (UTC)**: 2026-05-16 03:18 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 9 · vless × 99 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `mahdi0024` × 29 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 8 · `ruking-clash` × 6 · `surfboard-eternity` × 5
