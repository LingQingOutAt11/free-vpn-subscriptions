...
![nós](https://img.shields.io/badge/nós-75-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2448-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-111ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-01_13:11_UTC-informational)
...
- **Nós selecionados**: 75
- **Ativos em todas as fontes**: 2448
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 111 ms
- **Última atualização (UTC)**: 2026-06-01 13:11 UTC

**Mix de protocolos:** shadowsocks × 14 · trojan × 25 · vless × 7 · vmess × 29

**Fontes usadas nesta execução:** `barry-far-v2ray` × 17 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 6 · `pawdroid` × 3 · `surfboard-eternity` × 4
