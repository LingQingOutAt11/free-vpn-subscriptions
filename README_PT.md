...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1914-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-363ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_14:15_UTC-informational)
...
- **Nós selecionados**: 93
- **Ativos em todas as fontes**: 1914
- **RTT do nó mais rápido**: 21 ms
- **RTT mediano**: 363 ms
- **Última atualização (UTC)**: 2026-06-09 14:15 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 43 · trojan × 24 · vless × 13 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 3 · `epodonios` × 15 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 5
