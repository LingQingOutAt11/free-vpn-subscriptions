...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2320-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-227ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-19_16:24_UTC-informational)
...
- **Nós selecionados**: 86
- **Ativos em todas as fontes**: 2320
- **RTT do nó mais rápido**: 30 ms
- **RTT mediano**: 227 ms
- **Última atualização (UTC)**: 2026-06-19 16:24 UTC

**Mix de protocolos:** shadowsocks × 23 · trojan × 26 · vless × 9 · vmess × 28

**Fontes usadas nesta execução:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 5
