...
![nós](https://img.shields.io/badge/nós-133-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2060-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-424ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-23_12:27_UTC-informational)
...
- **Nós selecionados**: 133
- **Ativos em todas as fontes**: 2060
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 424 ms
- **Última atualização (UTC)**: 2026-06-23 12:27 UTC

**Mix de protocolos:** hysteria2 × 2 · shadowsocks × 38 · trojan × 31 · vless × 50 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 49 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 4
