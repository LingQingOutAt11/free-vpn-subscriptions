...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2422-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-89ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-18_14:16_UTC-informational)
...
- **Ativos em todas as fontes**: 2422
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 89 ms
- **Última atualização (UTC)**: 2026-05-18 14:16 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 10 · vless × 88 · vmess × 7

**Fontes usadas nesta execução:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 39 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 48 · `pawdroid` × 7 · `ruking-clash` × 7 · `surfboard-eternity` × 7
