...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2359-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-119ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-12_15:34_UTC-informational)
...
- **RTT mediano**: 119 ms
- **Última atualização (UTC)**: 2026-05-12 15:34 UTC

**Mix de protocolos:** shadowsocks × 34 · trojan × 18 · vless × 87 · vmess × 11

**Fontes usadas nesta execução:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 3
