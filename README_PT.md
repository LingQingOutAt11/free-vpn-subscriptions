...
![nós](https://img.shields.io/badge/nós-74-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3731-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-122ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-08-10_19:24_UTC-informational)
...
- **Nós selecionados**: 74
- **Ativos em todas as fontes**: 3731
- **RTT do nó mais rápido**: 28 ms
- **RTT mediano**: 122 ms
- **Última atualização (UTC)**: 2026-08-10 19:24 UTC

**Mix de protocolos:** shadowsocks × 12 · trojan × 17 · vless × 35 · vmess × 10

**Fontes usadas nesta execução:** `autojiedian-clash` × 8 · `automerge-verified-clash` × 12 · `barry-far-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `roosterkid-openproxylist` × 10 · `ruking-clash` × 5 · `snakem982` × 1 · `solispirit-v2ray` × 9 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 3
