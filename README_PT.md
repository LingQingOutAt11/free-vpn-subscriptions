...
![nós](https://img.shields.io/badge/nós-81-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2327-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-367ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-11_18:21_UTC-informational)
...
- **Nós selecionados**: 81
- **Ativos em todas as fontes**: 2327
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 367 ms
- **Última atualização (UTC)**: 2026-06-11 18:21 UTC

**Mix de protocolos:** shadowsocks × 47 · trojan × 13 · vless × 16 · vmess × 5

**Fontes usadas nesta execução:** `barry-far-v2ray` × 9 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 3
