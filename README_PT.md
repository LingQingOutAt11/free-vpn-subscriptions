...
![nós](https://img.shields.io/badge/nós-89-brightgreen) ![ativos](https://img.shields.io/badge/ativos-4116-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-44ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-26_19:41_UTC-informational)
...
- **Nós selecionados**: 89
- **Ativos em todas as fontes**: 4116
- **RTT do nó mais rápido**: 10 ms
- **RTT mediano**: 44 ms
- **Última atualização (UTC)**: 2026-07-26 19:41 UTC

**Mix de protocolos:** shadowsocks × 8 · trojan × 15 · vless × 65 · vmess × 1

**Fontes usadas nesta execução:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 4 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 1 · `roosterkid-openproxylist` × 6 · `ruking-clash` × 1 · `solispirit-v2ray` × 41 · `tg-v2ray-configs-every2h` × 21
