...
![nós](https://img.shields.io/badge/nós-86-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2246-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-185ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-29_02:28_UTC-informational)
...
- **Nós selecionados**: 86
- **Ativos em todas as fontes**: 2246
- **RTT do nó mais rápido**: 31 ms
- **RTT mediano**: 185 ms
- **Última atualização (UTC)**: 2026-06-29 02:28 UTC

**Mix de protocolos:** shadowsocks × 17 · trojan × 29 · vless × 28 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 7 · `epodonios` × 19 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 8 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 3
