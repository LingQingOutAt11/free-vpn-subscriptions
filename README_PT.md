...
![nós](https://img.shields.io/badge/nós-93-brightgreen) ![ativos](https://img.shields.io/badge/ativos-1917-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-163ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-04_22:11_UTC-informational)
...
- **RTT mediano**: 163 ms
- **Última atualização (UTC)**: 2026-06-04 22:11 UTC

**Mix de protocolos:** shadowsocks × 28 · trojan × 33 · vless × 19 · vmess × 13

**Fontes usadas nesta execução:** `barry-far-v2ray` × 14 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `ruking-clash` × 2 · `surfboard-eternity` × 5
