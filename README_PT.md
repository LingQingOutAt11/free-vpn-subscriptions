...
![nós](https://img.shields.io/badge/nós-76-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2070-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-208ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-06-09_16:39_UTC-informational)
...
- **Nós selecionados**: 76
- **Ativos em todas as fontes**: 2070
- **RTT do nó mais rápido**: 33 ms
- **RTT mediano**: 208 ms
- **Última atualização (UTC)**: 2026-06-09 16:39 UTC

**Mix de protocolos:** hysteria2 × 1 · shadowsocks × 31 · trojan × 14 · vless × 8 · vmess × 22

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 9 · `pawdroid` × 5 · `ruking-clash` × 4
