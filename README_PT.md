...
![nós](https://img.shields.io/badge/nós-150-brightgreen) ![ativos](https://img.shields.io/badge/ativos-2536-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-102ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-05-15_23:29_UTC-informational)
...
- **Ativos em todas as fontes**: 2536
- **RTT do nó mais rápido**: 32 ms
- **RTT mediano**: 102 ms
- **Última atualização (UTC)**: 2026-05-15 23:29 UTC

**Mix de protocolos:** shadowsocks × 32 · trojan × 27 · vless × 83 · vmess × 8

**Fontes usadas nesta execução:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 50 · `pawdroid` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
