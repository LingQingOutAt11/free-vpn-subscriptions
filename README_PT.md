...
![nós](https://img.shields.io/badge/nós-118-brightgreen) ![ativos](https://img.shields.io/badge/ativos-3042-blue) ![rtt--mediano](https://img.shields.io/badge/rtt--mediano-481ms-orange) ![atualizado](https://img.shields.io/badge/atualizado-2026-07-06_20:22_UTC-informational)
...
- **Nós selecionados**: 118
- **Ativos em todas as fontes**: 3042
- **RTT do nó mais rápido**: 29 ms
- **RTT mediano**: 481 ms
- **Última atualização (UTC)**: 2026-07-06 20:22 UTC

**Mix de protocolos:** shadowsocks × 3 · trojan × 40 · vless × 63 · vmess × 12

**Fontes usadas nesta execução:** `barry-far-v2ray` × 4 · `epodonios` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `ninjastrikers` × 8 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 13 · `solispirit-v2ray` × 46 · `tg-v2ray-configs-every2h` × 29
