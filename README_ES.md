...
![nodos](https://img.shields.io/badge/nodos-63-brightgreen) ![activos](https://img.shields.io/badge/activos-4055-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-394ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-17_08:34_UTC-informational)
...
- **Nodos seleccionados**: 63
- **Activos en todas las fuentes**: 4055
- **RTT del nodo más rápido**: 48 ms
- **RTT mediana**: 394 ms
- **Última actualización (UTC)**: 2026-07-17 08:34 UTC

**Mezcla de protocolos:** trojan × 19 · vless × 42 · vmess × 2

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 28 · `tg-v2ray-configs-every2h` × 9
