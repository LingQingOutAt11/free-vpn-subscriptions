...
![nodos](https://img.shields.io/badge/nodos-132-brightgreen) ![activos](https://img.shields.io/badge/activos-2132-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-80ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-26_14:30_UTC-informational)
...
- **RTT mediana**: 80 ms
- **Última actualización (UTC)**: 2026-05-26 14:30 UTC

**Mezcla de protocolos:** shadowsocks × 26 · trojan × 24 · vless × 67 · vmess × 15

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 25 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 8 · `ruking-clash` × 8 · `surfboard-eternity` × 1
