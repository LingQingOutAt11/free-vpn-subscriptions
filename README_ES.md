...
![nodos](https://img.shields.io/badge/nodos-135-brightgreen) ![activos](https://img.shields.io/badge/activos-2063-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-377ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-21_11:11_UTC-informational)
...
- **Nodos seleccionados**: 135
- **Activos en todas las fuentes**: 2063
- **RTT del nodo más rápido**: 28 ms
- **RTT mediana**: 377 ms
- **Última actualización (UTC)**: 2026-06-21 11:11 UTC

**Mezcla de protocolos:** shadowsocks × 40 · trojan × 30 · vless × 44 · vmess × 21

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 39 · `snakem982` × 1 · `surfboard-eternity` × 3
