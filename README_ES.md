...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2432-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-80ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-21_10:13_UTC-informational)
...
- **RTT mediana**: 80 ms
- **Última actualización (UTC)**: 2026-05-21 10:13 UTC

**Mezcla de protocolos:** shadowsocks × 38 · trojan × 11 · vless × 82 · vmess × 19

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 22 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 60 · `pawdroid` × 11 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 11 · `vxiaov-clash` × 1
