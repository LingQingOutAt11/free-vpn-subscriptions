...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1922-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-285ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-07_21:32_UTC-informational)
...
- **RTT mediana**: 285 ms
- **Última actualización (UTC)**: 2026-05-07 21:32 UTC

**Mezcla de protocolos:** shadowsocks × 54 · trojan × 14 · vless × 74 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 33 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
