...
![nodos](https://img.shields.io/badge/nodos-96-brightgreen) ![activos](https://img.shields.io/badge/activos-1898-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-366ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-25_20:14_UTC-informational)
...
- **RTT mediana**: 366 ms
- **Última actualización (UTC)**: 2026-06-25 20:14 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 37 · trojan × 27 · vless × 21 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 14 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 3
