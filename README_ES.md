...
![nodos](https://img.shields.io/badge/nodos-140-brightgreen) ![activos](https://img.shields.io/badge/activos-1964-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-400ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-21_20:26_UTC-informational)
...
- **Nodos seleccionados**: 140
- **Activos en todas las fuentes**: 1964
- **RTT del nodo más rápido**: 27 ms
- **RTT mediana**: 400 ms
- **Última actualización (UTC)**: 2026-06-21 20:26 UTC

**Mezcla de protocolos:** shadowsocks × 48 · trojan × 32 · vless × 46 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 19 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 27 · `snakem982` × 9 · `surfboard-eternity` × 6
