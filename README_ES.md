...
![nodos](https://img.shields.io/badge/nodos-89-brightgreen) ![activos](https://img.shields.io/badge/activos-2052-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-235ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-27_11:27_UTC-informational)
...
- **RTT mediana**: 235 ms
- **Última actualización (UTC)**: 2026-06-27 11:27 UTC

**Mezcla de protocolos:** shadowsocks × 17 · trojan × 34 · vless × 15 · vmess × 23

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `ruking-clash` × 14 · `surfboard-eternity` × 3
