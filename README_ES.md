...
![nodos](https://img.shields.io/badge/nodos-90-brightgreen) ![activos](https://img.shields.io/badge/activos-1955-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-204ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-04_10:40_UTC-informational)
...
- **RTT mediana**: 204 ms
- **Última actualización (UTC)**: 2026-06-04 10:40 UTC

**Mezcla de protocolos:** shadowsocks × 23 · trojan × 40 · vless × 17 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 30 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 7 · `surfboard-eternity` × 2
