...
![nodos](https://img.shields.io/badge/nodos-118-brightgreen) ![activos](https://img.shields.io/badge/activos-2114-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-343ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-24_16:29_UTC-informational)
...
- **RTT mediana**: 343 ms
- **Última actualización (UTC)**: 2026-06-24 16:29 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 31 · trojan × 33 · vless × 39 · vmess × 14

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 7 · `epodonios` × 38 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 7 · `ruking-clash` × 15 · `surfboard-eternity` × 2
