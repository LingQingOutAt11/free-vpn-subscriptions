...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1973-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-143ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-07_06:19_UTC-informational)
...
- **RTT mediana**: 143 ms
- **Última actualización (UTC)**: 2026-05-07 06:19 UTC

**Mezcla de protocolos:** shadowsocks × 43 · trojan × 7 · vless × 91 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 72 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
