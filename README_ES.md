...
![nodos](https://img.shields.io/badge/nodos-95-brightgreen) ![activos](https://img.shields.io/badge/activos-2271-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-214ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-20_06:20_UTC-informational)
...
- **RTT mediana**: 214 ms
- **Última actualización (UTC)**: 2026-06-20 06:20 UTC

**Mezcla de protocolos:** shadowsocks × 21 · trojan × 29 · vless × 17 · vmess × 28

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 7 · `ruking-clash` × 17 · `surfboard-eternity` × 7
