...
![nodos](https://img.shields.io/badge/nodos-142-brightgreen) ![activos](https://img.shields.io/badge/activos-2241-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-310ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-05_16:39_UTC-informational)
...
- **RTT mediana**: 310 ms
- **Última actualización (UTC)**: 2026-05-05 16:39 UTC

**Mezcla de protocolos:** shadowsocks × 34 · trojan × 27 · vless × 71 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `snakem982` × 1 · `surfboard-eternity` × 5
