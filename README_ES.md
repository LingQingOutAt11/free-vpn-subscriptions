...
![nodos](https://img.shields.io/badge/nodos-117-brightgreen) ![activos](https://img.shields.io/badge/activos-3119-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-105ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-08-01_14:00_UTC-informational)
...
- **Nodos seleccionados**: 117
- **Activos en todas las fuentes**: 3119
- **RTT del nodo más rápido**: 17 ms
- **RTT mediana**: 105 ms
- **Última actualización (UTC)**: 2026-08-01 14:00 UTC

**Mezcla de protocolos:** hysteria2 × 4 · shadowsocks × 23 · trojan × 20 · vless × 60 · vmess × 10

**Fuentes usadas en esta ejecución:** `autojiedian-clash` × 11 · `automerge-verified-clash` × 25 · `barry-far-v2ray` × 9 · `epodonios` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 1 · `pawdroid` × 4 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 4 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 13
