...
![nodos](https://img.shields.io/badge/nodos-112-brightgreen) ![activos](https://img.shields.io/badge/activos-3308-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-62ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-08-03_10:13_UTC-informational)
...
- **Nodos seleccionados**: 112
- **Activos en todas las fuentes**: 3308
- **RTT del nodo más rápido**: 18 ms
- **RTT mediana**: 62 ms
- **Última actualización (UTC)**: 2026-08-03 10:13 UTC

**Mezcla de protocolos:** hysteria2 × 3 · shadowsocks × 10 · trojan × 2 · vless × 89 · vmess × 8

**Fuentes usadas en esta ejecución:** `autojiedian-clash` × 12 · `automerge-verified-clash` × 12 · `ebrasha-v2ray` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 7 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 11 · `snakem982` × 1 · `solispirit-v2ray` × 30 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 15
