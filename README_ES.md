...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2348-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-131ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-13_14:10_UTC-informational)
...
- **RTT mediana**: 131 ms
- **Última actualización (UTC)**: 2026-05-13 14:10 UTC

**Mezcla de protocolos:** shadowsocks × 40 · trojan × 20 · vless × 81 · vmess × 9

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 44 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
