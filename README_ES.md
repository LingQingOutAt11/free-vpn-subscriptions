...
![nodos](https://img.shields.io/badge/nodos-81-brightgreen) ![activos](https://img.shields.io/badge/activos-2283-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-183ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-19_18:19_UTC-informational)
...
- **RTT mediana**: 183 ms
- **Última actualización (UTC)**: 2026-06-19 18:19 UTC

**Mezcla de protocolos:** shadowsocks × 21 · trojan × 24 · vless × 10 · vmess × 26

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 6 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 2
