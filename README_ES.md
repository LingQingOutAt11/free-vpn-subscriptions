...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1948-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-120ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-08_01:24_UTC-informational)
...
- **RTT mediana**: 120 ms
- **Última actualización (UTC)**: 2026-05-08 01:24 UTC

**Mezcla de protocolos:** shadowsocks × 53 · trojan × 5 · vless × 85 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 28 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 69 · `snakem982` × 1 · `surfboard-eternity` × 9
