...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1973-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-141ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-12_01:21_UTC-informational)
...
- **RTT mediana**: 141 ms
- **Última actualización (UTC)**: 2026-05-12 01:21 UTC

**Mezcla de protocolos:** shadowsocks × 59 · trojan × 3 · vless × 78 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 7 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 58 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 12 · `vxiaov-clash` × 1
