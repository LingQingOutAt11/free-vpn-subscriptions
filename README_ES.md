...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1979-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-465ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-22_22:36_UTC-informational)
...
- **RTT mediana**: 465 ms
- **Última actualización (UTC)**: 2026-06-22 22:36 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 42 · trojan × 24 · vless × 70 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 52 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 21 · `snakem982` × 3 · `surfboard-eternity` × 3
