...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2440-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-129ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-13_20:31_UTC-informational)
...
- **RTT mediana**: 129 ms
- **Última actualización (UTC)**: 2026-05-13 20:31 UTC

**Mezcla de protocolos:** shadowsocks × 40 · trojan × 22 · vless × 80 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
