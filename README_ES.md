...
![nodos](https://img.shields.io/badge/nodos-97-brightgreen) ![activos](https://img.shields.io/badge/activos-2074-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-220ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-27_06:39_UTC-informational)
...
- **RTT mediana**: 220 ms
- **Última actualización (UTC)**: 2026-06-27 06:39 UTC

**Mezcla de protocolos:** shadowsocks × 18 · trojan × 34 · vless × 25 · vmess × 20

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 4 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 2
