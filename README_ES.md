...
![nodos](https://img.shields.io/badge/nodos-67-brightgreen) ![activos](https://img.shields.io/badge/activos-3719-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-110ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-08-07_07:48_UTC-informational)
...
- **Activos en todas las fuentes**: 3719
- **RTT del nodo más rápido**: 16 ms
- **RTT mediana**: 110 ms
- **Última actualización (UTC)**: 2026-08-07 07:48 UTC

**Mezcla de protocolos:** shadowsocks × 6 · trojan × 16 · vless × 34 · vmess × 11

**Fuentes usadas en esta ejecución:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 1 · `roosterkid-openproxylist` × 12 · `ruking-clash` × 1 · `solispirit-v2ray` × 19 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 8
