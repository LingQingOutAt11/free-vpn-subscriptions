...
![nodos](https://img.shields.io/badge/nodos-56-brightgreen) ![activos](https://img.shields.io/badge/activos-4069-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-59ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-17_14:08_UTC-informational)
...
- **Nodos seleccionados**: 56
- **Activos en todas las fuentes**: 4069
- **RTT del nodo más rápido**: 24 ms
- **RTT mediana**: 59 ms
- **Última actualización (UTC)**: 2026-07-17 14:08 UTC

**Mezcla de protocolos:** shadowsocks × 1 · trojan × 10 · vless × 42 · vmess × 3

**Fuentes usadas en esta ejecución:** `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `mahdibland-aggregator` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 3 · `pawdroid` × 6 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 2 · `solispirit-v2ray` × 29 · `tg-v2ray-configs-every2h` × 8
