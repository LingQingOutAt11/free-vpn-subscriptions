...
![nodos](https://img.shields.io/badge/nodos-98-brightgreen) ![activos](https://img.shields.io/badge/activos-2285-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-371ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-12_10:38_UTC-informational)
...
- **RTT mediana**: 371 ms
- **Última actualización (UTC)**: 2026-06-12 10:38 UTC

**Mezcla de protocolos:** hysteria2 × 2 · shadowsocks × 39 · trojan × 40 · vless × 11 · vmess × 6

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 7
