...
![nodos](https://img.shields.io/badge/nodos-83-brightgreen) ![activos](https://img.shields.io/badge/activos-2094-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-246ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-10_12:12_UTC-informational)
...
- **RTT mediana**: 246 ms
- **Última actualización (UTC)**: 2026-06-10 12:12 UTC

**Mezcla de protocolos:** shadowsocks × 40 · trojan × 13 · vless × 8 · vmess × 22

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 12 · `ruking-clash` × 5 · `surfboard-eternity` × 3
