...
![nodos](https://img.shields.io/badge/nodos-142-brightgreen) ![activos](https://img.shields.io/badge/activos-1972-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-471ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-21_15:14_UTC-informational)
...
- **RTT mediana**: 471 ms
- **Última actualización (UTC)**: 2026-06-21 15:14 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 45 · trojan × 28 · vless × 58 · vmess × 10

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 33 · `snakem982` × 5 · `surfboard-eternity` × 2
