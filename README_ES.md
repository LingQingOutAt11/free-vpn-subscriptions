...
![nodos](https://img.shields.io/badge/nodos-137-brightgreen) ![activos](https://img.shields.io/badge/activos-2097-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-414ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-21_08:30_UTC-informational)
...
- **RTT mediana**: 414 ms
- **Última actualización (UTC)**: 2026-06-21 08:30 UTC

**Mezcla de protocolos:** shadowsocks × 37 · trojan × 32 · vless × 44 · vmess × 24

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 12 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 38 · `snakem982` × 3 · `surfboard-eternity` × 4
