...
![nodos](https://img.shields.io/badge/nodos-62-brightgreen) ![activos](https://img.shields.io/badge/activos-3493-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-110ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-08-07_13:46_UTC-informational)
...
- **Nodos seleccionados**: 62
- **Activos en todas las fuentes**: 3493
- **RTT del nodo más rápido**: 31 ms
- **RTT mediana**: 110 ms
- **Última actualización (UTC)**: 2026-08-07 13:46 UTC

**Mezcla de protocolos:** shadowsocks × 4 · trojan × 14 · vless × 35 · vmess × 9

**Fuentes usadas en esta ejecución:** `automerge-verified-clash` × 12 · `barry-far-v2ray` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 2 · `pawdroid` × 1 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 11 · `tg-v2ray-configs-every2h` × 11
