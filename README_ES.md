...
![nodos](https://img.shields.io/badge/nodos-128-brightgreen) ![activos](https://img.shields.io/badge/activos-2128-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-372ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-20_17:39_UTC-informational)
...
- **RTT mediana**: 372 ms
- **Última actualización (UTC)**: 2026-06-20 17:39 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 44 · trojan × 29 · vless × 31 · vmess × 23

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `mahdi0024` × 27 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 24 · `snakem982` × 3 · `surfboard-eternity` × 3
