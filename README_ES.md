...
![nodos](https://img.shields.io/badge/nodos-125-brightgreen) ![activos](https://img.shields.io/badge/activos-1937-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-340ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-17_00:32_UTC-informational)
...
- **RTT mediana**: 340 ms
- **Última actualización (UTC)**: 2026-06-17 00:32 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 51 · trojan × 31 · vless × 29 · vmess × 13

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 26 · `ruking-clash` × 17 · `surfboard-eternity` × 4
