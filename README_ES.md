...
![nodos](https://img.shields.io/badge/nodos-105-brightgreen) ![activos](https://img.shields.io/badge/activos-1936-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-231ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-04_13:25_UTC-informational)
...
- **RTT mediana**: 231 ms
- **Última actualización (UTC)**: 2026-06-04 13:25 UTC

**Mezcla de protocolos:** shadowsocks × 25 · trojan × 55 · vless × 18 · vmess × 7

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 39 · `epodonios` × 25 · `lagzian-mix` × 3 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 2
