...
![nodos](https://img.shields.io/badge/nodos-84-brightgreen) ![activos](https://img.shields.io/badge/activos-2277-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-224ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-20_11:16_UTC-informational)
...
- **RTT mediana**: 224 ms
- **Última actualización (UTC)**: 2026-06-20 11:16 UTC

**Mezcla de protocolos:** shadowsocks × 22 · trojan × 22 · vless × 11 · vmess × 29

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 1
