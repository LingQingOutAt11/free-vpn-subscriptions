...
![nodos](https://img.shields.io/badge/nodos-112-brightgreen) ![activos](https://img.shields.io/badge/activos-1832-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-421ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-16_15:20_UTC-informational)
...
- **RTT mediana**: 421 ms
- **Última actualización (UTC)**: 2026-06-16 15:20 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 49 · trojan × 26 · vless × 19 · vmess × 17

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 4
