...
![nodos](https://img.shields.io/badge/nodos-116-brightgreen) ![activos](https://img.shields.io/badge/activos-2084-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-425ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-23_09:35_UTC-informational)
...
- **RTT mediana**: 425 ms
- **Última actualización (UTC)**: 2026-06-23 09:35 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 36 · trojan × 28 · vless × 43 · vmess × 8

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 7 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 4
