...
![nodos](https://img.shields.io/badge/nodos-94-brightgreen) ![activos](https://img.shields.io/badge/activos-2284-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-243ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-20_07:19_UTC-informational)
...
- **RTT mediana**: 243 ms
- **Última actualización (UTC)**: 2026-06-20 07:19 UTC

**Mezcla de protocolos:** shadowsocks × 23 · trojan × 27 · vless × 16 · vmess × 28

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 3
