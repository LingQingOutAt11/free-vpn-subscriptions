...
![nodos](https://img.shields.io/badge/nodos-85-brightgreen) ![activos](https://img.shields.io/badge/activos-3579-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-634ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-29_19:48_UTC-informational)
...
- **Nodos seleccionados**: 85
- **Activos en todas las fuentes**: 3579
- **RTT del nodo más rápido**: 26 ms
- **RTT mediana**: 634 ms
- **Última actualización (UTC)**: 2026-07-29 19:48 UTC

**Mezcla de protocolos:** shadowsocks × 6 · trojan × 34 · vless × 35 · vmess × 10

**Fuentes usadas en esta ejecución:** `autojiedian-clash` × 8 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 22 · `tg-v2ray-configs-every2h` × 12
