...
![nodos](https://img.shields.io/badge/nodos-97-brightgreen) ![activos](https://img.shields.io/badge/activos-1892-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-116ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-05_08:20_UTC-informational)
...
- **RTT mediana**: 116 ms
- **Última actualización (UTC)**: 2026-06-05 08:20 UTC

**Mezcla de protocolos:** shadowsocks × 27 · trojan × 35 · vless × 23 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 15 · `epodonios` × 23 · `mahdi0024` × 13 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
