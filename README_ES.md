...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-2222-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-140ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-05-06_00:30_UTC-informational)
...
- **RTT mediana**: 140 ms
- **Última actualización (UTC)**: 2026-05-06 00:30 UTC

**Mezcla de protocolos:** shadowsocks × 36 · trojan × 9 · vless × 94 · vmess × 11

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 30 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 74 · `pawdroid` × 1 · `surfboard-eternity` × 9
