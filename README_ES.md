...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1943-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-508ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-17_01:11_UTC-informational)
...
- **RTT mediana**: 508 ms
- **Última actualización (UTC)**: 2026-06-17 01:11 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 43 · trojan × 30 · vless × 20 · vmess × 56

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 61 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 24 · `ruking-clash` × 16 · `surfboard-eternity` × 4
