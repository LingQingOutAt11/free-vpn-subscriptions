...
![nodos](https://img.shields.io/badge/nodos-97-brightgreen) ![activos](https://img.shields.io/badge/activos-4017-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-229ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-07-23_08:51_UTC-informational)
...
- **Activos en todas las fuentes**: 4017
- **RTT del nodo más rápido**: 40 ms
- **RTT mediana**: 229 ms
- **Última actualización (UTC)**: 2026-07-23 08:51 UTC

**Mezcla de protocolos:** shadowsocks × 7 · trojan × 22 · vless × 67 · vmess × 1

**Fuentes usadas en esta ejecución:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 6 · `barry-far-v2ray` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 1 · `solispirit-v2ray` × 42 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 13
