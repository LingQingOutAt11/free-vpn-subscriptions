...
![nodos](https://img.shields.io/badge/nodos-86-brightgreen) ![activos](https://img.shields.io/badge/activos-2347-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-123ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-02_17:27_UTC-informational)
...
- **RTT mediana**: 123 ms
- **Última actualización (UTC)**: 2026-06-02 17:27 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 21 · trojan × 24 · vless × 8 · vmess × 32

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `mahdi0024` × 30 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `surfboard-eternity` × 4
