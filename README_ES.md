...
![nodos](https://img.shields.io/badge/nodos-138-brightgreen) ![activos](https://img.shields.io/badge/activos-1978-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-427ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-21_17:22_UTC-informational)
...
- **Activos en todas las fuentes**: 1978
- **RTT del nodo más rápido**: 27 ms
- **RTT mediana**: 427 ms
- **Última actualización (UTC)**: 2026-06-21 17:22 UTC

**Mezcla de protocolos:** shadowsocks × 45 · trojan × 33 · vless × 48 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 17 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 28 · `snakem982` × 6 · `surfboard-eternity` × 4
