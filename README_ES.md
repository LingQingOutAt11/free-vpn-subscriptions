...
![nodos](https://img.shields.io/badge/nodos-150-brightgreen) ![activos](https://img.shields.io/badge/activos-1970-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-465ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-22_20:14_UTC-informational)
...
- **RTT mediana**: 465 ms
- **Última actualización (UTC)**: 2026-06-22 20:14 UTC

**Mezcla de protocolos:** hysteria2 × 1 · shadowsocks × 41 · trojan × 20 · vless × 76 · vmess × 12

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 51 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 33 · `snakem982` × 1 · `surfboard-eternity` × 2
