...
![nodos](https://img.shields.io/badge/nodos-144-brightgreen) ![activos](https://img.shields.io/badge/activos-2064-blue) ![rtt--mediana](https://img.shields.io/badge/rtt--mediana-367ms-orange) ![actualizado](https://img.shields.io/badge/actualizado-2026-06-23_04:34_UTC-informational)
...
- **RTT mediana**: 367 ms
- **Última actualización (UTC)**: 2026-06-23 04:34 UTC

**Mezcla de protocolos:** shadowsocks × 39 · trojan × 29 · vless × 60 · vmess × 16

**Fuentes usadas en esta ejecución:** `barry-far-v2ray` × 11 · `epodonios` × 54 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 18 · `surfboard-eternity` × 5
