...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-2094-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-291ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_21:14_UTC-informational)
...
- **Nodes selected**: 87
- **Alive across all sources**: 2094
- **Fastest node RTT**: 30 ms
- **Median RTT**: 291 ms
- **Last updated (UTC)**: 2026-06-09 21:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 34 · trojan × 19 · vless × 11 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 4 · `surfboard-eternity` × 5
