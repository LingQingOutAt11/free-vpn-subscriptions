...
![nodes](https://img.shields.io/badge/nodes-98-brightgreen) ![alive](https://img.shields.io/badge/alive-2979-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-323ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-03_09:43_UTC-informational)
...
- **Nodes selected**: 98
- **Alive across all sources**: 2979
- **Fastest node RTT**: 23 ms
- **Median RTT**: 323 ms
- **Last updated (UTC)**: 2026-07-03 09:43 UTC

**Protocol mix:** shadowsocks × 6 · trojan × 34 · vless × 53 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 6 · `mahdi0024` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 5 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 16 · `solispirit-v2ray` × 28 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 16
