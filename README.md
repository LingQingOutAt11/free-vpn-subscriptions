...
![nodes](https://img.shields.io/badge/nodes-113-brightgreen) ![alive](https://img.shields.io/badge/alive-1901-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-430ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_15:37_UTC-informational)
...
- **Nodes selected**: 113
- **Alive across all sources**: 1901
- **Fastest node RTT**: 33 ms
- **Median RTT**: 430 ms
- **Last updated (UTC)**: 2026-06-25 15:37 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 42 · vless × 23 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 18 · `surfboard-eternity` × 2
