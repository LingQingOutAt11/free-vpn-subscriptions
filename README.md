...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-1898-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-366ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_20:14_UTC-informational)
...
- **Nodes selected**: 96
- **Alive across all sources**: 1898
- **Fastest node RTT**: 29 ms
- **Median RTT**: 366 ms
- **Last updated (UTC)**: 2026-06-25 20:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 27 · vless × 21 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 3
