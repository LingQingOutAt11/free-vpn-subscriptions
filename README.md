...
![nodes](https://img.shields.io/badge/nodes-113-brightgreen) ![alive](https://img.shields.io/badge/alive-1956-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-492ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_13:33_UTC-informational)
...
- **Nodes selected**: 113
- **Alive across all sources**: 1956
- **Fastest node RTT**: 28 ms
- **Median RTT**: 492 ms
- **Last updated (UTC)**: 2026-06-18 13:33 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 33 · trojan × 34 · vless × 36 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 3 · `surfboard-eternity` × 3
