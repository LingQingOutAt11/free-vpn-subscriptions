...
![nodes](https://img.shields.io/badge/nodes-95-brightgreen) ![alive](https://img.shields.io/badge/alive-2159-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-375ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_15:15_UTC-informational)
...
- **Median RTT**: 375 ms
- **Last updated (UTC)**: 2026-06-11 15:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 21 · vless × 14 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 6 · `surfboard-eternity` × 8
