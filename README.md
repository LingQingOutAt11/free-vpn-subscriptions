...
![nodes](https://img.shields.io/badge/nodes-107-brightgreen) ![alive](https://img.shields.io/badge/alive-2286-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-118ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_03:23_UTC-informational)
...
- **Nodes selected**: 107
- **Alive across all sources**: 2286
- **Fastest node RTT**: 31 ms
- **Median RTT**: 118 ms
- **Last updated (UTC)**: 2026-05-31 03:23 UTC

**Protocol mix:** shadowsocks × 19 · trojan × 29 · vless × 31 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 33 · `surfboard-eternity` × 5
