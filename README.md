...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-2074-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-170ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-03_23:37_UTC-informational)
...
- **Nodes selected**: 140
- **Alive across all sources**: 2074
- **Fastest node RTT**: 27 ms
- **Median RTT**: 170 ms
- **Last updated (UTC)**: 2026-05-03 23:37 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 20 · vless × 82 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 56 · `ruking-clash` × 2 · `surfboard-eternity` × 11 · `vxiaov-clash` × 1
