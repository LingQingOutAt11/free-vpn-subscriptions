...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-2130-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-430ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_16:28_UTC-informational)
...
- **Nodes selected**: 126
- **Alive across all sources**: 2130
- **Fastest node RTT**: 36 ms
- **Median RTT**: 430 ms
- **Last updated (UTC)**: 2026-06-20 16:28 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 43 · trojan × 30 · vless × 29 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 28 · `snakem982` × 1 · `surfboard-eternity` × 2
