...
![nodes](https://img.shields.io/badge/nodes-83-brightgreen) ![alive](https://img.shields.io/badge/alive-1894-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-309ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-05_13:17_UTC-informational)
...
- **Nodes selected**: 83
- **Alive across all sources**: 1894
- **Fastest node RTT**: 31 ms
- **Median RTT**: 309 ms
- **Last updated (UTC)**: 2026-06-05 13:17 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 26 · vless × 14 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 24 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
