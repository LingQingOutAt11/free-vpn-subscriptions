...
![nodes](https://img.shields.io/badge/nodes-121-brightgreen) ![alive](https://img.shields.io/badge/alive-2116-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-355ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_18:36_UTC-informational)
...
- **Nodes selected**: 121
- **Alive across all sources**: 2116
- **Fastest node RTT**: 33 ms
- **Median RTT**: 355 ms
- **Last updated (UTC)**: 2026-06-20 18:36 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 28 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 5 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 23 · `snakem982` × 3 · `surfboard-eternity` × 5
