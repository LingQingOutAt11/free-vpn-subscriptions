...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2399-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-133ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_00:24_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2399
- **Fastest node RTT**: 26 ms
- **Median RTT**: 133 ms
- **Last updated (UTC)**: 2026-05-09 00:24 UTC

**Protocol mix:** shadowsocks × 51 · trojan × 7 · vless × 83 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 74 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 2
