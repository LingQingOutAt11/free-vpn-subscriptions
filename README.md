...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2277-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-140ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_00:20_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2277
- **Fastest node RTT**: 29 ms
- **Median RTT**: 140 ms
- **Last updated (UTC)**: 2026-05-05 00:20 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 11 · vless × 92 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 4 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 76 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 6
