...
![nodes](https://img.shields.io/badge/nodes-127-brightgreen) ![alive](https://img.shields.io/badge/alive-4241-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-169ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-27_20:03_UTC-informational)
...
- **Nodes selected**: 127
- **Alive across all sources**: 4241
- **Fastest node RTT**: 23 ms
- **Median RTT**: 169 ms
- **Last updated (UTC)**: 2026-07-27 20:03 UTC

**Protocol mix:** shadowsocks × 12 · trojan × 47 · vless × 60 · vmess × 8

**Sources used this run:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 8 · `barry-far-v2ray` × 2 · `epodonios` × 1 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 3 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 10 · `ruking-clash` × 28 · `solispirit-v2ray` × 35 · `tg-v2ray-configs-every2h` × 14
