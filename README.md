...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1926-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-120ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_08:35_UTC-informational)
...
- **Median RTT**: 120 ms
- **Last updated (UTC)**: 2026-05-12 08:35 UTC

**Protocol mix:** shadowsocks × 59 · trojan × 2 · vless × 79 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `ninjastrikers` × 64 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 5
