...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2404-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-251ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_16:30_UTC-informational)
...
- **Median RTT**: 251 ms
- **Last updated (UTC)**: 2026-05-10 16:30 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 15 · vless × 79 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 35 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 56 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 9
