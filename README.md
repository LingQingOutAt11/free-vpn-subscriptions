...
![nodes](https://img.shields.io/badge/nodes-119-brightgreen) ![alive](https://img.shields.io/badge/alive-2393-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-487ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_21:34_UTC-informational)
...
- **Nodes selected**: 119
- **Alive across all sources**: 2393
- **Fastest node RTT**: 39 ms
- **Median RTT**: 487 ms
- **Last updated (UTC)**: 2026-06-18 21:34 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 28 · vless × 40 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `pawdroid` × 6 · `ruking-clash` × 34 · `snakem982` × 6 · `surfboard-eternity` × 4
