...
![nodes](https://img.shields.io/badge/nodes-76-brightgreen) ![alive](https://img.shields.io/badge/alive-2222-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-246ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_23:32_UTC-informational)
...
- **Median RTT**: 246 ms
- **Last updated (UTC)**: 2026-06-28 23:32 UTC

**Protocol mix:** shadowsocks × 17 · trojan × 26 · vless × 18 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 11 · `ninjastrikers` × 12 · `ruking-clash` × 1 · `surfboard-eternity` × 4
