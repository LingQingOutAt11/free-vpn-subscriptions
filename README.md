...
![nodes](https://img.shields.io/badge/nodes-82-brightgreen) ![alive](https://img.shields.io/badge/alive-1774-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-350ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_09:21_UTC-informational)
...
- **Nodes selected**: 82
- **Alive across all sources**: 1774
- **Fastest node RTT**: 29 ms
- **Median RTT**: 350 ms
- **Last updated (UTC)**: 2026-06-08 09:21 UTC

**Protocol mix:** shadowsocks × 47 · trojan × 16 · vless × 14 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 7
