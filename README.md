...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2429-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-138ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_04:27_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2429
- **Fastest node RTT**: 28 ms
- **Median RTT**: 138 ms
- **Last updated (UTC)**: 2026-05-09 04:27 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 11 · vless × 89 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 74 · `pawdroid` × 1 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
