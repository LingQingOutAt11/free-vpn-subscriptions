...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2331-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-113ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-20_00:31_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2331
- **Fastest node RTT**: 37 ms
- **Median RTT**: 113 ms
- **Last updated (UTC)**: 2026-05-20 00:31 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 5 · vless × 86 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 20 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 66 · `pawdroid` × 5 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
