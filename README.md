...
![nodes](https://img.shields.io/badge/nodes-73-brightgreen) ![alive](https://img.shields.io/badge/alive-1927-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-276ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_18:17_UTC-informational)
...
- **Nodes selected**: 73
- **Alive across all sources**: 1927
- **Fastest node RTT**: 34 ms
- **Median RTT**: 276 ms
- **Last updated (UTC)**: 2026-06-08 18:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 30 · trojan × 19 · vless × 13 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 11 · `pawdroid` × 4 · `ruking-clash` × 6 · `surfboard-eternity` × 3
