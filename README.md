...
![nodes](https://img.shields.io/badge/nodes-54-brightgreen) ![alive](https://img.shields.io/badge/alive-3637-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-89ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-11_13:49_UTC-informational)
...
- **Nodes selected**: 54
- **Alive across all sources**: 3637
- **Fastest node RTT**: 29 ms
- **Median RTT**: 89 ms
- **Last updated (UTC)**: 2026-08-11 13:49 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 9 · trojan × 2 · vless × 33 · vmess × 9

**Sources used this run:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 1 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 1 · `solispirit-v2ray` × 7 · `tg-v2ray-configs-every2h` × 4
