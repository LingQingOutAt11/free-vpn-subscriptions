...
![nodes](https://img.shields.io/badge/nodes-130-brightgreen) ![alive](https://img.shields.io/badge/alive-2542-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-484ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_14:21_UTC-informational)
...
- **Nodes selected**: 130
- **Alive across all sources**: 2542
- **Fastest node RTT**: 35 ms
- **Median RTT**: 484 ms
- **Last updated (UTC)**: 2026-06-19 14:21 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 30 · trojan × 29 · vless × 50 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 42 · `snakem982` × 6 · `surfboard-eternity` × 3
