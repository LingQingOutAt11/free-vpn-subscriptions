...
![nodes](https://img.shields.io/badge/nodes-64-brightgreen) ![alive](https://img.shields.io/badge/alive-3701-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-311ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-28_14:42_UTC-informational)
...
- **Nodes selected**: 64
- **Alive across all sources**: 3701
- **Fastest node RTT**: 11 ms
- **Median RTT**: 311 ms
- **Last updated (UTC)**: 2026-07-28 14:42 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 16 · trojan × 21 · vless × 25 · vmess × 1

**Sources used this run:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `go4sharing-clash` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 8 · `pawdroid` × 5 · `roosterkid-openproxylist` × 2 · `solispirit-v2ray` × 19 · `tg-v2ray-configs-every2h` × 11
