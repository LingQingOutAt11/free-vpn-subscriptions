...
![nodes](https://img.shields.io/badge/nodes-119-brightgreen) ![alive](https://img.shields.io/badge/alive-1742-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-459ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_07:29_UTC-informational)
...
- **Nodes selected**: 119
- **Alive across all sources**: 1742
- **Fastest node RTT**: 35 ms
- **Median RTT**: 459 ms
- **Last updated (UTC)**: 2026-06-14 07:29 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 52 · trojan × 36 · vless × 24 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 24 · `pawdroid` × 7 · `ruking-clash` × 21 · `surfboard-eternity` × 5
