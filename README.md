...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1846-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-372ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-15_15:26_UTC-informational)
...
- **Nodes selected**: 105
- **Alive across all sources**: 1846
- **Fastest node RTT**: 29 ms
- **Median RTT**: 372 ms
- **Last updated (UTC)**: 2026-06-15 15:26 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 22 · vless × 17 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 6
