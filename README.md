...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-4195-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-65ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_08:14_UTC-informational)
...
- **Nodes selected**: 94
- **Alive across all sources**: 4195
- **Fastest node RTT**: 21 ms
- **Median RTT**: 65 ms
- **Last updated (UTC)**: 2026-07-18 08:14 UTC

**Protocol mix:** shadowsocks × 9 · trojan × 17 · vless × 63 · vmess × 5

**Sources used this run:** `automerge-verified-clash` × 5 · `epodonios` × 3 · `mahdi0024` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 4 · `ninjastrikers` × 8 · `pawdroid` × 4 · `roosterkid-openproxylist` × 5 · `snakem982` × 1 · `solispirit-v2ray` × 36 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 22
