...
![nodes](https://img.shields.io/badge/nodes-122-brightgreen) ![alive](https://img.shields.io/badge/alive-1594-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-400ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_14:25_UTC-informational)
...
- **Nodes selected**: 122
- **Alive across all sources**: 1594
- **Fastest node RTT**: 27 ms
- **Median RTT**: 400 ms
- **Last updated (UTC)**: 2026-06-14 14:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 57 · trojan × 26 · vless × 21 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 5
