...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2156-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-148ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_09:14_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2156
- **Fastest node RTT**: 30 ms
- **Median RTT**: 148 ms
- **Last updated (UTC)**: 2026-05-06 09:14 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 11 · vless × 85 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 65 · `pawdroid` × 4 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
