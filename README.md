...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2126-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-186ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_04:29_UTC-informational)
...
- **Median RTT**: 186 ms
- **Last updated (UTC)**: 2026-06-21 04:29 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 33 · vless × 58 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 35 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 28 · `surfboard-eternity` × 2
