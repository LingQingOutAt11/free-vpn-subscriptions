...
![nodes](https://img.shields.io/badge/nodes-149-brightgreen) ![alive](https://img.shields.io/badge/alive-2441-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-135ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-13_21:24_UTC-informational)
...
- **Nodes selected**: 149
- **Alive across all sources**: 2441
- **Fastest node RTT**: 29 ms
- **Median RTT**: 135 ms
- **Last updated (UTC)**: 2026-05-13 21:24 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 21 · vless × 76 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 29 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 1 · `ninjastrikers` × 54 · `pawdroid` × 1 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 4
