...
![nodes](https://img.shields.io/badge/nodes-144-brightgreen) ![alive](https://img.shields.io/badge/alive-2302-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-97ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-24_16:19_UTC-informational)
...
- **Nodes selected**: 144
- **Alive across all sources**: 2302
- **Fastest node RTT**: 38 ms
- **Median RTT**: 97 ms
- **Last updated (UTC)**: 2026-05-24 16:19 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 16 · vless × 60 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 43 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 4
