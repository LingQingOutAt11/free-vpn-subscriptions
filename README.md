...
![nodes](https://img.shields.io/badge/nodes-135-brightgreen) ![alive](https://img.shields.io/badge/alive-2047-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-413ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_13:38_UTC-informational)
...
- **Nodes selected**: 135
- **Alive across all sources**: 2047
- **Fastest node RTT**: 30 ms
- **Median RTT**: 413 ms
- **Last updated (UTC)**: 2026-06-21 13:38 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 29 · vless × 40 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 17 · `pawdroid` × 4 · `ruking-clash` × 30 · `snakem982` × 2 · `surfboard-eternity` × 7
