...
![nodes](https://img.shields.io/badge/nodes-124-brightgreen) ![alive](https://img.shields.io/badge/alive-1635-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-413ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_15:36_UTC-informational)
...
- **Nodes selected**: 124
- **Alive across all sources**: 1635
- **Fastest node RTT**: 30 ms
- **Median RTT**: 413 ms
- **Last updated (UTC)**: 2026-06-14 15:36 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 54 · trojan × 28 · vless × 25 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 3 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 2 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 4
