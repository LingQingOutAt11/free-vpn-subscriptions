...
![nodes](https://img.shields.io/badge/nodes-103-brightgreen) ![alive](https://img.shields.io/badge/alive-1922-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-320ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_06:18_UTC-informational)
...
- **Median RTT**: 320 ms
- **Last updated (UTC)**: 2026-06-13 06:18 UTC

**Protocol mix:** shadowsocks × 53 · trojan × 23 · vless × 20 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 25 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 4
