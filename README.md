...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1925-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-494ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_06:24_UTC-informational)
...
- **Median RTT**: 494 ms
- **Last updated (UTC)**: 2026-06-26 06:24 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 41 · vless × 24 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 21 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 3
