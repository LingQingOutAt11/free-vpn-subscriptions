...
![nodes](https://img.shields.io/badge/nodes-90-brightgreen) ![alive](https://img.shields.io/badge/alive-3681-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-143ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-12_13:52_UTC-informational)
...
- **Nodes selected**: 90
- **Alive across all sources**: 3681
- **Fastest node RTT**: 25 ms
- **Median RTT**: 143 ms
- **Last updated (UTC)**: 2026-08-12 13:52 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 24 · trojan × 15 · vless × 31 · vmess × 17

**Sources used this run:** `autojiedian-clash` × 10 · `automerge-verified-clash` × 11 · `barry-far-v2ray` × 3 · `epodonios` × 7 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 3 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 2 · `snakem982` × 3 · `solispirit-v2ray` × 11 · `surfboard-eternity` × 4 · `tg-v2ray-configs-every2h` × 10
