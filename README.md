...
![nodes](https://img.shields.io/badge/nodes-90-brightgreen) ![alive](https://img.shields.io/badge/alive-3327-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-218ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-19_13:59_UTC-informational)
...
- **Nodes selected**: 90
- **Alive across all sources**: 3327
- **Fastest node RTT**: 48 ms
- **Median RTT**: 218 ms
- **Last updated (UTC)**: 2026-07-19 13:59 UTC

**Protocol mix:** shadowsocks × 6 · trojan × 20 · vless × 54 · vmess × 10

**Sources used this run:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 3 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `roosterkid-openproxylist` × 3 · `solispirit-v2ray` × 40 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 20
