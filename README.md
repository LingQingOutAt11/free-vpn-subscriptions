...
![nodes](https://img.shields.io/badge/nodes-90-brightgreen) ![alive](https://img.shields.io/badge/alive-2845-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-315ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_20:23_UTC-informational)
...
- **Nodes selected**: 90
- **Alive across all sources**: 2845
- **Fastest node RTT**: 49 ms
- **Median RTT**: 315 ms
- **Last updated (UTC)**: 2026-07-07 20:23 UTC

**Protocol mix:** shadowsocks × 8 · trojan × 29 · vless × 41 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 3 · `ninjastrikers` × 8 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 15 · `solispirit-v2ray` × 32 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 9
