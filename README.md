...
![nodes](https://img.shields.io/badge/nodes-125-brightgreen) ![alive](https://img.shields.io/badge/alive-1676-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-402ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_22:28_UTC-informational)
...
- **Nodes selected**: 125
- **Alive across all sources**: 1676
- **Fastest node RTT**: 27 ms
- **Median RTT**: 402 ms
- **Last updated (UTC)**: 2026-06-14 22:28 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 67 · trojan × 26 · vless × 20 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 26 · `mahdibland-shadowsocks` × 22 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 4
