...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1925-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-401ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_03:17_UTC-informational)
...
- **Median RTT**: 401 ms
- **Last updated (UTC)**: 2026-06-26 03:17 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 40 · vless × 27 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `ruking-clash` × 17 · `surfboard-eternity` × 3
