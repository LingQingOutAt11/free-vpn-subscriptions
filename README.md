...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2535-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-101ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-15_17:28_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2535
- **Fastest node RTT**: 32 ms
- **Median RTT**: 101 ms
- **Last updated (UTC)**: 2026-05-15 17:28 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 21 · vless × 83 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 35 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 4 · `ruking-clash` × 5 · `surfboard-eternity` × 5
