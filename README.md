...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2440-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-129ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-13_20:31_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2440
- **Fastest node RTT**: 32 ms
- **Median RTT**: 129 ms
- **Last updated (UTC)**: 2026-05-13 20:31 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 22 · vless × 80 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
