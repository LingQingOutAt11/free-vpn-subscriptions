...
![nodes](https://img.shields.io/badge/nodes-135-brightgreen) ![alive](https://img.shields.io/badge/alive-2063-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-377ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_11:11_UTC-informational)
...
- **Nodes selected**: 135
- **Alive across all sources**: 2063
- **Fastest node RTT**: 28 ms
- **Median RTT**: 377 ms
- **Last updated (UTC)**: 2026-06-21 11:11 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 30 · vless × 44 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 39 · `snakem982` × 1 · `surfboard-eternity` × 3
