...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1968-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-146ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_08:23_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1968
- **Fastest node RTT**: 28 ms
- **Median RTT**: 146 ms
- **Last updated (UTC)**: 2026-05-08 08:23 UTC

**Protocol mix:** shadowsocks × 52 · trojan × 5 · vless × 84 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 68 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 11
