...
![nodes](https://img.shields.io/badge/nodes-76-brightgreen) ![alive](https://img.shields.io/badge/alive-1966-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-277ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-05_14:30_UTC-informational)
...
- **Nodes selected**: 76
- **Alive across all sources**: 1966
- **Fastest node RTT**: 28 ms
- **Median RTT**: 277 ms
- **Last updated (UTC)**: 2026-06-05 14:30 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 31 · vless × 6 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 1
