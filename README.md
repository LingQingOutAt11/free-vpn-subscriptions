...
![nodes](https://img.shields.io/badge/nodes-147-brightgreen) ![alive](https://img.shields.io/badge/alive-2159-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-77ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-26_12:14_UTC-informational)
...
- **Nodes selected**: 147
- **Alive across all sources**: 2159
- **Fastest node RTT**: 26 ms
- **Median RTT**: 77 ms
- **Last updated (UTC)**: 2026-05-26 12:14 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 28 · vless × 71 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 53 · `pawdroid` × 6 · `ruking-clash` × 12 · `surfboard-eternity` × 6
