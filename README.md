...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1939-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-279ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_11:24_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1939
- **Fastest node RTT**: 28 ms
- **Median RTT**: 279 ms
- **Last updated (UTC)**: 2026-05-08 11:24 UTC

**Protocol mix:** shadowsocks × 55 · trojan × 10 · vless × 78 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 9 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
