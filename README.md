...
![nodes](https://img.shields.io/badge/nodes-117-brightgreen) ![alive](https://img.shields.io/badge/alive-2064-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-374ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-24_09:13_UTC-informational)
...
- **Nodes selected**: 117
- **Alive across all sources**: 2064
- **Fastest node RTT**: 36 ms
- **Median RTT**: 374 ms
- **Last updated (UTC)**: 2026-06-24 09:13 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 29 · vless × 37 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 40 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 15 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 4
