...
![nodes](https://img.shields.io/badge/nodes-54-brightgreen) ![alive](https://img.shields.io/badge/alive-1941-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-164ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-27_21:14_UTC-informational)
...
- **Nodes selected**: 54
- **Alive across all sources**: 1941
- **Fastest node RTT**: 34 ms
- **Median RTT**: 164 ms
- **Last updated (UTC)**: 2026-05-27 21:14 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 16 · vless × 7 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 3 · `ninjastrikers` × 5 · `ruking-clash` × 4 · `snakem982` × 3 · `surfboard-eternity` × 2
