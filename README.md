...
![nodes](https://img.shields.io/badge/nodes-98-brightgreen) ![alive](https://img.shields.io/badge/alive-2153-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-173ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_05:24_UTC-informational)
...
- **Nodes selected**: 98
- **Alive across all sources**: 2153
- **Fastest node RTT**: 26 ms
- **Median RTT**: 173 ms
- **Last updated (UTC)**: 2026-06-06 05:24 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 29 · vless × 26 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 21 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 23 · `pawdroid` × 2 · `surfboard-eternity` × 3
