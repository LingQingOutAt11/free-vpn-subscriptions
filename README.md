...
![nodes](https://img.shields.io/badge/nodes-116-brightgreen) ![alive](https://img.shields.io/badge/alive-2084-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-425ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_09:35_UTC-informational)
...
- **Nodes selected**: 116
- **Alive across all sources**: 2084
- **Fastest node RTT**: 29 ms
- **Median RTT**: 425 ms
- **Last updated (UTC)**: 2026-06-23 09:35 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 28 · vless × 43 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 7 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 4
