...
![nodes](https://img.shields.io/badge/nodes-133-brightgreen) ![alive](https://img.shields.io/badge/alive-1884-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-465ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_02:27_UTC-informational)
...
- **Nodes selected**: 133
- **Alive across all sources**: 1884
- **Fastest node RTT**: 27 ms
- **Median RTT**: 465 ms
- **Last updated (UTC)**: 2026-06-18 02:27 UTC

**Protocol mix:** hysteria2 × 4 · shadowsocks × 46 · trojan × 32 · vless × 43 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 25 · `pawdroid` × 3 · `ruking-clash` × 32 · `surfboard-eternity` × 3
