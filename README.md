...
![nodes](https://img.shields.io/badge/nodes-119-brightgreen) ![alive](https://img.shields.io/badge/alive-1814-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-354ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-27_05:19_UTC-informational)
...
- **Nodes selected**: 119
- **Alive across all sources**: 1814
- **Fastest node RTT**: 26 ms
- **Median RTT**: 354 ms
- **Last updated (UTC)**: 2026-06-27 05:19 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 34 · vless × 22 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 1 · `ruking-clash` × 20 · `surfboard-eternity` × 5
