...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2222-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-140ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_00:30_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2222
- **Fastest node RTT**: 38 ms
- **Median RTT**: 140 ms
- **Last updated (UTC)**: 2026-05-06 00:30 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 9 · vless × 94 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 30 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 74 · `pawdroid` × 1 · `surfboard-eternity` × 9
