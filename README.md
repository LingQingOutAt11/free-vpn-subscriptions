...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-2191-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-281ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_05:13_UTC-informational)
...
- **Nodes selected**: 87
- **Alive across all sources**: 2191
- **Fastest node RTT**: 30 ms
- **Median RTT**: 281 ms
- **Last updated (UTC)**: 2026-06-29 05:13 UTC

**Protocol mix:** shadowsocks × 17 · trojan × 29 · vless × 28 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `mfuu-clash` × 11 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 3
