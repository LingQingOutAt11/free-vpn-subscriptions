...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-2321-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-346ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_04:31_UTC-informational)
...
- **Nodes selected**: 106
- **Alive across all sources**: 2321
- **Fastest node RTT**: 33 ms
- **Median RTT**: 346 ms
- **Last updated (UTC)**: 2026-07-01 04:31 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 35 · vless × 23 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 11 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 6 · `mfuu-clash` × 12 · `ninjastrikers` × 25 · `pawdroid` × 3 · `surfboard-eternity` × 3
