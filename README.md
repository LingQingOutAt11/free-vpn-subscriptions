...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-1833-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-385ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-15_20:16_UTC-informational)
...
- **Nodes selected**: 112
- **Alive across all sources**: 1833
- **Fastest node RTT**: 30 ms
- **Median RTT**: 385 ms
- **Last updated (UTC)**: 2026-06-15 20:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 52 · trojan × 24 · vless × 20 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 4
