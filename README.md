...
![nodes](https://img.shields.io/badge/nodes-78-brightgreen) ![alive](https://img.shields.io/badge/alive-2218-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-349ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_08:12_UTC-informational)
...
- **Nodes selected**: 78
- **Alive across all sources**: 2218
- **Fastest node RTT**: 33 ms
- **Median RTT**: 349 ms
- **Last updated (UTC)**: 2026-06-29 08:12 UTC

**Protocol mix:** shadowsocks × 16 · trojan × 28 · vless × 19 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 20 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 7 · `ninjastrikers` × 14 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 4
