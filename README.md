...
![nodes](https://img.shields.io/badge/nodes-75-brightgreen) ![alive](https://img.shields.io/badge/alive-2290-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-192ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_19:27_UTC-informational)
...
- **Nodes selected**: 75
- **Alive across all sources**: 2290
- **Fastest node RTT**: 31 ms
- **Median RTT**: 192 ms
- **Last updated (UTC)**: 2026-06-19 19:27 UTC

**Protocol mix:** shadowsocks × 20 · trojan × 22 · vless × 8 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `ruking-clash` × 16 · `surfboard-eternity` × 1
