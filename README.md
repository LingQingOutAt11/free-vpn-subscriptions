...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-3579-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-634ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-29_19:48_UTC-informational)
...
- **Nodes selected**: 85
- **Alive across all sources**: 3579
- **Fastest node RTT**: 26 ms
- **Median RTT**: 634 ms
- **Last updated (UTC)**: 2026-07-29 19:48 UTC

**Protocol mix:** shadowsocks × 6 · trojan × 34 · vless × 35 · vmess × 10

**Sources used this run:** `autojiedian-clash` × 8 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 22 · `tg-v2ray-configs-every2h` × 12
