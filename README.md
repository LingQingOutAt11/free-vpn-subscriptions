...
![nodes](https://img.shields.io/badge/nodes-86-brightgreen) ![alive](https://img.shields.io/badge/alive-2320-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-227ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_16:24_UTC-informational)
...
- **Nodes selected**: 86
- **Alive across all sources**: 2320
- **Fastest node RTT**: 30 ms
- **Median RTT**: 227 ms
- **Last updated (UTC)**: 2026-06-19 16:24 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 26 · vless × 9 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 14 · `surfboard-eternity` × 5
