...
![nodes](https://img.shields.io/badge/nodes-146-brightgreen) ![alive](https://img.shields.io/badge/alive-2044-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-99ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-21_20:16_UTC-informational)
...
- **Nodes selected**: 146
- **Alive across all sources**: 2044
- **Fastest node RTT**: 30 ms
- **Median RTT**: 99 ms
- **Last updated (UTC)**: 2026-05-21 20:16 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 31 · vless × 70 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 39 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 48 · `pawdroid` × 10 · `snakem982` × 1 · `surfboard-eternity` × 9
