...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1973-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-141ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_01:21_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1973
- **Fastest node RTT**: 29 ms
- **Median RTT**: 141 ms
- **Last updated (UTC)**: 2026-05-12 01:21 UTC

**Protocol mix:** shadowsocks × 59 · trojan × 3 · vless × 78 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 7 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 58 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 12 · `vxiaov-clash` × 1
