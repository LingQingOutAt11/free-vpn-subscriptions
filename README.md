...
![nodes](https://img.shields.io/badge/nodes-124-brightgreen) ![alive](https://img.shields.io/badge/alive-2100-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-85ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-26_18:37_UTC-informational)
...
- **Nodes selected**: 124
- **Alive across all sources**: 2100
- **Fastest node RTT**: 39 ms
- **Median RTT**: 85 ms
- **Last updated (UTC)**: 2026-05-26 18:37 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 20 · vless × 69 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 30 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 49 · `pawdroid` × 4 · `ruking-clash` × 12 · `snakem982` × 1 · `surfboard-eternity` × 2
