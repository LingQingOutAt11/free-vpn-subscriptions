...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-1843-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-356ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-30_17:30_UTC-informational)
...
- **Nodes selected**: 94
- **Alive across all sources**: 1843
- **Fastest node RTT**: 31 ms
- **Median RTT**: 356 ms
- **Last updated (UTC)**: 2026-06-30 17:30 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 34 · vless × 14 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 10 · `ruking-clash` × 12 · `surfboard-eternity` × 2
