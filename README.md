...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2472-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-75ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_07:20_UTC-informational)
...
- **Median RTT**: 75 ms
- **Last updated (UTC)**: 2026-05-25 07:20 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 2 · vless × 84 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 62 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 5
