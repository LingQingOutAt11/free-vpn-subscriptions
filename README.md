...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1946-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-219ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_00:14_UTC-informational)
...
- **Median RTT**: 219 ms
- **Last updated (UTC)**: 2026-06-22 00:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 44 · trojan × 17 · vless × 76 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 37 · `mahdi0024` × 7 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 5 · `ninjastrikers` × 26 · `pawdroid` × 2 · `ruking-clash` × 17 · `snakem982` × 5 · `surfboard-eternity` × 2
