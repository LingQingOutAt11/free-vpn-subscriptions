...
![nodes](https://img.shields.io/badge/nodes-134-brightgreen) ![alive](https://img.shields.io/badge/alive-2385-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-498ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_16:31_UTC-informational)
...
- **Nodes selected**: 134
- **Alive across all sources**: 2385
- **Fastest node RTT**: 33 ms
- **Median RTT**: 498 ms
- **Last updated (UTC)**: 2026-06-18 16:31 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 34 · trojan × 34 · vless × 54 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 29 · `snakem982` × 8 · `surfboard-eternity` × 4
