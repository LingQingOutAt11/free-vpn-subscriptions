...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-1781-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-318ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_08:17_UTC-informational)
...
- **Nodes selected**: 91
- **Alive across all sources**: 1781
- **Fastest node RTT**: 29 ms
- **Median RTT**: 318 ms
- **Last updated (UTC)**: 2026-06-08 08:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 48 · trojan × 17 · vless × 19 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 1 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 21 · `pawdroid` × 5 · `ruking-clash` × 2 · `surfboard-eternity` × 5
