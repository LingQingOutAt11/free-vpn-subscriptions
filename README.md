...
![nodes](https://img.shields.io/badge/nodes-132-brightgreen) ![alive](https://img.shields.io/badge/alive-2132-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-80ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-26_14:30_UTC-informational)
...
- **Median RTT**: 80 ms
- **Last updated (UTC)**: 2026-05-26 14:30 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 24 · vless × 67 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 25 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 8 · `ruking-clash` × 8 · `surfboard-eternity` × 1
