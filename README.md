...
![nodes](https://img.shields.io/badge/nodes-97-brightgreen) ![alive](https://img.shields.io/badge/alive-1844-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-370ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_23:36_UTC-informational)
...
- **Nodes selected**: 97
- **Alive across all sources**: 1844
- **Fastest node RTT**: 31 ms
- **Median RTT**: 370 ms
- **Last updated (UTC)**: 2026-06-08 23:36 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 47 · trojan × 21 · vless × 16 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 2
