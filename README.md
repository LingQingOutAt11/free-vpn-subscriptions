...
![nodes](https://img.shields.io/badge/nodes-113-brightgreen) ![alive](https://img.shields.io/badge/alive-3120-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-303ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-12_19:38_UTC-informational)
...
- **Nodes selected**: 113
- **Alive across all sources**: 3120
- **Fastest node RTT**: 19 ms
- **Median RTT**: 303 ms
- **Last updated (UTC)**: 2026-07-12 19:38 UTC

**Protocol mix:** shadowsocks × 9 · trojan × 22 · vless × 76 · vmess × 6

**Sources used this run:** `epodonios` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 6 · `pawdroid` × 4 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 16 · `solispirit-v2ray` × 52 · `tg-v2ray-configs-every2h` × 12
