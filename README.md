...
![nodes](https://img.shields.io/badge/nodes-80-brightgreen) ![alive](https://img.shields.io/badge/alive-2224-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-540ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_15:13_UTC-informational)
...
- **Nodes selected**: 80
- **Alive across all sources**: 2224
- **Fastest node RTT**: 35 ms
- **Median RTT**: 540 ms
- **Last updated (UTC)**: 2026-06-29 15:13 UTC

**Protocol mix:** shadowsocks × 17 · trojan × 31 · vless × 18 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 3
