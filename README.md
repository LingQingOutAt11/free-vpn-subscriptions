...
![nodes](https://img.shields.io/badge/nodes-121-brightgreen) ![alive](https://img.shields.io/badge/alive-1783-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-371ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_00:34_UTC-informational)
...
- **Nodes selected**: 121
- **Alive across all sources**: 1783
- **Fastest node RTT**: 31 ms
- **Median RTT**: 371 ms
- **Last updated (UTC)**: 2026-06-18 00:34 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 44 · trojan × 32 · vless × 33 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 9 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 25 · `pawdroid` × 1 · `ruking-clash` × 16 · `surfboard-eternity` × 4
