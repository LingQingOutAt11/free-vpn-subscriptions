...
![nodes](https://img.shields.io/badge/nodes-132-brightgreen) ![alive](https://img.shields.io/badge/alive-2091-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-363ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_14:20_UTC-informational)
...
- **Nodes selected**: 132
- **Alive across all sources**: 2091
- **Fastest node RTT**: 27 ms
- **Median RTT**: 363 ms
- **Last updated (UTC)**: 2026-06-20 14:20 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 37 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 34 · `snakem982` × 2 · `surfboard-eternity` × 2
