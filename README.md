...
![nodes](https://img.shields.io/badge/nodes-90-brightgreen) ![alive](https://img.shields.io/badge/alive-1955-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-204ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-04_10:40_UTC-informational)
...
- **Median RTT**: 204 ms
- **Last updated (UTC)**: 2026-06-04 10:40 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 40 · vless × 17 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 30 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 7 · `surfboard-eternity` × 2
