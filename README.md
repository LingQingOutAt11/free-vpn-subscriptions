...
![nodes](https://img.shields.io/badge/nodes-125-brightgreen) ![alive](https://img.shields.io/badge/alive-1723-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-306ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-15_02:19_UTC-informational)
...
- **Nodes selected**: 125
- **Alive across all sources**: 1723
- **Fastest node RTT**: 29 ms
- **Median RTT**: 306 ms
- **Last updated (UTC)**: 2026-06-15 02:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 24 · vless × 38 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 36 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 4
