...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2406-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-114ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-13_22:33_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2406
- **Fastest node RTT**: 29 ms
- **Median RTT**: 114 ms
- **Last updated (UTC)**: 2026-05-13 22:33 UTC

**Protocol mix:** shadowsocks × 48 · trojan × 18 · vless × 75 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 50 · `pawdroid` × 6 · `ruking-clash` × 9 · `snakem982` × 1 · `surfboard-eternity` × 8
