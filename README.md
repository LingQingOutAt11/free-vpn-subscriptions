...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-2330-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-390ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_08:16_UTC-informational)
...
- **Nodes selected**: 104
- **Alive across all sources**: 2330
- **Fastest node RTT**: 33 ms
- **Median RTT**: 390 ms
- **Last updated (UTC)**: 2026-06-12 08:16 UTC

**Protocol mix:** shadowsocks × 45 · trojan × 42 · vless × 12 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 4
