...
![nodes](https://img.shields.io/badge/nodes-116-brightgreen) ![alive](https://img.shields.io/badge/alive-1852-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-360ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_22:24_UTC-informational)
...
- **Nodes selected**: 116
- **Alive across all sources**: 1852
- **Fastest node RTT**: 29 ms
- **Median RTT**: 360 ms
- **Last updated (UTC)**: 2026-06-10 22:24 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 25 · vless × 13 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 26 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 19 · `pawdroid` × 1 · `ruking-clash` × 6 · `surfboard-eternity` × 4
