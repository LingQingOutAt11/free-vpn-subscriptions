...
![nodes](https://img.shields.io/badge/nodes-124-brightgreen) ![alive](https://img.shields.io/badge/alive-1928-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-493ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_05:17_UTC-informational)
...
- **Nodes selected**: 124
- **Alive across all sources**: 1928
- **Fastest node RTT**: 28 ms
- **Median RTT**: 493 ms
- **Last updated (UTC)**: 2026-06-18 05:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 30 · vless × 46 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 17 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 26 · `pawdroid` × 4 · `ruking-clash` × 19 · `snakem982` × 7 · `surfboard-eternity` × 3
