...
![nodes](https://img.shields.io/badge/nodes-78-brightgreen) ![alive](https://img.shields.io/badge/alive-1979-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-236ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_14:13_UTC-informational)
...
- **Median RTT**: 236 ms
- **Last updated (UTC)**: 2026-05-28 14:13 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 21 · vless × 15 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
