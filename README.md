...
![nodes](https://img.shields.io/badge/nodes-138-brightgreen) ![alive](https://img.shields.io/badge/alive-1978-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-427ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_17:22_UTC-informational)
...
- **Nodes selected**: 138
- **Alive across all sources**: 1978
- **Fastest node RTT**: 27 ms
- **Median RTT**: 427 ms
- **Last updated (UTC)**: 2026-06-21 17:22 UTC

**Protocol mix:** shadowsocks × 45 · trojan × 33 · vless × 48 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 17 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 28 · `snakem982` × 6 · `surfboard-eternity` × 4
