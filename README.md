...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1989-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-251ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_21:16_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1989
- **Fastest node RTT**: 31 ms
- **Median RTT**: 251 ms
- **Last updated (UTC)**: 2026-06-16 21:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 46 · trojan × 19 · vless × 13 · vmess × 71

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 75 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `ruking-clash` × 13 · `surfboard-eternity` × 2
