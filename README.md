...
![nodes](https://img.shields.io/badge/nodes-134-brightgreen) ![alive](https://img.shields.io/badge/alive-2084-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-465ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_21:20_UTC-informational)
...
- **Median RTT**: 465 ms
- **Last updated (UTC)**: 2026-06-20 21:20 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 35 · vless × 36 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 13 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 5 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 35 · `snakem982` × 1 · `surfboard-eternity` × 1
