...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2263-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-159ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_10:33_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2263
- **Fastest node RTT**: 29 ms
- **Median RTT**: 159 ms
- **Last updated (UTC)**: 2026-05-05 10:33 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 21 · vless × 84 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 69 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
