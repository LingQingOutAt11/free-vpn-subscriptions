...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2082-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-93ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_00:18_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2082
- **Fastest node RTT**: 28 ms
- **Median RTT**: 93 ms
- **Last updated (UTC)**: 2026-05-04 00:18 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 3 · vless × 107 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 28 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 69 · `ruking-clash` × 2 · `surfboard-eternity` × 6
