...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2674-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-73ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_07:14_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2674
- **Fastest node RTT**: 31 ms
- **Median RTT**: 73 ms
- **Last updated (UTC)**: 2026-05-18 07:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 6 · vless × 98 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 5 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 61 · `pawdroid` × 6 · `ruking-clash` × 9 · `snakem982` × 1 · `surfboard-eternity` × 8
