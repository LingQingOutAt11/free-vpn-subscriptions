...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2486-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-162ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_12:30_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2486
- **Fastest node RTT**: 28 ms
- **Median RTT**: 162 ms
- **Last updated (UTC)**: 2026-05-10 12:30 UTC

**Protocol mix:** shadowsocks × 49 · trojan × 16 · vless × 77 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 59 · `pawdroid` × 4 · `ruking-clash` × 3 · `snakem982` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
