...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1975-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-141ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_04:25_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1975
- **Fastest node RTT**: 28 ms
- **Median RTT**: 141 ms
- **Last updated (UTC)**: 2026-05-12 04:25 UTC

**Protocol mix:** shadowsocks × 56 · trojan × 5 · vless × 80 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 72 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 10
