...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-3498-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-92ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-07_00:22_UTC-informational)
...
- **Nodes selected**: 109
- **Alive across all sources**: 3498
- **Fastest node RTT**: 9 ms
- **Median RTT**: 92 ms
- **Last updated (UTC)**: 2026-08-07 00:22 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 18 · trojan × 13 · vless × 64 · vmess × 11

**Sources used this run:** `autojiedian-clash` × 7 · `automerge-verified-clash` × 13 · `barry-far-v2ray` × 4 · `epodonios` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `ninjastrikers` × 9 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 8 · `ruking-clash` × 1 · `solispirit-v2ray` × 32 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 11
