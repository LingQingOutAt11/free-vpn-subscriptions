...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-2117-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-316ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_05:20_UTC-informational)
...
- **Nodes selected**: 140
- **Alive across all sources**: 2117
- **Fastest node RTT**: 29 ms
- **Median RTT**: 316 ms
- **Last updated (UTC)**: 2026-06-21 05:20 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 34 · vless × 41 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 4 · `mfuu-clash` × 6 · `ninjastrikers` × 21 · `pawdroid` × 1 · `ruking-clash` × 31 · `snakem982` × 2 · `surfboard-eternity` × 1
