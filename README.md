...
![nodes](https://img.shields.io/badge/nodes-130-brightgreen) ![alive](https://img.shields.io/badge/alive-2081-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-83ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-26_15:31_UTC-informational)
...
- **Nodes selected**: 130
- **Alive across all sources**: 2081
- **Fastest node RTT**: 33 ms
- **Median RTT**: 83 ms
- **Last updated (UTC)**: 2026-05-26 15:31 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 21 · vless × 65 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 53 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 3
