...
![nodes](https://img.shields.io/badge/nodes-76-brightgreen) ![alive](https://img.shields.io/badge/alive-2070-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-208ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_16:39_UTC-informational)
...
- **Nodes selected**: 76
- **Alive across all sources**: 2070
- **Fastest node RTT**: 33 ms
- **Median RTT**: 208 ms
- **Last updated (UTC)**: 2026-06-09 16:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 31 · trojan × 14 · vless × 8 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 9 · `pawdroid` × 5 · `ruking-clash` × 4
