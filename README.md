...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-1964-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-400ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_20:26_UTC-informational)
...
- **Nodes selected**: 140
- **Alive across all sources**: 1964
- **Fastest node RTT**: 27 ms
- **Median RTT**: 400 ms
- **Last updated (UTC)**: 2026-06-21 20:26 UTC

**Protocol mix:** shadowsocks × 48 · trojan × 32 · vless × 46 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 27 · `snakem982` × 9 · `surfboard-eternity` × 6
