...
![nodes](https://img.shields.io/badge/nodes-69-brightgreen) ![alive](https://img.shields.io/badge/alive-3511-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-130ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-06_09:00_UTC-informational)
...
- **Median RTT**: 130 ms
- **Last updated (UTC)**: 2026-08-06 09:00 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 14 · trojan × 12 · vless × 38 · vmess × 3

**Sources used this run:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 8 · `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 2 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 13 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 13
