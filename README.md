...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1946-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-174ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_12:27_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1946
- **Fastest node RTT**: 31 ms
- **Median RTT**: 174 ms
- **Last updated (UTC)**: 2026-05-08 12:27 UTC

**Protocol mix:** shadowsocks × 60 · trojan × 5 · vless × 76 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 3 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 2 · `ninjastrikers` × 69 · `pawdroid` × 2 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
