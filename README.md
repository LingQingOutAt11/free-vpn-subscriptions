...
![nodes](https://img.shields.io/badge/nodes-64-brightgreen) ![alive](https://img.shields.io/badge/alive-2263-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-145ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-30_19:17_UTC-informational)
...
- **Median RTT**: 145 ms
- **Last updated (UTC)**: 2026-05-30 19:17 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 6 · vless × 8 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 3 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 4
