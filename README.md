...
![nodes](https://img.shields.io/badge/nodes-86-brightgreen) ![alive](https://img.shields.io/badge/alive-1882-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-354ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_21:27_UTC-informational)
...
- **Median RTT**: 354 ms
- **Last updated (UTC)**: 2026-06-08 21:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 22 · vless × 9 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `ruking-clash` × 5 · `surfboard-eternity` × 4
