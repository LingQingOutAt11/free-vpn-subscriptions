...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1955-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-100ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-22_01:18_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1955
- **Fastest node RTT**: 33 ms
- **Median RTT**: 100 ms
- **Last updated (UTC)**: 2026-05-22 01:18 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 10 · vless × 79 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 58 · `pawdroid` × 9 · `ruking-clash` × 1 · `surfboard-eternity` × 7
