...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-1664-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-407ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_22:15_UTC-informational)
...
- **Nodes selected**: 115
- **Alive across all sources**: 1664
- **Fastest node RTT**: 32 ms
- **Median RTT**: 407 ms
- **Last updated (UTC)**: 2026-06-13 22:15 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 54 · trojan × 34 · vless × 19 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 23 · `matin-v2ray` × 3 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 16 · `surfboard-eternity` × 3
