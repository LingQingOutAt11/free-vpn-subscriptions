...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2401-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-139ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_21:15_UTC-informational)
...
- **Median RTT**: 139 ms
- **Last updated (UTC)**: 2026-05-12 21:15 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 17 · vless × 84 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 44 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 47 · `snakem982` × 2 · `surfboard-eternity` × 3
