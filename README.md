...
![nodes](https://img.shields.io/badge/nodes-92-brightgreen) ![alive](https://img.shields.io/badge/alive-1893-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-398ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_11:37_UTC-informational)
...
- **Nodes selected**: 92
- **Alive across all sources**: 1893
- **Fastest node RTT**: 33 ms
- **Median RTT**: 398 ms
- **Last updated (UTC)**: 2026-06-26 11:37 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 34 · vless × 17 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 15 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 4
