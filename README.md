...
![nodes](https://img.shields.io/badge/nodes-101-brightgreen) ![alive](https://img.shields.io/badge/alive-2113-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-211ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_21:30_UTC-informational)
...
- **Nodes selected**: 101
- **Alive across all sources**: 2113
- **Fastest node RTT**: 27 ms
- **Median RTT**: 211 ms
- **Last updated (UTC)**: 2026-06-06 21:30 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 21 · vless × 10 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 45 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
