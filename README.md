...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2047-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-71ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-22_11:28_UTC-informational)
...
- **Median RTT**: 71 ms
- **Last updated (UTC)**: 2026-05-22 11:28 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 8 · vless × 90 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 64 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 6
