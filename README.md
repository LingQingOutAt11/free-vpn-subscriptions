...
![nodes](https://img.shields.io/badge/nodes-72-brightgreen) ![alive](https://img.shields.io/badge/alive-3388-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-112ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-01_08:41_UTC-informational)
...
- **Nodes selected**: 72
- **Alive across all sources**: 3388
- **Fastest node RTT**: 9 ms
- **Median RTT**: 112 ms
- **Last updated (UTC)**: 2026-08-01 08:41 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 12 · trojan × 11 · vless × 45 · vmess × 2

**Sources used this run:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 15 · `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `mahdi0024` × 1 · `mahdibland-aggregator` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 5 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 2 · `solispirit-v2ray` × 14 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 11
