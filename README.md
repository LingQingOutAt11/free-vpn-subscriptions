...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-1993-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-234ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_04:12_UTC-informational)
...
- **Nodes selected**: 115
- **Alive across all sources**: 1993
- **Fastest node RTT**: 31 ms
- **Median RTT**: 234 ms
- **Last updated (UTC)**: 2026-06-25 04:12 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 32 · vless × 45 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 36 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 20 · `pawdroid` × 2 · `ruking-clash` × 14 · `surfboard-eternity` × 5
