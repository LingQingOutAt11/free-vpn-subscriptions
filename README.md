...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-2314-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-416ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_09:29_UTC-informational)
...
- **Nodes selected**: 106
- **Alive across all sources**: 2314
- **Fastest node RTT**: 31 ms
- **Median RTT**: 416 ms
- **Last updated (UTC)**: 2026-06-12 09:29 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 44 · vless × 11 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 26 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 12 · `surfboard-eternity` × 6
