...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-2916-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-525ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-11_08:22_UTC-informational)
...
- **Nodes selected**: 115
- **Alive across all sources**: 2916
- **Fastest node RTT**: 14 ms
- **Median RTT**: 525 ms
- **Last updated (UTC)**: 2026-07-11 08:22 UTC

**Protocol mix:** shadowsocks × 3 · trojan × 28 · vless × 73 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 5 · `ninjastrikers` × 13 · `pawdroid` × 4 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 22 · `solispirit-v2ray` × 33 · `tg-v2ray-configs-every2h` × 25
