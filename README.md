...
![nodes](https://img.shields.io/badge/nodes-146-brightgreen) ![alive](https://img.shields.io/badge/alive-2380-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-301ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_11:31_UTC-informational)
...
- **Nodes selected**: 146
- **Alive across all sources**: 2380
- **Fastest node RTT**: 29 ms
- **Median RTT**: 301 ms
- **Last updated (UTC)**: 2026-05-09 11:31 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 18 · vless × 77 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 65 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
