...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2140-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-250ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_10:20_UTC-informational)
...
- **Median RTT**: 250 ms
- **Last updated (UTC)**: 2026-05-06 10:20 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 13 · vless × 86 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 65 · `pawdroid` × 2 · `surfboard-eternity` × 10
