...
![nodes](https://img.shields.io/badge/nodes-86-brightgreen) ![alive](https://img.shields.io/badge/alive-2124-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-174ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_18:39_UTC-informational)
...
- **Nodes selected**: 86
- **Alive across all sources**: 2124
- **Fastest node RTT**: 33 ms
- **Median RTT**: 174 ms
- **Last updated (UTC)**: 2026-06-06 18:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 31 · trojan × 21 · vless × 9 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 8 · `mahdi0024` × 36 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 4
