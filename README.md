...
![nodes](https://img.shields.io/badge/nodes-80-brightgreen) ![alive](https://img.shields.io/badge/alive-4107-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-207ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-21_14:28_UTC-informational)
...
- **Nodes selected**: 80
- **Alive across all sources**: 4107
- **Fastest node RTT**: 49 ms
- **Median RTT**: 207 ms
- **Last updated (UTC)**: 2026-07-21 14:28 UTC

**Protocol mix:** shadowsocks × 5 · trojan × 19 · vless × 52 · vmess × 4

**Sources used this run:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 2 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 7 · `roosterkid-openproxylist` × 7 · `snakem982` × 1 · `solispirit-v2ray` × 32 · `tg-v2ray-configs-every2h` × 15
