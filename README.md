...
![nodes](https://img.shields.io/badge/nodes-62-brightgreen) ![alive](https://img.shields.io/badge/alive-3493-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-110ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-07_13:46_UTC-informational)
...
- **Nodes selected**: 62
- **Alive across all sources**: 3493
- **Fastest node RTT**: 31 ms
- **Median RTT**: 110 ms
- **Last updated (UTC)**: 2026-08-07 13:46 UTC

**Protocol mix:** shadowsocks × 4 · trojan × 14 · vless × 35 · vmess × 9

**Sources used this run:** `automerge-verified-clash` × 12 · `barry-far-v2ray` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 2 · `pawdroid` × 1 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 11 · `tg-v2ray-configs-every2h` × 11
