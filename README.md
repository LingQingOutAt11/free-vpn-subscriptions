...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2161-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-180ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_12:37_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2161
- **Fastest node RTT**: 34 ms
- **Median RTT**: 180 ms
- **Last updated (UTC)**: 2026-05-06 12:37 UTC

**Protocol mix:** shadowsocks × 47 · trojan × 11 · vless × 79 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 60 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7
