...
![nodes](https://img.shields.io/badge/nodes-79-brightgreen) ![alive](https://img.shields.io/badge/alive-3387-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-127ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-31_19:59_UTC-informational)
...
- **Nodes selected**: 79
- **Alive across all sources**: 3387
- **Fastest node RTT**: 43 ms
- **Median RTT**: 127 ms
- **Last updated (UTC)**: 2026-07-31 19:59 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 16 · trojan × 14 · vless × 39 · vmess × 8

**Sources used this run:** `autojiedian-clash` × 9 · `automerge-verified-clash` × 14 · `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 11 · `ruking-clash` × 1 · `solispirit-v2ray` × 15 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 11
