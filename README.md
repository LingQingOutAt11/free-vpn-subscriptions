...
![nodes](https://img.shields.io/badge/nodes-143-brightgreen) ![alive](https://img.shields.io/badge/alive-2347-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-97ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-24_19:26_UTC-informational)
...
- **Nodes selected**: 143
- **Alive across all sources**: 2347
- **Fastest node RTT**: 31 ms
- **Median RTT**: 97 ms
- **Last updated (UTC)**: 2026-05-24 19:26 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 18 · vless × 58 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 44 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 50 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 6
