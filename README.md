...
![nodes](https://img.shields.io/badge/nodes-119-brightgreen) ![alive](https://img.shields.io/badge/alive-2126-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-94ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_16:14_UTC-informational)
...
- **Nodes selected**: 119
- **Alive across all sources**: 2126
- **Fastest node RTT**: 41 ms
- **Median RTT**: 94 ms
- **Last updated (UTC)**: 2026-05-25 16:14 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 17 · vless × 57 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 51 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
