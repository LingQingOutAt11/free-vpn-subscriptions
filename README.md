...
![nodes](https://img.shields.io/badge/nodes-52-brightgreen) ![alive](https://img.shields.io/badge/alive-3736-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-103ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-11_07:43_UTC-informational)
...
- **Nodes selected**: 52
- **Alive across all sources**: 3736
- **Fastest node RTT**: 25 ms
- **Median RTT**: 103 ms
- **Last updated (UTC)**: 2026-08-11 07:43 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 6 · trojan × 9 · vless × 28 · vmess × 8

**Sources used this run:** `automerge-verified-clash` × 9 · `barry-far-v2ray` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 4 · `pawdroid` × 4 · `roosterkid-openproxylist` × 5 · `ruking-clash` × 1 · `solispirit-v2ray` × 13 · `tg-v2ray-configs-every2h` × 2
