...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2260-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-149ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_06:20_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2260
- **Fastest node RTT**: 29 ms
- **Median RTT**: 149 ms
- **Last updated (UTC)**: 2026-05-05 06:20 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 21 · vless × 83 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 78 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
