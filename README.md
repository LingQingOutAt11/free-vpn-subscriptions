...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2079-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-90ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_01:31_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2079
- **Fastest node RTT**: 29 ms
- **Median RTT**: 90 ms
- **Last updated (UTC)**: 2026-05-04 01:31 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 7 · vless × 103 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 72 · `ruking-clash` × 2 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
