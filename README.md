...
![nodes](https://img.shields.io/badge/nodes-138-brightgreen) ![alive](https://img.shields.io/badge/alive-1757-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-463ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_08:37_UTC-informational)
...
- **Nodes selected**: 138
- **Alive across all sources**: 1757
- **Fastest node RTT**: 33 ms
- **Median RTT**: 463 ms
- **Last updated (UTC)**: 2026-06-14 08:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 71 · trojan × 30 · vless × 29 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 8 · `ruking-clash` × 24 · `surfboard-eternity` × 7
