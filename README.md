...
![nodes](https://img.shields.io/badge/nodes-136-brightgreen) ![alive](https://img.shields.io/badge/alive-1595-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-432ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_17:23_UTC-informational)
...
- **Nodes selected**: 136
- **Alive across all sources**: 1595
- **Fastest node RTT**: 28 ms
- **Median RTT**: 432 ms
- **Last updated (UTC)**: 2026-06-14 17:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 74 · trojan × 25 · vless × 22 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 7 · `mahdi0024` × 11 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 6
