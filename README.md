...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1979-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-465ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_22:36_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1979
- **Fastest node RTT**: 31 ms
- **Median RTT**: 465 ms
- **Last updated (UTC)**: 2026-06-22 22:36 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 24 · vless × 70 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 52 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 21 · `snakem982` × 3 · `surfboard-eternity` × 3
