...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-3469-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-530ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-29_09:15_UTC-informational)
...
- **Nodes selected**: 87
- **Alive across all sources**: 3469
- **Fastest node RTT**: 28 ms
- **Median RTT**: 530 ms
- **Last updated (UTC)**: 2026-07-29 09:15 UTC

**Protocol mix:** shadowsocks × 10 · trojan × 35 · vless × 33 · vmess × 9

**Sources used this run:** `autojiedian-clash` × 8 · `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 13 · `pawdroid` × 4 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 5 · `ruking-clash` × 2 · `snakem982` × 5 · `solispirit-v2ray` × 21 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 10
