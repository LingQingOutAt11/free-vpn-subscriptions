...
![nodes](https://img.shields.io/badge/nodes-82-brightgreen) ![alive](https://img.shields.io/badge/alive-3092-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-404ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_20:22_UTC-informational)
...
- **Nodes selected**: 82
- **Alive across all sources**: 3092
- **Fastest node RTT**: 12 ms
- **Median RTT**: 404 ms
- **Last updated (UTC)**: 2026-07-01 20:22 UTC

**Protocol mix:** shadowsocks × 11 · trojan × 28 · vless × 38 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 10 · `solispirit-v2ray` × 26 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 14
