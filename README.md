...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1997-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-147ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_04:14_UTC-informational)
...
- **Median RTT**: 147 ms
- **Last updated (UTC)**: 2026-05-08 04:14 UTC

**Protocol mix:** shadowsocks × 54 · trojan × 6 · vless × 81 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 2 · `ninjastrikers` × 73 · `pawdroid` × 2 · `surfboard-eternity` × 6
