...
![nodes](https://img.shields.io/badge/nodes-117-brightgreen) ![alive](https://img.shields.io/badge/alive-2029-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-285ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_09:38_UTC-informational)
...
- **Nodes selected**: 117
- **Alive across all sources**: 2029
- **Fastest node RTT**: 38 ms
- **Median RTT**: 285 ms
- **Last updated (UTC)**: 2026-06-25 09:38 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 30 · vless × 36 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 32 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 3 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 4
