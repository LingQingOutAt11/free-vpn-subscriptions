...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2581-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-70ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_08:21_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2581
- **Fastest node RTT**: 39 ms
- **Median RTT**: 70 ms
- **Last updated (UTC)**: 2026-05-16 08:21 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 7 · vless × 103 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 33 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 4 · `mfuu-clash` × 2 · `ninjastrikers` × 64 · `pawdroid` × 7 · `ruking-clash` × 6 · `surfboard-eternity` × 4
