...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-2274-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-163ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-30_17:28_UTC-informational)
...
- **Nodes selected**: 85
- **Alive across all sources**: 2274
- **Fastest node RTT**: 34 ms
- **Median RTT**: 163 ms
- **Last updated (UTC)**: 2026-05-30 17:28 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 23 · trojan × 24 · vless × 9 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `mahdi0024` × 24 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 1
