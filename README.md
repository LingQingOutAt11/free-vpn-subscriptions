...
![nodes](https://img.shields.io/badge/nodes-131-brightgreen) ![alive](https://img.shields.io/badge/alive-2528-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-489ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_13:37_UTC-informational)
...
- **Nodes selected**: 131
- **Alive across all sources**: 2528
- **Fastest node RTT**: 34 ms
- **Median RTT**: 489 ms
- **Last updated (UTC)**: 2026-06-19 13:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 33 · trojan × 27 · vless × 51 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 5 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 31 · `snakem982` × 8 · `surfboard-eternity` × 1
