...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-2177-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-174ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_11:38_UTC-informational)
...
- **Nodes selected**: 91
- **Alive across all sources**: 2177
- **Fastest node RTT**: 28 ms
- **Median RTT**: 174 ms
- **Last updated (UTC)**: 2026-06-07 11:38 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 24 · vless × 8 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 42 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
