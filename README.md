...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-2413-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-140ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-01_07:12_UTC-informational)
...
- **Nodes selected**: 94
- **Alive across all sources**: 2413
- **Fastest node RTT**: 31 ms
- **Median RTT**: 140 ms
- **Last updated (UTC)**: 2026-06-01 07:12 UTC

**Protocol mix:** shadowsocks × 19 · trojan × 26 · vless × 15 · vmess × 34

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 19 · `pawdroid` × 1 · `surfboard-eternity` × 1
