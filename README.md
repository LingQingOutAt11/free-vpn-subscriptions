...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1937-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-258ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_20:18_UTC-informational)
...
- **Median RTT**: 258 ms
- **Last updated (UTC)**: 2026-05-07 20:18 UTC

**Protocol mix:** shadowsocks × 59 · trojan × 11 · vless × 71 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 53 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
