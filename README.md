...
![nodes](https://img.shields.io/badge/nodes-102-brightgreen) ![alive](https://img.shields.io/badge/alive-2205-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-147ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_00:37_UTC-informational)
...
- **Nodes selected**: 102
- **Alive across all sources**: 2205
- **Fastest node RTT**: 22 ms
- **Median RTT**: 147 ms
- **Last updated (UTC)**: 2026-06-07 00:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 29 · trojan × 21 · vless × 27 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 37 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 30 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
