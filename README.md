...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2550-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-75ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-20_14:36_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2550
- **Fastest node RTT**: 37 ms
- **Median RTT**: 75 ms
- **Last updated (UTC)**: 2026-05-20 14:36 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 21 · vless × 69 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 5 · `ruking-clash` × 1 · `surfboard-eternity` × 7
