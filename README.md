...
![nodes](https://img.shields.io/badge/nodes-125-brightgreen) ![alive](https://img.shields.io/badge/alive-2291-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-78ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_17:27_UTC-informational)
...
- **Nodes selected**: 125
- **Alive across all sources**: 2291
- **Fastest node RTT**: 30 ms
- **Median RTT**: 78 ms
- **Last updated (UTC)**: 2026-05-18 17:27 UTC

**Protocol mix:** shadowsocks × 14 · trojan × 25 · vless × 67 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 53 · `pawdroid` × 10 · `ruking-clash` × 3 · `surfboard-eternity` × 5
