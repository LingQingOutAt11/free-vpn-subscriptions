...
![nodes](https://img.shields.io/badge/nodes-118-brightgreen) ![alive](https://img.shields.io/badge/alive-4423-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-169ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_13:54_UTC-informational)
...
- **Nodes selected**: 118
- **Alive across all sources**: 4423
- **Fastest node RTT**: 42 ms
- **Median RTT**: 169 ms
- **Last updated (UTC)**: 2026-07-18 13:54 UTC

**Protocol mix:** shadowsocks × 15 · trojan × 26 · vless × 65 · vmess × 12

**Sources used this run:** `autojiedian-clash` × 9 · `automerge-verified-clash` × 11 · `barry-far-v2ray` × 1 · `epodonios` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 12 · `roosterkid-openproxylist` × 3 · `solispirit-v2ray` × 40 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 17
