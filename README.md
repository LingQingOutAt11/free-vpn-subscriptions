...
![nodes](https://img.shields.io/badge/nodes-139-brightgreen) ![alive](https://img.shields.io/badge/alive-1996-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-440ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_16:17_UTC-informational)
...
- **Nodes selected**: 139
- **Alive across all sources**: 1996
- **Fastest node RTT**: 28 ms
- **Median RTT**: 440 ms
- **Last updated (UTC)**: 2026-06-21 16:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 47 · trojan × 27 · vless × 52 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 19 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 35 · `snakem982` × 4 · `surfboard-eternity` × 4
