...
![nodes](https://img.shields.io/badge/nodes-110-brightgreen) ![alive](https://img.shields.io/badge/alive-1880-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-102ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-05_01:13_UTC-informational)
...
- **Nodes selected**: 110
- **Alive across all sources**: 1880
- **Fastest node RTT**: 29 ms
- **Median RTT**: 102 ms
- **Last updated (UTC)**: 2026-06-05 01:13 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 32 · vless × 39 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 28 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 31 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
