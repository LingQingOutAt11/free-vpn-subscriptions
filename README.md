...
![nodes](https://img.shields.io/badge/nodes-95-brightgreen) ![alive](https://img.shields.io/badge/alive-3156-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-511ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-10_04:20_UTC-informational)
...
- **Nodes selected**: 95
- **Alive across all sources**: 3156
- **Fastest node RTT**: 24 ms
- **Median RTT**: 511 ms
- **Last updated (UTC)**: 2026-07-10 04:20 UTC

**Protocol mix:** shadowsocks × 3 · trojan × 25 · vless × 54 · vmess × 13

**Sources used this run:** `mahdi0024` × 7 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 31 · `tg-v2ray-configs-every2h` × 20
