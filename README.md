...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2170-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-90ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-26_02:32_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2170
- **Fastest node RTT**: 33 ms
- **Median RTT**: 90 ms
- **Last updated (UTC)**: 2026-05-26 02:32 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 16 · vless × 89 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 70 · `pawdroid` × 5 · `ruking-clash` × 14 · `snakem982` × 1 · `surfboard-eternity` × 2 · `vxiaov-clash` × 1
