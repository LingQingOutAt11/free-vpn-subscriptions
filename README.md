...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-1970-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-278ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_20:12_UTC-informational)
...
- **Median RTT**: 278 ms
- **Last updated (UTC)**: 2026-06-09 20:12 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 19 · vless × 11 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 8 · `surfboard-eternity` × 6
