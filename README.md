...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2467-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-102ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_05:38_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2467
- **Fastest node RTT**: 24 ms
- **Median RTT**: 102 ms
- **Last updated (UTC)**: 2026-05-10 05:38 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 3 · vless × 93 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 13 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 68 · `pawdroid` × 3 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
