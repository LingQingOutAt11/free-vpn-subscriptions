...
![nodes](https://img.shields.io/badge/nodes-146-brightgreen) ![alive](https://img.shields.io/badge/alive-2251-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-293ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_20:19_UTC-informational)
...
- **Nodes selected**: 146
- **Alive across all sources**: 2251
- **Fastest node RTT**: 37 ms
- **Median RTT**: 293 ms
- **Last updated (UTC)**: 2026-05-04 20:19 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 26 · vless × 73 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 60 · `ruking-clash` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
