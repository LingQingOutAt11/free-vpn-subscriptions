...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1983-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-389ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-24_01:18_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1983
- **Fastest node RTT**: 31 ms
- **Median RTT**: 389 ms
- **Last updated (UTC)**: 2026-06-24 01:18 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 39 · trojan × 31 · vless × 63 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 49 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 3 · `ninjastrikers` × 27 · `pawdroid` × 6 · `ruking-clash` × 16 · `surfboard-eternity` × 3
