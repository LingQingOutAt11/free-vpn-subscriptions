...
![nodes](https://img.shields.io/badge/nodes-103-brightgreen) ![alive](https://img.shields.io/badge/alive-1923-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-484ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_10:21_UTC-informational)
...
- **Median RTT**: 484 ms
- **Last updated (UTC)**: 2026-06-26 10:21 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 39 · vless × 19 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 21 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
