...
![nodes](https://img.shields.io/badge/nodes-124-brightgreen) ![alive](https://img.shields.io/badge/alive-2042-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-411ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_14:21_UTC-informational)
...
- **Nodes selected**: 124
- **Alive across all sources**: 2042
- **Fastest node RTT**: 31 ms
- **Median RTT**: 411 ms
- **Last updated (UTC)**: 2026-06-23 14:21 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 29 · vless × 43 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `mfuu-clash` × 8 · `ninjastrikers` × 14 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 6
