...
![nodes](https://img.shields.io/badge/nodes-132-brightgreen) ![alive](https://img.shields.io/badge/alive-2021-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-445ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_20:13_UTC-informational)
...
- **Nodes selected**: 132
- **Alive across all sources**: 2021
- **Fastest node RTT**: 30 ms
- **Median RTT**: 445 ms
- **Last updated (UTC)**: 2026-06-23 20:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 31 · vless × 48 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
