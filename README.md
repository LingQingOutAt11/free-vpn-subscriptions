...
![nodes](https://img.shields.io/badge/nodes-116-brightgreen) ![alive](https://img.shields.io/badge/alive-1776-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-416ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_21:29_UTC-informational)
...
- **Nodes selected**: 116
- **Alive across all sources**: 1776
- **Fastest node RTT**: 33 ms
- **Median RTT**: 416 ms
- **Last updated (UTC)**: 2026-06-17 21:29 UTC

**Protocol mix:** hysteria2 × 6 · shadowsocks × 47 · trojan × 30 · vless × 25 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 5 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 24 · `surfboard-eternity` × 6
