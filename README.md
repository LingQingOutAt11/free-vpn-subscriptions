...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-3523-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-137ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-09_02:36_UTC-informational)
...
- **Nodes selected**: 105
- **Alive across all sources**: 3523
- **Fastest node RTT**: 32 ms
- **Median RTT**: 137 ms
- **Last updated (UTC)**: 2026-08-09 02:36 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 23 · trojan × 16 · vless × 50 · vmess × 13

**Sources used this run:** `autojiedian-clash` × 8 · `automerge-verified-clash` × 18 · `barry-far-v2ray` × 3 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 7 · `pawdroid` × 4 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `solispirit-v2ray` × 15 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 3
