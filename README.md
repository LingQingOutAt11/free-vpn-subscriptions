...
![nodes](https://img.shields.io/badge/nodes-117-brightgreen) ![alive](https://img.shields.io/badge/alive-1875-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-445ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_23:32_UTC-informational)
...
- **Nodes selected**: 117
- **Alive across all sources**: 1875
- **Fastest node RTT**: 33 ms
- **Median RTT**: 445 ms
- **Last updated (UTC)**: 2026-06-25 23:32 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 41 · vless × 27 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 29 · `lagzian-mix` × 6 · `mahdi0024` × 9 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 3
