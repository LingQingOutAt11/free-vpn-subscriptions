...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-2805-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-320ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_10:08_UTC-informational)
...
- **Nodes selected**: 128
- **Alive across all sources**: 2805
- **Fastest node RTT**: 22 ms
- **Median RTT**: 320 ms
- **Last updated (UTC)**: 2026-07-07 10:08 UTC

**Protocol mix:** shadowsocks × 14 · trojan × 34 · vless × 69 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 6 · `ninjastrikers` × 11 · `pawdroid` × 5 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 12 · `ruking-clash` × 1 · `solispirit-v2ray` × 44 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 19
