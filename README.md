...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2520-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-79ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_14:17_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2520
- **Fastest node RTT**: 30 ms
- **Median RTT**: 79 ms
- **Last updated (UTC)**: 2026-05-16 14:17 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 13 · vless × 93 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 21 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 33 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 56 · `pawdroid` × 7 · `ruking-clash` × 4 · `surfboard-eternity` × 6
