...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2430-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-114ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_06:15_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2430
- **Fastest node RTT**: 28 ms
- **Median RTT**: 114 ms
- **Last updated (UTC)**: 2026-05-09 06:15 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 20 · vless × 86 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 3 · `ninjastrikers` × 75 · `pawdroid` × 2 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
