...
![nodes](https://img.shields.io/badge/nodes-92-brightgreen) ![alive](https://img.shields.io/badge/alive-1972-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-424ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_11:17_UTC-informational)
...
- **Median RTT**: 424 ms
- **Last updated (UTC)**: 2026-06-18 11:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 32 · trojan × 34 · vless × 17 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 1
