...
![nodes](https://img.shields.io/badge/nodes-144-brightgreen) ![alive](https://img.shields.io/badge/alive-2502-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-148ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_21:28_UTC-informational)
...
- **Nodes selected**: 144
- **Alive across all sources**: 2502
- **Fastest node RTT**: 29 ms
- **Median RTT**: 148 ms
- **Last updated (UTC)**: 2026-05-09 21:28 UTC

**Protocol mix:** shadowsocks × 50 · trojan × 19 · vless × 66 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 14 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 2
