...
![nodes](https://img.shields.io/badge/nodes-143-brightgreen) ![alive](https://img.shields.io/badge/alive-2440-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-77ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_14:25_UTC-informational)
...
- **Median RTT**: 77 ms
- **Last updated (UTC)**: 2026-05-19 14:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 20 · trojan × 22 · vless × 79 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 8 · `snakem982` × 1 · `surfboard-eternity` × 6
