...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-2321-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-359ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_07:33_UTC-informational)
...
- **Median RTT**: 359 ms
- **Last updated (UTC)**: 2026-07-01 07:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 38 · vless × 22 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 6 · `mfuu-clash` × 12 · `ninjastrikers` × 25 · `pawdroid` × 6 · `surfboard-eternity` × 4
