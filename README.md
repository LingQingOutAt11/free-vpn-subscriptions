...
![nodes](https://img.shields.io/badge/nodes-78-brightgreen) ![alive](https://img.shields.io/badge/alive-1825-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-161ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_18:14_UTC-informational)
...
- **Nodes selected**: 78
- **Alive across all sources**: 1825
- **Fastest node RTT**: 32 ms
- **Median RTT**: 161 ms
- **Last updated (UTC)**: 2026-06-28 18:14 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 16 · vless × 21 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `surfboard-eternity` × 2
