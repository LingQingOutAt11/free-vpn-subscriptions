...
![nodes](https://img.shields.io/badge/nodes-83-brightgreen) ![alive](https://img.shields.io/badge/alive-3596-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-120ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-09_07:23_UTC-informational)
...
- **Nodes selected**: 83
- **Alive across all sources**: 3596
- **Fastest node RTT**: 20 ms
- **Median RTT**: 120 ms
- **Last updated (UTC)**: 2026-08-09 07:23 UTC

**Protocol mix:** shadowsocks × 7 · trojan × 21 · vless × 42 · vmess × 13

**Sources used this run:** `autojiedian-clash` × 7 · `automerge-verified-clash` × 12 · `epodonios` × 4 · `mahdi0024` × 14 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 6 · `pawdroid` × 4 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 8 · `snakem982` × 2 · `solispirit-v2ray` × 15 · `tg-v2ray-configs-every2h` × 2
