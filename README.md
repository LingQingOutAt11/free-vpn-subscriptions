...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-1829-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-311ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_16:34_UTC-informational)
...
- **Nodes selected**: 85
- **Alive across all sources**: 1829
- **Fastest node RTT**: 26 ms
- **Median RTT**: 311 ms
- **Last updated (UTC)**: 2026-06-08 16:34 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 22 · vless × 13 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 19 · `ninjastrikers` × 13 · `pawdroid` × 6 · `ruking-clash` × 6 · `surfboard-eternity` × 6
