...
![nodes](https://img.shields.io/badge/nodes-48-brightgreen) ![alive](https://img.shields.io/badge/alive-3895-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-431ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-28_19:58_UTC-informational)
...
- **Nodes selected**: 48
- **Alive across all sources**: 3895
- **Fastest node RTT**: 18 ms
- **Median RTT**: 431 ms
- **Last updated (UTC)**: 2026-07-28 19:58 UTC

**Protocol mix:** shadowsocks × 6 · trojan × 21 · vless × 20 · vmess × 1

**Sources used this run:** `autojiedian-clash` × 7 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `go4sharing-clash` × 1 · `mahdibland-aggregator` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 15 · `tg-v2ray-configs-every2h` × 6
