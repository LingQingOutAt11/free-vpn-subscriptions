...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2348-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-131ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-13_14:10_UTC-informational)
...
- **Median RTT**: 131 ms
- **Last updated (UTC)**: 2026-05-13 14:10 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 20 · vless × 81 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 44 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 55 · `pawdroid` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 2
