...
![nodes](https://img.shields.io/badge/nodes-90-brightgreen) ![alive](https://img.shields.io/badge/alive-2185-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-217ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_14:13_UTC-informational)
...
- **Nodes selected**: 90
- **Alive across all sources**: 2185
- **Fastest node RTT**: 30 ms
- **Median RTT**: 217 ms
- **Last updated (UTC)**: 2026-06-06 14:13 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 33 · vless × 5 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 33 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `surfboard-eternity` × 3
