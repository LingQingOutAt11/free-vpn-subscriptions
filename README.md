...
![nodes](https://img.shields.io/badge/nodes-117-brightgreen) ![alive](https://img.shields.io/badge/alive-4306-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-96ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-18_19:37_UTC-informational)
...
- **Nodes selected**: 117
- **Alive across all sources**: 4306
- **Fastest node RTT**: 27 ms
- **Median RTT**: 96 ms
- **Last updated (UTC)**: 2026-07-18 19:37 UTC

**Protocol mix:** shadowsocks × 17 · trojan × 17 · vless × 77 · vmess × 6

**Sources used this run:** `autojiedian-clash` × 6 · `automerge-verified-clash` × 11 · `epodonios` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 4 · `ninjastrikers` × 8 · `pawdroid` × 7 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 45 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 20
