...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1970-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-465ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_20:14_UTC-informational)
...
- **Median RTT**: 465 ms
- **Last updated (UTC)**: 2026-06-22 20:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 20 · vless × 76 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 51 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 33 · `snakem982` × 1 · `surfboard-eternity` × 2
