...
![nodes](https://img.shields.io/badge/nodes-125-brightgreen) ![alive](https://img.shields.io/badge/alive-1937-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-340ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_00:32_UTC-informational)
...
- **Median RTT**: 340 ms
- **Last updated (UTC)**: 2026-06-17 00:32 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 51 · trojan × 31 · vless × 29 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 26 · `ruking-clash` × 17 · `surfboard-eternity` × 4
