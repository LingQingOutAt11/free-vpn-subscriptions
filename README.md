...
![nodes](https://img.shields.io/badge/nodes-81-brightgreen) ![alive](https://img.shields.io/badge/alive-2283-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-183ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_18:19_UTC-informational)
...
- **Median RTT**: 183 ms
- **Last updated (UTC)**: 2026-06-19 18:19 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 24 · vless × 10 · vmess × 26

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 2
