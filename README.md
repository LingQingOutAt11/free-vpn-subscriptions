...
![nodes](https://img.shields.io/badge/nodes-70-brightgreen) ![alive](https://img.shields.io/badge/alive-3764-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-517ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-19_19:37_UTC-informational)
...
- **Nodes selected**: 70
- **Alive across all sources**: 3764
- **Fastest node RTT**: 21 ms
- **Median RTT**: 517 ms
- **Last updated (UTC)**: 2026-07-19 19:37 UTC

**Protocol mix:** trojan × 14 · vless × 50 · vmess × 6

**Sources used this run:** `autojiedian-clash` × 4 · `barry-far-v2ray` × 1 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 7 · `ninjastrikers` × 3 · `pawdroid` × 2 · `roosterkid-openproxylist` × 1 · `solispirit-v2ray` × 36 · `tg-v2ray-configs-every2h` × 12
