...
![nodes](https://img.shields.io/badge/nodes-110-brightgreen) ![alive](https://img.shields.io/badge/alive-1853-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-266ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-09_00:31_UTC-informational)
...
- **Median RTT**: 266 ms
- **Last updated (UTC)**: 2026-06-09 00:31 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 46 · trojan × 20 · vless × 34 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 35 · `pawdroid` × 3 · `ruking-clash` × 6 · `surfboard-eternity` × 1
