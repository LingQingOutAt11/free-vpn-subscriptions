...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2489-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-214ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_23:22_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2489
- **Fastest node RTT**: 27 ms
- **Median RTT**: 214 ms
- **Last updated (UTC)**: 2026-05-09 23:22 UTC

**Protocol mix:** shadowsocks × 52 · trojan × 18 · vless × 72 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 41 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 3 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
