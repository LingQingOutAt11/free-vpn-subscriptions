...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2609-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-70ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-20_11:37_UTC-informational)
...
- **Median RTT**: 70 ms
- **Last updated (UTC)**: 2026-05-20 11:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 11 · vless × 83 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 9 · `surfboard-eternity` × 9
