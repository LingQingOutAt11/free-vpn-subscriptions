...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2043-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-335ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_20:17_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2043
- **Fastest node RTT**: 37 ms
- **Median RTT**: 335 ms
- **Last updated (UTC)**: 2026-05-06 20:17 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 21 · vless × 70 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 63 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
