...
![nodes](https://img.shields.io/badge/nodes-80-brightgreen) ![alive](https://img.shields.io/badge/alive-3958-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-107ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-24_14:18_UTC-informational)
...
- **Nodes selected**: 80
- **Alive across all sources**: 3958
- **Fastest node RTT**: 31 ms
- **Median RTT**: 107 ms
- **Last updated (UTC)**: 2026-07-24 14:18 UTC

**Protocol mix:** shadowsocks × 3 · trojan × 16 · vless × 57 · vmess × 4

**Sources used this run:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `roosterkid-openproxylist` × 1 · `snakem982` × 2 · `solispirit-v2ray` × 31 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 25
