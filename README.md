...
![nodes](https://img.shields.io/badge/nodes-52-brightgreen) ![alive](https://img.shields.io/badge/alive-2203-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-104ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-29_16:27_UTC-informational)
...
- **Nodes selected**: 52
- **Alive across all sources**: 2203
- **Fastest node RTT**: 33 ms
- **Median RTT**: 104 ms
- **Last updated (UTC)**: 2026-05-29 16:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 12 · trojan × 10 · vless × 4 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 4
