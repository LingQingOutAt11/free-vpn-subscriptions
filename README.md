...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2353-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-73ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-23_10:21_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2353
- **Fastest node RTT**: 35 ms
- **Median RTT**: 73 ms
- **Last updated (UTC)**: 2026-05-23 10:21 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 7 · vless × 95 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 22 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 62 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 3 · `vxiaov-clash` × 2
