...
![nodes](https://img.shields.io/badge/nodes-79-brightgreen) ![alive](https://img.shields.io/badge/alive-2404-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-331ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_22:17_UTC-informational)
...
- **Nodes selected**: 79
- **Alive across all sources**: 2404
- **Fastest node RTT**: 27 ms
- **Median RTT**: 331 ms
- **Last updated (UTC)**: 2026-06-11 22:17 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 20 · vless × 12 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 7 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 4
