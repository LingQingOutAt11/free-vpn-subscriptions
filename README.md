...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-2242-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-163ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-29_22:13_UTC-informational)
...
- **Nodes selected**: 87
- **Alive across all sources**: 2242
- **Fastest node RTT**: 33 ms
- **Median RTT**: 163 ms
- **Last updated (UTC)**: 2026-05-29 22:13 UTC

**Protocol mix:** shadowsocks × 20 · trojan × 36 · vless × 6 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 3
