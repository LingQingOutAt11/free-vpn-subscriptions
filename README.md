...
![nodes](https://img.shields.io/badge/nodes-101-brightgreen) ![alive](https://img.shields.io/badge/alive-3130-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-252ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-02_04:29_UTC-informational)
...
- **Nodes selected**: 101
- **Alive across all sources**: 3130
- **Fastest node RTT**: 20 ms
- **Median RTT**: 252 ms
- **Last updated (UTC)**: 2026-07-02 04:29 UTC

**Protocol mix:** shadowsocks × 3 · trojan × 38 · vless × 56 · vmess × 4

**Sources used this run:** `barry-far-v2ray` × 1 · `epodonios` × 7 · `mahdi0024` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 5 · `ninjastrikers` × 14 · `pawdroid` × 4 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 10 · `solispirit-v2ray` × 37 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 16
