...
![nodes](https://img.shields.io/badge/nodes-127-brightgreen) ![alive](https://img.shields.io/badge/alive-2120-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_18:30_UTC-informational)
...
- **Nodes selected**: 127
- **Alive across all sources**: 2120
- **Fastest node RTT**: 34 ms
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-05-25 18:30 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 23 · vless × 58 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 4 · `ruking-clash` × 8 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
