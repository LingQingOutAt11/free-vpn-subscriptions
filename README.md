...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1948-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-120ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_01:24_UTC-informational)
...
- **Median RTT**: 120 ms
- **Last updated (UTC)**: 2026-05-08 01:24 UTC

**Protocol mix:** shadowsocks × 53 · trojan × 5 · vless × 85 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 28 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 69 · `snakem982` × 1 · `surfboard-eternity` × 9
