...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2502-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-98ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_03:19_UTC-informational)
...
- **Median RTT**: 98 ms
- **Last updated (UTC)**: 2026-05-10 03:19 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 3 · vless × 94 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 15 · `mahdibland-aggregator` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 72 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 4
