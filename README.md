...
![nodes](https://img.shields.io/badge/nodes-113-brightgreen) ![alive](https://img.shields.io/badge/alive-2083-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-367ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-24_15:37_UTC-informational)
...
- **Nodes selected**: 113
- **Alive across all sources**: 2083
- **Fastest node RTT**: 28 ms
- **Median RTT**: 367 ms
- **Last updated (UTC)**: 2026-06-24 15:37 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 34 · vless × 28 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 36 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 5
