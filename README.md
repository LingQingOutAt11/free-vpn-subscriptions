...
![nodes](https://img.shields.io/badge/nodes-66-brightgreen) ![alive](https://img.shields.io/badge/alive-2240-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-133ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-29_19:21_UTC-informational)
...
- **Nodes selected**: 66
- **Alive across all sources**: 2240
- **Fastest node RTT**: 34 ms
- **Median RTT**: 133 ms
- **Last updated (UTC)**: 2026-05-29 19:21 UTC

**Protocol mix:** shadowsocks × 12 · trojan × 27 · vless × 4 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
