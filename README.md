...
![nodes](https://img.shields.io/badge/nodes-147-brightgreen) ![alive](https://img.shields.io/badge/alive-2369-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-22_22:25_UTC-informational)
...
- **Nodes selected**: 147
- **Alive across all sources**: 2369
- **Fastest node RTT**: 22 ms
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-05-22 22:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 26 · vless × 74 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 20 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 56 · `pawdroid` × 5 · `ruking-clash` × 3 · `surfboard-eternity` × 5
