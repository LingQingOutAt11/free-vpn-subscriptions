...
![nodes](https://img.shields.io/badge/nodes-147-brightgreen) ![alive](https://img.shields.io/badge/alive-2334-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-374ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_20:26_UTC-informational)
...
- **Median RTT**: 374 ms
- **Last updated (UTC)**: 2026-05-08 20:26 UTC

**Protocol mix:** shadowsocks × 50 · trojan × 22 · vless × 65 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 3 · `ninjastrikers` × 61 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7
