...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-3535-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-219ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-08_13:20_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 3535
- **Fastest node RTT**: 24 ms
- **Median RTT**: 219 ms
- **Last updated (UTC)**: 2026-08-08 13:20 UTC

**Protocol mix:** hysteria2 × 5 · shadowsocks × 33 · trojan × 31 · vless × 58 · vmess × 23

**Sources used this run:** `autojiedian-clash` × 5 · `automerge-verified-clash` × 29 · `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 47 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 10 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 10 · `ruking-clash` × 2 · `snakem982` × 3 · `solispirit-v2ray` × 7 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 5
