...
![nodes](https://img.shields.io/badge/nodes-72-brightgreen) ![alive](https://img.shields.io/badge/alive-2170-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-173ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-05_17:33_UTC-informational)
...
- **Median RTT**: 173 ms
- **Last updated (UTC)**: 2026-06-05 17:33 UTC

**Protocol mix:** shadowsocks × 20 · trojan × 21 · vless × 14 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 21 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 3
