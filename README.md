...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2125-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-172ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_02:24_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2125
- **Fastest node RTT**: 30 ms
- **Median RTT**: 172 ms
- **Last updated (UTC)**: 2026-06-21 02:24 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 27 · vless × 63 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 39 · `lagzian-mix` × 1 · `mahdi0024` × 28 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 6 · `ninjastrikers` × 21 · `pawdroid` × 4 · `ruking-clash` × 22 · `surfboard-eternity` × 3
