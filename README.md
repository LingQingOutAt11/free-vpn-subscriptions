...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2005-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-101ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_09:33_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2005
- **Fastest node RTT**: 29 ms
- **Median RTT**: 101 ms
- **Last updated (UTC)**: 2026-05-04 09:33 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 7 · vless × 100 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 63 · `pawdroid` × 3 · `surfboard-eternity` × 5
