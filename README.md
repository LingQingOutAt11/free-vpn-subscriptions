...
![nodes](https://img.shields.io/badge/nodes-79-brightgreen) ![alive](https://img.shields.io/badge/alive-2226-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-427ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_14:33_UTC-informational)
...
- **Nodes selected**: 79
- **Alive across all sources**: 2226
- **Fastest node RTT**: 27 ms
- **Median RTT**: 427 ms
- **Last updated (UTC)**: 2026-06-29 14:33 UTC

**Protocol mix:** shadowsocks × 15 · trojan × 32 · vless × 18 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 19 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 4
