...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-4104-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-173ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-28_08:59_UTC-informational)
...
- **Nodes selected**: 91
- **Alive across all sources**: 4104
- **Fastest node RTT**: 41 ms
- **Median RTT**: 173 ms
- **Last updated (UTC)**: 2026-07-28 08:59 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 27 · trojan × 21 · vless × 37 · vmess × 5

**Sources used this run:** `autojiedian-clash` × 5 · `automerge-verified-clash` × 14 · `barry-far-v2ray` × 1 · `ebrasha-v2ray` × 1 · `epodonios` × 2 · `go4sharing-clash` × 1 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 9 · `pawdroid` × 3 · `roosterkid-openproxylist` × 10 · `snakem982` × 1 · `solispirit-v2ray` × 25 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 5
