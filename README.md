...
![nodes](https://img.shields.io/badge/nodes-142-brightgreen) ![alive](https://img.shields.io/badge/alive-2214-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-164ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_14:14_UTC-informational)
...
- **Nodes selected**: 142
- **Alive across all sources**: 2214
- **Fastest node RTT**: 28 ms
- **Median RTT**: 164 ms
- **Last updated (UTC)**: 2026-05-04 14:14 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 23 · vless × 71 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 62 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
