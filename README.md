...
![nodes](https://img.shields.io/badge/nodes-103-brightgreen) ![alive](https://img.shields.io/badge/alive-1868-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-239ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_02:33_UTC-informational)
...
- **Nodes selected**: 103
- **Alive across all sources**: 1868
- **Fastest node RTT**: 29 ms
- **Median RTT**: 239 ms
- **Last updated (UTC)**: 2026-06-08 02:33 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 21 · vless × 29 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 1 · `ninjastrikers` × 32 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
