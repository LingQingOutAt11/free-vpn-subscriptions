...
![nodes](https://img.shields.io/badge/nodes-80-brightgreen) ![alive](https://img.shields.io/badge/alive-3556-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-136ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-11_19:27_UTC-informational)
...
- **Nodes selected**: 80
- **Alive across all sources**: 3556
- **Fastest node RTT**: 35 ms
- **Median RTT**: 136 ms
- **Last updated (UTC)**: 2026-08-11 19:27 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 22 · trojan × 7 · vless × 36 · vmess × 12

**Sources used this run:** `autojiedian-clash` × 15 · `automerge-verified-clash` × 14 · `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 2 · `solispirit-v2ray` × 2 · `tg-v2ray-configs-every2h` × 12
