...
![nodes](https://img.shields.io/badge/nodes-143-brightgreen) ![alive](https://img.shields.io/badge/alive-2200-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-306ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_23:24_UTC-informational)
...
- **Nodes selected**: 143
- **Alive across all sources**: 2200
- **Fastest node RTT**: 34 ms
- **Median RTT**: 306 ms
- **Last updated (UTC)**: 2026-05-05 23:24 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 27 · vless × 68 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 55 · `pawdroid` × 4 · `surfboard-eternity` × 6
