...
![nodes](https://img.shields.io/badge/nodes-88-brightgreen) ![alive](https://img.shields.io/badge/alive-2318-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-250ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_23:18_UTC-informational)
...
- **Median RTT**: 250 ms
- **Last updated (UTC)**: 2026-06-19 23:18 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 25 · vless × 9 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 10 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 4
