...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1922-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-285ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_21:32_UTC-informational)
...
- **Median RTT**: 285 ms
- **Last updated (UTC)**: 2026-05-07 21:32 UTC

**Protocol mix:** shadowsocks × 54 · trojan × 14 · vless × 74 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 33 · `epodonios` × 9 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 55 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
