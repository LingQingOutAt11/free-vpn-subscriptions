...
![nodes](https://img.shields.io/badge/nodes-83-brightgreen) ![alive](https://img.shields.io/badge/alive-2121-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-274ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-06_11:36_UTC-informational)
...
- **Nodes selected**: 83
- **Alive across all sources**: 2121
- **Fastest node RTT**: 34 ms
- **Median RTT**: 274 ms
- **Last updated (UTC)**: 2026-06-06 11:36 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 24 · vless × 16 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 20 · `lagzian-mix` × 1 · `mahdi0024` × 22 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
