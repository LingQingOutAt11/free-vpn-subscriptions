...
![nodes](https://img.shields.io/badge/nodes-83-brightgreen) ![alive](https://img.shields.io/badge/alive-2305-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-161ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-30_21:16_UTC-informational)
...
- **Nodes selected**: 83
- **Alive across all sources**: 2305
- **Fastest node RTT**: 28 ms
- **Median RTT**: 161 ms
- **Last updated (UTC)**: 2026-05-30 21:16 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 26 · vless × 8 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
