...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2358-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-93ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-23_17:22_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2358
- **Fastest node RTT**: 35 ms
- **Median RTT**: 93 ms
- **Last updated (UTC)**: 2026-05-23 17:22 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 22 · vless × 67 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 4 · `ruking-clash` × 1 · `surfboard-eternity` × 6
