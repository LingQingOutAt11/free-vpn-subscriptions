...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2018-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-145ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_05:25_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2018
- **Fastest node RTT**: 28 ms
- **Median RTT**: 145 ms
- **Last updated (UTC)**: 2026-05-08 05:25 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 12 · vless × 82 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 12 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 78 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
