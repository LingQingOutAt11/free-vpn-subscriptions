...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1943-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-508ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_01:11_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1943
- **Fastest node RTT**: 31 ms
- **Median RTT**: 508 ms
- **Last updated (UTC)**: 2026-06-17 01:11 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 43 · trojan × 30 · vless × 20 · vmess × 56

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 61 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 24 · `ruking-clash` × 16 · `surfboard-eternity` × 4
