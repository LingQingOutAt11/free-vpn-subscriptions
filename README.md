...
![nodes](https://img.shields.io/badge/nodes-86-brightgreen) ![alive](https://img.shields.io/badge/alive-2060-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-150ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-29_05:38_UTC-informational)
...
- **Median RTT**: 150 ms
- **Last updated (UTC)**: 2026-05-29 05:38 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 32 · vless × 20 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `ruking-clash` × 2 · `snakem982` × 2 · `surfboard-eternity` × 4
