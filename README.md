...
![nodes](https://img.shields.io/badge/nodes-131-brightgreen) ![alive](https://img.shields.io/badge/alive-2270-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-71ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_13:32_UTC-informational)
...
- **Nodes selected**: 131
- **Alive across all sources**: 2270
- **Fastest node RTT**: 34 ms
- **Median RTT**: 71 ms
- **Last updated (UTC)**: 2026-05-19 13:32 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 16 · trojan × 21 · vless × 73 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 22 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 49 · `pawdroid` × 5 · `snakem982` × 1 · `surfboard-eternity` × 2
