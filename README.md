...
![nodes](https://img.shields.io/badge/nodes-113-brightgreen) ![alive](https://img.shields.io/badge/alive-1932-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-290ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_02:18_UTC-informational)
...
- **Median RTT**: 290 ms
- **Last updated (UTC)**: 2026-06-13 02:18 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 51 · trojan × 24 · vless × 29 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 35 · `pawdroid` × 5 · `ruking-clash` × 9 · `surfboard-eternity` × 4
