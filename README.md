...
![nodes](https://img.shields.io/badge/nodes-89-brightgreen) ![alive](https://img.shields.io/badge/alive-3440-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-467ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-05_08:59_UTC-informational)
...
- **Nodes selected**: 89
- **Alive across all sources**: 3440
- **Fastest node RTT**: 17 ms
- **Median RTT**: 467 ms
- **Last updated (UTC)**: 2026-08-05 08:59 UTC

**Protocol mix:** shadowsocks × 7 · trojan × 13 · vless × 61 · vmess × 8

**Sources used this run:** `autojiedian-clash` × 19 · `automerge-verified-clash` × 5 · `epodonios` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 4 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 17 · `ruking-clash` × 1 · `solispirit-v2ray` × 17 · `tg-v2ray-configs-every2h` × 8
