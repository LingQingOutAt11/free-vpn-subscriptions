...
![nodes](https://img.shields.io/badge/nodes-129-brightgreen) ![alive](https://img.shields.io/badge/alive-1995-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-395ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_16:23_UTC-informational)
...
- **Nodes selected**: 129
- **Alive across all sources**: 1995
- **Fastest node RTT**: 34 ms
- **Median RTT**: 395 ms
- **Last updated (UTC)**: 2026-06-23 16:23 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 27 · vless × 43 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 44 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 2
