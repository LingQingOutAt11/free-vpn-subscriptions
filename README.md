...
![nodes](https://img.shields.io/badge/nodes-132-brightgreen) ![alive](https://img.shields.io/badge/alive-2195-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-490ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_08:27_UTC-informational)
...
- **Nodes selected**: 132
- **Alive across all sources**: 2195
- **Fastest node RTT**: 37 ms
- **Median RTT**: 490 ms
- **Last updated (UTC)**: 2026-06-19 08:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 54 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 37 · `snakem982` × 7 · `surfboard-eternity` × 1
