...
![nodes](https://img.shields.io/badge/nodes-143-brightgreen) ![alive](https://img.shields.io/badge/alive-2396-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-148ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_12:24_UTC-informational)
...
- **Nodes selected**: 143
- **Alive across all sources**: 2396
- **Fastest node RTT**: 27 ms
- **Median RTT**: 148 ms
- **Last updated (UTC)**: 2026-05-09 12:24 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 18 · vless × 75 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 61 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5
