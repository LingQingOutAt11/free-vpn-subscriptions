...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2294-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-279ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_14:17_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2294
- **Fastest node RTT**: 28 ms
- **Median RTT**: 279 ms
- **Last updated (UTC)**: 2026-05-08 14:17 UTC

**Protocol mix:** shadowsocks × 50 · trojan × 14 · vless × 76 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 12 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 69 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
