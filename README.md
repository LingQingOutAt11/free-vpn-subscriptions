...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-1876-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-426ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-29_17:17_UTC-informational)
...
- **Nodes selected**: 106
- **Alive across all sources**: 1876
- **Fastest node RTT**: 37 ms
- **Median RTT**: 426 ms
- **Last updated (UTC)**: 2026-06-29 17:17 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 31 · vless × 27 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 24 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 1
