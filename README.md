...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-2239-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-370ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_13:25_UTC-informational)
...
- **Nodes selected**: 87
- **Alive across all sources**: 2239
- **Fastest node RTT**: 34 ms
- **Median RTT**: 370 ms
- **Last updated (UTC)**: 2026-07-01 13:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 35 · trojan × 34 · vless × 11 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `mfuu-clash` × 10 · `ninjastrikers` × 16 · `pawdroid` × 3 · `surfboard-eternity` × 3
