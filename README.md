...
![nodes](https://img.shields.io/badge/nodes-82-brightgreen) ![alive](https://img.shields.io/badge/alive-3993-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-222ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-22_08:50_UTC-informational)
...
- **Nodes selected**: 82
- **Alive across all sources**: 3993
- **Fastest node RTT**: 39 ms
- **Median RTT**: 222 ms
- **Last updated (UTC)**: 2026-07-22 08:50 UTC

**Protocol mix:** shadowsocks × 4 · trojan × 22 · vless × 54 · vmess × 2

**Sources used this run:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 5 · `barry-far-v2ray` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 34 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 13
