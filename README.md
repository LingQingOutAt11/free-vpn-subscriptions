...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-4210-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-53ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-26_14:02_UTC-informational)
...
- **Nodes selected**: 96
- **Alive across all sources**: 4210
- **Fastest node RTT**: 17 ms
- **Median RTT**: 53 ms
- **Last updated (UTC)**: 2026-07-26 14:02 UTC

**Protocol mix:** shadowsocks × 6 · trojan × 17 · vless × 68 · vmess × 5

**Sources used this run:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `pawdroid` × 2 · `roosterkid-openproxylist` × 9 · `solispirit-v2ray` × 40 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 21
