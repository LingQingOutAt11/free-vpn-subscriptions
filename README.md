...
![nodes](https://img.shields.io/badge/nodes-92-brightgreen) ![alive](https://img.shields.io/badge/alive-2455-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-113ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-03_13:32_UTC-informational)
...
- **Nodes selected**: 92
- **Alive across all sources**: 2455
- **Fastest node RTT**: 23 ms
- **Median RTT**: 113 ms
- **Last updated (UTC)**: 2026-06-03 13:32 UTC

**Protocol mix:** shadowsocks × 14 · trojan × 36 · vless × 14 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 10 · `surfboard-eternity` × 4
