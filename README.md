...
![nodes](https://img.shields.io/badge/nodes-114-brightgreen) ![alive](https://img.shields.io/badge/alive-1936-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-302ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_03:35_UTC-informational)
...
- **Median RTT**: 302 ms
- **Last updated (UTC)**: 2026-06-13 03:35 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 25 · vless × 31 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 33 · `pawdroid` × 6 · `ruking-clash` × 13 · `surfboard-eternity` × 7
