...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-3173-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-98ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-02_04:00_UTC-informational)
...
- **Nodes selected**: 126
- **Alive across all sources**: 3173
- **Fastest node RTT**: 8 ms
- **Median RTT**: 98 ms
- **Last updated (UTC)**: 2026-08-02 04:00 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 19 · trojan × 16 · vless × 78 · vmess × 10

**Sources used this run:** `autojiedian-clash` × 13 · `automerge-verified-clash` × 20 · `epodonios` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 10 · `pawdroid` × 3 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 3 · `solispirit-v2ray` × 36 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
