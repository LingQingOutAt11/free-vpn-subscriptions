...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2481-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-126ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-10_09:29_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2481
- **Fastest node RTT**: 27 ms
- **Median RTT**: 126 ms
- **Last updated (UTC)**: 2026-05-10 09:29 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 6 · vless × 91 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 31 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 66 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 4
