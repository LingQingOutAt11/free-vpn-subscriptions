...
![nodes](https://img.shields.io/badge/nodes-62-brightgreen) ![alive](https://img.shields.io/badge/alive-3463-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-103ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-09_13:23_UTC-informational)
...
- **Nodes selected**: 62
- **Alive across all sources**: 3463
- **Fastest node RTT**: 21 ms
- **Median RTT**: 103 ms
- **Last updated (UTC)**: 2026-08-09 13:23 UTC

**Protocol mix:** shadowsocks × 12 · trojan × 10 · vless × 27 · vmess × 13

**Sources used this run:** `autojiedian-clash` × 5 · `automerge-verified-clash` × 13 · `barry-far-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 8 · `tg-v2ray-configs-every2h` × 3
