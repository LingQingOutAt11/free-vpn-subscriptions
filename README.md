...
![nodes](https://img.shields.io/badge/nodes-75-brightgreen) ![alive](https://img.shields.io/badge/alive-2357-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-92ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_18:18_UTC-informational)
...
- **Nodes selected**: 75
- **Alive across all sources**: 2357
- **Fastest node RTT**: 32 ms
- **Median RTT**: 92 ms
- **Last updated (UTC)**: 2026-06-02 18:18 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 15 · vless × 8 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 3 · `pawdroid` × 2 · `surfboard-eternity` × 2
