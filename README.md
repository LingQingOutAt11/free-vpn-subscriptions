...
![nodes](https://img.shields.io/badge/nodes-142-brightgreen) ![alive](https://img.shields.io/badge/alive-2241-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-215ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_16:19_UTC-informational)
...
- **Nodes selected**: 142
- **Alive across all sources**: 2241
- **Fastest node RTT**: 30 ms
- **Median RTT**: 215 ms
- **Last updated (UTC)**: 2026-05-04 16:19 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 24 · vless × 69 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 10 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 58 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 7
