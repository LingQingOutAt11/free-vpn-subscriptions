...
![nodes](https://img.shields.io/badge/nodes-137-brightgreen) ![alive](https://img.shields.io/badge/alive-2148-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-73ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-26_11:35_UTC-informational)
...
- **Nodes selected**: 137
- **Alive across all sources**: 2148
- **Fastest node RTT**: 37 ms
- **Median RTT**: 73 ms
- **Last updated (UTC)**: 2026-05-26 11:35 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 19 · vless × 73 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 25 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 7 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 56 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 1
