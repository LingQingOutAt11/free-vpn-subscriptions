...
![nodes](https://img.shields.io/badge/nodes-137-brightgreen) ![alive](https://img.shields.io/badge/alive-2097-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-414ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_08:30_UTC-informational)
...
- **Median RTT**: 414 ms
- **Last updated (UTC)**: 2026-06-21 08:30 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 32 · vless × 44 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 38 · `snakem982` × 3 · `surfboard-eternity` × 4
