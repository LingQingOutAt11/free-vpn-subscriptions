...
![nodes](https://img.shields.io/badge/nodes-79-brightgreen) ![alive](https://img.shields.io/badge/alive-2284-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-190ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_06:13_UTC-informational)
...
- **Nodes selected**: 79
- **Alive across all sources**: 2284
- **Fastest node RTT**: 34 ms
- **Median RTT**: 190 ms
- **Last updated (UTC)**: 2026-06-10 06:13 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 13 · vless × 15 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 2 · `epodonios` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 7 · `ruking-clash` × 2 · `surfboard-eternity` × 8
