...
![nodes](https://img.shields.io/badge/nodes-59-brightgreen) ![alive](https://img.shields.io/badge/alive-1988-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-125ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-27_20:36_UTC-informational)
...
- **Nodes selected**: 59
- **Alive across all sources**: 1988
- **Fastest node RTT**: 37 ms
- **Median RTT**: 125 ms
- **Last updated (UTC)**: 2026-05-27 20:36 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 4 · vless × 21 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 3 · `surfboard-eternity` × 3
