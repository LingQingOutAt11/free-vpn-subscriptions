...
![nodes](https://img.shields.io/badge/nodes-77-brightgreen) ![alive](https://img.shields.io/badge/alive-1936-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-158ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-27_04:15_UTC-informational)
...
- **Nodes selected**: 77
- **Alive across all sources**: 1936
- **Fastest node RTT**: 36 ms
- **Median RTT**: 158 ms
- **Last updated (UTC)**: 2026-05-27 04:15 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 22 · vless × 18 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 1
