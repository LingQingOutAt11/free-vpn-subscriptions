...
![nodes](https://img.shields.io/badge/nodes-142-brightgreen) ![alive](https://img.shields.io/badge/alive-1972-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-471ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_15:14_UTC-informational)
...
- **Nodes selected**: 142
- **Alive across all sources**: 1972
- **Fastest node RTT**: 29 ms
- **Median RTT**: 471 ms
- **Last updated (UTC)**: 2026-06-21 15:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 28 · vless × 58 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 33 · `snakem982` × 5 · `surfboard-eternity` × 2
