...
![nodes](https://img.shields.io/badge/nodes-102-brightgreen) ![alive](https://img.shields.io/badge/alive-2217-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-476ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_12:11_UTC-informational)
...
- **Nodes selected**: 102
- **Alive across all sources**: 2217
- **Fastest node RTT**: 29 ms
- **Median RTT**: 476 ms
- **Last updated (UTC)**: 2026-06-12 12:11 UTC

**Protocol mix:** shadowsocks × 45 · trojan × 41 · vless × 11 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 29 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 10 · `surfboard-eternity` × 3
