...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-2382-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-165ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_13:17_UTC-informational)
...
- **Nodes selected**: 140
- **Alive across all sources**: 2382
- **Fastest node RTT**: 27 ms
- **Median RTT**: 165 ms
- **Last updated (UTC)**: 2026-05-09 13:17 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 17 · vless × 74 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 28 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 6 · `ninjastrikers` × 60 · `snakem982` × 1 · `surfboard-eternity` × 8
