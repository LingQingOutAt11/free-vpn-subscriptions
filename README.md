...
![nodes](https://img.shields.io/badge/nodes-116-brightgreen) ![alive](https://img.shields.io/badge/alive-1820-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-447ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-30_15:26_UTC-informational)
...
- **Nodes selected**: 116
- **Alive across all sources**: 1820
- **Fastest node RTT**: 31 ms
- **Median RTT**: 447 ms
- **Last updated (UTC)**: 2026-06-30 15:26 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 42 · trojan × 48 · vless × 18 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 4 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 13 · `surfboard-eternity` × 5
