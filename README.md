...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2432-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-80ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-21_10:13_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2432
- **Fastest node RTT**: 36 ms
- **Median RTT**: 80 ms
- **Last updated (UTC)**: 2026-05-21 10:13 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 11 · vless × 82 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 22 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 60 · `pawdroid` × 11 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 11 · `vxiaov-clash` × 1
