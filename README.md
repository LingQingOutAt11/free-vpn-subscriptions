...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2348-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-99ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_14:35_UTC-informational)
...
- **Median RTT**: 99 ms
- **Last updated (UTC)**: 2026-05-12 14:35 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 16 · vless × 90 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 39 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 52 · `snakem982` × 1 · `surfboard-eternity` × 4
