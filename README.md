...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1937-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-484ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_12:31_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1937
- **Fastest node RTT**: 29 ms
- **Median RTT**: 484 ms
- **Last updated (UTC)**: 2026-06-22 12:31 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 31 · vless × 63 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 30 · `snakem982` × 2 · `surfboard-eternity` × 4
