...
![nodes](https://img.shields.io/badge/nodes-108-brightgreen) ![alive](https://img.shields.io/badge/alive-2963-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-394ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-07_04:23_UTC-informational)
...
- **Nodes selected**: 108
- **Alive across all sources**: 2963
- **Fastest node RTT**: 27 ms
- **Median RTT**: 394 ms
- **Last updated (UTC)**: 2026-07-07 04:23 UTC

**Protocol mix:** shadowsocks × 3 · trojan × 35 · vless × 62 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 3 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 5 · `ninjastrikers` × 16 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 7 · `solispirit-v2ray` × 41 · `tg-v2ray-configs-every2h` × 20
