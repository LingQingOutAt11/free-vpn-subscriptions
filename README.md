...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2335-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-90ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-24_11:30_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2335
- **Fastest node RTT**: 30 ms
- **Median RTT**: 90 ms
- **Last updated (UTC)**: 2026-05-24 11:30 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 20 · vless × 67 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 41 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 51 · `pawdroid` × 4 · `surfboard-eternity` × 8 · `vxiaov-clash` × 2
