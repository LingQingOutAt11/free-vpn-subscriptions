...
![nodes](https://img.shields.io/badge/nodes-125-brightgreen) ![alive](https://img.shields.io/badge/alive-2049-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-282ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_03:34_UTC-informational)
...
- **Nodes selected**: 125
- **Alive across all sources**: 2049
- **Fastest node RTT**: 30 ms
- **Median RTT**: 282 ms
- **Last updated (UTC)**: 2026-06-11 03:34 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 47 · trojan × 24 · vless × 30 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 32 · `pawdroid` × 6 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 1
