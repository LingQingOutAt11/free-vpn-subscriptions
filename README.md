...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-2128-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-372ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_17:39_UTC-informational)
...
- **Nodes selected**: 128
- **Alive across all sources**: 2128
- **Fastest node RTT**: 30 ms
- **Median RTT**: 372 ms
- **Last updated (UTC)**: 2026-06-20 17:39 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 44 · trojan × 29 · vless × 31 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `mahdi0024` × 27 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 24 · `snakem982` × 3 · `surfboard-eternity` × 3
