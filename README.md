...
![nodes](https://img.shields.io/badge/nodes-63-brightgreen) ![alive](https://img.shields.io/badge/alive-2066-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-230ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-29_14:39_UTC-informational)
...
- **Nodes selected**: 63
- **Alive across all sources**: 2066
- **Fastest node RTT**: 21 ms
- **Median RTT**: 230 ms
- **Last updated (UTC)**: 2026-05-29 14:39 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 20 · vless × 9 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 2 · `surfboard-eternity` × 2
