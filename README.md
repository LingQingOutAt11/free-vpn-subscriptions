...
![nodes](https://img.shields.io/badge/nodes-85-brightgreen) ![alive](https://img.shields.io/badge/alive-2310-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-275ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_15:29_UTC-informational)
...
- **Nodes selected**: 85
- **Alive across all sources**: 2310
- **Fastest node RTT**: 33 ms
- **Median RTT**: 275 ms
- **Last updated (UTC)**: 2026-06-19 15:29 UTC

**Protocol mix:** shadowsocks × 21 · trojan × 29 · vless × 8 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 9 · `epodonios` × 10 · `mahdi0024` × 20 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 5 · `ruking-clash` × 17 · `surfboard-eternity` × 2
