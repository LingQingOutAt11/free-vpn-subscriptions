...
![nodes](https://img.shields.io/badge/nodes-89-brightgreen) ![alive](https://img.shields.io/badge/alive-1923-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-160ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-27_03:23_UTC-informational)
...
- **Nodes selected**: 89
- **Alive across all sources**: 1923
- **Fastest node RTT**: 38 ms
- **Median RTT**: 160 ms
- **Last updated (UTC)**: 2026-05-27 03:23 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 29 · vless × 24 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 7 · `snakem982` × 2 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
