...
![nodes](https://img.shields.io/badge/nodes-116-brightgreen) ![alive](https://img.shields.io/badge/alive-2204-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-493ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_16:36_UTC-informational)
...
- **Nodes selected**: 116
- **Alive across all sources**: 2204
- **Fastest node RTT**: 30 ms
- **Median RTT**: 493 ms
- **Last updated (UTC)**: 2026-06-11 16:36 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 47 · trojan × 26 · vless × 37 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 16 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 3 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 6 · `surfboard-eternity` × 3
