...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1973-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-140ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_00:13_UTC-informational)
...
- **Median RTT**: 140 ms
- **Last updated (UTC)**: 2026-05-12 00:13 UTC

**Protocol mix:** shadowsocks × 53 · trojan × 3 · vless × 83 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 7 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 71 · `snakem982` × 2 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
