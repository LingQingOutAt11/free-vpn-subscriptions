...
![nodes](https://img.shields.io/badge/nodes-70-brightgreen) ![alive](https://img.shields.io/badge/alive-2463-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-106ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_11:39_UTC-informational)
...
- **Nodes selected**: 70
- **Alive across all sources**: 2463
- **Fastest node RTT**: 29 ms
- **Median RTT**: 106 ms
- **Last updated (UTC)**: 2026-06-02 11:39 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 16 · vless × 8 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 30 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 1 · `ninjastrikers` × 5 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
