...
![nodes](https://img.shields.io/badge/nodes-70-brightgreen) ![alive](https://img.shields.io/badge/alive-2414-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-124ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-01_16:10_UTC-informational)
...
- **Median RTT**: 124 ms
- **Last updated (UTC)**: 2026-06-01 16:10 UTC

**Protocol mix:** shadowsocks × 13 · trojan × 21 · vless × 6 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `mahdi0024` × 23 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 5 · `pawdroid` × 3 · `surfboard-eternity` × 4
