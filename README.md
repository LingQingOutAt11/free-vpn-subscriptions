...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2370-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-128ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-13_12:29_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2370
- **Fastest node RTT**: 27 ms
- **Median RTT**: 128 ms
- **Last updated (UTC)**: 2026-05-13 12:29 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 13 · vless × 88 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 4 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 5 · `snakem982` × 1 · `surfboard-eternity` × 5
