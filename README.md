...
![nodes](https://img.shields.io/badge/nodes-120-brightgreen) ![alive](https://img.shields.io/badge/alive-2099-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-234ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_00:09_UTC-informational)
...
- **Nodes selected**: 120
- **Alive across all sources**: 2099
- **Fastest node RTT**: 32 ms
- **Median RTT**: 234 ms
- **Last updated (UTC)**: 2026-06-11 00:09 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 15 · vless × 31 · vmess × 32

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 31 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 35 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 5
