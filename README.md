...
![nodes](https://img.shields.io/badge/nodes-88-brightgreen) ![alive](https://img.shields.io/badge/alive-1994-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-284ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-10_20:30_UTC-informational)
...
- **Nodes selected**: 88
- **Alive across all sources**: 1994
- **Fastest node RTT**: 31 ms
- **Median RTT**: 284 ms
- **Last updated (UTC)**: 2026-06-10 20:30 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 14 · vless × 9 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 4 · `ruking-clash` × 8 · `surfboard-eternity` × 5
