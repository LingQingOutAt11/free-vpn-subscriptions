...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2013-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-105ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_08:30_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2013
- **Fastest node RTT**: 28 ms
- **Median RTT**: 105 ms
- **Last updated (UTC)**: 2026-05-04 08:30 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 3 · vless × 104 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 66 · `pawdroid` × 3 · `surfboard-eternity` × 5
