...
![nodes](https://img.shields.io/badge/nodes-73-brightgreen) ![alive](https://img.shields.io/badge/alive-2365-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-78ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-02_19:27_UTC-informational)
...
- **Nodes selected**: 73
- **Alive across all sources**: 2365
- **Fastest node RTT**: 30 ms
- **Median RTT**: 78 ms
- **Last updated (UTC)**: 2026-06-02 19:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 18 · trojan × 23 · vless × 6 · vmess × 25

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 5 · `pawdroid` × 1 · `surfboard-eternity` × 1
