...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-1691-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-408ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-13_21:20_UTC-informational)
...
- **Nodes selected**: 106
- **Alive across all sources**: 1691
- **Fastest node RTT**: 29 ms
- **Median RTT**: 408 ms
- **Last updated (UTC)**: 2026-06-13 21:20 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 53 · trojan × 30 · vless × 15 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 19 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 3
