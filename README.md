...
![nodes](https://img.shields.io/badge/nodes-74-brightgreen) ![alive](https://img.shields.io/badge/alive-2433-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-335ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_21:13_UTC-informational)
...
- **Nodes selected**: 74
- **Alive across all sources**: 2433
- **Fastest node RTT**: 36 ms
- **Median RTT**: 335 ms
- **Last updated (UTC)**: 2026-06-11 21:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 19 · vless × 9 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 3
