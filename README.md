...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2283-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-82ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_02:14_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2283
- **Fastest node RTT**: 37 ms
- **Median RTT**: 82 ms
- **Last updated (UTC)**: 2026-05-19 02:14 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 18 · trojan × 29 · vless × 82 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 63 · `pawdroid` × 9 · `ruking-clash` × 10 · `surfboard-eternity` × 4
