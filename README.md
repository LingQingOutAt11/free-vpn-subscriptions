...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-1997-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-373ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-28_10:16_UTC-informational)
...
- **Nodes selected**: 112
- **Alive across all sources**: 1997
- **Fastest node RTT**: 29 ms
- **Median RTT**: 373 ms
- **Last updated (UTC)**: 2026-06-28 10:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 26 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 26 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 4
