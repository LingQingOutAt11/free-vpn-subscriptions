...
![nodes](https://img.shields.io/badge/nodes-124-brightgreen) ![alive](https://img.shields.io/badge/alive-2019-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-391ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_19:25_UTC-informational)
...
- **Nodes selected**: 124
- **Alive across all sources**: 2019
- **Fastest node RTT**: 37 ms
- **Median RTT**: 391 ms
- **Last updated (UTC)**: 2026-06-23 19:25 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 37 · trojan × 26 · vless × 43 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 45 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
