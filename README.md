...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2109-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-108ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_03:36_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2109
- **Fastest node RTT**: 29 ms
- **Median RTT**: 108 ms
- **Last updated (UTC)**: 2026-05-04 03:36 UTC

**Protocol mix:** shadowsocks × 29 · trojan × 6 · vless × 105 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 24 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 3 · `ninjastrikers` × 72 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 6
