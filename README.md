...
![nodes](https://img.shields.io/badge/nodes-86-brightgreen) ![alive](https://img.shields.io/badge/alive-1982-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-260ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_19:24_UTC-informational)
...
- **Nodes selected**: 86
- **Alive across all sources**: 1982
- **Fastest node RTT**: 32 ms
- **Median RTT**: 260 ms
- **Last updated (UTC)**: 2026-06-26 19:24 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 29 · vless × 16 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 14 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 3
