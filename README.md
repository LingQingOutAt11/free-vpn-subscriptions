...
![nodes](https://img.shields.io/badge/nodes-104-brightgreen) ![alive](https://img.shields.io/badge/alive-1858-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-393ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_16:31_UTC-informational)
...
- **Nodes selected**: 104
- **Alive across all sources**: 1858
- **Fastest node RTT**: 30 ms
- **Median RTT**: 393 ms
- **Last updated (UTC)**: 2026-06-16 16:31 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 23 · vless × 20 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 3 · `mahdi0024` × 16 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 9 · `surfboard-eternity` × 3
