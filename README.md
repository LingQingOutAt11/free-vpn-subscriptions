...
![nodes](https://img.shields.io/badge/nodes-135-brightgreen) ![alive](https://img.shields.io/badge/alive-1607-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-475ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_21:19_UTC-informational)
...
- **Nodes selected**: 135
- **Alive across all sources**: 1607
- **Fastest node RTT**: 29 ms
- **Median RTT**: 475 ms
- **Last updated (UTC)**: 2026-06-14 21:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 65 · trojan × 32 · vless × 26 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 5 · `ruking-clash` × 19 · `surfboard-eternity` × 5
