...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2285-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-135ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_02:13_UTC-informational)
...
- **Median RTT**: 135 ms
- **Last updated (UTC)**: 2026-05-05 02:13 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 13 · vless × 93 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 28 · `epodonios` × 11 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 3 · `ninjastrikers` × 72 · `pawdroid` × 2 · `ruking-clash` × 2 · `surfboard-eternity` × 6
