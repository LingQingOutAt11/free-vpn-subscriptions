...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2061-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-163ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_16:14_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2061
- **Fastest node RTT**: 29 ms
- **Median RTT**: 163 ms
- **Last updated (UTC)**: 2026-05-07 16:14 UTC

**Protocol mix:** shadowsocks × 59 · trojan × 9 · vless × 71 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 11 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 56 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 8
