...
![nodes](https://img.shields.io/badge/nodes-128-brightgreen) ![alive](https://img.shields.io/badge/alive-2102-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-392ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_22:32_UTC-informational)
...
- **Nodes selected**: 128
- **Alive across all sources**: 2102
- **Fastest node RTT**: 29 ms
- **Median RTT**: 392 ms
- **Last updated (UTC)**: 2026-06-20 22:32 UTC

**Protocol mix:** shadowsocks × 41 · trojan × 33 · vless × 31 · vmess × 23

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 11 · `mahdi0024` × 23 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 30 · `snakem982` × 1 · `surfboard-eternity` × 4
