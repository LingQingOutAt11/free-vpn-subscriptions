...
![nodes](https://img.shields.io/badge/nodes-46-brightgreen) ![alive](https://img.shields.io/badge/alive-3508-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-152ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-08_19:06_UTC-informational)
...
- **Nodes selected**: 46
- **Alive across all sources**: 3508
- **Fastest node RTT**: 36 ms
- **Median RTT**: 152 ms
- **Last updated (UTC)**: 2026-08-08 19:06 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 11 · trojan × 4 · vless × 22 · vmess × 8

**Sources used this run:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 1 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 8 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 7
