...
![nodes](https://img.shields.io/badge/nodes-146-brightgreen) ![alive](https://img.shields.io/badge/alive-2285-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-432ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_19:36_UTC-informational)
...
- **Median RTT**: 432 ms
- **Last updated (UTC)**: 2026-05-08 19:36 UTC

**Protocol mix:** shadowsocks × 51 · trojan × 21 · vless × 65 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 4 · `ninjastrikers` × 58 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
