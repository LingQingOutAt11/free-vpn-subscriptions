...
![nodes](https://img.shields.io/badge/nodes-84-brightgreen) ![alive](https://img.shields.io/badge/alive-2173-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-277ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_11:37_UTC-informational)
...
- **Nodes selected**: 84
- **Alive across all sources**: 2173
- **Fastest node RTT**: 29 ms
- **Median RTT**: 277 ms
- **Last updated (UTC)**: 2026-06-11 11:37 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 16 · vless × 8 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 4
