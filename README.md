...
![nodes](https://img.shields.io/badge/nodes-122-brightgreen) ![alive](https://img.shields.io/badge/alive-2084-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-385ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-24_07:22_UTC-informational)
...
- **Median RTT**: 385 ms
- **Last updated (UTC)**: 2026-06-24 07:22 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 29 · vless × 45 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 39 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 8 · `ruking-clash` × 12 · `surfboard-eternity` × 4
