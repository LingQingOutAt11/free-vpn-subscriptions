...
![nodes](https://img.shields.io/badge/nodes-73-brightgreen) ![alive](https://img.shields.io/badge/alive-3479-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-314ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-29_03:44_UTC-informational)
...
- **Nodes selected**: 73
- **Alive across all sources**: 3479
- **Fastest node RTT**: 8 ms
- **Median RTT**: 314 ms
- **Last updated (UTC)**: 2026-07-29 03:44 UTC

**Protocol mix:** shadowsocks × 15 · trojan × 26 · vless × 31 · vmess × 1

**Sources used this run:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `roosterkid-openproxylist` × 5 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 11
