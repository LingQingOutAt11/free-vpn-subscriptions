...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-1763-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-470ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_23:23_UTC-informational)
...
- **Nodes selected**: 111
- **Alive across all sources**: 1763
- **Fastest node RTT**: 29 ms
- **Median RTT**: 470 ms
- **Last updated (UTC)**: 2026-06-17 23:23 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 47 · trojan × 31 · vless × 23 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 20 · `surfboard-eternity` × 5
