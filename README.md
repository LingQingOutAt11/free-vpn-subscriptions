...
![nodes](https://img.shields.io/badge/nodes-110-brightgreen) ![alive](https://img.shields.io/badge/alive-2273-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-103ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_02:26_UTC-informational)
...
- **Median RTT**: 103 ms
- **Last updated (UTC)**: 2026-05-31 02:26 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 20 · trojan × 30 · vless × 31 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 34 · `pawdroid` × 1 · `surfboard-eternity` × 3
