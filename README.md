...
![nodes](https://img.shields.io/badge/nodes-108-brightgreen) ![alive](https://img.shields.io/badge/alive-1765-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-416ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_18:19_UTC-informational)
...
- **Nodes selected**: 108
- **Alive across all sources**: 1765
- **Fastest node RTT**: 30 ms
- **Median RTT**: 416 ms
- **Last updated (UTC)**: 2026-06-17 18:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 51 · trojan × 23 · vless × 25 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 15 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 22 · `surfboard-eternity` × 2
