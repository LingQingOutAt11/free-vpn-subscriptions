...
![nodes](https://img.shields.io/badge/nodes-93-brightgreen) ![alive](https://img.shields.io/badge/alive-1924-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-156ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-04_21:39_UTC-informational)
...
- **Median RTT**: 156 ms
- **Last updated (UTC)**: 2026-06-04 21:39 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 35 · vless × 20 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 15 · `epodonios` × 26 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 4 · `ninjastrikers` × 9 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 3 · `surfboard-eternity` × 5
