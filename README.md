...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2359-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-77ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-23_05:19_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2359
- **Fastest node RTT**: 46 ms
- **Median RTT**: 77 ms
- **Last updated (UTC)**: 2026-05-23 05:19 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 7 · vless × 98 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 17 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 72 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
