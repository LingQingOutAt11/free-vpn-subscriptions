...
![nodes](https://img.shields.io/badge/nodes-110-brightgreen) ![alive](https://img.shields.io/badge/alive-1940-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-392ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_20:31_UTC-informational)
...
- **Nodes selected**: 110
- **Alive across all sources**: 1940
- **Fastest node RTT**: 29 ms
- **Median RTT**: 392 ms
- **Last updated (UTC)**: 2026-06-12 20:31 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 53 · trojan × 38 · vless × 10 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 9 · `surfboard-eternity` × 5
