...
![nodes](https://img.shields.io/badge/nodes-127-brightgreen) ![alive](https://img.shields.io/badge/alive-1687-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-384ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_05:30_UTC-informational)
...
- **Nodes selected**: 127
- **Alive across all sources**: 1687
- **Fastest node RTT**: 33 ms
- **Median RTT**: 384 ms
- **Last updated (UTC)**: 2026-06-14 05:30 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 36 · vless × 33 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 5 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 32 · `pawdroid` × 4 · `ruking-clash` × 23 · `surfboard-eternity` × 1
