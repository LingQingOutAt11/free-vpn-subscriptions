...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-2248-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-415ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-01_09:37_UTC-informational)
...
- **Nodes selected**: 115
- **Alive across all sources**: 2248
- **Fastest node RTT**: 34 ms
- **Median RTT**: 415 ms
- **Last updated (UTC)**: 2026-07-01 09:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 46 · trojan × 47 · vless × 13 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 13 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 19 · `matin-v2ray` × 1 · `mfuu-clash` × 10 · `ninjastrikers` × 19 · `pawdroid` × 6 · `surfboard-eternity` × 1
