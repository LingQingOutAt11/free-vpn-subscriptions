...
![nodes](https://img.shields.io/badge/nodes-62-brightgreen) ![alive](https://img.shields.io/badge/alive-2198-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-261ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-29_15:39_UTC-informational)
...
- **Median RTT**: 261 ms
- **Last updated (UTC)**: 2026-05-29 15:39 UTC

**Protocol mix:** shadowsocks × 13 · trojan × 20 · vless × 5 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
