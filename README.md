...
![nodes](https://img.shields.io/badge/nodes-137-brightgreen) ![alive](https://img.shields.io/badge/alive-1944-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-403ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_21:19_UTC-informational)
...
- **Nodes selected**: 137
- **Alive across all sources**: 1944
- **Fastest node RTT**: 28 ms
- **Median RTT**: 403 ms
- **Last updated (UTC)**: 2026-06-21 21:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 48 · trojan × 27 · vless × 47 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 25 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 27 · `snakem982` × 6 · `surfboard-eternity` × 5
