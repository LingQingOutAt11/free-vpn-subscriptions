...
![nodes](https://img.shields.io/badge/nodes-130-brightgreen) ![alive](https://img.shields.io/badge/alive-2132-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-98ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-25_21:11_UTC-informational)
...
- **Nodes selected**: 130
- **Alive across all sources**: 2132
- **Fastest node RTT**: 44 ms
- **Median RTT**: 98 ms
- **Last updated (UTC)**: 2026-05-25 21:11 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 26 · vless × 55 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 48 · `pawdroid` × 7 · `ruking-clash` × 9 · `surfboard-eternity` × 6
