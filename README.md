...
![nodes](https://img.shields.io/badge/nodes-81-brightgreen) ![alive](https://img.shields.io/badge/alive-3019-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-394ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-05_19:49_UTC-informational)
...
- **Nodes selected**: 81
- **Alive across all sources**: 3019
- **Fastest node RTT**: 26 ms
- **Median RTT**: 394 ms
- **Last updated (UTC)**: 2026-07-05 19:49 UTC

**Protocol mix:** shadowsocks × 2 · trojan × 23 · vless × 45 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 6 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 10 · `solispirit-v2ray` × 27 · `tg-v2ray-configs-every2h` × 13
