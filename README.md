...
![nodes](https://img.shields.io/badge/nodes-117-brightgreen) ![alive](https://img.shields.io/badge/alive-3119-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-105ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-01_14:00_UTC-informational)
...
- **Nodes selected**: 117
- **Alive across all sources**: 3119
- **Fastest node RTT**: 17 ms
- **Median RTT**: 105 ms
- **Last updated (UTC)**: 2026-08-01 14:00 UTC

**Protocol mix:** hysteria2 × 4 · shadowsocks × 23 · trojan × 20 · vless × 60 · vmess × 10

**Sources used this run:** `autojiedian-clash` × 11 · `automerge-verified-clash` × 25 · `barry-far-v2ray` × 9 · `epodonios` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 1 · `pawdroid` × 4 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 4 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 13
