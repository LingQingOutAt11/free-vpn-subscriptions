...
![nodes](https://img.shields.io/badge/nodes-99-brightgreen) ![alive](https://img.shields.io/badge/alive-2266-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-130ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_05:25_UTC-informational)
...
- **Nodes selected**: 99
- **Alive across all sources**: 2266
- **Fastest node RTT**: 34 ms
- **Median RTT**: 130 ms
- **Last updated (UTC)**: 2026-05-31 05:25 UTC

**Protocol mix:** shadowsocks × 16 · trojan × 30 · vless × 24 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 23 · `pawdroid` × 2
