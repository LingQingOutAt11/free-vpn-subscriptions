...
![nodes](https://img.shields.io/badge/nodes-86-brightgreen) ![alive](https://img.shields.io/badge/alive-3987-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-350ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-20_14:40_UTC-informational)
...
- **Nodes selected**: 86
- **Alive across all sources**: 3987
- **Fastest node RTT**: 18 ms
- **Median RTT**: 350 ms
- **Last updated (UTC)**: 2026-07-20 14:40 UTC

**Protocol mix:** shadowsocks × 1 · trojan × 23 · vless × 57 · vmess × 5

**Sources used this run:** `autojiedian-clash` × 2 · `barry-far-v2ray` × 1 · `mahdi0024` × 5 · `matin-v2ray` × 10 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 39 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
