...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-2140-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-331ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-24_23:23_UTC-informational)
...
- **Nodes selected**: 112
- **Alive across all sources**: 2140
- **Fastest node RTT**: 32 ms
- **Median RTT**: 331 ms
- **Last updated (UTC)**: 2026-06-24 23:23 UTC

**Protocol mix:** shadowsocks × 28 · trojan × 33 · vless × 36 · vmess × 15

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 31 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 16 · `surfboard-eternity` × 3
