...
![nodes](https://img.shields.io/badge/nodes-112-brightgreen) ![alive](https://img.shields.io/badge/alive-1832-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-421ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-16_15:20_UTC-informational)
...
- **Median RTT**: 421 ms
- **Last updated (UTC)**: 2026-06-16 15:20 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 26 · vless × 19 · vmess × 17

**Sources used this run:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 4
