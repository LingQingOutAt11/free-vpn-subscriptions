...
![nodes](https://img.shields.io/badge/nodes-67-brightgreen) ![alive](https://img.shields.io/badge/alive-3460-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-108ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-05_14:39_UTC-informational)
...
- **Median RTT**: 108 ms
- **Last updated (UTC)**: 2026-08-05 14:39 UTC

**Protocol mix:** shadowsocks × 3 · trojan × 20 · vless × 38 · vmess × 6

**Sources used this run:** `autojiedian-clash` × 6 · `automerge-verified-clash` × 10 · `mahdi0024` × 6 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 5 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 12 · `solispirit-v2ray` × 15 · `tg-v2ray-configs-every2h` × 9
