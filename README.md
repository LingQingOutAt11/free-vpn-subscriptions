...
![nodes](https://img.shields.io/badge/nodes-136-brightgreen) ![alive](https://img.shields.io/badge/alive-2229-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-69ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-19_12:28_UTC-informational)
...
- **Nodes selected**: 136
- **Alive across all sources**: 2229
- **Fastest node RTT**: 29 ms
- **Median RTT**: 69 ms
- **Last updated (UTC)**: 2026-05-19 12:28 UTC

**Protocol mix:** shadowsocks × 16 · trojan × 20 · vless × 80 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 10 · `surfboard-eternity` × 3
