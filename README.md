...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2507-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-97ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-15_14:34_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2507
- **Fastest node RTT**: 38 ms
- **Median RTT**: 97 ms
- **Last updated (UTC)**: 2026-05-15 14:34 UTC

**Protocol mix:** shadowsocks × 40 · trojan × 19 · vless × 83 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 3 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 27 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 64 · `pawdroid` × 8 · `ruking-clash` × 4 · `surfboard-eternity` × 1
