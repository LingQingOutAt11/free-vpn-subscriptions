...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2480-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-71ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-21_12:37_UTC-informational)
...
- **Median RTT**: 71 ms
- **Last updated (UTC)**: 2026-05-21 12:37 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 14 · vless × 80 · vmess × 19

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 58 · `pawdroid` × 12 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
