...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2409-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-146ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-13_23:16_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2409
- **Fastest node RTT**: 29 ms
- **Median RTT**: 146 ms
- **Last updated (UTC)**: 2026-05-13 23:16 UTC

**Protocol mix:** shadowsocks × 47 · trojan × 16 · vless × 79 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 5 · `mahdi0024` × 30 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 53 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 3
