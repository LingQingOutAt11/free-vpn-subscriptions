...
![nodes](https://img.shields.io/badge/nodes-136-brightgreen) ![alive](https://img.shields.io/badge/alive-2075-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-366ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-24_03:30_UTC-informational)
...
- **Median RTT**: 366 ms
- **Last updated (UTC)**: 2026-06-24 03:30 UTC

**Protocol mix:** shadowsocks × 35 · trojan × 28 · vless × 57 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 44 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 26 · `pawdroid` × 8 · `ruking-clash` × 14 · `surfboard-eternity` × 3
