...
![nodes](https://img.shields.io/badge/nodes-111-brightgreen) ![alive](https://img.shields.io/badge/alive-2062-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-429ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_10:22_UTC-informational)
...
- **Nodes selected**: 111
- **Alive across all sources**: 2062
- **Fastest node RTT**: 25 ms
- **Median RTT**: 429 ms
- **Last updated (UTC)**: 2026-06-23 10:22 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 27 · vless × 43 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
