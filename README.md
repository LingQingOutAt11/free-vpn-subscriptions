...
![nodes](https://img.shields.io/badge/nodes-121-brightgreen) ![alive](https://img.shields.io/badge/alive-1919-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-365ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_04:17_UTC-informational)
...
- **Nodes selected**: 121
- **Alive across all sources**: 1919
- **Fastest node RTT**: 28 ms
- **Median RTT**: 365 ms
- **Last updated (UTC)**: 2026-06-26 04:17 UTC

**Protocol mix:** shadowsocks × 37 · trojan × 40 · vless × 31 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 25 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 2 · `ninjastrikers` × 22 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 5
