...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-3017-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-341ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-11_13:59_UTC-informational)
...
- **Nodes selected**: 109
- **Alive across all sources**: 3017
- **Fastest node RTT**: 26 ms
- **Median RTT**: 341 ms
- **Last updated (UTC)**: 2026-07-11 13:59 UTC

**Protocol mix:** shadowsocks × 10 · trojan × 30 · vless × 62 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 1 · `go4sharing-clash` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 8 · `pawdroid` × 3 · `radikal-clash` × 4 · `roosterkid-openproxylist` × 12 · `solispirit-v2ray` × 40 · `tg-v2ray-configs-every2h` × 22
