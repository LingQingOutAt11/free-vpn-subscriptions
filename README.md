...
![nodes](https://img.shields.io/badge/nodes-117-brightgreen) ![alive](https://img.shields.io/badge/alive-1916-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-410ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_22:13_UTC-informational)
...
- **Nodes selected**: 117
- **Alive across all sources**: 1916
- **Fastest node RTT**: 32 ms
- **Median RTT**: 410 ms
- **Last updated (UTC)**: 2026-06-25 22:13 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 40 · trojan × 37 · vless × 23 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 3 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 19 · `surfboard-eternity` × 3
