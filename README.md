...
![nodes](https://img.shields.io/badge/nodes-133-brightgreen) ![alive](https://img.shields.io/badge/alive-2060-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-424ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_12:27_UTC-informational)
...
- **Nodes selected**: 133
- **Alive across all sources**: 2060
- **Fastest node RTT**: 32 ms
- **Median RTT**: 424 ms
- **Last updated (UTC)**: 2026-06-23 12:27 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 38 · trojan × 31 · vless × 50 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 49 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 4
