...
![nodes](https://img.shields.io/badge/nodes-106-brightgreen) ![alive](https://img.shields.io/badge/alive-3623-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-81ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-19_03:59_UTC-informational)
...
- **Nodes selected**: 106
- **Alive across all sources**: 3623
- **Fastest node RTT**: 18 ms
- **Median RTT**: 81 ms
- **Last updated (UTC)**: 2026-07-19 03:59 UTC

**Protocol mix:** shadowsocks × 9 · trojan × 18 · vless × 75 · vmess × 4

**Sources used this run:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 10 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 5 · `ninjastrikers` × 15 · `pawdroid` × 2 · `roosterkid-openproxylist` × 1 · `solispirit-v2ray` × 41 · `tg-v2ray-configs-every2h` × 26
