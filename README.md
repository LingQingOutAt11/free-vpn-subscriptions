...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2538-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-77ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-14_11:35_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2538
- **Fastest node RTT**: 30 ms
- **Median RTT**: 77 ms
- **Last updated (UTC)**: 2026-05-14 11:35 UTC

**Protocol mix:** shadowsocks × 31 · trojan × 20 · vless × 91 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 1 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 60 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 3
