...
![nodes](https://img.shields.io/badge/nodes-80-brightgreen) ![alive](https://img.shields.io/badge/alive-4137-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-160ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-22_19:50_UTC-informational)
...
- **Nodes selected**: 80
- **Alive across all sources**: 4137
- **Fastest node RTT**: 31 ms
- **Median RTT**: 160 ms
- **Last updated (UTC)**: 2026-07-22 19:50 UTC

**Protocol mix:** shadowsocks × 5 · trojan × 15 · vless × 54 · vmess × 6

**Sources used this run:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 5 · `mahdi0024` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 4 · `ninjastrikers` × 8 · `pawdroid` × 1 · `roosterkid-openproxylist` × 13 · `solispirit-v2ray` × 30 · `tg-v2ray-configs-every2h` × 13
