...
![nodes](https://img.shields.io/badge/nodes-141-brightgreen) ![alive](https://img.shields.io/badge/alive-1693-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-469ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_10:11_UTC-informational)
...
- **Nodes selected**: 141
- **Alive across all sources**: 1693
- **Fastest node RTT**: 34 ms
- **Median RTT**: 469 ms
- **Last updated (UTC)**: 2026-06-14 10:11 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 87 · trojan × 25 · vless × 20 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 3 · `epodonios` × 19 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 28 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 7 · `ruking-clash` × 17 · `surfboard-eternity` × 7
