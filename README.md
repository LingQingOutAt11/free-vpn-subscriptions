...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-1994-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-423ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_14:21_UTC-informational)
...
- **Median RTT**: 423 ms
- **Last updated (UTC)**: 2026-06-21 14:21 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 29 · vless × 43 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 27 · `snakem982` × 6 · `surfboard-eternity` × 2
