...
![nodes](https://img.shields.io/badge/nodes-84-brightgreen) ![alive](https://img.shields.io/badge/alive-2172-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-296ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-11_12:16_UTC-informational)
...
- **Nodes selected**: 84
- **Alive across all sources**: 2172
- **Fastest node RTT**: 29 ms
- **Median RTT**: 296 ms
- **Last updated (UTC)**: 2026-06-11 12:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 15 · vless × 9 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 6
