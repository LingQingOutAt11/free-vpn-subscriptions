...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1662-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-440ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_20:21_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1662
- **Fastest node RTT**: 32 ms
- **Median RTT**: 440 ms
- **Last updated (UTC)**: 2026-06-17 20:21 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 78 · trojan × 31 · vless × 33 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 32 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 3 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 26 · `surfboard-eternity` × 2
