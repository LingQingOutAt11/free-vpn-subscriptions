...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2386-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-88ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-21_00:36_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2386
- **Fastest node RTT**: 32 ms
- **Median RTT**: 88 ms
- **Last updated (UTC)**: 2026-05-21 00:36 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 14 · vless × 82 · vmess × 18

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 6 · `mahdi0024` × 15 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `mfuu-clash` × 4 · `ninjastrikers` × 71 · `pawdroid` × 7 · `surfboard-eternity` × 6
