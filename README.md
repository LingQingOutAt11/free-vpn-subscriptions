...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-1794-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-421ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_16:21_UTC-informational)
...
- **Nodes selected**: 115
- **Alive across all sources**: 1794
- **Fastest node RTT**: 28 ms
- **Median RTT**: 421 ms
- **Last updated (UTC)**: 2026-06-17 16:21 UTC

**Protocol mix:** shadowsocks × 47 · trojan × 31 · vless × 28 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 15 · `mahdi0024` × 6 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 22 · `surfboard-eternity` × 5
