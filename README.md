...
![nodes](https://img.shields.io/badge/nodes-76-brightgreen) ![alive](https://img.shields.io/badge/alive-4120-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-386ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-21_08:50_UTC-informational)
...
- **Nodes selected**: 76
- **Alive across all sources**: 4120
- **Fastest node RTT**: 31 ms
- **Median RTT**: 386 ms
- **Last updated (UTC)**: 2026-07-21 08:50 UTC

**Protocol mix:** shadowsocks × 1 · trojan × 19 · vless × 54 · vmess × 2

**Sources used this run:** `automerge-verified-clash` × 1 · `barry-far-v2ray` × 1 · `mahdi0024` × 1 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 1 · `roosterkid-openproxylist` × 7 · `snakem982` × 2 · `solispirit-v2ray` × 38 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 10
