...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2000-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-279ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_15:33_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2000
- **Fastest node RTT**: 38 ms
- **Median RTT**: 279 ms
- **Last updated (UTC)**: 2026-05-06 15:33 UTC

**Protocol mix:** shadowsocks × 47 · trojan × 19 · vless × 72 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 34 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 9 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 60 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
