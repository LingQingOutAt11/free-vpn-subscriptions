...
![nodes](https://img.shields.io/badge/nodes-89-brightgreen) ![alive](https://img.shields.io/badge/alive-2306-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-235ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-19_22:26_UTC-informational)
...
- **Median RTT**: 235 ms
- **Last updated (UTC)**: 2026-06-19 22:26 UTC

**Protocol mix:** shadowsocks × 24 · trojan × 26 · vless × 8 · vmess × 31

**Sources used this run:** `barry-far-v2ray` × 7 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 2
