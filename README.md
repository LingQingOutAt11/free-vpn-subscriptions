...
![nodes](https://img.shields.io/badge/nodes-53-brightgreen) ![alive](https://img.shields.io/badge/alive-3616-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-52ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-08_07:21_UTC-informational)
...
- **Nodes selected**: 53
- **Alive across all sources**: 3616
- **Fastest node RTT**: 12 ms
- **Median RTT**: 52 ms
- **Last updated (UTC)**: 2026-08-08 07:21 UTC

**Protocol mix:** shadowsocks × 1 · trojan × 11 · vless × 29 · vmess × 12

**Sources used this run:** `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `mahdi0024` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 4 · `pawdroid` × 1 · `roosterkid-openproxylist` × 7 · `snakem982` × 1 · `solispirit-v2ray` × 19 · `tg-v2ray-configs-every2h` × 8
