...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2452-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-121ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_01:09_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2452
- **Fastest node RTT**: 30 ms
- **Median RTT**: 121 ms
- **Last updated (UTC)**: 2026-05-11 01:09 UTC

**Protocol mix:** shadowsocks × 50 · trojan × 2 · vless × 88 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 2 · `epodonios` × 3 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 2 · `ninjastrikers` × 66 · `pawdroid` × 1 · `ruking-clash` × 5 · `snakem982` × 6 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
