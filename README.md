...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-1931-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-480ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_09:11_UTC-informational)
...
- **Nodes selected**: 96
- **Alive across all sources**: 1931
- **Fastest node RTT**: 29 ms
- **Median RTT**: 480 ms
- **Last updated (UTC)**: 2026-06-26 09:11 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 37 · vless × 19 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 6 · `epodonios` × 20 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 7
