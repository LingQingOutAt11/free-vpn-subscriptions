...
![nodes](https://img.shields.io/badge/nodes-84-brightgreen) ![alive](https://img.shields.io/badge/alive-2277-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-224ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_11:16_UTC-informational)
...
- **Median RTT**: 224 ms
- **Last updated (UTC)**: 2026-06-20 11:16 UTC

**Protocol mix:** shadowsocks × 22 · trojan × 22 · vless × 11 · vmess × 29

**Sources used this run:** `barry-far-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 1
