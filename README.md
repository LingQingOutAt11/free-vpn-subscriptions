...
![nodes](https://img.shields.io/badge/nodes-142-brightgreen) ![alive](https://img.shields.io/badge/alive-2294-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-309ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_23:36_UTC-informational)
...
- **Median RTT**: 309 ms
- **Last updated (UTC)**: 2026-05-04 23:36 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 26 · vless × 68 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 12 · `mfuu-clash` × 2 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 1 · `surfboard-eternity` × 9
