...
![nodes](https://img.shields.io/badge/nodes-84-brightgreen) ![alive](https://img.shields.io/badge/alive-2203-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-174ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_08:25_UTC-informational)
...
- **Median RTT**: 174 ms
- **Last updated (UTC)**: 2026-06-07 08:25 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 23 · vless × 10 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `surfboard-eternity` × 4
