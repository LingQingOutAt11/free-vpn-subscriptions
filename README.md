...
![nodes](https://img.shields.io/badge/nodes-108-brightgreen) ![alive](https://img.shields.io/badge/alive-2211-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-502ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_14:26_UTC-informational)
...
- **Nodes selected**: 108
- **Alive across all sources**: 2211
- **Fastest node RTT**: 34 ms
- **Median RTT**: 502 ms
- **Last updated (UTC)**: 2026-06-12 14:26 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 44 · trojan × 41 · vless × 14 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 33 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 4
