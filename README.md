...
![nodes](https://img.shields.io/badge/nodes-69-brightgreen) ![alive](https://img.shields.io/badge/alive-1878-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-255ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_19:38_UTC-informational)
...
- **Nodes selected**: 69
- **Alive across all sources**: 1878
- **Fastest node RTT**: 32 ms
- **Median RTT**: 255 ms
- **Last updated (UTC)**: 2026-06-08 19:38 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 36 · trojan × 12 · vless × 9 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 1 · `ruking-clash` × 3 · `surfboard-eternity` × 7
