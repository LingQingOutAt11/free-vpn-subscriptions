...
![nodes](https://img.shields.io/badge/nodes-64-brightgreen) ![alive](https://img.shields.io/badge/alive-4174-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-97ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-22_14:28_UTC-informational)
...
- **Nodes selected**: 64
- **Alive across all sources**: 4174
- **Fastest node RTT**: 29 ms
- **Median RTT**: 97 ms
- **Last updated (UTC)**: 2026-07-22 14:28 UTC

**Protocol mix:** shadowsocks × 9 · trojan × 13 · vless × 38 · vmess × 4

**Sources used this run:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 9 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 25 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 9
