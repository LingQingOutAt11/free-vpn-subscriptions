...
![nodes](https://img.shields.io/badge/nodes-99-brightgreen) ![alive](https://img.shields.io/badge/alive-2965-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-322ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-04_14:06_UTC-informational)
...
- **Nodes selected**: 99
- **Alive across all sources**: 2965
- **Fastest node RTT**: 23 ms
- **Median RTT**: 322 ms
- **Last updated (UTC)**: 2026-07-04 14:06 UTC

**Protocol mix:** shadowsocks × 15 · trojan × 28 · vless × 46 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 1 · `epodonios` × 2 · `go4sharing-clash` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 4 · `ninjastrikers` × 7 · `pawdroid` × 3 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 40 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 11
