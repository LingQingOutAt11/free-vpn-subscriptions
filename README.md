...
![nodes](https://img.shields.io/badge/nodes-89-brightgreen) ![alive](https://img.shields.io/badge/alive-4075-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-113ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-23_03:49_UTC-informational)
...
- **Nodes selected**: 89
- **Alive across all sources**: 4075
- **Fastest node RTT**: 16 ms
- **Median RTT**: 113 ms
- **Last updated (UTC)**: 2026-07-23 03:49 UTC

**Protocol mix:** shadowsocks × 8 · trojan × 23 · vless × 56 · vmess × 2

**Sources used this run:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 6 · `epodonios` × 2 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `roosterkid-openproxylist` × 4 · `snakem982` × 1 · `solispirit-v2ray` × 34 · `tg-v2ray-configs-every2h` × 19
