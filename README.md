...
![nodes](https://img.shields.io/badge/nodes-87-brightgreen) ![alive](https://img.shields.io/badge/alive-1887-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-359ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_22:11_UTC-informational)
...
- **Nodes selected**: 87
- **Alive across all sources**: 1887
- **Fastest node RTT**: 38 ms
- **Median RTT**: 359 ms
- **Last updated (UTC)**: 2026-06-08 22:11 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 23 · vless × 11 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 8 · `surfboard-eternity` × 7
