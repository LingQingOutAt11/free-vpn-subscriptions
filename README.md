...
![nodes](https://img.shields.io/badge/nodes-107-brightgreen) ![alive](https://img.shields.io/badge/alive-1845-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-298ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_05:18_UTC-informational)
...
- **Nodes selected**: 107
- **Alive across all sources**: 1845
- **Fastest node RTT**: 28 ms
- **Median RTT**: 298 ms
- **Last updated (UTC)**: 2026-06-08 05:18 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 47 · trojan × 22 · vless × 31 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 31 · `pawdroid` × 3 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 6
