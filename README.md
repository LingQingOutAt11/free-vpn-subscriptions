...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2104-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-103ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-04_02:28_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2104
- **Fastest node RTT**: 28 ms
- **Median RTT**: 103 ms
- **Last updated (UTC)**: 2026-05-04 02:28 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 8 · vless × 105 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 3 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
