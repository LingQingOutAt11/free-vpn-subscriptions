...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2359-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-120ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-13_13:29_UTC-informational)
...
- **Median RTT**: 120 ms
- **Last updated (UTC)**: 2026-05-13 13:29 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 18 · vless × 78 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 42 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 51 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
