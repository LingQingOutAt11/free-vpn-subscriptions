...
![nodes](https://img.shields.io/badge/nodes-120-brightgreen) ![alive](https://img.shields.io/badge/alive-1969-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-250ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-25_02:22_UTC-informational)
...
- **Nodes selected**: 120
- **Alive across all sources**: 1969
- **Fastest node RTT**: 35 ms
- **Median RTT**: 250 ms
- **Last updated (UTC)**: 2026-06-25 02:22 UTC

**Protocol mix:** shadowsocks × 26 · trojan × 32 · vless × 50 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 3 · `epodonios` × 37 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 14 · `surfboard-eternity` × 6
