...
![nodes](https://img.shields.io/badge/nodes-139-brightgreen) ![alive](https://img.shields.io/badge/alive-2231-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-407ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_22:20_UTC-informational)
...
- **Nodes selected**: 139
- **Alive across all sources**: 2231
- **Fastest node RTT**: 33 ms
- **Median RTT**: 407 ms
- **Last updated (UTC)**: 2026-05-05 22:20 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 28 · vless × 65 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `surfboard-eternity` × 6
