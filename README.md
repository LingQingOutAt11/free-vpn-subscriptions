...
![nodes](https://img.shields.io/badge/nodes-122-brightgreen) ![alive](https://img.shields.io/badge/alive-1614-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-407ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-14_19:12_UTC-informational)
...
- **Nodes selected**: 122
- **Alive across all sources**: 1614
- **Fastest node RTT**: 30 ms
- **Median RTT**: 407 ms
- **Last updated (UTC)**: 2026-06-14 19:12 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 61 · trojan × 29 · vless × 19 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 13 · `ruking-clash` × 20 · `surfboard-eternity` × 8
