...
![nodes](https://img.shields.io/badge/nodes-121-brightgreen) ![alive](https://img.shields.io/badge/alive-3460-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-135ms-orange) ![updated](https://img.shields.io/badge/updated-2026-08-01_03:56_UTC-informational)
...
- **Nodes selected**: 121
- **Alive across all sources**: 3460
- **Fastest node RTT**: 14 ms
- **Median RTT**: 135 ms
- **Last updated (UTC)**: 2026-08-01 03:56 UTC

**Protocol mix:** hysteria2 × 3 · shadowsocks × 20 · trojan × 18 · vless × 73 · vmess × 7

**Sources used this run:** `autojiedian-clash` × 16 · `automerge-verified-clash` × 23 · `barry-far-v2ray` × 2 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 10 · `pawdroid` × 3 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 8 · `ruking-clash` × 3 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
