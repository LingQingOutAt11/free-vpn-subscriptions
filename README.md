...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-3630-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-132ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-19_08:39_UTC-informational)
...
- **Nodes selected**: 109
- **Alive across all sources**: 3630
- **Fastest node RTT**: 21 ms
- **Median RTT**: 132 ms
- **Last updated (UTC)**: 2026-07-19 08:39 UTC

**Protocol mix:** shadowsocks × 4 · trojan × 18 · vless × 79 · vmess × 8

**Sources used this run:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 4 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 4 · `roosterkid-openproxylist` × 7 · `solispirit-v2ray` × 48 · `tg-v2ray-configs-every2h` × 20
