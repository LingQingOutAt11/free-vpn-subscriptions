...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2372-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-257ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_12:30_UTC-informational)
...
- **Median RTT**: 257 ms
- **Last updated (UTC)**: 2026-05-11 12:30 UTC

**Protocol mix:** shadowsocks × 44 · trojan × 18 · vless × 81 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 4
