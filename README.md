...
![nodes](https://img.shields.io/badge/nodes-81-brightgreen) ![alive](https://img.shields.io/badge/alive-2333-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-167ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-31_20:19_UTC-informational)
...
- **Nodes selected**: 81
- **Alive across all sources**: 2333
- **Fastest node RTT**: 22 ms
- **Median RTT**: 167 ms
- **Last updated (UTC)**: 2026-05-31 20:19 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 18 · vless × 6 · vmess × 34

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 8 · `mahdi0024` × 28 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 8 · `pawdroid` × 1 · `surfboard-eternity` × 2
