...
![nodes](https://img.shields.io/badge/nodes-93-brightgreen) ![alive](https://img.shields.io/badge/alive-2253-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-171ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-07_06:36_UTC-informational)
...
- **Median RTT**: 171 ms
- **Last updated (UTC)**: 2026-06-07 06:36 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 23 · vless × 14 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 4 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 17 · `pawdroid` × 2 · `surfboard-eternity` × 5
