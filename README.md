...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-3058-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-160ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-15_03:40_UTC-informational)
...
- **Nodes selected**: 126
- **Alive across all sources**: 3058
- **Fastest node RTT**: 46 ms
- **Median RTT**: 160 ms
- **Last updated (UTC)**: 2026-07-15 03:40 UTC

**Protocol mix:** shadowsocks × 18 · trojan × 25 · vless × 70 · vmess × 13

**Sources used this run:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 2 · `epodonios` × 5 · `go4sharing-clash` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 4 · `radikal-clash` × 3 · `roosterkid-openproxylist` × 11 · `snakem982` × 1 · `solispirit-v2ray` × 44 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 21
