...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2464-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-94ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-15_04:19_UTC-informational)
...
- **Median RTT**: 94 ms
- **Last updated (UTC)**: 2026-05-15 04:19 UTC

**Protocol mix:** shadowsocks × 49 · trojan × 6 · vless × 86 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 34 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 47 · `pawdroid` × 7 · `ruking-clash` × 9 · `surfboard-eternity` × 4
