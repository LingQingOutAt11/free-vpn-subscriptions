...
![nodes](https://img.shields.io/badge/nodes-107-brightgreen) ![alive](https://img.shields.io/badge/alive-2186-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-135ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-30_03:19_UTC-informational)
...
- **Nodes selected**: 107
- **Alive across all sources**: 2186
- **Fastest node RTT**: 33 ms
- **Median RTT**: 135 ms
- **Last updated (UTC)**: 2026-05-30 03:19 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 26 · vless × 29 · vmess × 27

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 32 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 2
