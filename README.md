...
![nodes](https://img.shields.io/badge/nodes-124-brightgreen) ![alive](https://img.shields.io/badge/alive-2269-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-78ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_18:37_UTC-informational)
...
- **Nodes selected**: 124
- **Alive across all sources**: 2269
- **Fastest node RTT**: 36 ms
- **Median RTT**: 78 ms
- **Last updated (UTC)**: 2026-05-18 18:37 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 15 · trojan × 22 · vless × 66 · vmess × 20

**Sources used this run:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `mahdi0024` × 21 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 51 · `pawdroid` × 6 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6
