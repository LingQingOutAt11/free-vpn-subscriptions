...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1942-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-135ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-12_07:13_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1942
- **Fastest node RTT**: 28 ms
- **Median RTT**: 135 ms
- **Last updated (UTC)**: 2026-05-12 07:13 UTC

**Protocol mix:** shadowsocks × 57 · trojan × 3 · vless × 80 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 7 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
