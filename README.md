...
![nodes](https://img.shields.io/badge/nodes-100-brightgreen) ![alive](https://img.shields.io/badge/alive-1943-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-337ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-27_15:12_UTC-informational)
...
- **Median RTT**: 337 ms
- **Last updated (UTC)**: 2026-06-27 15:12 UTC

**Protocol mix:** shadowsocks × 30 · trojan × 35 · vless × 21 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 13 · `surfboard-eternity` × 7
