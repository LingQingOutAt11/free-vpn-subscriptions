...
![nodes](https://img.shields.io/badge/nodes-141-brightgreen) ![alive](https://img.shields.io/badge/alive-2250-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-289ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-05_19:21_UTC-informational)
...
- **Nodes selected**: 141
- **Alive across all sources**: 2250
- **Fastest node RTT**: 29 ms
- **Median RTT**: 289 ms
- **Last updated (UTC)**: 2026-05-05 19:21 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 27 · vless × 67 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 56 · `pawdroid` × 3 · `surfboard-eternity` × 7
