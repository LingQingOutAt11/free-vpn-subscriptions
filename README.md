...
![nodes](https://img.shields.io/badge/nodes-90-brightgreen) ![alive](https://img.shields.io/badge/alive-3803-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-77ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-24_08:48_UTC-informational)
...
- **Nodes selected**: 90
- **Alive across all sources**: 3803
- **Fastest node RTT**: 31 ms
- **Median RTT**: 77 ms
- **Last updated (UTC)**: 2026-07-24 08:48 UTC

**Protocol mix:** shadowsocks × 5 · trojan × 17 · vless × 63 · vmess × 5

**Sources used this run:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 2 · `epodonios` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 1 · `roosterkid-openproxylist` × 10 · `solispirit-v2ray` × 32 · `tg-v2ray-configs-every2h` × 20
