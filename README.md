...
![nodes](https://img.shields.io/badge/nodes-68-brightgreen) ![alive](https://img.shields.io/badge/alive-1981-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-324ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-30_23:15_UTC-informational)
...
- **Nodes selected**: 68
- **Alive across all sources**: 1981
- **Fastest node RTT**: 48 ms
- **Median RTT**: 324 ms
- **Last updated (UTC)**: 2026-06-30 23:15 UTC

**Protocol mix:** shadowsocks × 27 · trojan × 28 · vless × 7 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 13 · `ruking-clash` × 4 · `surfboard-eternity` × 5
