...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2040-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-362ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_02:18_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2040
- **Fastest node RTT**: 31 ms
- **Median RTT**: 362 ms
- **Last updated (UTC)**: 2026-06-23 02:18 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 43 · trojan × 26 · vless × 65 · vmess × 14

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 50 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `ninjastrikers` × 25 · `pawdroid` × 4 · `ruking-clash` × 17 · `surfboard-eternity` × 4
