...
![nodes](https://img.shields.io/badge/nodes-105-brightgreen) ![alive](https://img.shields.io/badge/alive-1864-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-276ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_04:19_UTC-informational)
...
- **Nodes selected**: 105
- **Alive across all sources**: 1864
- **Fastest node RTT**: 28 ms
- **Median RTT**: 276 ms
- **Last updated (UTC)**: 2026-06-08 04:19 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 50 · trojan × 21 · vless × 28 · vmess × 5

**Sources used this run:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 1 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 33 · `ruking-clash` × 3 · `surfboard-eternity` × 5
