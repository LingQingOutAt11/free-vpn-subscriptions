...
![nodes](https://img.shields.io/badge/nodes-94-brightgreen) ![alive](https://img.shields.io/badge/alive-2284-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-243ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-20_07:19_UTC-informational)
...
- **Median RTT**: 243 ms
- **Last updated (UTC)**: 2026-06-20 07:19 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 27 · vless × 16 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 3
