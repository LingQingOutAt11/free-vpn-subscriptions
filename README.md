...
![nodes](https://img.shields.io/badge/nodes-140-brightgreen) ![alive](https://img.shields.io/badge/alive-2354-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-93ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-24_15:33_UTC-informational)
...
- **Nodes selected**: 140
- **Alive across all sources**: 2354
- **Fastest node RTT**: 36 ms
- **Median RTT**: 93 ms
- **Last updated (UTC)**: 2026-05-24 15:33 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 17 · vless × 60 · vmess × 24

**Sources used this run:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 43 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 54 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 4
