...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1985-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-140ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-07_03:10_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1985
- **Fastest node RTT**: 33 ms
- **Median RTT**: 140 ms
- **Last updated (UTC)**: 2026-05-07 03:10 UTC

**Protocol mix:** shadowsocks × 54 · trojan × 4 · vless × 82 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 2 · `ninjastrikers` × 70 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
