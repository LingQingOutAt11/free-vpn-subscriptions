...
![nodes](https://img.shields.io/badge/nodes-97-brightgreen) ![alive](https://img.shields.io/badge/alive-1903-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-476ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_12:18_UTC-informational)
...
- **Nodes selected**: 97
- **Alive across all sources**: 1903
- **Fastest node RTT**: 29 ms
- **Median RTT**: 476 ms
- **Last updated (UTC)**: 2026-06-26 12:18 UTC

**Protocol mix:** shadowsocks × 34 · trojan × 36 · vless × 18 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 8 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 13 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 20 · `surfboard-eternity` × 2
