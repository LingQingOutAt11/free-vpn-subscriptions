...
![nodes](https://img.shields.io/badge/nodes-95-brightgreen) ![alive](https://img.shields.io/badge/alive-1917-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-413ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_13:36_UTC-informational)
...
- **Nodes selected**: 95
- **Alive across all sources**: 1917
- **Fastest node RTT**: 33 ms
- **Median RTT**: 413 ms
- **Last updated (UTC)**: 2026-06-26 13:36 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 29 · trojan × 35 · vless × 18 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 10 · `epodonios` × 23 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 17 · `surfboard-eternity` × 2
