...
![nodes](https://img.shields.io/badge/nodes-122-brightgreen) ![alive](https://img.shields.io/badge/alive-1909-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-413ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-26_00:33_UTC-informational)
...
- **Median RTT**: 413 ms
- **Last updated (UTC)**: 2026-06-26 00:33 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 40 · vless × 37 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 14 · `epodonios` × 27 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `ruking-clash` × 18 · `surfboard-eternity` × 1
