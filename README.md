...
![nodes](https://img.shields.io/badge/nodes-91-brightgreen) ![alive](https://img.shields.io/badge/alive-3807-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-96ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-24_03:48_UTC-informational)
...
- **Nodes selected**: 91
- **Alive across all sources**: 3807
- **Fastest node RTT**: 29 ms
- **Median RTT**: 96 ms
- **Last updated (UTC)**: 2026-07-24 03:48 UTC

**Protocol mix:** shadowsocks × 5 · trojan × 15 · vless × 66 · vmess × 5

**Sources used this run:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 2 · `epodonios` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 3 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 42 · `tg-v2ray-configs-every2h` × 14
