...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2279-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-306ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-08_17:20_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2279
- **Fastest node RTT**: 29 ms
- **Median RTT**: 306 ms
- **Last updated (UTC)**: 2026-05-08 17:20 UTC

**Protocol mix:** shadowsocks × 51 · trojan × 17 · vless × 72 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 2 · `ninjastrikers` × 60 · `pawdroid` × 1 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 5
