...
![nodes](https://img.shields.io/badge/nodes-89-brightgreen) ![alive](https://img.shields.io/badge/alive-4116-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-44ms-orange) ![updated](https://img.shields.io/badge/updated-2026-07-26_19:41_UTC-informational)
...
- **Nodes selected**: 89
- **Alive across all sources**: 4116
- **Fastest node RTT**: 10 ms
- **Median RTT**: 44 ms
- **Last updated (UTC)**: 2026-07-26 19:41 UTC

**Protocol mix:** shadowsocks × 8 · trojan × 15 · vless × 65 · vmess × 1

**Sources used this run:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 4 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 1 · `roosterkid-openproxylist` × 6 · `ruking-clash` × 1 · `solispirit-v2ray` × 41 · `tg-v2ray-configs-every2h` × 21
