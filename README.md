...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2449-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-86ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-14_10:21_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2449
- **Fastest node RTT**: 30 ms
- **Median RTT**: 86 ms
- **Last updated (UTC)**: 2026-05-14 10:21 UTC

**Protocol mix:** shadowsocks × 43 · trojan × 6 · vless × 92 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 6 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 57 · `pawdroid` × 5 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 3
