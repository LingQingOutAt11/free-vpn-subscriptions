...
![nodes](https://img.shields.io/badge/nodes-109-brightgreen) ![alive](https://img.shields.io/badge/alive-1841-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-392ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_10:32_UTC-informational)
...
- **Median RTT**: 392 ms
- **Last updated (UTC)**: 2026-06-17 10:32 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 47 · trojan × 28 · vless × 20 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
