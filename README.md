...
![nodes](https://img.shields.io/badge/nodes-113-brightgreen) ![alive](https://img.shields.io/badge/alive-2309-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-377ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-12_07:10_UTC-informational)
...
- **Nodes selected**: 113
- **Alive across all sources**: 2309
- **Fastest node RTT**: 27 ms
- **Median RTT**: 377 ms
- **Last updated (UTC)**: 2026-06-12 07:10 UTC

**Protocol mix:** shadowsocks × 48 · trojan × 43 · vless × 16 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 26 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `pawdroid` × 1 · `ruking-clash` × 10 · `surfboard-eternity` × 4
