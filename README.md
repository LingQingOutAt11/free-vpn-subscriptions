...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2536-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-102ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-15_23:29_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2536
- **Fastest node RTT**: 32 ms
- **Median RTT**: 102 ms
- **Last updated (UTC)**: 2026-05-15 23:29 UTC

**Protocol mix:** shadowsocks × 32 · trojan × 27 · vless × 83 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 37 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 50 · `pawdroid` × 6 · `ruking-clash` × 4 · `surfboard-eternity` × 4 · `vxiaov-clash` × 1
