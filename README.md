...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2706-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-92ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-18_03:16_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2706
- **Fastest node RTT**: 32 ms
- **Median RTT**: 92 ms
- **Last updated (UTC)**: 2026-05-18 03:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 45 · trojan × 4 · vless × 93 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 6 · `epodonios` × 4 · `lagzian-mix` × 5 · `mahdi0024` × 37 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 56 · `pawdroid` × 5 · `ruking-clash` × 8 · `surfboard-eternity` × 5
