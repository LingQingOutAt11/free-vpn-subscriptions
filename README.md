...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2426-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-138ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-11_08:26_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2426
- **Fastest node RTT**: 29 ms
- **Median RTT**: 138 ms
- **Last updated (UTC)**: 2026-05-11 08:26 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 11 · vless × 92 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 6 · `mahdi0024` × 5 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 73 · `pawdroid` × 1 · `ruking-clash` × 5 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
