...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2203-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-151ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_02:29_UTC-informational)
...
- **Median RTT**: 151 ms
- **Last updated (UTC)**: 2026-05-06 02:29 UTC

**Protocol mix:** shadowsocks × 38 · trojan × 10 · vless × 92 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 29 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 4 · `ninjastrikers` × 80 · `pawdroid` × 2 · `surfboard-eternity` × 6
