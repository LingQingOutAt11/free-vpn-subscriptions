...
![nodes](https://img.shields.io/badge/nodes-126-brightgreen) ![alive](https://img.shields.io/badge/alive-1892-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-361ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-17_02:29_UTC-informational)
...
- **Nodes selected**: 126
- **Alive across all sources**: 1892
- **Fastest node RTT**: 32 ms
- **Median RTT**: 361 ms
- **Last updated (UTC)**: 2026-06-17 02:29 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 49 · trojan × 34 · vless × 29 · vmess × 13

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 15 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 1 · `ninjastrikers` × 25 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 5
