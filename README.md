...
![nodes](https://img.shields.io/badge/nodes-114-brightgreen) ![alive](https://img.shields.io/badge/alive-2389-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-483ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_17:29_UTC-informational)
...
- **Nodes selected**: 114
- **Alive across all sources**: 2389
- **Fastest node RTT**: 28 ms
- **Median RTT**: 483 ms
- **Last updated (UTC)**: 2026-06-18 17:29 UTC

**Protocol mix:** shadowsocks × 36 · trojan × 30 · vless × 40 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 17 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 8 · `pawdroid` × 1 · `ruking-clash` × 25 · `snakem982` × 9 · `surfboard-eternity` × 5
