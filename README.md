...
![nodes](https://img.shields.io/badge/nodes-115-brightgreen) ![alive](https://img.shields.io/badge/alive-2374-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-483ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-18_18:38_UTC-informational)
...
- **Nodes selected**: 115
- **Alive across all sources**: 2374
- **Fastest node RTT**: 31 ms
- **Median RTT**: 483 ms
- **Last updated (UTC)**: 2026-06-18 18:38 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 38 · trojan × 31 · vless × 35 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 32 · `snakem982` × 10 · `surfboard-eternity` × 5
