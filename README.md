...
![nodes](https://img.shields.io/badge/nodes-120-brightgreen) ![alive](https://img.shields.io/badge/alive-1841-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-278ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-08_01:16_UTC-informational)
...
- **Nodes selected**: 120
- **Alive across all sources**: 1841
- **Fastest node RTT**: 31 ms
- **Median RTT**: 278 ms
- **Last updated (UTC)**: 2026-06-08 01:16 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 52 · trojan × 27 · vless × 34 · vmess × 6

**Sources used this run:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 2 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 3 · `ninjastrikers` × 35 · `pawdroid` × 4 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
