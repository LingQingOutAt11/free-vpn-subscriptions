...
![nodes](https://img.shields.io/badge/nodes-114-brightgreen) ![alive](https://img.shields.io/badge/alive-2039-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-360ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-24_14:25_UTC-informational)
...
- **Nodes selected**: 114
- **Alive across all sources**: 2039
- **Fastest node RTT**: 31 ms
- **Median RTT**: 360 ms
- **Last updated (UTC)**: 2026-06-24 14:25 UTC

**Protocol mix:** hysteria2 × 2 · shadowsocks × 33 · trojan × 29 · vless × 34 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 40 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 6
