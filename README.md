...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2574-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-76ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-16_13:22_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2574
- **Fastest node RTT**: 34 ms
- **Median RTT**: 76 ms
- **Last updated (UTC)**: 2026-05-16 13:22 UTC

**Protocol mix:** shadowsocks × 33 · trojan × 16 · vless × 93 · vmess × 8

**Sources used this run:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 38 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 55 · `pawdroid` × 11 · `ruking-clash` × 5 · `snakem982` × 1 · `surfboard-eternity` × 2
