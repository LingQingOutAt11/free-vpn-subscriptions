...
![nodes](https://img.shields.io/badge/nodes-83-brightgreen) ![alive](https://img.shields.io/badge/alive-2437-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-147ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-01_08:08_UTC-informational)
...
- **Nodes selected**: 83
- **Alive across all sources**: 2437
- **Fastest node RTT**: 27 ms
- **Median RTT**: 147 ms
- **Last updated (UTC)**: 2026-06-01 08:08 UTC

**Protocol mix:** shadowsocks × 14 · trojan × 29 · vless × 10 · vmess × 30

**Sources used this run:** `barry-far-v2ray` × 18 · `epodonios` × 15 · `mahdi0024` × 21 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `surfboard-eternity` × 3
