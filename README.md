...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1945-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-363ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-06_18:16_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1945
- **Fastest node RTT**: 38 ms
- **Median RTT**: 363 ms
- **Last updated (UTC)**: 2026-05-06 18:16 UTC

**Protocol mix:** shadowsocks × 46 · trojan × 24 · vless × 68 · vmess × 12

**Sources used this run:** `barry-far-v2ray` × 31 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 2 · `ninjastrikers` × 57 · `pawdroid` × 2 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
