...
![nodes](https://img.shields.io/badge/nodes-144-brightgreen) ![alive](https://img.shields.io/badge/alive-2064-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-367ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-23_04:34_UTC-informational)
...
- **Median RTT**: 367 ms
- **Last updated (UTC)**: 2026-06-23 04:34 UTC

**Protocol mix:** shadowsocks × 39 · trojan × 29 · vless × 60 · vmess × 16

**Sources used this run:** `barry-far-v2ray` × 11 · `epodonios` × 54 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 18 · `surfboard-eternity` × 5
