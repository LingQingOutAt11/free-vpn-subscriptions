...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-1961-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-466ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-22_18:12_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 1961
- **Fastest node RTT**: 28 ms
- **Median RTT**: 466 ms
- **Last updated (UTC)**: 2026-06-22 18:12 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 41 · trojan × 22 · vless × 76 · vmess × 10

**Sources used this run:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 53 · `lagzian-mix` × 1 · `mahdi0024` × 14 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 23 · `snakem982` × 3 · `surfboard-eternity` × 3
