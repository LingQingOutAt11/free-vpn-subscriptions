...
![nodes](https://img.shields.io/badge/nodes-132-brightgreen) ![alive](https://img.shields.io/badge/alive-2525-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-235ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-09_16:13_UTC-informational)
...
- **Median RTT**: 235 ms
- **Last updated (UTC)**: 2026-05-09 16:13 UTC

**Protocol mix:** shadowsocks × 50 · trojan × 18 · vless × 57 · vmess × 7

**Sources used this run:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 2 · `ruking-clash` × 4 · `snakem982` × 3 · `surfboard-eternity` × 7
