...
![nodes](https://img.shields.io/badge/nodes-96-brightgreen) ![alive](https://img.shields.io/badge/alive-2300-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-162ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-30_22:16_UTC-informational)
...
- **Nodes selected**: 96
- **Alive across all sources**: 2300
- **Fastest node RTT**: 29 ms
- **Median RTT**: 162 ms
- **Last updated (UTC)**: 2026-05-30 22:16 UTC

**Protocol mix:** shadowsocks × 23 · trojan × 36 · vless × 9 · vmess × 28

**Sources used this run:** `barry-far-v2ray` × 24 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 28 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 10 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 3
