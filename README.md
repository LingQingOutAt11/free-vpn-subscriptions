...
![nodes](https://img.shields.io/badge/nodes-86-brightgreen) ![alive](https://img.shields.io/badge/alive-2055-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-199ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-28_06:27_UTC-informational)
...
- **Nodes selected**: 86
- **Alive across all sources**: 2055
- **Fastest node RTT**: 32 ms
- **Median RTT**: 199 ms
- **Last updated (UTC)**: 2026-05-28 06:27 UTC

**Protocol mix:** hysteria2 × 1 · shadowsocks × 28 · trojan × 25 · vless × 21 · vmess × 11

**Sources used this run:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 2 · `epodonios` × 18 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 3 · `surfboard-eternity` × 4
