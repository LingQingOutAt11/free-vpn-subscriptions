...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2318-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-100ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-20_04:32_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2318
- **Fastest node RTT**: 35 ms
- **Median RTT**: 100 ms
- **Last updated (UTC)**: 2026-05-20 04:32 UTC

**Protocol mix:** shadowsocks × 45 · trojan × 7 · vless × 76 · vmess × 22

**Sources used this run:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 55 · `pawdroid` × 7 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 8 · `vxiaov-clash` × 1
