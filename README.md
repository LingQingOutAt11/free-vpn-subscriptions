...
![nodes](https://img.shields.io/badge/nodes-150-brightgreen) ![alive](https://img.shields.io/badge/alive-2131-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-179ms-orange) ![updated](https://img.shields.io/badge/updated-2026-06-21_00:11_UTC-informational)
...
- **Nodes selected**: 150
- **Alive across all sources**: 2131
- **Fastest node RTT**: 31 ms
- **Median RTT**: 179 ms
- **Last updated (UTC)**: 2026-06-21 00:11 UTC

**Protocol mix:** shadowsocks × 42 · trojan × 23 · vless × 64 · vmess × 21

**Sources used this run:** `barry-far-v2ray` × 12 · `epodonios` × 40 · `mahdi0024` × 29 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 6 · `ninjastrikers` × 24 · `pawdroid` × 2 · `ruking-clash` × 15 · `snakem982` × 2 · `surfboard-eternity` × 2
