...
![nodes](https://img.shields.io/badge/nodes-77-brightgreen) ![alive](https://img.shields.io/badge/alive-2010-blue) ![median--rtt](https://img.shields.io/badge/median--rtt-420ms-orange) ![updated](https://img.shields.io/badge/updated-2026-05-27_23:11_UTC-informational)
...
- **Nodes selected**: 77
- **Alive across all sources**: 2010
- **Fastest node RTT**: 35 ms
- **Median RTT**: 420 ms
- **Last updated (UTC)**: 2026-05-27 23:11 UTC

**Protocol mix:** shadowsocks × 25 · trojan × 36 · vless × 7 · vmess × 9

**Sources used this run:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 3 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `ruking-clash` × 3 · `snakem982` × 4 · `surfboard-eternity` × 2
