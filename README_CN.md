...
![节点](https://img.shields.io/badge/节点-85-brightgreen) ![存活](https://img.shields.io/badge/存活-4014-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-368ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-21_03:50_UTC-informational)
...
- **最快延迟**: 41 ms
- **中位延迟**: 368 ms
- **最后更新 (UTC)**: 2026-07-21 03:50 UTC

**协议分布:** shadowsocks × 5 · trojan × 20 · vless × 55 · vmess × 5

**本次使用的源:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 3 · `roosterkid-openproxylist` × 2 · `solispirit-v2ray` × 39 · `tg-v2ray-configs-every2h` × 12
