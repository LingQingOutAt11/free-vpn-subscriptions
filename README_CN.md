...
![节点](https://img.shields.io/badge/节点-94-brightgreen) ![存活](https://img.shields.io/badge/存活-1843-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-356ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_17:30_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 356 ms
- **最后更新 (UTC)**: 2026-06-30 17:30 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 38 · trojan × 34 · vless × 14 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 10 · `ruking-clash` × 12 · `surfboard-eternity` × 2
