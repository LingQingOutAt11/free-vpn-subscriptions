...
![节点](https://img.shields.io/badge/节点-132-brightgreen) ![存活](https://img.shields.io/badge/存活-2132-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-80ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-26_14:30_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 80 ms
- **最后更新 (UTC)**: 2026-05-26 14:30 UTC

**协议分布:** shadowsocks × 26 · trojan × 24 · vless × 67 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 25 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 8 · `ruking-clash` × 8 · `surfboard-eternity` × 1
