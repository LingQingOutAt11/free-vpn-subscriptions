...
![节点](https://img.shields.io/badge/节点-97-brightgreen) ![存活](https://img.shields.io/badge/存活-4017-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-229ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-23_08:51_UTC-informational)
...
- **最快延迟**: 40 ms
- **中位延迟**: 229 ms
- **最后更新 (UTC)**: 2026-07-23 08:51 UTC

**协议分布:** shadowsocks × 7 · trojan × 22 · vless × 67 · vmess × 1

**本次使用的源:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 6 · `barry-far-v2ray` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 1 · `solispirit-v2ray` × 42 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 13
