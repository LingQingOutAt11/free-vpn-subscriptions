...
![节点](https://img.shields.io/badge/节点-57-brightgreen) ![存活](https://img.shields.io/badge/存活-3559-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-537ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-15_14:14_UTC-informational)
...
- **最快延迟**: 22 ms
- **中位延迟**: 537 ms
- **最后更新 (UTC)**: 2026-07-15 14:14 UTC

**协议分布:** shadowsocks × 1 · trojan × 14 · vless × 36 · vmess × 6

**本次使用的源:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 1 · `mahdibland-aggregator` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 1 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 28 · `tg-v2ray-configs-every2h` × 10
