...
![节点](https://img.shields.io/badge/节点-97-brightgreen) ![存活](https://img.shields.io/badge/存活-3447-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-388ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-30_08:56_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 388 ms
- **最后更新 (UTC)**: 2026-07-30 08:56 UTC

**协议分布:** shadowsocks × 7 · trojan × 21 · vless × 61 · vmess × 8

**本次使用的源:** `autojiedian-clash` × 23 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 1 · `go4sharing-clash` × 1 · `mahdi0024` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `ninjastrikers` × 7 · `pawdroid` × 7 · `roosterkid-openproxylist` × 9 · `solispirit-v2ray` × 23 · `tg-v2ray-configs-every2h` × 10
