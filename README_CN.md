...
![节点](https://img.shields.io/badge/节点-85-brightgreen) ![存活](https://img.shields.io/badge/存活-2128-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-180ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_16:19_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 180 ms
- **最后更新 (UTC)**: 2026-06-06 16:19 UTC

**协议分布:** shadowsocks × 27 · trojan × 26 · vless × 8 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 13 · `mahdi0024` × 35 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 4
