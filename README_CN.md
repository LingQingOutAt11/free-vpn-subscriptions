...
![节点](https://img.shields.io/badge/节点-85-brightgreen) ![存活](https://img.shields.io/badge/存活-3579-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-634ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-29_19:48_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 634 ms
- **最后更新 (UTC)**: 2026-07-29 19:48 UTC

**协议分布:** shadowsocks × 6 · trojan × 34 · vless × 35 · vmess × 10

**本次使用的源:** `autojiedian-clash` × 8 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 22 · `tg-v2ray-configs-every2h` × 12
