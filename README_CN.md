...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2126-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-186ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_04:29_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 186 ms
- **最后更新 (UTC)**: 2026-06-21 04:29 UTC

**协议分布:** shadowsocks × 37 · trojan × 33 · vless × 58 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 35 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 28 · `surfboard-eternity` × 2
