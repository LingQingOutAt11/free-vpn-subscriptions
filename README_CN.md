...
![节点](https://img.shields.io/badge/节点-46-brightgreen) ![存活](https://img.shields.io/badge/存活-2073-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-166ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-29_11:17_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 166 ms
- **最后更新 (UTC)**: 2026-05-29 11:17 UTC

**协议分布:** shadowsocks × 20 · trojan × 11 · vless × 6 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 7 · `pawdroid` × 1 · `ruking-clash` × 2 · `snakem982` × 3 · `surfboard-eternity` × 3
