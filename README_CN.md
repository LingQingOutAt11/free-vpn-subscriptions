...
![节点](https://img.shields.io/badge/节点-124-brightgreen) ![存活](https://img.shields.io/badge/存活-1928-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-493ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_05:17_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 493 ms
- **最后更新 (UTC)**: 2026-06-18 05:17 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 41 · trojan × 30 · vless × 46 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 14 · `epodonios` × 17 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 26 · `pawdroid` × 4 · `ruking-clash` × 19 · `snakem982` × 7 · `surfboard-eternity` × 3
