...
![节点](https://img.shields.io/badge/节点-81-brightgreen) ![存活](https://img.shields.io/badge/存活-2327-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-367ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_18:21_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 367 ms
- **最后更新 (UTC)**: 2026-06-11 18:21 UTC

**协议分布:** shadowsocks × 47 · trojan × 13 · vless × 16 · vmess × 5

**本次使用的源:** `barry-far-v2ray` × 9 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 3
