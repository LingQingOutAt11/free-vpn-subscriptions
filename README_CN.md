...
![节点](https://img.shields.io/badge/节点-111-brightgreen) ![存活](https://img.shields.io/badge/存活-1925-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-401ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_03:17_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 401 ms
- **最后更新 (UTC)**: 2026-06-26 03:17 UTC

**协议分布:** shadowsocks × 32 · trojan × 40 · vless × 27 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 10 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `ruking-clash` × 17 · `surfboard-eternity` × 3
