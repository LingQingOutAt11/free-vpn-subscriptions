...
![节点](https://img.shields.io/badge/节点-86-brightgreen) ![存活](https://img.shields.io/badge/存活-4054-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-153ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-23_14:36_UTC-informational)
...
- **最快延迟**: 18 ms
- **中位延迟**: 153 ms
- **最后更新 (UTC)**: 2026-07-23 14:36 UTC

**协议分布:** shadowsocks × 7 · trojan × 28 · vless × 49 · vmess × 2

**本次使用的源:** `automerge-verified-clash` × 3 · `barry-far-v2ray` × 4 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 1 · `roosterkid-openproxylist` × 1 · `snakem982` × 1 · `solispirit-v2ray` × 41 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 21
