...
![节点](https://img.shields.io/badge/节点-84-brightgreen) ![存活](https://img.shields.io/badge/存活-2203-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-174ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_08:25_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 174 ms
- **最后更新 (UTC)**: 2026-06-07 08:25 UTC

**协议分布:** shadowsocks × 27 · trojan × 23 · vless × 10 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 36 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 14 · `ruking-clash` × 2 · `surfboard-eternity` × 4
