...
![节点](https://img.shields.io/badge/节点-130-brightgreen) ![存活](https://img.shields.io/badge/存活-2542-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-484ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_14:21_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 484 ms
- **最后更新 (UTC)**: 2026-06-19 14:21 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 30 · trojan × 29 · vless × 50 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 16 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 42 · `snakem982` × 6 · `surfboard-eternity` × 3
