...
![节点](https://img.shields.io/badge/节点-75-brightgreen) ![存活](https://img.shields.io/badge/存活-2448-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-111ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-01_13:11_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 111 ms
- **最后更新 (UTC)**: 2026-06-01 13:11 UTC

**协议分布:** shadowsocks × 14 · trojan × 25 · vless × 7 · vmess × 29

**本次使用的源:** `barry-far-v2ray` × 17 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `ninjastrikers` × 6 · `pawdroid` × 3 · `surfboard-eternity` × 4
