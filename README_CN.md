...
![节点](https://img.shields.io/badge/节点-86-brightgreen) ![存活](https://img.shields.io/badge/存活-3987-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-350ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-20_14:40_UTC-informational)
...
- **最快延迟**: 18 ms
- **中位延迟**: 350 ms
- **最后更新 (UTC)**: 2026-07-20 14:40 UTC

**协议分布:** shadowsocks × 1 · trojan × 23 · vless × 57 · vmess × 5

**本次使用的源:** `autojiedian-clash` × 2 · `barry-far-v2ray` × 1 · `mahdi0024` × 5 · `matin-v2ray` × 10 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 39 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
