...
![节点](https://img.shields.io/badge/节点-113-brightgreen) ![存活](https://img.shields.io/badge/存活-2083-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-367ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_15:37_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 367 ms
- **最后更新 (UTC)**: 2026-06-24 15:37 UTC

**协议分布:** shadowsocks × 35 · trojan × 34 · vless × 28 · vmess × 16

**本次使用的源:** `barry-far-v2ray` × 8 · `epodonios` × 36 · `lagzian-mix` × 1 · `mahdi0024` × 15 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 5
