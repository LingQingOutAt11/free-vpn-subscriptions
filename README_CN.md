...
![节点](https://img.shields.io/badge/节点-77-brightgreen) ![存活](https://img.shields.io/badge/存活-4227-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-177ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-17_19:38_UTC-informational)
...
- **最快延迟**: 52 ms
- **中位延迟**: 177 ms
- **最后更新 (UTC)**: 2026-07-17 19:38 UTC

**协议分布:** trojan × 17 · vless × 55 · vmess × 5

**本次使用的源:** `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 7 · `pawdroid` × 6 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 33 · `tg-v2ray-configs-every2h` × 24
