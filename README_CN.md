...
![节点](https://img.shields.io/badge/节点-82-brightgreen) ![存活](https://img.shields.io/badge/存活-3728-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-227ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-16_03:41_UTC-informational)
...
- **最快延迟**: 26 ms
- **中位延迟**: 227 ms
- **最后更新 (UTC)**: 2026-07-16 03:41 UTC

**协议分布:** shadowsocks × 1 · trojan × 22 · vless × 55 · vmess × 4

**本次使用的源:** `autojiedian-clash` × 1 · `epodonios` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 4 · `ninjastrikers` × 14 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 39 · `tg-v2ray-configs-every2h` × 16
