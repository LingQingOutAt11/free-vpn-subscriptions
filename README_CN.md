...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2131-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-179ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_00:11_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 179 ms
- **最后更新 (UTC)**: 2026-06-21 00:11 UTC

**协议分布:** shadowsocks × 42 · trojan × 23 · vless × 64 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 40 · `mahdi0024` × 29 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 6 · `ninjastrikers` × 24 · `pawdroid` × 2 · `ruking-clash` × 15 · `snakem982` × 2 · `surfboard-eternity` × 2
