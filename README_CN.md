...
![节点](https://img.shields.io/badge/节点-67-brightgreen) ![存活](https://img.shields.io/badge/存活-3719-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-110ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-07_07:48_UTC-informational)
...
- **最快延迟**: 16 ms
- **中位延迟**: 110 ms
- **最后更新 (UTC)**: 2026-08-07 07:48 UTC

**协议分布:** shadowsocks × 6 · trojan × 16 · vless × 34 · vmess × 11

**本次使用的源:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 1 · `roosterkid-openproxylist` × 12 · `ruking-clash` × 1 · `solispirit-v2ray` × 19 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 8
