...
![节点](https://img.shields.io/badge/节点-96-brightgreen) ![存活](https://img.shields.io/badge/存活-1955-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-463ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_07:22_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 463 ms
- **最后更新 (UTC)**: 2026-06-18 07:22 UTC

**协议分布:** shadowsocks × 35 · trojan × 29 · vless × 23 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 13 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 17 · `snakem982` × 6 · `surfboard-eternity` × 3
