...
![节点](https://img.shields.io/badge/节点-89-brightgreen) ![存活](https://img.shields.io/badge/存活-2052-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-235ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_11:27_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 235 ms
- **最后更新 (UTC)**: 2026-06-27 11:27 UTC

**协议分布:** shadowsocks × 17 · trojan × 34 · vless × 15 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 10 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 3 · `ninjastrikers` × 12 · `ruking-clash` × 14 · `surfboard-eternity` × 3
