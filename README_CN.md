...
![节点](https://img.shields.io/badge/节点-107-brightgreen) ![存活](https://img.shields.io/badge/存活-3961-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-309ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-20_04:09_UTC-informational)
...
- **最快延迟**: 48 ms
- **中位延迟**: 309 ms
- **最后更新 (UTC)**: 2026-07-20 04:09 UTC

**协议分布:** shadowsocks × 4 · trojan × 28 · vless × 72 · vmess × 3

**本次使用的源:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 1 · `epodonios` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 4 · `matin-v2ray` × 8 · `ninjastrikers` × 13 · `pawdroid` × 5 · `roosterkid-openproxylist` × 2 · `solispirit-v2ray` × 49 · `tg-v2ray-configs-every2h` × 16
