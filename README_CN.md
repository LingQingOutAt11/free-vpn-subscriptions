...
![节点](https://img.shields.io/badge/节点-48-brightgreen) ![存活](https://img.shields.io/badge/存活-3895-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-431ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-28_19:58_UTC-informational)
...
- **最快延迟**: 18 ms
- **中位延迟**: 431 ms
- **最后更新 (UTC)**: 2026-07-28 19:58 UTC

**协议分布:** shadowsocks × 6 · trojan × 21 · vless × 20 · vmess × 1

**本次使用的源:** `autojiedian-clash` × 7 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `go4sharing-clash` × 1 · `mahdibland-aggregator` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 15 · `tg-v2ray-configs-every2h` × 6
