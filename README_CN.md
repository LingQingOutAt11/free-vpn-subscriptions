...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2576-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-80ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-16_05:38_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 80 ms
- **最后更新 (UTC)**: 2026-05-16 05:38 UTC

**协议分布:** shadowsocks × 32 · trojan × 14 · vless × 96 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 20 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 35 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 57 · `pawdroid` × 10 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 5
