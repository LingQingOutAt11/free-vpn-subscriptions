...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1975-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-141ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_04:25_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 141 ms
- **最后更新 (UTC)**: 2026-05-12 04:25 UTC

**协议分布:** shadowsocks × 56 · trojan × 5 · vless × 80 · vmess × 9

**本次使用的源:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 72 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 10
