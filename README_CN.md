...
![节点](https://img.shields.io/badge/节点-93-brightgreen) ![存活](https://img.shields.io/badge/存活-3146-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-65ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-03_20:05_UTC-informational)
...
- **最快延迟**: 12 ms
- **中位延迟**: 65 ms
- **最后更新 (UTC)**: 2026-08-03 20:05 UTC

**协议分布:** shadowsocks × 6 · trojan × 11 · vless × 67 · vmess × 9

**本次使用的源:** `autojiedian-clash` × 18 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 2 · `epodonios` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 3 · `pawdroid` × 3 · `roosterkid-openproxylist` × 16 · `snakem982` × 1 · `solispirit-v2ray` × 27 · `tg-v2ray-configs-every2h` × 8
