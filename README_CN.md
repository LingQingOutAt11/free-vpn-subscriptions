...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2401-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-139ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_21:15_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 139 ms
- **最后更新 (UTC)**: 2026-05-12 21:15 UTC

**协议分布:** shadowsocks × 37 · trojan × 17 · vless × 84 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 4 · `mahdi0024` × 44 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 47 · `snakem982` × 2 · `surfboard-eternity` × 3
