...
![节点](https://img.shields.io/badge/节点-104-brightgreen) ![存活](https://img.shields.io/badge/存活-1849-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-346ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-08_06:30_UTC-informational)
...
- **最快延迟**: 40 ms
- **中位延迟**: 346 ms
- **最后更新 (UTC)**: 2026-06-08 06:30 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 51 · trojan × 21 · vless × 26 · vmess × 5

**本次使用的源:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `pawdroid` × 6 · `ruking-clash` × 5 · `surfboard-eternity` × 6
