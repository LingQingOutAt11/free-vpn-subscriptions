...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1957-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-305ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-06_16:22_UTC-informational)
...
- **最快延迟**: 41 ms
- **中位延迟**: 305 ms
- **最后更新 (UTC)**: 2026-05-06 16:22 UTC

**协议分布:** shadowsocks × 45 · trojan × 19 · vless × 75 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 61 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
