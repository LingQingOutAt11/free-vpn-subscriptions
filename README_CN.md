...
![节点](https://img.shields.io/badge/节点-78-brightgreen) ![存活](https://img.shields.io/badge/存活-3842-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-387ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-20_09:40_UTC-informational)
...
- **最快延迟**: 18 ms
- **中位延迟**: 387 ms
- **最后更新 (UTC)**: 2026-07-20 09:40 UTC

**协议分布:** shadowsocks × 1 · trojan × 16 · vless × 55 · vmess × 6

**本次使用的源:** `automerge-verified-clash` × 3 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 5 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 39 · `tg-v2ray-configs-every2h` × 10
