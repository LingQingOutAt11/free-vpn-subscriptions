...
![节点](https://img.shields.io/badge/节点-91-brightgreen) ![存活](https://img.shields.io/badge/存活-3204-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-129ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-14_19:52_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 129 ms
- **最后更新 (UTC)**: 2026-07-14 19:52 UTC

**协议分布:** shadowsocks × 7 · trojan × 22 · vless × 51 · vmess × 11

**本次使用的源:** `autojiedian-clash` × 5 · `barry-far-v2ray` × 2 · `go4sharing-clash` × 3 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 6 · `pawdroid` × 1 · `roosterkid-openproxylist` × 10 · `solispirit-v2ray` × 38 · `tg-v2ray-configs-every2h` × 21
