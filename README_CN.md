...
![节点](https://img.shields.io/badge/节点-132-brightgreen) ![存活](https://img.shields.io/badge/存活-2195-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-490ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_08:27_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 490 ms
- **最后更新 (UTC)**: 2026-06-19 08:27 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 54 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 37 · `snakem982` × 7 · `surfboard-eternity` × 1
