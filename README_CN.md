...
![节点](https://img.shields.io/badge/节点-138-brightgreen) ![存活](https://img.shields.io/badge/存活-3088-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-223ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-05_04:27_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 223 ms
- **最后更新 (UTC)**: 2026-07-05 04:27 UTC

**协议分布:** shadowsocks × 18 · trojan × 31 · vless × 78 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 1 · `radikal-clash` × 6 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 56 · `tg-v2ray-configs-every2h` × 24
