...
![节点](https://img.shields.io/badge/节点-99-brightgreen) ![存活](https://img.shields.io/badge/存活-2266-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-130ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-31_05:25_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 130 ms
- **最后更新 (UTC)**: 2026-05-31 05:25 UTC

**协议分布:** shadowsocks × 16 · trojan × 30 · vless × 24 · vmess × 29

**本次使用的源:** `barry-far-v2ray` × 18 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 29 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 23 · `pawdroid` × 2
