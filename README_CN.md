...
![节点](https://img.shields.io/badge/节点-113-brightgreen) ![存活](https://img.shields.io/badge/存活-1932-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-290ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_02:18_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 290 ms
- **最后更新 (UTC)**: 2026-06-13 02:18 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 51 · trojan × 24 · vless × 29 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 35 · `pawdroid` × 5 · `ruking-clash` × 9 · `surfboard-eternity` × 4
