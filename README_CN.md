...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2440-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-129ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-13_20:31_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 129 ms
- **最后更新 (UTC)**: 2026-05-13 20:31 UTC

**协议分布:** shadowsocks × 40 · trojan × 22 · vless × 80 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 29 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 5 · `ruking-clash` × 4 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
