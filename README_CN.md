...
![节点](https://img.shields.io/badge/节点-80-brightgreen) ![存活](https://img.shields.io/badge/存活-3958-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-107ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-24_14:18_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 107 ms
- **最后更新 (UTC)**: 2026-07-24 14:18 UTC

**协议分布:** shadowsocks × 3 · trojan × 16 · vless × 57 · vmess × 4

**本次使用的源:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `roosterkid-openproxylist` × 1 · `snakem982` × 2 · `solispirit-v2ray` × 31 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 25
