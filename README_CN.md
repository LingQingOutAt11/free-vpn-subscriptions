...
![节点](https://img.shields.io/badge/节点-136-brightgreen) ![存活](https://img.shields.io/badge/存活-2229-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-69ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_12:28_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 69 ms
- **最后更新 (UTC)**: 2026-05-19 12:28 UTC

**协议分布:** shadowsocks × 16 · trojan × 20 · vless × 80 · vmess × 20

**本次使用的源:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 10 · `surfboard-eternity` × 3
