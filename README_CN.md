...
![节点](https://img.shields.io/badge/节点-145-brightgreen) ![存活](https://img.shields.io/badge/存活-2789-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-238ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-11_03:48_UTC-informational)
...
- **最快延迟**: 23 ms
- **中位延迟**: 238 ms
- **最后更新 (UTC)**: 2026-07-11 03:48 UTC

**协议分布:** shadowsocks × 7 · trojan × 30 · vless × 94 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 5 · `radikal-clash` × 9 · `roosterkid-openproxylist` × 23 · `ruking-clash` × 1 · `solispirit-v2ray` × 49 · `tg-v2ray-configs-every2h` × 22
