...
![节点](https://img.shields.io/badge/节点-142-brightgreen) ![存活](https://img.shields.io/badge/存活-1972-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-471ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_15:14_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 471 ms
- **最后更新 (UTC)**: 2026-06-21 15:14 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 45 · trojan × 28 · vless × 58 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 33 · `snakem982` × 5 · `surfboard-eternity` × 2
