...
![节点](https://img.shields.io/badge/节点-63-brightgreen) ![存活](https://img.shields.io/badge/存活-1891-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-147ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-27_06:27_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 147 ms
- **最后更新 (UTC)**: 2026-05-27 06:27 UTC

**协议分布:** shadowsocks × 26 · trojan × 14 · vless × 12 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 1 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 9 · `pawdroid` × 1 · `ruking-clash` × 8 · `snakem982` × 1 · `surfboard-eternity` × 4
