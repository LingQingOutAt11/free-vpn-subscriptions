...
![节点](https://img.shields.io/badge/节点-122-brightgreen) ![存活](https://img.shields.io/badge/存活-1909-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-413ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_00:33_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 413 ms
- **最后更新 (UTC)**: 2026-06-26 00:33 UTC

**协议分布:** shadowsocks × 32 · trojan × 40 · vless × 37 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 14 · `epodonios` × 27 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `ruking-clash` × 18 · `surfboard-eternity` × 1
