...
![节点](https://img.shields.io/badge/节点-93-brightgreen) ![存活](https://img.shields.io/badge/存活-3953-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-299ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-20_20:04_UTC-informational)
...
- **最快延迟**: 19 ms
- **中位延迟**: 299 ms
- **最后更新 (UTC)**: 2026-07-20 20:04 UTC

**协议分布:** shadowsocks × 2 · trojan × 23 · vless × 61 · vmess × 7

**本次使用的源:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 4 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 42 · `tg-v2ray-configs-every2h` × 22
