...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1973-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-141ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_01:21_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 141 ms
- **最后更新 (UTC)**: 2026-05-12 01:21 UTC

**协议分布:** shadowsocks × 59 · trojan × 3 · vless × 78 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 4 · `epodonios` × 5 · `lagzian-mix` × 7 · `mahdi0024` × 4 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 58 · `ruking-clash` × 1 · `snakem982` × 2 · `surfboard-eternity` × 12 · `vxiaov-clash` × 1
