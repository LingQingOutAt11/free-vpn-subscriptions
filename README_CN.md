...
![节点](https://img.shields.io/badge/节点-138-brightgreen) ![存活](https://img.shields.io/badge/存活-1978-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-427ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_17:22_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 427 ms
- **最后更新 (UTC)**: 2026-06-21 17:22 UTC

**协议分布:** shadowsocks × 45 · trojan × 33 · vless × 48 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 17 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 28 · `snakem982` × 6 · `surfboard-eternity` × 4
