...
![节点](https://img.shields.io/badge/节点-134-brightgreen) ![存活](https://img.shields.io/badge/存活-2084-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-465ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_21:20_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 465 ms
- **最后更新 (UTC)**: 2026-06-20 21:20 UTC

**协议分布:** shadowsocks × 39 · trojan × 35 · vless × 36 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 13 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 5 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 35 · `snakem982` × 1 · `surfboard-eternity` × 1
