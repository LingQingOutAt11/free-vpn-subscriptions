...
![节点](https://img.shields.io/badge/节点-89-brightgreen) ![存活](https://img.shields.io/badge/存活-4116-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-44ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-26_19:41_UTC-informational)
...
- **最快延迟**: 10 ms
- **中位延迟**: 44 ms
- **最后更新 (UTC)**: 2026-07-26 19:41 UTC

**协议分布:** shadowsocks × 8 · trojan × 15 · vless × 65 · vmess × 1

**本次使用的源:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 4 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 1 · `roosterkid-openproxylist` × 6 · `ruking-clash` × 1 · `solispirit-v2ray` × 41 · `tg-v2ray-configs-every2h` × 21
