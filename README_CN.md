...
![节点](https://img.shields.io/badge/节点-137-brightgreen) ![存活](https://img.shields.io/badge/存活-2097-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-414ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_08:30_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 414 ms
- **最后更新 (UTC)**: 2026-06-21 08:30 UTC

**协议分布:** shadowsocks × 37 · trojan × 32 · vless × 44 · vmess × 24

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 38 · `snakem982` × 3 · `surfboard-eternity` × 4
