...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2401-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-111ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-13_00:30_UTC-informational)
...
- **最快延迟**: 39 ms
- **中位延迟**: 111 ms
- **最后更新 (UTC)**: 2026-05-13 00:30 UTC

**协议分布:** shadowsocks × 36 · trojan × 3 · vless × 98 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 3 · `mahdi0024` × 37 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 68 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 5
