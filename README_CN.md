...
![节点](https://img.shields.io/badge/节点-76-brightgreen) ![存活](https://img.shields.io/badge/存活-4154-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-45ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-24_19:53_UTC-informational)
...
- **最快延迟**: 14 ms
- **中位延迟**: 45 ms
- **最后更新 (UTC)**: 2026-07-24 19:53 UTC

**协议分布:** shadowsocks × 7 · trojan × 11 · vless × 56 · vmess × 2

**本次使用的源:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 6 · `epodonios` × 1 · `go4sharing-clash` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 6 · `roosterkid-openproxylist` × 4 · `snakem982` × 1 · `solispirit-v2ray` × 30 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 22
