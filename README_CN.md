...
![节点](https://img.shields.io/badge/节点-106-brightgreen) ![存活](https://img.shields.io/badge/存活-3795-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-147ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-12_02:50_UTC-informational)
...
- **最快延迟**: 50 ms
- **中位延迟**: 147 ms
- **最后更新 (UTC)**: 2026-08-12 02:50 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 19 · trojan × 20 · vless × 51 · vmess × 15

**本次使用的源:** `autojiedian-clash` × 15 · `automerge-verified-clash` × 23 · `barry-far-v2ray` × 1 · `epodonios` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 16 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 12
