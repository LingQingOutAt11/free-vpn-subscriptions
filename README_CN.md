...
![节点](https://img.shields.io/badge/节点-109-brightgreen) ![存活](https://img.shields.io/badge/存活-3630-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-132ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-19_08:39_UTC-informational)
...
- **最快延迟**: 21 ms
- **中位延迟**: 132 ms
- **最后更新 (UTC)**: 2026-07-19 08:39 UTC

**协议分布:** shadowsocks × 4 · trojan × 18 · vless × 79 · vmess × 8

**本次使用的源:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 4 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 4 · `roosterkid-openproxylist` × 7 · `solispirit-v2ray` × 48 · `tg-v2ray-configs-every2h` × 20
