...
![节点](https://img.shields.io/badge/节点-93-brightgreen) ![存活](https://img.shields.io/badge/存活-4049-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-214ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-21_19:58_UTC-informational)
...
- **最快延迟**: 41 ms
- **中位延迟**: 214 ms
- **最后更新 (UTC)**: 2026-07-21 19:58 UTC

**协议分布:** shadowsocks × 11 · trojan × 23 · vless × 54 · vmess × 5

**本次使用的源:** `autojiedian-clash` × 6 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `roosterkid-openproxylist` × 15 · `solispirit-v2ray` × 34 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 12
