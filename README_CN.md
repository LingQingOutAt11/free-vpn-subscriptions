...
![节点](https://img.shields.io/badge/节点-133-brightgreen) ![存活](https://img.shields.io/badge/存活-1884-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-465ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_02:27_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 465 ms
- **最后更新 (UTC)**: 2026-06-18 02:27 UTC

**协议分布:** hysteria2 × 4 · shadowsocks × 46 · trojan × 32 · vless × 43 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 3 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 25 · `pawdroid` × 3 · `ruking-clash` × 32 · `surfboard-eternity` × 3
