...
![节点](https://img.shields.io/badge/节点-90-brightgreen) ![存活](https://img.shields.io/badge/存活-1955-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-204ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_10:40_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 204 ms
- **最后更新 (UTC)**: 2026-06-04 10:40 UTC

**协议分布:** shadowsocks × 23 · trojan × 40 · vless × 17 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 30 · `epodonios` × 29 · `lagzian-mix` × 2 · `mahdi0024` × 13 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 7 · `surfboard-eternity` × 2
