...
![节点](https://img.shields.io/badge/节点-80-brightgreen) ![存活](https://img.shields.io/badge/存活-4137-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-160ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-22_19:50_UTC-informational)
...
- **最快延迟**: 31 ms
- **中位延迟**: 160 ms
- **最后更新 (UTC)**: 2026-07-22 19:50 UTC

**协议分布:** shadowsocks × 5 · trojan × 15 · vless × 54 · vmess × 6

**本次使用的源:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 5 · `mahdi0024` × 1 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 4 · `ninjastrikers` × 8 · `pawdroid` × 1 · `roosterkid-openproxylist` × 13 · `solispirit-v2ray` × 30 · `tg-v2ray-configs-every2h` × 13
