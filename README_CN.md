...
![节点](https://img.shields.io/badge/节点-76-brightgreen) ![存活](https://img.shields.io/badge/存活-2222-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-246ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_23:32_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 246 ms
- **最后更新 (UTC)**: 2026-06-28 23:32 UTC

**协议分布:** shadowsocks × 17 · trojan × 26 · vless × 18 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 11 · `ninjastrikers` × 12 · `ruking-clash` × 1 · `surfboard-eternity` × 4
