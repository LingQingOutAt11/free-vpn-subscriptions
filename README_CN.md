...
![节点](https://img.shields.io/badge/节点-125-brightgreen) ![存活](https://img.shields.io/badge/存活-2291-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-78ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-18_17:27_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 78 ms
- **最后更新 (UTC)**: 2026-05-18 17:27 UTC

**协议分布:** shadowsocks × 14 · trojan × 25 · vless × 67 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 22 · `epodonios` × 6 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 53 · `pawdroid` × 10 · `ruking-clash` × 3 · `surfboard-eternity` × 5
