...
![节点](https://img.shields.io/badge/节点-90-brightgreen) ![存活](https://img.shields.io/badge/存活-3327-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-218ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-19_13:59_UTC-informational)
...
- **最快延迟**: 48 ms
- **中位延迟**: 218 ms
- **最后更新 (UTC)**: 2026-07-19 13:59 UTC

**协议分布:** shadowsocks × 6 · trojan × 20 · vless × 54 · vmess × 10

**本次使用的源:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 3 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 2 · `roosterkid-openproxylist` × 3 · `solispirit-v2ray` × 40 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 20
