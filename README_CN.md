...
![节点](https://img.shields.io/badge/节点-113-brightgreen) ![存活](https://img.shields.io/badge/存活-2156-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-136ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-29_00:28_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 136 ms
- **最后更新 (UTC)**: 2026-05-29 00:28 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 26 · trojan × 40 · vless × 38 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 40 · `ruking-clash` × 2
