...
![节点](https://img.shields.io/badge/节点-126-brightgreen) ![存活](https://img.shields.io/badge/存活-1915-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-485ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_04:13_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 485 ms
- **最后更新 (UTC)**: 2026-06-18 04:13 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 44 · trojan × 30 · vless × 44 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 21 · `epodonios` × 17 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 25 · `pawdroid` × 2 · `ruking-clash` × 21 · `snakem982` × 6 · `surfboard-eternity` × 2
