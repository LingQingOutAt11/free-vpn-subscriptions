...
![节点](https://img.shields.io/badge/节点-113-brightgreen) ![存活](https://img.shields.io/badge/存活-2300-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-115ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-31_00:20_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 115 ms
- **最后更新 (UTC)**: 2026-05-31 00:20 UTC

**协议分布:** shadowsocks × 24 · trojan × 30 · vless × 31 · vmess × 28

**本次使用的源:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 33 · `surfboard-eternity` × 1
