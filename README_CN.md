...
![节点](https://img.shields.io/badge/节点-71-brightgreen) ![存活](https://img.shields.io/badge/存活-3443-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-62ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-04_20:04_UTC-informational)
...
- **最快延迟**: 18 ms
- **中位延迟**: 62 ms
- **最后更新 (UTC)**: 2026-08-04 20:04 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 5 · trojan × 8 · vless × 47 · vmess × 10

**本次使用的源:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `ninjastrikers` × 4 · `pawdroid` × 4 · `roosterkid-openproxylist` × 15 · `ruking-clash` × 1 · `snakem982` × 3 · `solispirit-v2ray` × 11 · `tg-v2ray-configs-every2h` × 8
