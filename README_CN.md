...
![节点](https://img.shields.io/badge/节点-114-brightgreen) ![存活](https://img.shields.io/badge/存活-1936-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-302ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_03:35_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 302 ms
- **最后更新 (UTC)**: 2026-06-13 03:35 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 50 · trojan × 25 · vless × 31 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 33 · `pawdroid` × 6 · `ruking-clash` × 13 · `surfboard-eternity` × 7
