...
![节点](https://img.shields.io/badge/节点-59-brightgreen) ![存活](https://img.shields.io/badge/存活-1988-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-125ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-27_20:36_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 125 ms
- **最后更新 (UTC)**: 2026-05-27 20:36 UTC

**协议分布:** shadowsocks × 26 · trojan × 4 · vless × 21 · vmess × 8

**本次使用的源:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 5 · `pawdroid` × 2 · `ruking-clash` × 5 · `snakem982` × 3 · `surfboard-eternity` × 3
