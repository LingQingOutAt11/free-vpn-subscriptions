...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-1911-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-387ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_06:31_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 387 ms
- **最后更新 (UTC)**: 2026-06-22 06:31 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 45 · trojan × 32 · vless × 58 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 30 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 25 · `pawdroid` × 4 · `ruking-clash` × 25 · `snakem982` × 3 · `surfboard-eternity` × 4
