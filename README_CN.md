...
![节点](https://img.shields.io/badge/节点-128-brightgreen) ![存活](https://img.shields.io/badge/存活-2397-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-451ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_01:17_UTC-informational)
...
- **最快延迟**: 36 ms
- **中位延迟**: 451 ms
- **最后更新 (UTC)**: 2026-06-19 01:17 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 37 · trojan × 28 · vless × 50 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 26 · `pawdroid` × 7 · `ruking-clash` × 26 · `snakem982` × 8 · `surfboard-eternity` × 2
