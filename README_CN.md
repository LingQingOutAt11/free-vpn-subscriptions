...
![节点](https://img.shields.io/badge/节点-68-brightgreen) ![存活](https://img.shields.io/badge/存活-1981-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-324ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_23:15_UTC-informational)
...
- **最快延迟**: 48 ms
- **中位延迟**: 324 ms
- **最后更新 (UTC)**: 2026-06-30 23:15 UTC

**协议分布:** shadowsocks × 27 · trojan × 28 · vless × 7 · vmess × 6

**本次使用的源:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 13 · `ruking-clash` × 4 · `surfboard-eternity` × 5
