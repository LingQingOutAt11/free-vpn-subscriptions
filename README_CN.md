...
![节点](https://img.shields.io/badge/节点-127-brightgreen) ![存活](https://img.shields.io/badge/存活-1687-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-384ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_05:30_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 384 ms
- **最后更新 (UTC)**: 2026-06-14 05:30 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 50 · trojan × 36 · vless × 33 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 5 · `mahdi0024` × 5 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 32 · `pawdroid` × 4 · `ruking-clash` × 23 · `surfboard-eternity` × 1
