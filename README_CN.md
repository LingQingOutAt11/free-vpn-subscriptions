...
![节点](https://img.shields.io/badge/节点-67-brightgreen) ![存活](https://img.shields.io/badge/存活-3460-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-108ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-05_14:39_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 108 ms
- **最后更新 (UTC)**: 2026-08-05 14:39 UTC

**协议分布:** shadowsocks × 3 · trojan × 20 · vless × 38 · vmess × 6

**本次使用的源:** `autojiedian-clash` × 6 · `automerge-verified-clash` × 10 · `mahdi0024` × 6 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 5 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 12 · `solispirit-v2ray` × 15 · `tg-v2ray-configs-every2h` × 9
