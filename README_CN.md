...
![节点](https://img.shields.io/badge/节点-80-brightgreen) ![存活](https://img.shields.io/badge/存活-3556-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-136ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-11_19:27_UTC-informational)
...
- **最快延迟**: 35 ms
- **中位延迟**: 136 ms
- **最后更新 (UTC)**: 2026-08-11 19:27 UTC

**协议分布:** hysteria2 × 3 · shadowsocks × 22 · trojan × 7 · vless × 36 · vmess × 12

**本次使用的源:** `autojiedian-clash` × 15 · `automerge-verified-clash` × 14 · `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 2 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 2 · `solispirit-v2ray` × 2 · `tg-v2ray-configs-every2h` × 12
