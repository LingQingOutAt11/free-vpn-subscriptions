...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2046-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-141ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-07_00:17_UTC-informational)
...
- **最快延迟**: 39 ms
- **中位延迟**: 141 ms
- **最后更新 (UTC)**: 2026-05-07 00:17 UTC

**协议分布:** shadowsocks × 50 · trojan × 5 · vless × 83 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 25 · `epodonios` × 8 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 5 · `ninjastrikers` × 63 · `pawdroid` × 3 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 6 · `vxiaov-clash` × 1
