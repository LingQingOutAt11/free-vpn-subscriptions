...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2375-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-100ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-23_19:18_UTC-informational)
...
- **最快延迟**: 42 ms
- **中位延迟**: 100 ms
- **最后更新 (UTC)**: 2026-05-23 19:18 UTC

**协议分布:** shadowsocks × 41 · trojan × 18 · vless × 66 · vmess × 25

**本次使用的源:** `barry-far-v2ray` × 19 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 42 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 1 · `ninjastrikers` × 52 · `pawdroid` × 6 · `surfboard-eternity` × 4
