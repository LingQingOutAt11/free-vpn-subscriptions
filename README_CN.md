...
![节点](https://img.shields.io/badge/节点-147-brightgreen) ![存活](https://img.shields.io/badge/存活-2093-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-411ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_06:14_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 411 ms
- **最后更新 (UTC)**: 2026-06-21 06:14 UTC

**协议分布:** shadowsocks × 38 · trojan × 34 · vless × 50 · vmess × 25

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 39 · `snakem982` × 4 · `surfboard-eternity` × 3
