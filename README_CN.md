...
![节点](https://img.shields.io/badge/节点-122-brightgreen) ![存活](https://img.shields.io/badge/存活-1614-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-407ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_19:12_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 407 ms
- **最后更新 (UTC)**: 2026-06-14 19:12 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 61 · trojan × 29 · vless × 19 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 13 · `ruking-clash` × 20 · `surfboard-eternity` × 8
