...
![节点](https://img.shields.io/badge/节点-135-brightgreen) ![存活](https://img.shields.io/badge/存活-2063-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-377ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_11:11_UTC-informational)
...
- **最快延迟**: 28 ms
- **中位延迟**: 377 ms
- **最后更新 (UTC)**: 2026-06-21 11:11 UTC

**协议分布:** shadowsocks × 40 · trojan × 30 · vless × 44 · vmess × 21

**本次使用的源:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 39 · `snakem982` × 1 · `surfboard-eternity` × 3
