...
![节点](https://img.shields.io/badge/节点-89-brightgreen) ![存活](https://img.shields.io/badge/存活-4075-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-113ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-23_03:49_UTC-informational)
...
- **最快延迟**: 16 ms
- **中位延迟**: 113 ms
- **最后更新 (UTC)**: 2026-07-23 03:49 UTC

**协议分布:** shadowsocks × 8 · trojan × 23 · vless × 56 · vmess × 2

**本次使用的源:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 6 · `epodonios` × 2 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `roosterkid-openproxylist` × 4 · `snakem982` × 1 · `solispirit-v2ray` × 34 · `tg-v2ray-configs-every2h` × 19
