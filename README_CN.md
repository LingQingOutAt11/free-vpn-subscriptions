...
![节点](https://img.shields.io/badge/节点-91-brightgreen) ![存活](https://img.shields.io/badge/存活-3917-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-140ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-25_19:41_UTC-informational)
...
- **最快延迟**: 39 ms
- **中位延迟**: 140 ms
- **最后更新 (UTC)**: 2026-07-25 19:41 UTC

**协议分布:** shadowsocks × 12 · trojan × 16 · vless × 57 · vmess × 6

**本次使用的源:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 2 · `epodonios` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 2 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 14 · `solispirit-v2ray` × 28 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 18
