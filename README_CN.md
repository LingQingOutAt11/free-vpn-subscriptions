...
![节点](https://img.shields.io/badge/节点-146-brightgreen) ![存活](https://img.shields.io/badge/存活-2251-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-293ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-04_20:19_UTC-informational)
...
- **最快延迟**: 37 ms
- **中位延迟**: 293 ms
- **最后更新 (UTC)**: 2026-05-04 20:19 UTC

**协议分布:** shadowsocks × 34 · trojan × 26 · vless × 73 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 12 · `ninjastrikers` × 60 · `ruking-clash` × 4 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
