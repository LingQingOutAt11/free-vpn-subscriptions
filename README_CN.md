...
![节点](https://img.shields.io/badge/节点-140-brightgreen) ![存活](https://img.shields.io/badge/存活-1964-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-400ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_20:26_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 400 ms
- **最后更新 (UTC)**: 2026-06-21 20:26 UTC

**协议分布:** shadowsocks × 48 · trojan × 32 · vless × 46 · vmess × 14

**本次使用的源:** `barry-far-v2ray` × 19 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 27 · `snakem982` × 9 · `surfboard-eternity` × 6
