...
![节点](https://img.shields.io/badge/节点-87-brightgreen) ![存活](https://img.shields.io/badge/存活-1887-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-359ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-08_22:11_UTC-informational)
...
- **最快延迟**: 38 ms
- **中位延迟**: 359 ms
- **最后更新 (UTC)**: 2026-06-08 22:11 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 41 · trojan × 23 · vless × 11 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 8 · `surfboard-eternity` × 7
