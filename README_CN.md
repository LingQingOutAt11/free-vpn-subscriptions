...
![节点](https://img.shields.io/badge/节点-86-brightgreen) ![存活](https://img.shields.io/badge/存活-1882-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-354ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-08_21:27_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 354 ms
- **最后更新 (UTC)**: 2026-06-08 21:27 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 42 · trojan × 22 · vless × 9 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 1 · `mahdi0024` × 13 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 13 · `ruking-clash` × 5 · `surfboard-eternity` × 4
