...
![节点](https://img.shields.io/badge/节点-140-brightgreen) ![存活](https://img.shields.io/badge/存活-2382-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-165ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-09_13:17_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 165 ms
- **最后更新 (UTC)**: 2026-05-09 13:17 UTC

**协议分布:** shadowsocks × 37 · trojan × 17 · vless × 74 · vmess × 12

**本次使用的源:** `barry-far-v2ray` × 28 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 6 · `ninjastrikers` × 60 · `snakem982` × 1 · `surfboard-eternity` × 8
