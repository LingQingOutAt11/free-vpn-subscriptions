...
![节点](https://img.shields.io/badge/节点-73-brightgreen) ![存活](https://img.shields.io/badge/存活-3479-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-314ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-29_03:44_UTC-informational)
...
- **最快延迟**: 8 ms
- **中位延迟**: 314 ms
- **最后更新 (UTC)**: 2026-07-29 03:44 UTC

**协议分布:** shadowsocks × 15 · trojan × 26 · vless × 31 · vmess × 1

**本次使用的源:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 4 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `roosterkid-openproxylist` × 5 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 11
