...
![节点](https://img.shields.io/badge/节点-140-brightgreen) ![存活](https://img.shields.io/badge/存活-2117-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-316ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_05:20_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 316 ms
- **最后更新 (UTC)**: 2026-06-21 05:20 UTC

**协议分布:** shadowsocks × 42 · trojan × 34 · vless × 41 · vmess × 23

**本次使用的源:** `barry-far-v2ray` × 9 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 4 · `mfuu-clash` × 6 · `ninjastrikers` × 21 · `pawdroid` × 1 · `ruking-clash` × 31 · `snakem982` × 2 · `surfboard-eternity` × 1
