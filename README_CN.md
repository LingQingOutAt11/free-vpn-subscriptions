...
![节点](https://img.shields.io/badge/节点-87-brightgreen) ![存活](https://img.shields.io/badge/存活-2385-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-91ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_07:28_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 91 ms
- **最后更新 (UTC)**: 2026-06-03 07:28 UTC

**协议分布:** shadowsocks × 16 · trojan × 33 · vless × 7 · vmess × 31

**本次使用的源:** `barry-far-v2ray` × 19 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 11 · `surfboard-eternity` × 4
