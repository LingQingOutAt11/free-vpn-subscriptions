...
![节点](https://img.shields.io/badge/节点-94-brightgreen) ![存活](https://img.shields.io/badge/存活-2284-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-243ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_07:19_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 243 ms
- **最后更新 (UTC)**: 2026-06-20 07:19 UTC

**协议分布:** shadowsocks × 23 · trojan × 27 · vless × 16 · vmess × 28

**本次使用的源:** `barry-far-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 3
