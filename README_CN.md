...
![节点](https://img.shields.io/badge/节点-117-brightgreen) ![存活](https://img.shields.io/badge/存活-2651-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-179ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-09_04:20_UTC-informational)
...
- **最快延迟**: 43 ms
- **中位延迟**: 179 ms
- **最后更新 (UTC)**: 2026-07-09 04:20 UTC

**协议分布:** shadowsocks × 20 · trojan × 22 · vless × 62 · vmess × 13

**本次使用的源:** `barry-far-v2ray` × 3 · `epodonios` × 9 · `go4sharing-clash` × 1 · `lagzian-mix` × 3 · `mahdi0024` × 6 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 2 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 49
