...
![节点](https://img.shields.io/badge/节点-119-brightgreen) ![存活](https://img.shields.io/badge/存活-2393-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-487ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_21:34_UTC-informational)
...
- **最快延迟**: 39 ms
- **中位延迟**: 487 ms
- **最后更新 (UTC)**: 2026-06-18 21:34 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 40 · trojan × 28 · vless × 40 · vmess × 10

**本次使用的源:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `pawdroid` × 6 · `ruking-clash` × 34 · `snakem982` × 6 · `surfboard-eternity` × 4
