...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2188-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-137ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-06_07:15_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 137 ms
- **最后更新 (UTC)**: 2026-05-06 07:15 UTC

**协议分布:** shadowsocks × 39 · trojan × 11 · vless × 89 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 30 · `ebrasha-v2ray` × 2 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `mfuu-clash` × 5 · `ninjastrikers` × 71 · `surfboard-eternity` × 9 · `vxiaov-clash` × 1
