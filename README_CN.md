...
![节点](https://img.shields.io/badge/节点-69-brightgreen) ![存活](https://img.shields.io/badge/存活-3197-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-69ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-04_09:01_UTC-informational)
...
- **最快延迟**: 12 ms
- **中位延迟**: 69 ms
- **最后更新 (UTC)**: 2026-08-04 09:01 UTC

**协议分布:** shadowsocks × 2 · trojan × 11 · vless × 48 · vmess × 8

**本次使用的源:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 3 · `barry-far-v2ray` × 2 · `epodonios` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 5 · `pawdroid` × 7 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 23 · `tg-v2ray-configs-every2h` × 7
