...
![节点](https://img.shields.io/badge/节点-76-brightgreen) ![存活](https://img.shields.io/badge/存活-2337-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-205ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_08:30_UTC-informational)
...
- **最快延迟**: 22 ms
- **中位延迟**: 205 ms
- **最后更新 (UTC)**: 2026-06-10 08:30 UTC

**协议分布:** shadowsocks × 30 · trojan × 12 · vless × 12 · vmess × 22

**本次使用的源:** `barry-far-v2ray` × 4 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 20 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 3 · `surfboard-eternity` × 3
