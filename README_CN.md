...
![节点](https://img.shields.io/badge/节点-89-brightgreen) ![存活](https://img.shields.io/badge/存活-2306-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-235ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_22:26_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 235 ms
- **最后更新 (UTC)**: 2026-06-19 22:26 UTC

**协议分布:** shadowsocks × 24 · trojan × 26 · vless × 8 · vmess × 31

**本次使用的源:** `barry-far-v2ray` × 7 · `epodonios` × 12 · `lagzian-mix` × 1 · `mahdi0024` × 23 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 2
