...
![节点](https://img.shields.io/badge/节点-122-brightgreen) ![存活](https://img.shields.io/badge/存活-2084-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-385ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_07:22_UTC-informational)
...
- **最快延迟**: 29 ms
- **中位延迟**: 385 ms
- **最后更新 (UTC)**: 2026-06-24 07:22 UTC

**协议分布:** shadowsocks × 32 · trojan × 29 · vless × 45 · vmess × 16

**本次使用的源:** `barry-far-v2ray` × 8 · `epodonios` × 39 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 8 · `ruking-clash` × 12 · `surfboard-eternity` × 4
