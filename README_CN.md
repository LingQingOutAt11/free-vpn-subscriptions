...
![节点](https://img.shields.io/badge/节点-108-brightgreen) ![存活](https://img.shields.io/badge/存活-2211-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-502ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_14:26_UTC-informational)
...
- **最快延迟**: 34 ms
- **中位延迟**: 502 ms
- **最后更新 (UTC)**: 2026-06-12 14:26 UTC

**协议分布:** hysteria2 × 2 · shadowsocks × 44 · trojan × 41 · vless × 14 · vmess × 7

**本次使用的源:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 33 · `lagzian-mix` × 4 · `mahdi0024` × 4 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 11 · `surfboard-eternity` × 4
