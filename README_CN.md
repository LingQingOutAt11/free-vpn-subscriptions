...
![节点](https://img.shields.io/badge/节点-150-brightgreen) ![存活](https://img.shields.io/badge/存活-2359-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-77ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-23_05:19_UTC-informational)
...
- **最快延迟**: 46 ms
- **中位延迟**: 77 ms
- **最后更新 (UTC)**: 2026-05-23 05:19 UTC

**协议分布:** shadowsocks × 34 · trojan × 7 · vless × 98 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 17 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 72 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
