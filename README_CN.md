...
![节点](https://img.shields.io/badge/节点-134-brightgreen) ![存活](https://img.shields.io/badge/存活-2385-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-498ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_16:31_UTC-informational)
...
- **最快延迟**: 33 ms
- **中位延迟**: 498 ms
- **最后更新 (UTC)**: 2026-06-18 16:31 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 34 · trojan × 34 · vless × 54 · vmess × 11

**本次使用的源:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 29 · `snakem982` × 8 · `surfboard-eternity` × 4
