...
![节点](https://img.shields.io/badge/节点-70-brightgreen) ![存活](https://img.shields.io/badge/存活-3764-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-517ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-19_19:37_UTC-informational)
...
- **最快延迟**: 21 ms
- **中位延迟**: 517 ms
- **最后更新 (UTC)**: 2026-07-19 19:37 UTC

**协议分布:** trojan × 14 · vless × 50 · vmess × 6

**本次使用的源:** `autojiedian-clash` × 4 · `barry-far-v2ray` × 1 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 7 · `ninjastrikers` × 3 · `pawdroid` × 2 · `roosterkid-openproxylist` × 1 · `solispirit-v2ray` × 36 · `tg-v2ray-configs-every2h` × 12
