...
![节点](https://img.shields.io/badge/节点-113-brightgreen) ![存活](https://img.shields.io/badge/存活-1936-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-359ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_14:30_UTC-informational)
...
- **最快延迟**: 27 ms
- **中位延迟**: 359 ms
- **最后更新 (UTC)**: 2026-06-27 14:30 UTC

**协议分布:** shadowsocks × 32 · trojan × 40 · vless × 22 · vmess × 19

**本次使用的源:** `barry-far-v2ray` × 12 · `epodonios` × 27 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 3
