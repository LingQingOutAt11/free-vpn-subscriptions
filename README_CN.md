...
![节点](https://img.shields.io/badge/节点-112-brightgreen) ![存活](https://img.shields.io/badge/存活-1833-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-385ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_20:16_UTC-informational)
...
- **最快延迟**: 30 ms
- **中位延迟**: 385 ms
- **最后更新 (UTC)**: 2026-06-15 20:16 UTC

**协议分布:** hysteria2 × 1 · shadowsocks × 52 · trojan × 24 · vless × 20 · vmess × 15

**本次使用的源:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 4
