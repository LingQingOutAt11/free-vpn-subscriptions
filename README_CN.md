...
![节点](https://img.shields.io/badge/节点-116-brightgreen) ![存活](https://img.shields.io/badge/存活-2119-blue) ![中位延迟](https://img.shields.io/badge/中位延迟-278ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-25_05:16_UTC-informational)
...
- **最快延迟**: 32 ms
- **中位延迟**: 278 ms
- **最后更新 (UTC)**: 2026-06-25 05:16 UTC

**协议分布:** shadowsocks × 27 · trojan × 31 · vless × 42 · vmess × 16

**本次使用的源:** `barry-far-v2ray` × 8 · `epodonios` × 36 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 7
