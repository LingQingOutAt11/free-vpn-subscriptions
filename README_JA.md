...
![ノード](https://img.shields.io/badge/ノード-75-brightgreen) ![生存](https://img.shields.io/badge/生存-2459-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-120ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_15:16_UTC-informational)
...
- **最速 RTT**: 25 ms
- **中央値 RTT**: 120 ms
- **最終更新 (UTC)**: 2026-06-02 15:16 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 24 · vless × 7 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 8 · `mahdi0024` × 32 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 7 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
