...
![ノード](https://img.shields.io/badge/ノード-125-brightgreen) ![生存](https://img.shields.io/badge/生存-2049-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-282ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_03:34_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 282 ms
- **最終更新 (UTC)**: 2026-06-11 03:34 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 47 · trojan × 24 · vless × 30 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 10 · `lagzian-mix` × 2 · `mahdi0024` × 24 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 21 · `ninjastrikers` × 32 · `pawdroid` × 6 · `ruking-clash` × 6 · `snakem982` × 1 · `surfboard-eternity` × 1
