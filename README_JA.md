...
![ノード](https://img.shields.io/badge/ノード-126-brightgreen) ![生存](https://img.shields.io/badge/生存-1915-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-485ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_04:13_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 485 ms
- **最終更新 (UTC)**: 2026-06-18 04:13 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 44 · trojan × 30 · vless × 44 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 21 · `epodonios` × 17 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 25 · `pawdroid` × 2 · `ruking-clash` × 21 · `snakem982` × 6 · `surfboard-eternity` × 2
