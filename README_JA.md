...
![ノード](https://img.shields.io/badge/ノード-125-brightgreen) ![生存](https://img.shields.io/badge/生存-1959-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-278ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-25_01:24_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 278 ms
- **最終更新 (UTC)**: 2026-06-25 01:24 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 27 · trojan × 34 · vless × 49 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 39 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 23 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 4
