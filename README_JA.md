...
![ノード](https://img.shields.io/badge/ノード-111-brightgreen) ![生存](https://img.shields.io/badge/生存-1763-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-470ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_23:23_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 470 ms
- **最終更新 (UTC)**: 2026-06-17 23:23 UTC

**プロトコル構成:** hysteria2 × 3 · shadowsocks × 47 · trojan × 31 · vless × 23 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `ruking-clash` × 20 · `surfboard-eternity` × 5
