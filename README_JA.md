...
![ノード](https://img.shields.io/badge/ノード-138-brightgreen) ![生存](https://img.shields.io/badge/生存-1978-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-427ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_17:22_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 427 ms
- **最終更新 (UTC)**: 2026-06-21 17:22 UTC

**プロトコル構成:** shadowsocks × 45 · trojan × 33 · vless × 48 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 17 · `epodonios` × 25 · `lagzian-mix` × 4 · `mahdi0024` × 8 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 28 · `snakem982` × 6 · `surfboard-eternity` × 4
