...
![ノード](https://img.shields.io/badge/ノード-117-brightgreen) ![生存](https://img.shields.io/badge/生存-3119-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-105ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-01_14:00_UTC-informational)
...
- **最速 RTT**: 17 ms
- **中央値 RTT**: 105 ms
- **最終更新 (UTC)**: 2026-08-01 14:00 UTC

**プロトコル構成:** hysteria2 × 4 · shadowsocks × 23 · trojan × 20 · vless × 60 · vmess × 10

**今回使用したソース:** `autojiedian-clash` × 11 · `automerge-verified-clash` × 25 · `barry-far-v2ray` × 9 · `epodonios` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 1 · `pawdroid` × 4 · `roosterkid-openproxylist` × 7 · `ruking-clash` × 4 · `snakem982` × 1 · `solispirit-v2ray` × 22 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 13
