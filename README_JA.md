...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2239-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-82ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_01:33_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 82 ms
- **最終更新 (UTC)**: 2026-05-19 01:33 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 19 · trojan × 23 · vless × 86 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 1 · `epodonios` × 10 · `lagzian-mix` × 4 · `mahdi0024` × 23 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 70 · `pawdroid` × 8 · `ruking-clash` × 2 · `surfboard-eternity` × 3
