...
![ノード](https://img.shields.io/badge/ノード-95-brightgreen) ![生存](https://img.shields.io/badge/生存-2180-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-547ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_10:25_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 547 ms
- **最終更新 (UTC)**: 2026-06-29 10:25 UTC

**プロトコル構成:** shadowsocks × 21 · trojan × 36 · vless × 22 · vmess × 16

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 19 · `lagzian-mix` × 6 · `mahdi0024` × 13 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 3
