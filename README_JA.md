...
![ノード](https://img.shields.io/badge/ノード-96-brightgreen) ![生存](https://img.shields.io/badge/生存-1955-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-463ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_07:22_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 463 ms
- **最終更新 (UTC)**: 2026-06-18 07:22 UTC

**プロトコル構成:** shadowsocks × 35 · trojan × 29 · vless × 23 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 13 · `epodonios` × 7 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 3 · `ninjastrikers` × 16 · `pawdroid` × 3 · `ruking-clash` × 17 · `snakem982` × 6 · `surfboard-eternity` × 3
