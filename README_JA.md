...
![ノード](https://img.shields.io/badge/ノード-118-brightgreen) ![生存](https://img.shields.io/badge/生存-2114-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-343ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_16:29_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 343 ms
- **最終更新 (UTC)**: 2026-06-24 16:29 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 31 · trojan × 33 · vless × 39 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 38 · `lagzian-mix` × 5 · `mahdi0024` × 19 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 11 · `pawdroid` × 7 · `ruking-clash` × 15 · `surfboard-eternity` × 2
