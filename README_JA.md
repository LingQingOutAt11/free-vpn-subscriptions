...
![ノード](https://img.shields.io/badge/ノード-136-brightgreen) ![生存](https://img.shields.io/badge/生存-1595-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-432ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_17:23_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 432 ms
- **最終更新 (UTC)**: 2026-06-14 17:23 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 74 · trojan × 25 · vless × 22 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 17 · `lagzian-mix` × 7 · `mahdi0024` × 11 · `mahdibland-aggregator` × 25 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 15 · `surfboard-eternity` × 6
