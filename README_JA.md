...
![ノード](https://img.shields.io/badge/ノード-119-brightgreen) ![生存](https://img.shields.io/badge/生存-2393-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-487ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_21:34_UTC-informational)
...
- **最速 RTT**: 39 ms
- **中央値 RTT**: 487 ms
- **最終更新 (UTC)**: 2026-06-18 21:34 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 40 · trojan × 28 · vless × 40 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 18 · `pawdroid` × 6 · `ruking-clash` × 34 · `snakem982` × 6 · `surfboard-eternity` × 4
