...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2082-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-93ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-04_00:18_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 93 ms
- **最終更新 (UTC)**: 2026-05-04 00:18 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 3 · vless × 107 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 28 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 69 · `ruking-clash` × 2 · `surfboard-eternity` × 6
