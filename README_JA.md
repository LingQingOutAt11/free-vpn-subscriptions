...
![ノード](https://img.shields.io/badge/ノード-85-brightgreen) ![生存](https://img.shields.io/badge/生存-3579-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-634ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-29_19:48_UTC-informational)
...
- **最速 RTT**: 26 ms
- **中央値 RTT**: 634 ms
- **最終更新 (UTC)**: 2026-07-29 19:48 UTC

**プロトコル構成:** shadowsocks × 6 · trojan × 34 · vless × 35 · vmess × 10

**今回使用したソース:** `autojiedian-clash` × 8 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 11 · `solispirit-v2ray` × 22 · `tg-v2ray-configs-every2h` × 12
