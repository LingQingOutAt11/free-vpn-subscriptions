...
![ノード](https://img.shields.io/badge/ノード-67-brightgreen) ![生存](https://img.shields.io/badge/生存-3719-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-110ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-07_07:48_UTC-informational)
...
- **最速 RTT**: 16 ms
- **中央値 RTT**: 110 ms
- **最終更新 (UTC)**: 2026-08-07 07:48 UTC

**プロトコル構成:** shadowsocks × 6 · trojan × 16 · vless × 34 · vmess × 11

**今回使用したソース:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 1 · `barry-far-v2ray` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 2 · `ninjastrikers` × 7 · `pawdroid` × 1 · `roosterkid-openproxylist` × 12 · `ruking-clash` × 1 · `solispirit-v2ray` × 19 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 8
