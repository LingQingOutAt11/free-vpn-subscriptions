...
![ノード](https://img.shields.io/badge/ノード-138-brightgreen) ![生存](https://img.shields.io/badge/生存-1757-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-463ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_08:37_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 463 ms
- **最終更新 (UTC)**: 2026-06-14 08:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 71 · trojan × 30 · vless × 29 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 25 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 8 · `ruking-clash` × 24 · `surfboard-eternity` × 7
