...
![ノード](https://img.shields.io/badge/ノード-139-brightgreen) ![生存](https://img.shields.io/badge/生存-2231-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-407ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-05_22:20_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 407 ms
- **最終更新 (UTC)**: 2026-05-05 22:20 UTC

**プロトコル構成:** shadowsocks × 34 · trojan × 28 · vless × 65 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 3 · `epodonios` × 7 · `lagzian-mix` × 6 · `mahdi0024` × 6 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 55 · `pawdroid` × 2 · `surfboard-eternity` × 6
