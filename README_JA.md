...
![ノード](https://img.shields.io/badge/ノード-113-brightgreen) ![生存](https://img.shields.io/badge/生存-2020-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-339ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-25_13:16_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 339 ms
- **最終更新 (UTC)**: 2026-06-25 13:16 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 34 · trojan × 31 · vless × 33 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 32 · `lagzian-mix` × 4 · `mahdi0024` × 19 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 5 · `ruking-clash` × 13 · `surfboard-eternity` × 2
