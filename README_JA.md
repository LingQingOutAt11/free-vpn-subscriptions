...
![ノード](https://img.shields.io/badge/ノード-125-brightgreen) ![生存](https://img.shields.io/badge/生存-1937-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-340ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_00:32_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 340 ms
- **最終更新 (UTC)**: 2026-06-17 00:32 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 51 · trojan × 31 · vless × 29 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 12 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 26 · `ruking-clash` × 17 · `surfboard-eternity` × 4
