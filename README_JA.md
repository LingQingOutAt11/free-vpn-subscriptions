...
![ノード](https://img.shields.io/badge/ノード-69-brightgreen) ![生存](https://img.shields.io/badge/生存-3511-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-130ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-06_09:00_UTC-informational)
...
- **最速 RTT**: 46 ms
- **中央値 RTT**: 130 ms
- **最終更新 (UTC)**: 2026-08-06 09:00 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 14 · trojan × 12 · vless × 38 · vmess × 3

**今回使用したソース:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 8 · `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 2 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 1 · `ninjastrikers` × 4 · `pawdroid` × 2 · `roosterkid-openproxylist` × 8 · `solispirit-v2ray` × 13 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 13
