...
![ノード](https://img.shields.io/badge/ノード-99-brightgreen) ![生存](https://img.shields.io/badge/生存-1834-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-406ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_16:34_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 406 ms
- **最終更新 (UTC)**: 2026-06-30 16:34 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 38 · trojan × 38 · vless × 15 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 4 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 14 · `surfboard-eternity` × 6
