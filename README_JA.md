...
![ノード](https://img.shields.io/badge/ノード-105-brightgreen) ![生存](https://img.shields.io/badge/生存-1864-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-276ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-08_04:19_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 276 ms
- **最終更新 (UTC)**: 2026-06-08 04:19 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 50 · trojan × 21 · vless × 28 · vmess × 5

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 1 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 33 · `ruking-clash` × 3 · `surfboard-eternity` × 5
