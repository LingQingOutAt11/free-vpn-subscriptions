...
![ノード](https://img.shields.io/badge/ノード-114-brightgreen) ![生存](https://img.shields.io/badge/生存-2389-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-483ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_17:29_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 483 ms
- **最終更新 (UTC)**: 2026-06-18 17:29 UTC

**プロトコル構成:** shadowsocks × 36 · trojan × 30 · vless × 40 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 17 · `epodonios` × 4 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 3 · `ninjastrikers` × 8 · `pawdroid` × 1 · `ruking-clash` × 25 · `snakem982` × 9 · `surfboard-eternity` × 5
