...
![ノード](https://img.shields.io/badge/ノード-113-brightgreen) ![生存](https://img.shields.io/badge/生存-1956-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-492ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_13:33_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 492 ms
- **最終更新 (UTC)**: 2026-06-18 13:33 UTC

**プロトコル構成:** hysteria2 × 3 · shadowsocks × 33 · trojan × 34 · vless × 36 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 18 · `pawdroid` × 4 · `ruking-clash` × 32 · `snakem982` × 3 · `surfboard-eternity` × 3
