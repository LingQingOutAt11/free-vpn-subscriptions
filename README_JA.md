...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1970-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-465ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_20:14_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 465 ms
- **最終更新 (UTC)**: 2026-06-22 20:14 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 41 · trojan × 20 · vless × 76 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 51 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 2 · `ruking-clash` × 33 · `snakem982` × 1 · `surfboard-eternity` × 2
