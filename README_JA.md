...
![ノード](https://img.shields.io/badge/ノード-80-brightgreen) ![生存](https://img.shields.io/badge/生存-4107-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-207ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-21_14:28_UTC-informational)
...
- **最速 RTT**: 49 ms
- **中央値 RTT**: 207 ms
- **最終更新 (UTC)**: 2026-07-21 14:28 UTC

**プロトコル構成:** shadowsocks × 5 · trojan × 19 · vless × 52 · vmess × 4

**今回使用したソース:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 2 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `ninjastrikers` × 7 · `roosterkid-openproxylist` × 7 · `snakem982` × 1 · `solispirit-v2ray` × 32 · `tg-v2ray-configs-every2h` × 15
