...
![ノード](https://img.shields.io/badge/ノード-79-brightgreen) ![生存](https://img.shields.io/badge/生存-2233-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-262ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_11:34_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 262 ms
- **最終更新 (UTC)**: 2026-06-10 11:34 UTC

**プロトコル構成:** shadowsocks × 35 · trojan × 17 · vless × 7 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 10 · `lagzian-mix` × 3 · `mahdi0024` × 19 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 11 · `ruking-clash` × 3 · `surfboard-eternity` × 4
