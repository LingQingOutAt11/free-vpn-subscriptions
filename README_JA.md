...
![ノード](https://img.shields.io/badge/ノード-82-brightgreen) ![生存](https://img.shields.io/badge/生存-3993-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-222ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-22_08:50_UTC-informational)
...
- **最速 RTT**: 39 ms
- **中央値 RTT**: 222 ms
- **最終更新 (UTC)**: 2026-07-22 08:50 UTC

**プロトコル構成:** shadowsocks × 4 · trojan × 22 · vless × 54 · vmess × 2

**今回使用したソース:** `autojiedian-clash` × 3 · `automerge-verified-clash` × 5 · `barry-far-v2ray` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 3 · `ninjastrikers` × 11 · `pawdroid` × 2 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 34 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 13
