...
![ノード](https://img.shields.io/badge/ノード-57-brightgreen) ![生存](https://img.shields.io/badge/生存-3559-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-537ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-15_14:14_UTC-informational)
...
- **最速 RTT**: 22 ms
- **中央値 RTT**: 537 ms
- **最終更新 (UTC)**: 2026-07-15 14:14 UTC

**プロトコル構成:** shadowsocks × 1 · trojan × 14 · vless × 36 · vmess × 6

**今回使用したソース:** `autojiedian-clash` × 2 · `automerge-verified-clash` × 1 · `mahdibland-aggregator` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 8 · `pawdroid` × 1 · `roosterkid-openproxylist` × 5 · `solispirit-v2ray` × 28 · `tg-v2ray-configs-every2h` × 10
