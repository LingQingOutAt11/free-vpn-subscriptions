...
![ノード](https://img.shields.io/badge/ノード-86-brightgreen) ![生存](https://img.shields.io/badge/生存-2347-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-123ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_17:27_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 123 ms
- **最終更新 (UTC)**: 2026-06-02 17:27 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 21 · trojan × 24 · vless × 8 · vmess × 32

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `mahdi0024` × 30 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `surfboard-eternity` × 4
