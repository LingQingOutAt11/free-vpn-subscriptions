...
![ノード](https://img.shields.io/badge/ノード-126-brightgreen) ![生存](https://img.shields.io/badge/生存-1994-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-423ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_14:21_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 423 ms
- **最終更新 (UTC)**: 2026-06-21 14:21 UTC

**プロトコル構成:** shadowsocks × 43 · trojan × 29 · vless × 43 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 22 · `lagzian-mix` × 4 · `mahdi0024` × 10 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 27 · `snakem982` × 6 · `surfboard-eternity` × 2
