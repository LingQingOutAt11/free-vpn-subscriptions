...
![ノード](https://img.shields.io/badge/ノード-61-brightgreen) ![生存](https://img.shields.io/badge/生存-2245-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-127ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-29_18:34_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 127 ms
- **最終更新 (UTC)**: 2026-05-29 18:34 UTC

**プロトコル構成:** shadowsocks × 11 · trojan × 23 · vless × 3 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 19 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 6 · `pawdroid` × 2 · `snakem982` × 1 · `surfboard-eternity` × 3
