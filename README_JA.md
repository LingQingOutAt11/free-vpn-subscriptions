...
![ノード](https://img.shields.io/badge/ノード-109-brightgreen) ![生存](https://img.shields.io/badge/生存-1751-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-472ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_19:23_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 472 ms
- **最終更新 (UTC)**: 2026-06-17 19:23 UTC

**プロトコル構成:** hysteria2 × 4 · shadowsocks × 44 · trojan × 27 · vless × 26 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 4 · `epodonios` × 17 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 23 · `surfboard-eternity` × 2
