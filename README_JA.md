...
![ノード](https://img.shields.io/badge/ノード-132-brightgreen) ![生存](https://img.shields.io/badge/生存-2091-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-363ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_14:20_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 363 ms
- **最終更新 (UTC)**: 2026-06-20 14:20 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 42 · trojan × 27 · vless × 37 · vmess × 25

**今回使用したソース:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 7 · `matin-v2ray` × 1 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 34 · `snakem982` × 2 · `surfboard-eternity` × 2
