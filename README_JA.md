...
![ノード](https://img.shields.io/badge/ノード-112-brightgreen) ![生存](https://img.shields.io/badge/生存-2140-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-331ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_23:23_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 331 ms
- **最終更新 (UTC)**: 2026-06-24 23:23 UTC

**プロトコル構成:** shadowsocks × 28 · trojan × 33 · vless × 36 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 31 · `lagzian-mix` × 4 · `mahdi0024` × 18 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 5 · `ruking-clash` × 16 · `surfboard-eternity` × 3
