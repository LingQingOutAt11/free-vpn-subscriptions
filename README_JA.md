...
![ノード](https://img.shields.io/badge/ノード-104-brightgreen) ![生存](https://img.shields.io/badge/生存-1849-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-346ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-08_06:30_UTC-informational)
...
- **最速 RTT**: 40 ms
- **中央値 RTT**: 346 ms
- **最終更新 (UTC)**: 2026-06-08 06:30 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 51 · trojan × 21 · vless × 26 · vmess × 5

**今回使用したソース:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 2 · `ninjastrikers` × 24 · `pawdroid` × 6 · `ruking-clash` × 5 · `surfboard-eternity` × 6
