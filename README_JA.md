...
![ノード](https://img.shields.io/badge/ノード-143-brightgreen) ![生存](https://img.shields.io/badge/生存-2440-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-77ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-19_14:25_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 77 ms
- **最終更新 (UTC)**: 2026-05-19 14:25 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 20 · trojan × 22 · vless × 79 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 28 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 3 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 1 · `ninjastrikers` × 54 · `pawdroid` × 8 · `snakem982` × 1 · `surfboard-eternity` × 6
