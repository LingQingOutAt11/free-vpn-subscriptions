...
![ノード](https://img.shields.io/badge/ノード-124-brightgreen) ![生存](https://img.shields.io/badge/生存-1928-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-493ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_05:17_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 493 ms
- **最終更新 (UTC)**: 2026-06-18 05:17 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 41 · trojan × 30 · vless × 46 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 17 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 26 · `pawdroid` × 4 · `ruking-clash` × 19 · `snakem982` × 7 · `surfboard-eternity` × 3
