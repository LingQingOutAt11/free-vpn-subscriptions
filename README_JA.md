...
![ノード](https://img.shields.io/badge/ノード-56-brightgreen) ![生存](https://img.shields.io/badge/生存-4069-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-59ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-17_14:08_UTC-informational)
...
- **最速 RTT**: 24 ms
- **中央値 RTT**: 59 ms
- **最終更新 (UTC)**: 2026-07-17 14:08 UTC

**プロトコル構成:** shadowsocks × 1 · trojan × 10 · vless × 42 · vmess × 3

**今回使用したソース:** `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `mahdibland-aggregator` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 3 · `pawdroid` × 6 · `radikal-clash` × 2 · `roosterkid-openproxylist` × 2 · `solispirit-v2ray` × 29 · `tg-v2ray-configs-every2h` × 8
