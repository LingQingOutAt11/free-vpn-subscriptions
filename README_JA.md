...
![ノード](https://img.shields.io/badge/ノード-124-brightgreen) ![生存](https://img.shields.io/badge/生存-2042-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-411ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_14:21_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 411 ms
- **最終更新 (UTC)**: 2026-06-23 14:21 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 38 · trojan × 29 · vless × 43 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 1 · `mfuu-clash` × 8 · `ninjastrikers` × 14 · `pawdroid` × 6 · `ruking-clash` × 9 · `surfboard-eternity` × 6
