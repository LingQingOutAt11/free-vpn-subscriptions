...
![ノード](https://img.shields.io/badge/ノード-76-brightgreen) ![生存](https://img.shields.io/badge/生存-2222-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-246ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_23:32_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 246 ms
- **最終更新 (UTC)**: 2026-06-28 23:32 UTC

**プロトコル構成:** shadowsocks × 17 · trojan × 26 · vless × 18 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 17 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 3 · `mfuu-clash` × 11 · `ninjastrikers` × 12 · `ruking-clash` × 1 · `surfboard-eternity` × 4
