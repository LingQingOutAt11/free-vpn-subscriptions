...
![ノード](https://img.shields.io/badge/ノード-142-brightgreen) ![生存](https://img.shields.io/badge/生存-1972-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-471ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_15:14_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 471 ms
- **最終更新 (UTC)**: 2026-06-21 15:14 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 45 · trojan × 28 · vless × 58 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 11 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 33 · `snakem982` × 5 · `surfboard-eternity` × 2
