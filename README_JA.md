...
![ノード](https://img.shields.io/badge/ノード-126-brightgreen) ![生存](https://img.shields.io/badge/生存-1924-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-495ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_06:22_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 495 ms
- **最終更新 (UTC)**: 2026-06-18 06:22 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 30 · vless × 45 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 15 · `epodonios` × 13 · `lagzian-mix` × 2 · `mahdi0024` × 3 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `matin-v2ray` × 1 · `ninjastrikers` × 19 · `pawdroid` × 6 · `ruking-clash` × 25 · `snakem982` × 7 · `surfboard-eternity` × 3
