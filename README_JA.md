...
![ノード](https://img.shields.io/badge/ノード-148-brightgreen) ![生存](https://img.shields.io/badge/生存-1884-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-481ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_10:18_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 481 ms
- **最終更新 (UTC)**: 2026-06-22 10:18 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 46 · trojan × 27 · vless × 58 · vmess × 16

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 35 · `snakem982` × 4 · `surfboard-eternity` × 6
