...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1943-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-508ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_01:11_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 508 ms
- **最終更新 (UTC)**: 2026-06-17 01:11 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 30 · vless × 20 · vmess × 56

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 61 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 24 · `ruking-clash` × 16 · `surfboard-eternity` × 4
