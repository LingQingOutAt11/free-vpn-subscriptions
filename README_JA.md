...
![ノード](https://img.shields.io/badge/ノード-141-brightgreen) ![生存](https://img.shields.io/badge/生存-2226-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-318ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-05_21:15_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 318 ms
- **最終更新 (UTC)**: 2026-05-05 21:15 UTC

**プロトコル構成:** shadowsocks × 36 · trojan × 28 · vless × 66 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 35 · `epodonios` × 7 · `lagzian-mix` × 5 · `mahdi0024` × 8 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 9 · `mfuu-clash` × 4 · `ninjastrikers` × 56 · `pawdroid` × 1 · `surfboard-eternity` × 7
