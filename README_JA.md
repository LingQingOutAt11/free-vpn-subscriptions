...
![ノード](https://img.shields.io/badge/ノード-140-brightgreen) ![生存](https://img.shields.io/badge/生存-2074-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-170ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-03_23:37_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 170 ms
- **最終更新 (UTC)**: 2026-05-03 23:37 UTC

**プロトコル構成:** shadowsocks × 26 · trojan × 20 · vless × 82 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 24 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 26 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 5 · `mfuu-clash` × 3 · `ninjastrikers` × 56 · `ruking-clash` × 2 · `surfboard-eternity` × 11 · `vxiaov-clash` × 1
