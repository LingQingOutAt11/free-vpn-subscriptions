...
![ノード](https://img.shields.io/badge/ノード-86-brightgreen) ![生存](https://img.shields.io/badge/生存-2246-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-185ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_02:28_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 185 ms
- **最終更新 (UTC)**: 2026-06-29 02:28 UTC

**プロトコル構成:** shadowsocks × 17 · trojan × 29 · vless × 28 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 19 · `mahdi0024` × 11 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 8 · `ninjastrikers` × 21 · `pawdroid` × 2 · `ruking-clash` × 5 · `surfboard-eternity` × 3
