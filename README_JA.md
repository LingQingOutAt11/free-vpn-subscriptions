...
![ノード](https://img.shields.io/badge/ノード-54-brightgreen) ![生存](https://img.shields.io/badge/生存-1941-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-164ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-27_21:14_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 164 ms
- **最終更新 (UTC)**: 2026-05-27 21:14 UTC

**プロトコル構成:** shadowsocks × 23 · trojan × 16 · vless × 7 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 13 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 3 · `ninjastrikers` × 5 · `ruking-clash` × 4 · `snakem982` × 3 · `surfboard-eternity` × 2
