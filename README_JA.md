...
![ノード](https://img.shields.io/badge/ノード-122-brightgreen) ![生存](https://img.shields.io/badge/生存-1909-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-413ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_00:33_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 413 ms
- **最終更新 (UTC)**: 2026-06-26 00:33 UTC

**プロトコル構成:** shadowsocks × 32 · trojan × 40 · vless × 37 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 27 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 5 · `ninjastrikers` × 24 · `ruking-clash` × 18 · `surfboard-eternity` × 1
