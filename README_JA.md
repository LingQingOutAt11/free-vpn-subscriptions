...
![ノード](https://img.shields.io/badge/ノード-135-brightgreen) ![生存](https://img.shields.io/badge/生存-2063-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-377ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_11:11_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 377 ms
- **最終更新 (UTC)**: 2026-06-21 11:11 UTC

**プロトコル構成:** shadowsocks × 40 · trojan × 30 · vless × 44 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 3 · `mahdi0024` × 26 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 39 · `snakem982` × 1 · `surfboard-eternity` × 3
