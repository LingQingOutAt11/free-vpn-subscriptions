...
![ノード](https://img.shields.io/badge/ノード-138-brightgreen) ![生存](https://img.shields.io/badge/生存-3088-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-223ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-05_04:27_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 223 ms
- **最終更新 (UTC)**: 2026-07-05 04:27 UTC

**プロトコル構成:** shadowsocks × 18 · trojan × 31 · vless × 78 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 1 · `radikal-clash` × 6 · `roosterkid-openproxylist` × 6 · `solispirit-v2ray` × 56 · `tg-v2ray-configs-every2h` × 24
