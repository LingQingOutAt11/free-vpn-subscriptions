...
![ノード](https://img.shields.io/badge/ノード-98-brightgreen) ![生存](https://img.shields.io/badge/生存-1861-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-356ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_21:35_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 356 ms
- **最終更新 (UTC)**: 2026-06-07 21:35 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 51 · trojan × 28 · vless × 11 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 3 · `mfuu-clash` × 6 · `ninjastrikers` × 16 · `ruking-clash` × 2 · `surfboard-eternity` × 4
