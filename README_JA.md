...
![ノード](https://img.shields.io/badge/ノード-83-brightgreen) ![生存](https://img.shields.io/badge/生存-2094-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-246ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_12:12_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 246 ms
- **最終更新 (UTC)**: 2026-06-10 12:12 UTC

**プロトコル構成:** shadowsocks × 40 · trojan × 13 · vless × 8 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 6 · `lagzian-mix` × 3 · `mahdi0024` × 21 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 12 · `ruking-clash` × 5 · `surfboard-eternity` × 3
