...
![ノード](https://img.shields.io/badge/ノード-86-brightgreen) ![生存](https://img.shields.io/badge/生存-3987-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-350ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-20_14:40_UTC-informational)
...
- **最速 RTT**: 18 ms
- **中央値 RTT**: 350 ms
- **最終更新 (UTC)**: 2026-07-20 14:40 UTC

**プロトコル構成:** shadowsocks × 1 · trojan × 23 · vless × 57 · vmess × 5

**今回使用したソース:** `autojiedian-clash` × 2 · `barry-far-v2ray` × 1 · `mahdi0024` × 5 · `matin-v2ray` × 10 · `ninjastrikers` × 9 · `pawdroid` × 1 · `roosterkid-openproxylist` × 4 · `solispirit-v2ray` × 39 · `surfboard-eternity` × 1 · `tg-v2ray-configs-every2h` × 14
