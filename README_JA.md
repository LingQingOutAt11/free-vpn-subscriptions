...
![ノード](https://img.shields.io/badge/ノード-125-brightgreen) ![生存](https://img.shields.io/badge/生存-2528-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-175ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-02_04:38_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 175 ms
- **最終更新 (UTC)**: 2026-06-02 04:38 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 38 · trojan × 33 · vless × 22 · vmess × 30

**今回使用したソース:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 41 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 22 · `pawdroid` × 2 · `snakem982` × 2 · `surfboard-eternity` × 7
