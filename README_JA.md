...
![ノード](https://img.shields.io/badge/ノード-112-brightgreen) ![生存](https://img.shields.io/badge/生存-1832-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-421ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_15:20_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 421 ms
- **最終更新 (UTC)**: 2026-06-16 15:20 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 49 · trojan × 26 · vless × 19 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 25 · `lagzian-mix` × 5 · `mahdi0024` × 13 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 11 · `surfboard-eternity` × 4
