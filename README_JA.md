...
![ノード](https://img.shields.io/badge/ノード-136-brightgreen) ![生存](https://img.shields.io/badge/生存-1689-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-359ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_00:11_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 359 ms
- **最終更新 (UTC)**: 2026-06-14 00:11 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 56 · trojan × 35 · vless × 37 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 11 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 24 · `ninjastrikers` × 37 · `pawdroid` × 5 · `ruking-clash` × 15 · `surfboard-eternity` × 2
