...
![ノード](https://img.shields.io/badge/ノード-94-brightgreen) ![生存](https://img.shields.io/badge/生存-1843-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-356ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_17:30_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 356 ms
- **最終更新 (UTC)**: 2026-06-30 17:30 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 38 · trojan × 34 · vless × 14 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 7 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 3 · `ninjastrikers` × 14 · `pawdroid` × 10 · `ruking-clash` × 12 · `surfboard-eternity` × 2
