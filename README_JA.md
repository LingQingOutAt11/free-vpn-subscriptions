...
![ノード](https://img.shields.io/badge/ノード-135-brightgreen) ![生存](https://img.shields.io/badge/生存-1607-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-475ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_21:19_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 475 ms
- **最終更新 (UTC)**: 2026-06-14 21:19 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 65 · trojan × 32 · vless × 26 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 23 · `ebrasha-v2ray` × 1 · `epodonios` × 15 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 22 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 2 · `ninjastrikers` × 19 · `pawdroid` × 5 · `ruking-clash` × 19 · `surfboard-eternity` × 5
