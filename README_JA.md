...
![ノード](https://img.shields.io/badge/ノード-84-brightgreen) ![生存](https://img.shields.io/badge/生存-2172-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-296ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-11_12:16_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 296 ms
- **最終更新 (UTC)**: 2026-06-11 12:16 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 38 · trojan × 15 · vless × 9 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 20 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 3 · `surfboard-eternity` × 6
