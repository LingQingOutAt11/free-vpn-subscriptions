...
![ノード](https://img.shields.io/badge/ノード-129-brightgreen) ![生存](https://img.shields.io/badge/生存-2472-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-470ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_03:26_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 470 ms
- **最終更新 (UTC)**: 2026-06-19 03:26 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 38 · trojan × 29 · vless × 50 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 13 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 26 · `pawdroid` × 6 · `ruking-clash` × 33 · `snakem982` × 6 · `surfboard-eternity` × 2
