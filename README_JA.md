...
![ノード](https://img.shields.io/badge/ノード-131-brightgreen) ![生存](https://img.shields.io/badge/生存-2528-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-489ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_13:37_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 489 ms
- **最終更新 (UTC)**: 2026-06-19 13:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 33 · trojan × 27 · vless × 51 · vmess × 19

**今回使用したソース:** `barry-far-v2ray` × 15 · `ebrasha-v2ray` × 1 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 4 · `matin-v2ray` × 5 · `ninjastrikers` × 14 · `pawdroid` × 7 · `ruking-clash` × 31 · `snakem982` × 8 · `surfboard-eternity` × 1
