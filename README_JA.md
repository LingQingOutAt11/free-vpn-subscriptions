...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1979-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-465ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_22:36_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 465 ms
- **最終更新 (UTC)**: 2026-06-22 22:36 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 42 · trojan × 24 · vless × 70 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 52 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 21 · `snakem982` × 3 · `surfboard-eternity` × 3
