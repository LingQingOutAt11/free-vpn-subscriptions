...
![ノード](https://img.shields.io/badge/ノード-94-brightgreen) ![生存](https://img.shields.io/badge/生存-2413-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-140ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-01_07:12_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 140 ms
- **最終更新 (UTC)**: 2026-06-01 07:12 UTC

**プロトコル構成:** shadowsocks × 19 · trojan × 26 · vless × 15 · vmess × 34

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 14 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 19 · `pawdroid` × 1 · `surfboard-eternity` × 1
