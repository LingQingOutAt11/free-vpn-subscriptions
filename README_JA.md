...
![ノード](https://img.shields.io/badge/ノード-120-brightgreen) ![生存](https://img.shields.io/badge/生存-1969-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-250ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-25_02:22_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 250 ms
- **最終更新 (UTC)**: 2026-06-25 02:22 UTC

**プロトコル構成:** shadowsocks × 26 · trojan × 32 · vless × 50 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 3 · `epodonios` × 37 · `lagzian-mix` × 2 · `mahdi0024` × 17 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 2 · `matin-v2ray` × 3 · `mfuu-clash` × 2 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 14 · `surfboard-eternity` × 6
