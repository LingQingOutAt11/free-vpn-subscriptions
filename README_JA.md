...
![ノード](https://img.shields.io/badge/ノード-137-brightgreen) ![生存](https://img.shields.io/badge/生存-2097-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-414ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_08:30_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 414 ms
- **最終更新 (UTC)**: 2026-06-21 08:30 UTC

**プロトコル構成:** shadowsocks × 37 · trojan × 32 · vless × 44 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 24 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 38 · `snakem982` × 3 · `surfboard-eternity` × 4
