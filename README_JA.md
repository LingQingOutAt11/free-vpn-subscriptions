...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1662-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-440ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_20:21_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 440 ms
- **最終更新 (UTC)**: 2026-06-17 20:21 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 78 · trojan × 31 · vless × 33 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 26 · `ebrasha-v2ray` × 1 · `epodonios` × 11 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 32 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 3 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 26 · `surfboard-eternity` × 2
