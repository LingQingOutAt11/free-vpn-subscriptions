...
![ノード](https://img.shields.io/badge/ノード-108-brightgreen) ![生存](https://img.shields.io/badge/生存-1765-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-416ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_18:19_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 416 ms
- **最終更新 (UTC)**: 2026-06-17 18:19 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 51 · trojan × 23 · vless × 25 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 15 · `epodonios` × 15 · `lagzian-mix` × 4 · `mahdi0024` × 5 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 3 · `ninjastrikers` × 10 · `pawdroid` × 1 · `ruking-clash` × 22 · `surfboard-eternity` × 2
