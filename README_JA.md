...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2609-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-81ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-17_20:13_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 81 ms
- **最終更新 (UTC)**: 2026-05-17 20:13 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 46 · trojan × 11 · vless × 86 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 22 · `ebrasha-v2ray` × 8 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 37 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 45 · `pawdroid` × 5 · `ruking-clash` × 9 · `surfboard-eternity` × 5
