...
![ノード](https://img.shields.io/badge/ノード-66-brightgreen) ![生存](https://img.shields.io/badge/生存-2305-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-102ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-31_14:30_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 102 ms
- **最終更新 (UTC)**: 2026-05-31 14:30 UTC

**プロトコル構成:** shadowsocks × 14 · trojan × 16 · vless × 4 · vmess × 32

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 7 · `lagzian-mix` × 2 · `mahdi0024` × 25 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 1 · `ninjastrikers` × 6 · `pawdroid` × 1 · `surfboard-eternity` × 2
