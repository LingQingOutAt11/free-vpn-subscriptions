...
![ノード](https://img.shields.io/badge/ノード-79-brightgreen) ![生存](https://img.shields.io/badge/生存-2258-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-248ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_10:14_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 248 ms
- **最終更新 (UTC)**: 2026-06-10 10:14 UTC

**プロトコル構成:** shadowsocks × 37 · trojan × 14 · vless × 6 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 3 · `surfboard-eternity` × 7
