...
![ノード](https://img.shields.io/badge/ノード-111-brightgreen) ![生存](https://img.shields.io/badge/生存-1925-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-401ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_03:17_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 401 ms
- **最終更新 (UTC)**: 2026-06-26 03:17 UTC

**プロトコル構成:** shadowsocks × 32 · trojan × 40 · vless × 27 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 24 · `lagzian-mix` × 4 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 22 · `ruking-clash` × 17 · `surfboard-eternity` × 3
