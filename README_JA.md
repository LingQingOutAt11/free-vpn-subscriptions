...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1911-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-387ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_06:31_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 387 ms
- **最終更新 (UTC)**: 2026-06-22 06:31 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 45 · trojan × 32 · vless × 58 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 30 · `lagzian-mix` × 5 · `mahdi0024` × 10 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 14 · `ninjastrikers` × 25 · `pawdroid` × 4 · `ruking-clash` × 25 · `snakem982` × 3 · `surfboard-eternity` × 4
