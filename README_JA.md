...
![ノード](https://img.shields.io/badge/ノード-113-brightgreen) ![生存](https://img.shields.io/badge/生存-1932-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-290ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_02:18_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 290 ms
- **最終更新 (UTC)**: 2026-06-13 02:18 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 51 · trojan × 24 · vless × 29 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 16 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 35 · `pawdroid` × 5 · `ruking-clash` × 9 · `surfboard-eternity` × 4
