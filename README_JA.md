...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2348-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-89ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_19:20_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 89 ms
- **最終更新 (UTC)**: 2026-05-22 19:20 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 35 · trojan × 20 · vless × 81 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 2 · `epodonios` × 5 · `lagzian-mix` × 4 · `mahdi0024` × 22 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 56 · `pawdroid` × 4 · `ruking-clash` × 8 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
