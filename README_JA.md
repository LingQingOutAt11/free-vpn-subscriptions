...
![ノード](https://img.shields.io/badge/ノード-144-brightgreen) ![生存](https://img.shields.io/badge/生存-2064-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-367ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_04:34_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 367 ms
- **最終更新 (UTC)**: 2026-06-23 04:34 UTC

**プロトコル構成:** shadowsocks × 39 · trojan × 29 · vless × 60 · vmess × 16

**今回使用したソース:** `barry-far-v2ray` × 11 · `epodonios` × 54 · `mahdi0024` × 10 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 2 · `ninjastrikers` × 22 · `pawdroid` × 2 · `ruking-clash` × 18 · `surfboard-eternity` × 5
