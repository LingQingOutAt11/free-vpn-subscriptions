...
![ノード](https://img.shields.io/badge/ノード-66-brightgreen) ![生存](https://img.shields.io/badge/生存-2240-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-133ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-29_19:21_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 133 ms
- **最終更新 (UTC)**: 2026-05-29 19:21 UTC

**プロトコル構成:** shadowsocks × 12 · trojan × 27 · vless × 4 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 21 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 6 · `pawdroid` × 1 · `ruking-clash` × 2 · `surfboard-eternity` × 3
