...
![ノード](https://img.shields.io/badge/ノード-132-brightgreen) ![生存](https://img.shields.io/badge/生存-2195-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-490ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_08:27_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 490 ms
- **最終更新 (UTC)**: 2026-06-19 08:27 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 35 · trojan × 27 · vless × 54 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 20 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 37 · `snakem982` × 7 · `surfboard-eternity` × 1
