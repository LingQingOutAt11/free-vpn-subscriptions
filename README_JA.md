...
![ノード](https://img.shields.io/badge/ノード-54-brightgreen) ![生存](https://img.shields.io/badge/生存-3637-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-89ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-11_13:49_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 89 ms
- **最終更新 (UTC)**: 2026-08-11 13:49 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 9 · trojan × 2 · vless × 33 · vmess × 9

**今回使用したソース:** `autojiedian-clash` × 4 · `automerge-verified-clash` × 9 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 4 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 2 · `pawdroid` × 1 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 1 · `solispirit-v2ray` × 7 · `tg-v2ray-configs-every2h` × 4
