...
![ノード](https://img.shields.io/badge/ノード-53-brightgreen) ![生存](https://img.shields.io/badge/生存-3616-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-52ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-08_07:21_UTC-informational)
...
- **最速 RTT**: 12 ms
- **中央値 RTT**: 52 ms
- **最終更新 (UTC)**: 2026-08-08 07:21 UTC

**プロトコル構成:** shadowsocks × 1 · trojan × 11 · vless × 29 · vmess × 12

**今回使用したソース:** `automerge-verified-clash` × 2 · `barry-far-v2ray` × 1 · `mahdi0024` × 6 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 4 · `pawdroid` × 1 · `roosterkid-openproxylist` × 7 · `snakem982` × 1 · `solispirit-v2ray` × 19 · `tg-v2ray-configs-every2h` × 8
