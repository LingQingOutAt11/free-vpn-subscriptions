...
![ノード](https://img.shields.io/badge/ノード-119-brightgreen) ![生存](https://img.shields.io/badge/生存-1742-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-459ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_07:29_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 459 ms
- **最終更新 (UTC)**: 2026-06-14 07:29 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 52 · trojan × 36 · vless × 24 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 8 · `mahdibland-aggregator` × 21 · `mahdibland-shadowsocks` × 11 · `ninjastrikers` × 24 · `pawdroid` × 7 · `ruking-clash` × 21 · `surfboard-eternity` × 5
