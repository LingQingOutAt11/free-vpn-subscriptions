...
![ノード](https://img.shields.io/badge/ノード-96-brightgreen) ![生存](https://img.shields.io/badge/生存-1919-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-341ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_19:36_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 341 ms
- **最終更新 (UTC)**: 2026-06-27 19:36 UTC

**プロトコル構成:** shadowsocks × 25 · trojan × 37 · vless × 18 · vmess × 16

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 23 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 4 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 17 · `surfboard-eternity` × 5
