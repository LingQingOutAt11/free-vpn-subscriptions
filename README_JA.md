...
![ノード](https://img.shields.io/badge/ノード-68-brightgreen) ![生存](https://img.shields.io/badge/生存-1981-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-324ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_23:15_UTC-informational)
...
- **最速 RTT**: 48 ms
- **中央値 RTT**: 324 ms
- **最終更新 (UTC)**: 2026-06-30 23:15 UTC

**プロトコル構成:** shadowsocks × 27 · trojan × 28 · vless × 7 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 4 · `mfuu-clash` × 8 · `ninjastrikers` × 13 · `ruking-clash` × 4 · `surfboard-eternity` × 5
