...
![ノード](https://img.shields.io/badge/ノード-110-brightgreen) ![生存](https://img.shields.io/badge/生存-1940-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-392ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_20:31_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 392 ms
- **最終更新 (UTC)**: 2026-06-12 20:31 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 53 · trojan × 38 · vless × 10 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 28 · `lagzian-mix` × 1 · `mahdi0024` × 3 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 9 · `surfboard-eternity` × 5
