...
![ノード](https://img.shields.io/badge/ノード-122-brightgreen) ![生存](https://img.shields.io/badge/生存-2084-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-385ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_07:22_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 385 ms
- **最終更新 (UTC)**: 2026-06-24 07:22 UTC

**プロトコル構成:** shadowsocks × 32 · trojan × 29 · vless × 45 · vmess × 16

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 39 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 8 · `ruking-clash` × 12 · `surfboard-eternity` × 4
