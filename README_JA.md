...
![ノード](https://img.shields.io/badge/ノード-122-brightgreen) ![生存](https://img.shields.io/badge/生存-2263-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-333ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_02:29_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 333 ms
- **最終更新 (UTC)**: 2026-06-12 02:29 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 45 · trojan × 41 · vless × 29 · vmess × 5

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 2 · `epodonios` × 29 · `lagzian-mix` × 3 · `mahdi0024` × 2 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 33 · `pawdroid` × 1 · `ruking-clash` × 9 · `surfboard-eternity` × 5
