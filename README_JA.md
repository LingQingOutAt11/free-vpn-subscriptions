...
![ノード](https://img.shields.io/badge/ノード-138-brightgreen) ![生存](https://img.shields.io/badge/生存-1959-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-405ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_19:26_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 405 ms
- **最終更新 (UTC)**: 2026-06-21 19:26 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 31 · vless × 50 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 17 · `epodonios` × 24 · `lagzian-mix` × 3 · `mahdi0024` × 9 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 16 · `matin-v2ray` × 2 · `ninjastrikers` × 15 · `pawdroid` × 3 · `ruking-clash` × 30 · `snakem982` × 4 · `surfboard-eternity` × 4
