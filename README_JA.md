...
![ノード](https://img.shields.io/badge/ノード-86-brightgreen) ![生存](https://img.shields.io/badge/生存-2124-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-174ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_18:39_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 174 ms
- **最終更新 (UTC)**: 2026-06-06 18:39 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 31 · trojan × 21 · vless × 9 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 2 · `epodonios` × 8 · `mahdi0024` × 36 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 10 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 5 · `surfboard-eternity` × 4
