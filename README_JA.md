...
![ノード](https://img.shields.io/badge/ノード-102-brightgreen) ![生存](https://img.shields.io/badge/生存-1863-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-345ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_03:17_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 345 ms
- **最終更新 (UTC)**: 2026-06-30 03:17 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 39 · trojan × 33 · vless × 22 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 11 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 4 · `ninjastrikers` × 25 · `pawdroid` × 6 · `ruking-clash` × 12 · `surfboard-eternity` × 3
