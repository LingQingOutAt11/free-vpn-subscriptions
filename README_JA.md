...
![ノード](https://img.shields.io/badge/ノード-102-brightgreen) ![生存](https://img.shields.io/badge/生存-2205-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-147ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_00:37_UTC-informational)
...
- **最速 RTT**: 22 ms
- **中央値 RTT**: 147 ms
- **最終更新 (UTC)**: 2026-06-07 00:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 29 · trojan × 21 · vless × 27 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 37 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 3 · `ninjastrikers` × 30 · `pawdroid` × 1 · `ruking-clash` × 3 · `snakem982` × 1 · `surfboard-eternity` × 3
