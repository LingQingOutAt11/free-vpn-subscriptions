...
![ノード](https://img.shields.io/badge/ノード-112-brightgreen) ![生存](https://img.shields.io/badge/生存-1949-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-160ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-04_04:31_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 160 ms
- **最終更新 (UTC)**: 2026-06-04 04:31 UTC

**プロトコル構成:** shadowsocks × 24 · trojan × 47 · vless × 29 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 32 · `epodonios` × 32 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 4 · `ninjastrikers` × 23 · `pawdroid` × 1 · `snakem982` × 1 · `surfboard-eternity` × 4
