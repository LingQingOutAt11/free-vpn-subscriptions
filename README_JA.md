...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1946-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-219ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_00:14_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 219 ms
- **最終更新 (UTC)**: 2026-06-22 00:14 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 44 · trojan × 17 · vless × 76 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 37 · `mahdi0024` × 7 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 5 · `ninjastrikers` × 26 · `pawdroid` × 2 · `ruking-clash` × 17 · `snakem982` × 5 · `surfboard-eternity` × 2
