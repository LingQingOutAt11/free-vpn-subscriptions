...
![ノード](https://img.shields.io/badge/ノード-93-brightgreen) ![生存](https://img.shields.io/badge/生存-4049-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-214ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-21_19:58_UTC-informational)
...
- **最速 RTT**: 41 ms
- **中央値 RTT**: 214 ms
- **最終更新 (UTC)**: 2026-07-21 19:58 UTC

**プロトコル構成:** shadowsocks × 11 · trojan × 23 · vless × 54 · vmess × 5

**今回使用したソース:** `autojiedian-clash` × 6 · `automerge-verified-clash` × 7 · `barry-far-v2ray` × 1 · `epodonios` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 1 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `mfuu-clash` × 1 · `ninjastrikers` × 7 · `pawdroid` × 1 · `roosterkid-openproxylist` × 15 · `solispirit-v2ray` × 34 · `surfboard-eternity` × 2 · `tg-v2ray-configs-every2h` × 12
