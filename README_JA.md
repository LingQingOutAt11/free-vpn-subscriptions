...
![ノード](https://img.shields.io/badge/ノード-87-brightgreen) ![生存](https://img.shields.io/badge/生存-2191-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-281ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_05:13_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 281 ms
- **最終更新 (UTC)**: 2026-06-29 05:13 UTC

**プロトコル構成:** shadowsocks × 17 · trojan × 29 · vless × 28 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 21 · `lagzian-mix` × 1 · `mahdi0024` × 9 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 1 · `mfuu-clash` × 11 · `ninjastrikers` × 19 · `pawdroid` × 4 · `ruking-clash` × 2 · `surfboard-eternity` × 3
