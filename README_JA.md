...
![ノード](https://img.shields.io/badge/ノード-81-brightgreen) ![生存](https://img.shields.io/badge/生存-2450-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-78ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-03_11:16_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 78 ms
- **最終更新 (UTC)**: 2026-06-03 11:16 UTC

**プロトコル構成:** shadowsocks × 14 · trojan × 38 · vless × 8 · vmess × 21

**今回使用したソース:** `barry-far-v2ray` × 23 · `epodonios` × 11 · `lagzian-mix` × 2 · `mahdi0024` × 18 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 10 · `pawdroid` × 3 · `snakem982` × 1 · `surfboard-eternity` × 1
