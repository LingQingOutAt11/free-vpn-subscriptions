...
![ノード](https://img.shields.io/badge/ノード-82-brightgreen) ![生存](https://img.shields.io/badge/生存-2114-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-180ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_19:36_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 180 ms
- **最終更新 (UTC)**: 2026-06-28 19:36 UTC

**プロトコル構成:** shadowsocks × 18 · trojan × 28 · vless × 19 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 21 · `mahdi0024` × 12 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 2 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 12 · `surfboard-eternity` × 2
