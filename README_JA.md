...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1970-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-252ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_01:11_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 252 ms
- **最終更新 (UTC)**: 2026-06-22 01:11 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 44 · trojan × 17 · vless × 77 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 13 · `ebrasha-v2ray` × 1 · `epodonios` × 39 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 6 · `ninjastrikers` × 23 · `pawdroid` × 3 · `ruking-clash` × 16 · `snakem982` × 5 · `surfboard-eternity` × 1
