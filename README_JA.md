...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1937-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-484ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_12:31_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 484 ms
- **最終更新 (UTC)**: 2026-06-22 12:31 UTC

**プロトコル構成:** shadowsocks × 41 · trojan × 31 · vless × 63 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 10 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 18 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 5 · `ruking-clash` × 30 · `snakem982` × 2 · `surfboard-eternity` × 4
