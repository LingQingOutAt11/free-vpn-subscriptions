...
![ノード](https://img.shields.io/badge/ノード-132-brightgreen) ![生存](https://img.shields.io/badge/生存-2021-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-445ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_20:13_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 445 ms
- **最終更新 (UTC)**: 2026-06-23 20:13 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 31 · vless × 48 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 50 · `lagzian-mix` × 3 · `mahdi0024` × 5 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 2 · `ninjastrikers` × 16 · `pawdroid` × 2 · `ruking-clash` × 16 · `surfboard-eternity` × 4
