...
![ノード](https://img.shields.io/badge/ノード-112-brightgreen) ![生存](https://img.shields.io/badge/生存-1997-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-373ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-28_10:16_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 373 ms
- **最終更新 (UTC)**: 2026-06-28 10:16 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 26 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 17 · `ebrasha-v2ray` × 1 · `epodonios` × 26 · `lagzian-mix` × 3 · `mahdi0024` × 3 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 3 · `mfuu-clash` × 1 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 15 · `surfboard-eternity` × 4
