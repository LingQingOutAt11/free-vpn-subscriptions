...
![ノード](https://img.shields.io/badge/ノード-113-brightgreen) ![生存](https://img.shields.io/badge/生存-2004-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-364ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-25_12:36_UTC-informational)
...
- **最速 RTT**: 41 ms
- **中央値 RTT**: 364 ms
- **最終更新 (UTC)**: 2026-06-25 12:36 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 36 · trojan × 34 · vless × 28 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 30 · `lagzian-mix` × 2 · `mahdi0024` × 19 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 13 · `surfboard-eternity` × 2
