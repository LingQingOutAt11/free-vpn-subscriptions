...
![ノード](https://img.shields.io/badge/ノード-140-brightgreen) ![生存](https://img.shields.io/badge/生存-2382-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-165ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-09_13:17_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 165 ms
- **最終更新 (UTC)**: 2026-05-09 13:17 UTC

**プロトコル構成:** shadowsocks × 37 · trojan × 17 · vless × 74 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 28 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 6 · `ninjastrikers` × 60 · `snakem982` × 1 · `surfboard-eternity` × 8
