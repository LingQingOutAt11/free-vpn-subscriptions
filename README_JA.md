...
![ノード](https://img.shields.io/badge/ノード-125-brightgreen) ![生存](https://img.shields.io/badge/生存-1723-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-306ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_02:19_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 306 ms
- **最終更新 (UTC)**: 2026-06-15 02:19 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 49 · trojan × 24 · vless × 38 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 2 · `epodonios` × 13 · `lagzian-mix` × 1 · `mahdi0024` × 12 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 18 · `ninjastrikers` × 36 · `pawdroid` × 5 · `ruking-clash` × 12 · `surfboard-eternity` × 4
