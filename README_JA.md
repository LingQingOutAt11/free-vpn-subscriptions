...
![ノード](https://img.shields.io/badge/ノード-131-brightgreen) ![生存](https://img.shields.io/badge/生存-1898-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-334ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_02:33_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 334 ms
- **最終更新 (UTC)**: 2026-06-16 02:33 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 52 · trojan × 28 · vless × 38 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 21 · `lagzian-mix` × 4 · `mahdi0024` × 16 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 34 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 3
