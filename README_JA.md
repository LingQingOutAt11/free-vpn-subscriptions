...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2359-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-77ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-23_05:19_UTC-informational)
...
- **最速 RTT**: 46 ms
- **中央値 RTT**: 77 ms
- **最終更新 (UTC)**: 2026-05-23 05:19 UTC

**プロトコル構成:** shadowsocks × 34 · trojan × 7 · vless × 98 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 17 · `epodonios` × 5 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 72 · `pawdroid` × 8 · `ruking-clash` × 1 · `surfboard-eternity` × 7 · `vxiaov-clash` × 1
