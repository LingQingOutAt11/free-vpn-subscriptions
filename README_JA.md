...
![ノード](https://img.shields.io/badge/ノード-128-brightgreen) ![生存](https://img.shields.io/badge/生存-2128-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-372ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_17:39_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 372 ms
- **最終更新 (UTC)**: 2026-06-20 17:39 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 44 · trojan × 29 · vless × 31 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `mahdi0024` × 27 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `mfuu-clash` × 4 · `ninjastrikers` × 17 · `pawdroid` × 3 · `ruking-clash` × 24 · `snakem982` × 3 · `surfboard-eternity` × 3
