...
![ノード](https://img.shields.io/badge/ノード-112-brightgreen) ![生存](https://img.shields.io/badge/生存-1833-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-385ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-15_20:16_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 385 ms
- **最終更新 (UTC)**: 2026-06-15 20:16 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 52 · trojan × 24 · vless × 20 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 9 · `ebrasha-v2ray` × 2 · `epodonios` × 19 · `lagzian-mix` × 4 · `mahdi0024` × 21 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 4
