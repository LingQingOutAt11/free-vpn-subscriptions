...
![ノード](https://img.shields.io/badge/ノード-96-brightgreen) ![生存](https://img.shields.io/badge/生存-1898-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-366ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-25_20:14_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 366 ms
- **最終更新 (UTC)**: 2026-06-25 20:14 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 27 · vless × 21 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 2 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 18 · `surfboard-eternity` × 3
