...
![ノード](https://img.shields.io/badge/ノード-142-brightgreen) ![生存](https://img.shields.io/badge/生存-2241-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-310ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-05_16:39_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 310 ms
- **最終更新 (UTC)**: 2026-05-05 16:39 UTC

**プロトコル構成:** shadowsocks × 34 · trojan × 27 · vless × 71 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 32 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 6 · `mahdi0024` × 7 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 3 · `ninjastrikers` × 62 · `snakem982` × 1 · `surfboard-eternity` × 5
