...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2126-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-186ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_04:29_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 186 ms
- **最終更新 (UTC)**: 2026-06-21 04:29 UTC

**プロトコル構成:** shadowsocks × 37 · trojan × 33 · vless × 58 · vmess × 22

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 35 · `lagzian-mix` × 2 · `mahdi0024` × 27 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `mfuu-clash` × 5 · `ninjastrikers` × 22 · `pawdroid` × 3 · `ruking-clash` × 28 · `surfboard-eternity` × 2
