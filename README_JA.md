...
![ノード](https://img.shields.io/badge/ノード-139-brightgreen) ![生存](https://img.shields.io/badge/生存-1934-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-403ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_18:10_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 403 ms
- **最終更新 (UTC)**: 2026-06-21 18:10 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 27 · vless × 55 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 18 · `ebrasha-v2ray` × 1 · `epodonios` × 27 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 5 · `ruking-clash` × 32 · `snakem982` × 4 · `surfboard-eternity` × 6
