...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1971-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-621ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_19:26_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 621 ms
- **最終更新 (UTC)**: 2026-06-16 19:26 UTC

**プロトコル構成:** shadowsocks × 48 · trojan × 20 · vless × 12 · vmess × 70

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 12 · `lagzian-mix` × 2 · `mahdi0024` × 77 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `mfuu-clash` × 1 · `ninjastrikers` × 9 · `pawdroid` × 2 · `ruking-clash` × 9 · `surfboard-eternity` × 3
