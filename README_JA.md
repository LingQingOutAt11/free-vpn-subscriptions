...
![ノード](https://img.shields.io/badge/ノード-142-brightgreen) ![生存](https://img.shields.io/badge/生存-2302-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-89ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-24_20:36_UTC-informational)
...
- **最速 RTT**: 19 ms
- **中央値 RTT**: 89 ms
- **最終更新 (UTC)**: 2026-05-24 20:36 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 19 · vless × 53 · vmess × 26

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 46 · `mahdibland-aggregator` × 8 · `mahdibland-shadowsocks` × 3 · `ninjastrikers` × 50 · `pawdroid` × 1 · `ruking-clash` × 4 · `surfboard-eternity` × 3 · `vxiaov-clash` × 1
