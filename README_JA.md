...
![ノード](https://img.shields.io/badge/ノード-98-brightgreen) ![生存](https://img.shields.io/badge/生存-1990-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-380ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_22:17_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 380 ms
- **最終更新 (UTC)**: 2026-06-29 22:17 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 37 · vless × 8 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 16 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 1 · `ruking-clash` × 12 · `surfboard-eternity` × 5
