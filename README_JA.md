...
![ノード](https://img.shields.io/badge/ノード-85-brightgreen) ![生存](https://img.shields.io/badge/生存-2128-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-180ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-06_16:19_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 180 ms
- **最終更新 (UTC)**: 2026-06-06 16:19 UTC

**プロトコル構成:** shadowsocks × 27 · trojan × 26 · vless × 8 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 3 · `epodonios` × 13 · `mahdi0024` × 35 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 9 · `pawdroid` × 3 · `ruking-clash` × 1 · `surfboard-eternity` × 4
