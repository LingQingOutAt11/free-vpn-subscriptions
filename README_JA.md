...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2361-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-117ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-20_23:28_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 117 ms
- **最終更新 (UTC)**: 2026-05-20 23:28 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 38 · trojan × 28 · vless × 65 · vmess × 18

**今回使用したソース:** `barry-far-v2ray` × 35 · `ebrasha-v2ray` × 2 · `epodonios` × 8 · `lagzian-mix` × 5 · `mahdi0024` × 16 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 50 · `pawdroid` × 6 · `ruking-clash` × 1 · `surfboard-eternity` × 6
