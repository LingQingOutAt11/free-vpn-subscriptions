...
![ノード](https://img.shields.io/badge/ノード-93-brightgreen) ![生存](https://img.shields.io/badge/生存-2054-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-299ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-09_19:30_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 299 ms
- **最終更新 (UTC)**: 2026-06-09 19:30 UTC

**プロトコル構成:** shadowsocks × 40 · trojan × 17 · vless × 9 · vmess × 27

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 2 · `mahdi0024` × 31 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 8 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 4 · `surfboard-eternity` × 6
