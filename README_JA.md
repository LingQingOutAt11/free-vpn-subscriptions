...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1942-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-135ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_07:13_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 135 ms
- **最終更新 (UTC)**: 2026-05-12 07:13 UTC

**プロトコル構成:** shadowsocks × 57 · trojan × 3 · vless × 80 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 27 · `ebrasha-v2ray` × 7 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 3 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 2 · `ninjastrikers` × 62 · `pawdroid` × 3 · `snakem982` × 2 · `surfboard-eternity` × 5 · `vxiaov-clash` × 1
