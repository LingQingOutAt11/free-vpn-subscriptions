...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2609-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-70ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-20_11:37_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 70 ms
- **最終更新 (UTC)**: 2026-05-20 11:37 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 11 · vless × 83 · vmess × 18

**今回使用したソース:** `barry-far-v2ray` × 29 · `ebrasha-v2ray` × 2 · `epodonios` × 2 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 59 · `pawdroid` × 9 · `surfboard-eternity` × 9
