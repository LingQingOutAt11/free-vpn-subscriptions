...
![ノード](https://img.shields.io/badge/ノード-140-brightgreen) ![生存](https://img.shields.io/badge/生存-2117-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-316ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_05:20_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 316 ms
- **最終更新 (UTC)**: 2026-06-21 05:20 UTC

**プロトコル構成:** shadowsocks × 42 · trojan × 34 · vless × 41 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 9 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 19 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 4 · `mfuu-clash` × 6 · `ninjastrikers` × 21 · `pawdroid` × 1 · `ruking-clash` × 31 · `snakem982` × 2 · `surfboard-eternity` × 1
