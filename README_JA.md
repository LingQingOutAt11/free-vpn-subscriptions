...
![ノード](https://img.shields.io/badge/ノード-111-brightgreen) ![生存](https://img.shields.io/badge/生存-2062-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-429ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_10:22_UTC-informational)
...
- **最速 RTT**: 25 ms
- **中央値 RTT**: 429 ms
- **最終更新 (UTC)**: 2026-06-23 10:22 UTC

**プロトコル構成:** shadowsocks × 34 · trojan × 27 · vless × 43 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 41 · `lagzian-mix` × 2 · `mahdi0024` × 8 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 6 · `ninjastrikers` × 13 · `pawdroid` × 2 · `ruking-clash` × 13 · `surfboard-eternity` × 2
