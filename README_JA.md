...
![ノード](https://img.shields.io/badge/ノード-109-brightgreen) ![生存](https://img.shields.io/badge/生存-1841-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-392ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_10:32_UTC-informational)
...
- **最速 RTT**: 23 ms
- **中央値 RTT**: 392 ms
- **最終更新 (UTC)**: 2026-06-17 10:32 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 47 · trojan × 28 · vless × 20 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 2 · `epodonios` × 15 · `lagzian-mix` × 1 · `mahdi0024` × 18 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 15 · `ninjastrikers` × 14 · `pawdroid` × 3 · `ruking-clash` × 15 · `surfboard-eternity` × 4
