...
![ノード](https://img.shields.io/badge/ノード-124-brightgreen) ![生存](https://img.shields.io/badge/生存-2019-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-391ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_19:25_UTC-informational)
...
- **最速 RTT**: 37 ms
- **中央値 RTT**: 391 ms
- **最終更新 (UTC)**: 2026-06-23 19:25 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 26 · vless × 43 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 6 · `ebrasha-v2ray` × 1 · `epodonios` × 45 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `mfuu-clash` × 2 · `ninjastrikers` × 11 · `pawdroid` × 3 · `ruking-clash` × 16 · `surfboard-eternity` × 3
