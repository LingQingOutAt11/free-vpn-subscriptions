...
![ノード](https://img.shields.io/badge/ノード-90-brightgreen) ![生存](https://img.shields.io/badge/生存-3681-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-143ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-12_13:52_UTC-informational)
...
- **最速 RTT**: 25 ms
- **中央値 RTT**: 143 ms
- **最終更新 (UTC)**: 2026-08-12 13:52 UTC

**プロトコル構成:** hysteria2 × 3 · shadowsocks × 24 · trojan × 15 · vless × 31 · vmess × 17

**今回使用したソース:** `autojiedian-clash` × 10 · `automerge-verified-clash` × 11 · `barry-far-v2ray` × 3 · `epodonios` × 7 · `mahdi0024` × 5 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 2 · `ninjastrikers` × 3 · `radikal-clash` × 5 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 2 · `snakem982` × 3 · `solispirit-v2ray` × 11 · `surfboard-eternity` × 4 · `tg-v2ray-configs-every2h` × 10
