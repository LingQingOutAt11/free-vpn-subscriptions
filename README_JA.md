...
![ノード](https://img.shields.io/badge/ノード-79-brightgreen) ![生存](https://img.shields.io/badge/生存-2226-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-427ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-29_14:33_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 427 ms
- **最終更新 (UTC)**: 2026-06-29 14:33 UTC

**プロトコル構成:** shadowsocks × 15 · trojan × 32 · vless × 18 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 8 · `epodonios` × 19 · `lagzian-mix` × 2 · `mahdi0024` × 12 · `mahdibland-aggregator` × 4 · `mahdibland-shadowsocks` × 3 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 4 · `ruking-clash` × 10 · `surfboard-eternity` × 4
