...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1989-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-251ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-16_21:16_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 251 ms
- **最終更新 (UTC)**: 2026-06-16 21:16 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 46 · trojan × 19 · vless × 13 · vmess × 71

**今回使用したソース:** `barry-far-v2ray` × 5 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 4 · `mahdi0024` × 75 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 16 · `mfuu-clash` × 3 · `ninjastrikers` × 13 · `ruking-clash` × 13 · `surfboard-eternity` × 2
