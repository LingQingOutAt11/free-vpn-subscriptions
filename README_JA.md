...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2222-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-140ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-06_00:30_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 140 ms
- **最終更新 (UTC)**: 2026-05-06 00:30 UTC

**プロトコル構成:** shadowsocks × 36 · trojan × 9 · vless × 94 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 30 · `epodonios` × 5 · `lagzian-mix` × 2 · `mahdi0024` × 4 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 6 · `mfuu-clash` × 6 · `ninjastrikers` × 74 · `pawdroid` × 1 · `surfboard-eternity` × 9
