...
![ノード](https://img.shields.io/badge/ノード-67-brightgreen) ![生存](https://img.shields.io/badge/生存-3460-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-108ms-orange) ![更新](https://img.shields.io/badge/更新-2026-08-05_14:39_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 108 ms
- **最終更新 (UTC)**: 2026-08-05 14:39 UTC

**プロトコル構成:** shadowsocks × 3 · trojan × 20 · vless × 38 · vmess × 6

**今回使用したソース:** `autojiedian-clash` × 6 · `automerge-verified-clash` × 10 · `mahdi0024` × 6 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 1 · `ninjastrikers` × 5 · `pawdroid` × 1 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 12 · `solispirit-v2ray` × 15 · `tg-v2ray-configs-every2h` × 9
