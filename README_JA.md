...
![ノード](https://img.shields.io/badge/ノード-106-brightgreen) ![生存](https://img.shields.io/badge/生存-1921-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-387ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_18:25_UTC-informational)
...
- **最速 RTT**: 26 ms
- **中央値 RTT**: 387 ms
- **最終更新 (UTC)**: 2026-06-12 18:25 UTC

**プロトコル構成:** hysteria2 × 2 · shadowsocks × 49 · trojan × 39 · vless × 8 · vmess × 8

**今回使用したソース:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 2 · `epodonios` × 28 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 7 · `surfboard-eternity` × 5
