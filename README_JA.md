...
![ノード](https://img.shields.io/badge/ノード-122-brightgreen) ![生存](https://img.shields.io/badge/生存-1614-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-407ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_19:12_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 407 ms
- **最終更新 (UTC)**: 2026-06-14 19:12 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 61 · trojan × 29 · vless × 19 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 19 · `ebrasha-v2ray` × 3 · `epodonios` × 9 · `lagzian-mix` × 3 · `mahdi0024` × 11 · `mahdibland-aggregator` × 20 · `mahdibland-shadowsocks` × 16 · `ninjastrikers` × 13 · `ruking-clash` × 20 · `surfboard-eternity` × 8
