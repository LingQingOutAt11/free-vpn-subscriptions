...
![ノード](https://img.shields.io/badge/ノード-94-brightgreen) ![生存](https://img.shields.io/badge/生存-1789-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-377ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_18:33_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 377 ms
- **最終更新 (UTC)**: 2026-06-13 18:33 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 50 · trojan × 26 · vless × 10 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 2 · `epodonios` × 12 · `lagzian-mix` × 3 · `mahdi0024` × 7 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 20 · `matin-v2ray` × 1 · `ninjastrikers` × 14 · `pawdroid` × 1 · `ruking-clash` × 13
