...
![ノード](https://img.shields.io/badge/ノード-102-brightgreen) ![生存](https://img.shields.io/badge/生存-1672-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-376ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_19:15_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 376 ms
- **最終更新 (UTC)**: 2026-06-07 19:15 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 56 · trojan × 23 · vless × 16 · vmess × 6

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 14 · `lagzian-mix` × 1 · `mahdi0024` × 1 · `mahdibland-aggregator` × 23 · `mahdibland-shadowsocks` × 25 · `mfuu-clash` × 6 · `ninjastrikers` × 13 · `ruking-clash` × 2 · `snakem982` × 1 · `surfboard-eternity` × 2
