...
![ノード](https://img.shields.io/badge/ノード-130-brightgreen) ![生存](https://img.shields.io/badge/生存-2265-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-345ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_00:26_UTC-informational)
...
- **最速 RTT**: 32 ms
- **中央値 RTT**: 345 ms
- **最終更新 (UTC)**: 2026-06-12 00:26 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 50 · trojan × 45 · vless × 29 · vmess × 5

**今回使用したソース:** `barry-far-v2ray` × 11 · `ebrasha-v2ray` × 1 · `epodonios` × 32 · `lagzian-mix` × 2 · `mahdi0024` × 2 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 17 · `ninjastrikers` × 36 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 4
