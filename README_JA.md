...
![ノード](https://img.shields.io/badge/ノード-124-brightgreen) ![生存](https://img.shields.io/badge/生存-1635-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-413ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-14_15:36_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 413 ms
- **最終更新 (UTC)**: 2026-06-14 15:36 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 54 · trojan × 28 · vless × 25 · vmess × 16

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 3 · `epodonios` × 17 · `lagzian-mix` × 2 · `mahdi0024` × 15 · `mahdibland-aggregator` × 18 · `mahdibland-shadowsocks` × 22 · `matin-v2ray` × 2 · `ninjastrikers` × 18 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 4
