...
![ノード](https://img.shields.io/badge/ノード-134-brightgreen) ![生存](https://img.shields.io/badge/生存-2385-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-498ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_16:31_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 498 ms
- **最終更新 (UTC)**: 2026-06-18 16:31 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 34 · trojan × 34 · vless × 54 · vmess × 11

**今回使用したソース:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 30 · `mahdibland-aggregator` × 9 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 29 · `snakem982` × 8 · `surfboard-eternity` × 4
