...
![ノード](https://img.shields.io/badge/ノード-119-brightgreen) ![生存](https://img.shields.io/badge/生存-1814-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-354ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-27_05:19_UTC-informational)
...
- **最速 RTT**: 26 ms
- **中央値 RTT**: 354 ms
- **最終更新 (UTC)**: 2026-06-27 05:19 UTC

**プロトコル構成:** shadowsocks × 37 · trojan × 34 · vless × 22 · vmess × 26

**今回使用したソース:** `barry-far-v2ray` × 13 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 20 · `mahdibland-aggregator` × 14 · `mahdibland-shadowsocks` × 21 · `matin-v2ray` × 1 · `ruking-clash` × 20 · `surfboard-eternity` × 5
