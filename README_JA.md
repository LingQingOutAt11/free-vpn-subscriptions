...
![ノード](https://img.shields.io/badge/ノード-96-brightgreen) ![生存](https://img.shields.io/badge/生存-1843-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-376ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-30_09:29_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 376 ms
- **最終更新 (UTC)**: 2026-06-30 09:29 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 39 · trojan × 37 · vless × 10 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 6 · `lagzian-mix` × 2 · `mahdi0024` × 16 · `mahdibland-aggregator` × 16 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 16 · `pawdroid` × 6 · `ruking-clash` × 13
