...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-1975-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-141ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-12_04:25_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 141 ms
- **最終更新 (UTC)**: 2026-05-12 04:25 UTC

**プロトコル構成:** shadowsocks × 56 · trojan × 5 · vless × 80 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 6 · `epodonios` × 6 · `lagzian-mix` × 5 · `mahdi0024` × 4 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 13 · `matin-v2ray` × 1 · `mfuu-clash` × 5 · `ninjastrikers` × 72 · `ruking-clash` × 1 · `snakem982` × 1 · `surfboard-eternity` × 10
