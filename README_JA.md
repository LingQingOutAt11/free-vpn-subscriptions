...
![ノード](https://img.shields.io/badge/ノード-115-brightgreen) ![生存](https://img.shields.io/badge/生存-1794-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-421ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-17_16:21_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 421 ms
- **最終更新 (UTC)**: 2026-06-17 16:21 UTC

**プロトコル構成:** shadowsocks × 47 · trojan × 31 · vless × 28 · vmess × 9

**今回使用したソース:** `barry-far-v2ray` × 14 · `epodonios` × 15 · `mahdi0024` × 6 · `mahdibland-aggregator` × 17 · `mahdibland-shadowsocks` × 17 · `matin-v2ray` × 2 · `ninjastrikers` × 13 · `pawdroid` × 4 · `ruking-clash` × 22 · `surfboard-eternity` × 5
