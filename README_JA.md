...
![ノード](https://img.shields.io/badge/ノード-130-brightgreen) ![生存](https://img.shields.io/badge/生存-2542-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-484ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_14:21_UTC-informational)
...
- **最速 RTT**: 35 ms
- **中央値 RTT**: 484 ms
- **最終更新 (UTC)**: 2026-06-19 14:21 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 30 · trojan × 29 · vless × 50 · vmess × 20

**今回使用したソース:** `barry-far-v2ray` × 16 · `epodonios` × 19 · `lagzian-mix` × 1 · `mahdi0024` × 5 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 5 · `matin-v2ray` × 5 · `ninjastrikers` × 18 · `pawdroid` × 3 · `ruking-clash` × 42 · `snakem982` × 6 · `surfboard-eternity` × 3
