...
![ノード](https://img.shields.io/badge/ノード-128-brightgreen) ![生存](https://img.shields.io/badge/生存-2102-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-392ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_22:32_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 392 ms
- **最終更新 (UTC)**: 2026-06-20 22:32 UTC

**プロトコル構成:** shadowsocks × 41 · trojan × 33 · vless × 31 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 15 · `epodonios` × 11 · `mahdi0024` × 23 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 3 · `mfuu-clash` × 4 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 30 · `snakem982` × 1 · `surfboard-eternity` × 4
