...
![ノード](https://img.shields.io/badge/ノード-128-brightgreen) ![生存](https://img.shields.io/badge/生存-2397-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-451ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_01:17_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 451 ms
- **最終更新 (UTC)**: 2026-06-19 01:17 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 37 · trojan × 28 · vless × 50 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 10 · `ebrasha-v2ray` × 1 · `epodonios` × 18 · `lagzian-mix` × 1 · `mahdi0024` × 6 · `mahdibland-aggregator` × 11 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 26 · `pawdroid` × 7 · `ruking-clash` × 26 · `snakem982` × 8 · `surfboard-eternity` × 2
