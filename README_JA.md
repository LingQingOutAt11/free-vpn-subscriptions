...
![ノード](https://img.shields.io/badge/ノード-115-brightgreen) ![生存](https://img.shields.io/badge/生存-2374-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-483ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-18_18:38_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 483 ms
- **最終更新 (UTC)**: 2026-06-18 18:38 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 38 · trojan × 31 · vless × 35 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 20 · `ebrasha-v2ray` × 1 · `epodonios` × 3 · `lagzian-mix` × 2 · `mahdi0024` × 5 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 32 · `snakem982` × 10 · `surfboard-eternity` × 5
