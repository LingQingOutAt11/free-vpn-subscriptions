...
![ノード](https://img.shields.io/badge/ノード-88-brightgreen) ![生存](https://img.shields.io/badge/生存-2014-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-253ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-26_17:14_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 253 ms
- **最終更新 (UTC)**: 2026-06-26 17:14 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 27 · vless × 16 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 15 · `lagzian-mix` × 3 · `mahdi0024` × 15 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 7 · `pawdroid` × 3 · `ruking-clash` × 18 · `surfboard-eternity` × 3
