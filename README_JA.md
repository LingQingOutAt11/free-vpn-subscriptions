...
![ノード](https://img.shields.io/badge/ノード-94-brightgreen) ![生存](https://img.shields.io/badge/生存-2107-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-323ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-10_14:14_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 323 ms
- **最終更新 (UTC)**: 2026-06-10 14:14 UTC

**プロトコル構成:** shadowsocks × 41 · trojan × 14 · vless × 13 · vmess × 26

**今回使用したソース:** `barry-far-v2ray` × 10 · `epodonios` × 9 · `lagzian-mix` × 1 · `mahdi0024` × 26 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 9 · `matin-v2ray` × 1 · `ninjastrikers` × 11 · `pawdroid` × 2 · `ruking-clash` × 6 · `surfboard-eternity` × 6
