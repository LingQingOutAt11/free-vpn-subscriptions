...
![ノード](https://img.shields.io/badge/ノード-129-brightgreen) ![生存](https://img.shields.io/badge/生存-1995-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-395ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_16:23_UTC-informational)
...
- **最速 RTT**: 34 ms
- **中央値 RTT**: 395 ms
- **最終更新 (UTC)**: 2026-06-23 16:23 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 41 · trojan × 27 · vless × 43 · vmess × 17

**今回使用したソース:** `barry-far-v2ray` × 12 · `ebrasha-v2ray` × 1 · `epodonios` × 44 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 13 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 4 · `mfuu-clash` × 1 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 2
