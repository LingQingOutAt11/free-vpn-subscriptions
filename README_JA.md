...
![ノード](https://img.shields.io/badge/ノード-86-brightgreen) ![生存](https://img.shields.io/badge/生存-2265-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-212ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_10:17_UTC-informational)
...
- **最速 RTT**: 29 ms
- **中央値 RTT**: 212 ms
- **最終更新 (UTC)**: 2026-06-20 10:17 UTC

**プロトコル構成:** shadowsocks × 22 · trojan × 24 · vless × 10 · vmess × 30

**今回使用したソース:** `barry-far-v2ray` × 3 · `epodonios` × 8 · `lagzian-mix` × 2 · `mahdi0024` × 23 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `ninjastrikers` × 12 · `pawdroid` × 2 · `ruking-clash` × 17 · `surfboard-eternity` × 3
