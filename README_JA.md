...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2047-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-71ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-22_11:28_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 71 ms
- **最終更新 (UTC)**: 2026-05-22 11:28 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 36 · trojan × 8 · vless × 90 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 33 · `ebrasha-v2ray` × 2 · `epodonios` × 4 · `lagzian-mix` × 4 · `mahdi0024` × 11 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 9 · `ninjastrikers` × 64 · `pawdroid` × 3 · `ruking-clash` × 8 · `surfboard-eternity` × 6
