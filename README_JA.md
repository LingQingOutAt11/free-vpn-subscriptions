...
![ノード](https://img.shields.io/badge/ノード-126-brightgreen) ![生存](https://img.shields.io/badge/生存-2130-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-430ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_16:28_UTC-informational)
...
- **最速 RTT**: 36 ms
- **中央値 RTT**: 430 ms
- **最終更新 (UTC)**: 2026-06-20 16:28 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 43 · trojan × 30 · vless × 29 · vmess × 23

**今回使用したソース:** `barry-far-v2ray` × 16 · `ebrasha-v2ray` × 1 · `epodonios` × 14 · `mahdi0024` × 30 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 8 · `matin-v2ray` × 2 · `mfuu-clash` × 3 · `ninjastrikers` × 12 · `pawdroid` × 3 · `ruking-clash` × 28 · `snakem982` × 1 · `surfboard-eternity` × 2
