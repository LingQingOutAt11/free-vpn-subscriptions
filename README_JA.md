...
![ノード](https://img.shields.io/badge/ノード-97-brightgreen) ![生存](https://img.shields.io/badge/生存-4017-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-229ms-orange) ![更新](https://img.shields.io/badge/更新-2026-07-23_08:51_UTC-informational)
...
- **最速 RTT**: 40 ms
- **中央値 RTT**: 229 ms
- **最終更新 (UTC)**: 2026-07-23 08:51 UTC

**プロトコル構成:** shadowsocks × 7 · trojan × 22 · vless × 67 · vmess × 1

**今回使用したソース:** `autojiedian-clash` × 1 · `automerge-verified-clash` × 6 · `barry-far-v2ray` × 2 · `mahdibland-aggregator` × 2 · `mahdibland-shadowsocks` × 1 · `matin-v2ray` × 2 · `ninjastrikers` × 12 · `pawdroid` × 2 · `radikal-clash` × 1 · `roosterkid-openproxylist` × 9 · `ruking-clash` × 1 · `solispirit-v2ray` × 42 · `surfboard-eternity` × 3 · `tg-v2ray-configs-every2h` × 13
