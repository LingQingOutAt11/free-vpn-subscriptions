...
![ノード](https://img.shields.io/badge/ノード-88-brightgreen) ![生存](https://img.shields.io/badge/生存-2318-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-250ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-19_23:18_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 250 ms
- **最終更新 (UTC)**: 2026-06-19 23:18 UTC

**プロトコル構成:** shadowsocks × 23 · trojan × 25 · vless × 9 · vmess × 31

**今回使用したソース:** `barry-far-v2ray` × 6 · `epodonios` × 10 · `mahdi0024` × 24 · `mahdibland-aggregator` × 6 · `mahdibland-shadowsocks` × 7 · `ninjastrikers` × 13 · `pawdroid` × 1 · `ruking-clash` × 17 · `surfboard-eternity` × 4
