...
![ノード](https://img.shields.io/badge/ノード-144-brightgreen) ![生存](https://img.shields.io/badge/生存-1902-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-451ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-22_09:28_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 451 ms
- **最終更新 (UTC)**: 2026-06-22 09:28 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 49 · trojan × 30 · vless × 51 · vmess × 13

**今回使用したソース:** `barry-far-v2ray` × 8 · `ebrasha-v2ray` × 1 · `epodonios` × 28 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 24 · `matin-v2ray` × 2 · `ninjastrikers` × 20 · `pawdroid` × 5 · `ruking-clash` × 29 · `snakem982` × 1 · `surfboard-eternity` × 3
