...
![ノード](https://img.shields.io/badge/ノード-91-brightgreen) ![生存](https://img.shields.io/badge/生存-2177-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-174ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_11:38_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 174 ms
- **最終更新 (UTC)**: 2026-06-07 11:38 UTC

**プロトコル構成:** shadowsocks × 35 · trojan × 24 · vless × 8 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 5 · `epodonios` × 8 · `lagzian-mix` × 1 · `mahdi0024` × 42 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 1 · `ninjastrikers` × 12 · `pawdroid` × 1 · `ruking-clash` × 1 · `surfboard-eternity` × 2
