...
![ノード](https://img.shields.io/badge/ノード-112-brightgreen) ![生存](https://img.shields.io/badge/生存-2112-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-334ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_18:12_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 334 ms
- **最終更新 (UTC)**: 2026-06-24 18:12 UTC

**プロトコル構成:** shadowsocks × 31 · trojan × 31 · vless × 35 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 2 · `epodonios` × 39 · `lagzian-mix` × 1 · `mahdi0024` × 19 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `ninjastrikers` × 10 · `pawdroid` × 3 · `ruking-clash` × 14 · `surfboard-eternity` × 3
