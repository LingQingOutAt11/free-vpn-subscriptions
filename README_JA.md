...
![ノード](https://img.shields.io/badge/ノード-150-brightgreen) ![生存](https://img.shields.io/badge/生存-2084-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-197ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-03_19:24_UTC-informational)
...
- **最速 RTT**: 28 ms
- **中央値 RTT**: 197 ms
- **最終更新 (UTC)**: 2026-05-03 19:24 UTC

**プロトコル構成:** shadowsocks × 29 · trojan × 23 · vless × 86 · vmess × 12

**今回使用したソース:** `barry-far-v2ray` × 31 · `epodonios` × 7 · `lagzian-mix` × 3 · `mahdi0024` × 25 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 10 · `matin-v2ray` × 1 · `mfuu-clash` × 3 · `ninjastrikers` × 58 · `pawdroid` × 2 · `surfboard-eternity` × 5
