...
![ノード](https://img.shields.io/badge/ノード-106-brightgreen) ![生存](https://img.shields.io/badge/生存-1885-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-363ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-13_09:09_UTC-informational)
...
- **最速 RTT**: 24 ms
- **中央値 RTT**: 363 ms
- **最終更新 (UTC)**: 2026-06-13 09:09 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 55 · trojan × 25 · vless × 18 · vmess × 7

**今回使用したソース:** `barry-far-v2ray` × 14 · `ebrasha-v2ray` × 1 · `epodonios` × 17 · `lagzian-mix` × 4 · `mahdi0024` × 3 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 15 · `matin-v2ray` × 2 · `ninjastrikers` × 17 · `pawdroid` × 5 · `ruking-clash` × 10 · `surfboard-eternity` × 6
