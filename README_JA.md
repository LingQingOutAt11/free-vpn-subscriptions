...
![ノード](https://img.shields.io/badge/ノード-132-brightgreen) ![生存](https://img.shields.io/badge/生存-2132-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-80ms-orange) ![更新](https://img.shields.io/badge/更新-2026-05-26_14:30_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 80 ms
- **最終更新 (UTC)**: 2026-05-26 14:30 UTC

**プロトコル構成:** shadowsocks × 26 · trojan × 24 · vless × 67 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 25 · `epodonios` × 4 · `lagzian-mix` × 3 · `mahdi0024` × 14 · `mahdibland-aggregator` × 5 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 1 · `ninjastrikers` × 52 · `pawdroid` × 8 · `ruking-clash` × 8 · `surfboard-eternity` × 1
