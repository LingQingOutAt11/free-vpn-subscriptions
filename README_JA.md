...
![ノード](https://img.shields.io/badge/ノード-118-brightgreen) ![生存](https://img.shields.io/badge/生存-2114-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-360ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-24_06:31_UTC-informational)
...
- **最速 RTT**: 38 ms
- **中央値 RTT**: 360 ms
- **最終更新 (UTC)**: 2026-06-24 06:31 UTC

**プロトコル構成:** shadowsocks × 30 · trojan × 28 · vless × 45 · vmess × 15

**今回使用したソース:** `barry-far-v2ray` × 7 · `epodonios` × 43 · `lagzian-mix` × 2 · `mahdi0024` × 6 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 6 · `matin-v2ray` × 2 · `ninjastrikers` × 21 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 5
