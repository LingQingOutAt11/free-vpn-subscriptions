...
![ノード](https://img.shields.io/badge/ノード-126-brightgreen) ![生存](https://img.shields.io/badge/生存-2014-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-376ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-23_13:12_UTC-informational)
...
- **最速 RTT**: 30 ms
- **中央値 RTT**: 376 ms
- **最終更新 (UTC)**: 2026-06-23 13:12 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 38 · trojan × 30 · vless × 47 · vmess × 10

**今回使用したソース:** `barry-far-v2ray` × 7 · `ebrasha-v2ray` × 1 · `epodonios` × 41 · `lagzian-mix` × 1 · `mahdi0024` × 7 · `mahdibland-aggregator` × 10 · `mahdibland-shadowsocks` × 10 · `mfuu-clash` × 9 · `ninjastrikers` × 16 · `pawdroid` × 4 · `ruking-clash` × 12 · `surfboard-eternity` × 8
