...
![ノード](https://img.shields.io/badge/ノード-106-brightgreen) ![生存](https://img.shields.io/badge/生存-2314-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-416ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-12_09:29_UTC-informational)
...
- **最速 RTT**: 31 ms
- **中央値 RTT**: 416 ms
- **最終更新 (UTC)**: 2026-06-12 09:29 UTC

**プロトコル構成:** hysteria2 × 1 · shadowsocks × 45 · trojan × 44 · vless × 11 · vmess × 5

**今回使用したソース:** `barry-far-v2ray` × 12 · `epodonios` × 26 · `lagzian-mix` × 4 · `mahdi0024` × 2 · `mahdibland-aggregator` × 12 · `mahdibland-shadowsocks` × 12 · `matin-v2ray` × 1 · `ninjastrikers` × 17 · `pawdroid` × 2 · `ruking-clash` × 12 · `surfboard-eternity` × 6
