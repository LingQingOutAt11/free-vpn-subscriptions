...
![ノード](https://img.shields.io/badge/ノード-93-brightgreen) ![生存](https://img.shields.io/badge/生存-2253-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-171ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-07_06:36_UTC-informational)
...
- **最速 RTT**: 33 ms
- **中央値 RTT**: 171 ms
- **最終更新 (UTC)**: 2026-06-07 06:36 UTC

**プロトコル構成:** shadowsocks × 32 · trojan × 23 · vless × 14 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 4 · `epodonios` × 8 · `lagzian-mix` × 3 · `mahdi0024` × 38 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 7 · `mfuu-clash` × 2 · `ninjastrikers` × 17 · `pawdroid` × 2 · `surfboard-eternity` × 5
