...
![ノード](https://img.shields.io/badge/ノード-140-brightgreen) ![生存](https://img.shields.io/badge/生存-1964-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-400ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-21_20:26_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 400 ms
- **最終更新 (UTC)**: 2026-06-21 20:26 UTC

**プロトコル構成:** shadowsocks × 48 · trojan × 32 · vless × 46 · vmess × 14

**今回使用したソース:** `barry-far-v2ray` × 19 · `epodonios` × 24 · `lagzian-mix` × 1 · `mahdi0024` × 8 · `mahdibland-aggregator` × 15 · `mahdibland-shadowsocks` × 11 · `matin-v2ray` × 2 · `mfuu-clash` × 1 · `ninjastrikers` × 15 · `pawdroid` × 2 · `ruking-clash` × 27 · `snakem982` × 9 · `surfboard-eternity` × 6
