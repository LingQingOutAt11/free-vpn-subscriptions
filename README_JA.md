...
![ノード](https://img.shields.io/badge/ノード-134-brightgreen) ![生存](https://img.shields.io/badge/生存-2084-blue) ![中央値--rtt](https://img.shields.io/badge/中央値--rtt-465ms-orange) ![更新](https://img.shields.io/badge/更新-2026-06-20_21:20_UTC-informational)
...
- **最速 RTT**: 27 ms
- **中央値 RTT**: 465 ms
- **最終更新 (UTC)**: 2026-06-20 21:20 UTC

**プロトコル構成:** shadowsocks × 39 · trojan × 35 · vless × 36 · vmess × 24

**今回使用したソース:** `barry-far-v2ray` × 13 · `epodonios` × 15 · `mahdi0024` × 28 · `mahdibland-aggregator` × 7 · `mahdibland-shadowsocks` × 13 · `mfuu-clash` × 5 · `ninjastrikers` × 13 · `pawdroid` × 3 · `ruking-clash` × 35 · `snakem982` × 1 · `surfboard-eternity` × 1
